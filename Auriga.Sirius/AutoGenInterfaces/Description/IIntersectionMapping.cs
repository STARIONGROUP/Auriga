...
namespace Auriga.Sirius.Table.Description
{
    ...
    /// </summary>
    public partial interface IIntersectionMapping : Auriga.Sirius.Table.Description.ITableMapping, Auriga.Sirius.Table.Description.ICellUpdater, Auriga.Sirius.Table.Description.IStyleUpdater
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Sirius.Table.Description.IColumnMapping ColumnMapping { get; set; }

        /// <summary>
        /// Gets or sets the create.
        /// </summary>
        Auriga.Sirius.Table.Description.ICreateCellTool Create { get; set; }
        ...
        /// </summary>
        List<Auriga.Sirius.Table.Description.ILineMapping> LineMapping { get; }
