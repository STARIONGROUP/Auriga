...
namespace Auriga.Sirius.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface IRepresentationNavigationDescription : Auriga.Sirius.Viewpoint.Description.Tool.IAbstractToolDescription
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Sirius.Viewpoint.Description.IRepresentationDescription RepresentationDescription { get; }

        /// <summary>
        /// The variable representationName that represents the name of the representation to open.
        /// </summary>
        Auriga.Sirius.Viewpoint.Description.Tool.INameVariable RepresentationNameVariable { get; set; }
