...
namespace Auriga.Sirius.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface IOperationAction : Auriga.Sirius.Viewpoint.Description.Tool.IMenuItemDescriptionWithIcon, Auriga.Sirius.Viewpoint.Description.Tool.IGroupMenuItem
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Sirius.Viewpoint.Description.Tool.IContainerViewVariable View { get; set; }
