// ------------------------------------------------------------------------------------------------
// <copyright file="IChangeContext.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface IChangeContext : Auriga.Sirius.Viewpoint.Description.Tool.IContainerModelOperation
    {
        /// <summary>
