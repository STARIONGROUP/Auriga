...
namespace Auriga.Sirius.Diagram
{
    ...
    /// </summary>
    public partial interface IDDiagram : Auriga.Sirius.Viewpoint.IDRepresentation, Auriga.Sirius.Diagram.IDragAndDropTarget
    {
        /// <summary>
        /// Behaviors that are currently activated for this viewpoint.
        /// </summary>
        List<Auriga.Sirius.Diagram.Description.Tool.IBehaviorTool> ActivateBehaviors { get; }

        /// <summary>
        /// Filters that are currently activated for this viewpoint.
        /// </summary>
        List<Auriga.Sirius.Diagram.Description.Filter.IFilterDescription> ActivatedFilters { get; }

        /// <summary>
        /// Gets the activated layers.
        /// </summary>
        List<Auriga.Sirius.Diagram.Description.ILayer> ActivatedLayers { get; }

        /// <summary>
        /// Validation rules that are currently activated for this viewpoint.
        /// </summary>
        List<Auriga.Sirius.Viewpoint.Description.Validation.IValidationRule> ActivatedRules { get; }

        /// <summary>
        /// Gets the activated transient layers.
        /// </summary>
        IEnumerable<Auriga.Sirius.Diagram.Description.IAdditionalLayer> ActivatedTransientLayers { get; }

        /// <summary>
        /// Filters that can be activated for this viewpoint.
        /// </summary>
        IEnumerable<Auriga.Sirius.Diagram.Description.Filter.IFilterDescription> AllFilters { get; }
        ...
        /// </summary>
        Auriga.Sirius.Diagram.Description.Concern.IConcernDescription CurrentConcern { get; set; }

        /// <summary>
        /// The description of the diagram. It may be null.
        /// </summary>
        Auriga.Sirius.Diagram.Description.IDiagramDescription Description { get; set; }

        /// <summary>
        /// The diagram elements directly and indirectly owned by this diagram.
        /// </summary>
        IEnumerable<Auriga.Sirius.Diagram.IDDiagramElement> DiagramElements { get; }

        /// <summary>
        /// All edges of the diagram. It is a subset of diagramElements
        /// </summary>
        IEnumerable<Auriga.Sirius.Diagram.IDEdge> Edges { get; }

        /// <summary>
        /// Gets or sets the filter variable history.
        /// </summary>
        Auriga.Sirius.Diagram.IFilterVariableHistory FilterVariableHistory { get; set; }
        ...
        /// </summary>
        IEnumerable<Auriga.Sirius.Diagram.IDDiagramElement> HiddenElements { get; }
        ...
        /// </summary>
        IEnumerable<Auriga.Sirius.Diagram.IDNodeListElement> NodeListElements { get; }
