...
namespace Auriga.Sirius.Sequence.Template
{
    ...
    /// </summary>
    public partial interface ITBasicMessageMapping : Auriga.Sirius.Sequence.Template.ITSourceTargetMessageMapping
    {
        /// <summary>
        ...
        /// Gets the target.
        /// </summary>
        List<Auriga.Sirius.Sequence.Template.ITMessageExtremity> Target { get; }
