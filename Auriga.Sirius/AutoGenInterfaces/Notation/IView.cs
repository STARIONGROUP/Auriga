...
namespace Auriga.Sirius.Notation
{
    ...
    public partial interface IView : Auriga.Core.IAurigaElement
    {
        ...
        /// Gets the diagram.
        /// </summary>
        Auriga.Sirius.Notation.IDiagram Diagram_ { get; }
        ...
        /// </summary>
        IEnumerable<Auriga.Sirius.Notation.IEdge> SourceEdges { get; }
        ...
        /// </summary>
        IEnumerable<Auriga.Sirius.Notation.IEdge> TargetEdges { get; }

        /// <summary>
        /// Gets the transient children.
        /// </summary>
        IEnumerable<Auriga.Sirius.Notation.INode> TransientChildren { get; }
