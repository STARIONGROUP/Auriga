...
namespace Auriga.Sirius.Notation
{
    ...
    /// </summary>
    public partial interface IRoutingStyle : Auriga.Sirius.Notation.IRoundedCornersStyle
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Sirius.Notation.JumpLinkStatus? JumpLinkStatus { get; set; }

        /// <summary>
        /// Gets or sets the jump link type.
        /// </summary>
        Auriga.Sirius.Notation.JumpLinkType? JumpLinkType { get; set; }
        ...
        /// </summary>
        Auriga.Sirius.Notation.Routing? Routing { get; set; }

        /// <summary>
        /// Gets or sets the smoothness.
        /// </summary>
        Auriga.Sirius.Notation.Smoothness? Smoothness { get; set; }
