// ------------------------------------------------------------------------------------------------
// <copyright file="ArrowStyle.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Notation
{
    ...
    public partial class ArrowStyle : Auriga.AurigaElement, Auriga.Sirius.Notation.IArrowStyle
    {
        ...
        /// </summary>
        public Auriga.Sirius.Notation.ArrowType? ArrowSource { get; set; }

        /// <summary>
        /// Gets or sets the arrow target.
        /// </summary>
        public Auriga.Sirius.Notation.ArrowType? ArrowTarget { get; set; }
