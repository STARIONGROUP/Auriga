// ------------------------------------------------------------------------------------------------
// <copyright file="MultiDiagramLinkStyle.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Notation
{
    ...
    public partial class MultiDiagramLinkStyle : Auriga.Core.AurigaElement, Auriga.Sirius.Notation.IMultiDiagramLinkStyle
    {
        ...
        /// </summary>
        public List<Auriga.Sirius.Notation.IDiagram> DiagramLinks { get; } = new List<Auriga.Sirius.Notation.IDiagram>();
