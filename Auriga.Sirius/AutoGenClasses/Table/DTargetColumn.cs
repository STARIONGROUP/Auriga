// ------------------------------------------------------------------------------------------------
// <copyright file="DTargetColumn.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Table
{
    ...
    public partial class DTargetColumn : Auriga.AurigaElement, Auriga.Sirius.Table.IDTargetColumn
    {
        ...
        /// </summary>
        private Auriga.Sirius.Table.IDTableElementStyle backingCurrentStyle;
        ...
        /// </summary>
        public IEnumerable<Auriga.Sirius.Table.IDCell> OrderedCells => Enumerable.Empty<Auriga.Sirius.Table.IDCell>();

        /// <summary>
        /// Gets or sets the origin mapping.
        /// </summary>
        public Auriga.Sirius.Table.Description.IColumnMapping OriginMapping { get; set; }
        ...
        /// </summary>
        public Auriga.Sirius.Table.IDTable Table { get; set; }
