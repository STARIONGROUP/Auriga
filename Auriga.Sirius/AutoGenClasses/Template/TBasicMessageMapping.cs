...
namespace Auriga.Sirius.Sequence.Template
{
    ...
    /// </summary>
    public partial class TBasicMessageMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Template.ITBasicMessageMapping
    {
        /// <summary>
        ...
        /// Gets the target.
        /// </summary>
        public List<Auriga.Sirius.Sequence.Template.ITMessageExtremity> Target { get; } = new List<Auriga.Sirius.Sequence.Template.ITMessageExtremity>();
