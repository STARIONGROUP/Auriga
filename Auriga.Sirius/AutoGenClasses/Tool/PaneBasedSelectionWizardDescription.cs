// ------------------------------------------------------------------------------------------------
// <copyright file="PaneBasedSelectionWizardDescription.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>PaneBasedSelectionWizardDescription</c> class.
    /// </summary>
    public partial class PaneBasedSelectionWizardDescription : Auriga.Core.AurigaElement, Auriga.Sirius.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription
    {
        /// <summary>
        ...
        /// </summary>
        public string PreSelectedCandidatesExpression { get; set; }
