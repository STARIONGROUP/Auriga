...
namespace Auriga.Sirius.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial class Switch : Auriga.Core.AurigaElement, Auriga.Sirius.Viewpoint.Description.Tool.ISwitch
    {
        /// <summary>
        /// Gets the cases.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Sirius.Viewpoint.Description.Tool.ICase> Cases => this.backingCases ??= new Auriga.Core.ContainerList<Auriga.Sirius.Viewpoint.Description.Tool.ICase>(this);

        /// <summary>
        /// Backing field for <see cref="Cases"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Sirius.Viewpoint.Description.Tool.ICase> backingCases;
