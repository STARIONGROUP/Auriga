// ------------------------------------------------------------------------------------------------
// <copyright file="MenuItemDescriptionReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Viewpoint.Description.Tool
{
    ...
    public partial class MenuItemDescriptionReference : Auriga.Core.AurigaElement, Auriga.Sirius.Viewpoint.Description.Tool.IMenuItemDescriptionReference
    {
        ...
        /// </summary>
        public Auriga.Sirius.Viewpoint.Description.Tool.IMenuItemDescription Item { get; set; }
