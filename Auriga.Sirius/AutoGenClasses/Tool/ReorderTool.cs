...
namespace Auriga.Sirius.Sequence.Description.Tool
{
    ...
    /// </summary>
    public partial class ReorderTool : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Description.Tool.IReorderTool
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Sirius.Sequence.Description.IMessageEndVariable FinishingEndPredecessorAfter
        {
        ...
        /// </summary>
        private Auriga.Sirius.Sequence.Description.IMessageEndVariable backingFinishingEndPredecessorAfter;

        /// <summary>
        /// Gets or sets the finishing end predecessor before.
        /// </summary>
        public Auriga.Sirius.Sequence.Description.IMessageEndVariable FinishingEndPredecessorBefore
        {
        ...
        /// </summary>
        private Auriga.Sirius.Sequence.Description.IMessageEndVariable backingFinishingEndPredecessorBefore;
        ...
        /// Gets the mappings.
        /// </summary>
        public List<Auriga.Sirius.Sequence.Description.IEventMapping> Mappings { get; } = new List<Auriga.Sirius.Sequence.Description.IEventMapping>();
        ...
        /// </summary>
        public Auriga.Sirius.Viewpoint.Description.Tool.IInitialOperation OnEventMovedOperation
        {
        ...
        /// </summary>
        private Auriga.Sirius.Viewpoint.Description.Tool.IInitialOperation backingOnEventMovedOperation;
        ...
        /// </summary>
        public Auriga.Sirius.Sequence.Description.IMessageEndVariable StartingEndPredecessorAfter
        {
        ...
        /// </summary>
        private Auriga.Sirius.Sequence.Description.IMessageEndVariable backingStartingEndPredecessorAfter;

        /// <summary>
        /// Gets or sets the starting end predecessor before.
        /// </summary>
        public Auriga.Sirius.Sequence.Description.IMessageEndVariable StartingEndPredecessorBefore
        {
        ...
        /// </summary>
        private Auriga.Sirius.Sequence.Description.IMessageEndVariable backingStartingEndPredecessorBefore;
