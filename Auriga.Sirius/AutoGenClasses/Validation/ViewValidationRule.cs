...
namespace Auriga.Sirius.Viewpoint.Description.Validation
{
    ...
    public partial class ViewValidationRule : Auriga.Core.AurigaElement, Auriga.Sirius.Viewpoint.Description.Validation.IViewValidationRule
    {
        ...
        /// </summary>
        public List<Auriga.Sirius.Viewpoint.Description.IRepresentationElementMapping> Targets { get; } = new List<Auriga.Sirius.Viewpoint.Description.IRepresentationElementMapping>();
