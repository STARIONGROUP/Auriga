// ------------------------------------------------------------------------------------------------
// <copyright file="StateMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>StateMapping</c> class.
    /// </summary>
    public partial class StateMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Description.IStateMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>StateMapping</c>.
        /// </summary>
