// ------------------------------------------------------------------------------------------------
// <copyright file="CombinedFragmentMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>CombinedFragmentMapping</c> class.
    /// </summary>
    public partial class CombinedFragmentMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Description.ICombinedFragmentMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the center label expression.
        /// </summary>
        public string CenterLabelExpression { get; set; }

        /// <summary>
        /// Set to List if you want a container acting like a list.
        /// </summary>
        public Auriga.Sirius.Diagram.ContainerLayout ChildrenPresentation { get; set; }
        ...
        /// <summary>
        /// Gets or sets the covered lifelines expression.
        /// </summary>
        public string CoveredLifelinesExpression { get; set; }
        ...
        /// </summary>
        public List<Auriga.Sirius.Diagram.Description.INodeMapping> ReusedBorderedNodeMappings { get; } = new List<Auriga.Sirius.Diagram.Description.INodeMapping>();

        /// <summary>
        /// Gets the reused container mappings.
        /// </summary>
        public List<Auriga.Sirius.Diagram.Description.IContainerMapping> ReusedContainerMappings { get; } = new List<Auriga.Sirius.Diagram.Description.IContainerMapping>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CombinedFragmentMapping</c>.
        /// </summary>
