// ------------------------------------------------------------------------------------------------
// <copyright file="ExecutionMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>ExecutionMapping</c> class.
    /// </summary>
    public partial class ExecutionMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Description.IExecutionMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExecutionMapping</c>.
        /// </summary>
