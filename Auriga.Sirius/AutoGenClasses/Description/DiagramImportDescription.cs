// ------------------------------------------------------------------------------------------------
// <copyright file="DiagramImportDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Diagram.Description
{
    ...
    public partial class DiagramImportDescription : Auriga.AurigaElement, Auriga.Sirius.Diagram.Description.IDiagramImportDescription
    {
        ...
        /// </summary>
        public Auriga.Sirius.Diagram.Description.IDiagramDescription ImportedDiagram { get; set; }
