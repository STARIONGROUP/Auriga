// ------------------------------------------------------------------------------------------------
// <copyright file="InstanceRoleMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>InstanceRoleMapping</c> class.
    /// </summary>
    public partial class InstanceRoleMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Description.IInstanceRoleMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InstanceRoleMapping</c>.
        /// </summary>
