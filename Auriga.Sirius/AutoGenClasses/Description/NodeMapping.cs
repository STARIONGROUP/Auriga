// ------------------------------------------------------------------------------------------------
// <copyright file="NodeMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Diagram.Description
{
    ...
    /// </summary>
    public partial class NodeMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Diagram.Description.INodeMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>NodeMapping</c>.
        /// </summary>
