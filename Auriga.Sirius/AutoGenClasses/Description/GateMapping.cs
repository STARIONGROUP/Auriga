// ------------------------------------------------------------------------------------------------
// <copyright file="GateMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>GateMapping</c> class.
    /// </summary>
    public partial class GateMapping : Auriga.Core.AurigaElement, Auriga.Sirius.Sequence.Description.IGateMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>GateMapping</c>.
        /// </summary>
