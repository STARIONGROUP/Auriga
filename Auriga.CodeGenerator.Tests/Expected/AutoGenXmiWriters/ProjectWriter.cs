...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellamodeller
{
    ...
    /// </summary>
    public class ProjectWriter : XmiElementWriter<Auriga.Capellamodeller.IProject>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellamodeller.IProject poco, IXmiWriteContext context)
        {
