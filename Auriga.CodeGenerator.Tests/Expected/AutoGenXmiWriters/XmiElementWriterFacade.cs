    ...
    public sealed class XmiElementWriterFacade : IXmiElementWriterFacade
    {
        ...
        public XmiElementWriterFacade(ILoggerFactory? loggerFactory = null)
        {
            this.writers = new Dictionary<Type, IXmiElementWriter>()
            {
                ...
                [typeof(Auriga.Model.Cybersecurity.CybersecurityConfiguration)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.CybersecurityConfigurationWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.CybersecurityPkg)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.CybersecurityPkgWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.EnterprisePrimaryAsset)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.EnterprisePrimaryAssetWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.FunctionStorage)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.FunctionStorageWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.FunctionalPrimaryAsset)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.FunctionalPrimaryAssetWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.InformationPrimaryAsset)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.InformationPrimaryAssetWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.PrimaryAssetMember)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.PrimaryAssetMemberWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.PrimaryAssetStorage)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.PrimaryAssetStorageWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.SecurityNeeds)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.SecurityNeedsWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.Threat)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.ThreatWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.ThreatApplication)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.ThreatApplicationWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.ThreatInvolvement)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.ThreatInvolvementWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.ThreatSourceUse)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.ThreatSourceUseWriter(this, loggerFactory),
                [typeof(Auriga.Model.Cybersecurity.TrustBoundaryStorage)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity.TrustBoundaryStorageWriter(this, loggerFactory),
                ...
                [typeof(Auriga.Model.Mass.Mass)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Mass.MassWriter(this, loggerFactory),
                [typeof(Auriga.Model.Mass.PartMass)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Mass.PartMassWriter(this, loggerFactory),
                ...
                [typeof(Auriga.Model.Requirement.RequirementsPkg)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.RequirementsPkgWriter(this, loggerFactory),
                [typeof(Auriga.Model.Requirement.RequirementsTrace)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.RequirementsTraceWriter(this, loggerFactory),
                [typeof(Auriga.Model.Requirement.SystemFunctionalInterfaceRequirement)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.SystemFunctionalInterfaceRequirementWriter(this, loggerFactory),
                [typeof(Auriga.Model.Requirement.SystemFunctionalRequirement)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.SystemFunctionalRequirementWriter(this, loggerFactory),
                [typeof(Auriga.Model.Requirement.SystemNonFunctionalInterfaceRequirement)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.SystemNonFunctionalInterfaceRequirementWriter(this, loggerFactory),
                [typeof(Auriga.Model.Requirement.SystemNonFunctionalRequirement)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.SystemNonFunctionalRequirementWriter(this, loggerFactory),
                [typeof(Auriga.Model.Requirement.SystemUserRequirement)] = new Auriga.Xmi.Model.AutoGenXmiWriters.Requirement.SystemUserRequirementWriter(this, loggerFactory),
