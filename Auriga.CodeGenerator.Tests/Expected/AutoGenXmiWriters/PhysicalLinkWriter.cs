...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkWriter : XmiElementWriter<Auriga.Cs.IPhysicalLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalLink poco, IXmiWriteContext context)
        {
