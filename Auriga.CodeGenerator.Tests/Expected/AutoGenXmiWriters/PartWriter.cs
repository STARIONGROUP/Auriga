...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PartWriter : XmiElementWriter<Auriga.Model.Cs.IPart>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>Part</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cs.IPart poco, IXmiWriteContext context)
        {
