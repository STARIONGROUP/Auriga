...
namespace Auriga.Ctx
{
    ...
    /// </summary>
    public partial class SystemCommunication : Auriga.AurigaElement, Auriga.Ctx.ISystemCommunication
    {
        /// <summary>
        ...
        /// Gets the ends.
        /// </summary>
        public Auriga.IContainerList<Auriga.Ctx.ISystemCommunicationHook> Ends => this.backingEnds ??= new Auriga.ContainerList<Auriga.Ctx.ISystemCommunicationHook>(this);

        /// <summary>
        /// Backing field for <see cref="Ends"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Ctx.ISystemCommunicationHook> backingEnds;
