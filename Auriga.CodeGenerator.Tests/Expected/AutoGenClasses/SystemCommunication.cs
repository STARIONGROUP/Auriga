...
namespace Auriga.Ctx
{
    ...
    /// </summary>
    public partial class SystemCommunication : Auriga.Core.AurigaElement, Auriga.Ctx.ISystemCommunication
    {
        /// <summary>
        ...
        /// Gets the ends.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.ISystemCommunicationHook> Ends => this.backingEnds ??= new Auriga.Core.ContainerList<Auriga.Ctx.ISystemCommunicationHook>(this);

        /// <summary>
        /// Backing field for <see cref="Ends"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.ISystemCommunicationHook> backingEnds;
