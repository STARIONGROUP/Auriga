...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial class PhysicalLink : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalLink
    {
        /// <summary>
        ...
        /// Gets the categories.
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalLinkCategory> Categories => Enumerable.Empty<Auriga.Model.Cs.IPhysicalLinkCategory>();
        ...
        /// Gets the link ends.
        /// </summary>
        public List<Auriga.Model.Cs.IAbstractPhysicalLinkEnd> LinkEnds { get; } = new List<Auriga.Model.Cs.IAbstractPhysicalLinkEnd>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalLinkEnd> OwnedPhysicalLinkEnds => this.backingOwnedPhysicalLinkEnds ??= new Auriga.Core.ContainerList<Auriga.Model.Cs.IPhysicalLinkEnd>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalLinkEnds"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalLinkEnd> backingOwnedPhysicalLinkEnds;

        /// <summary>
        /// Gets the owned physical link realizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalLinkRealization> OwnedPhysicalLinkRealizations => this.backingOwnedPhysicalLinkRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Cs.IPhysicalLinkRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalLinkRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalLinkRealization> backingOwnedPhysicalLinkRealizations;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalLink> RealizedPhysicalLinks => Enumerable.Empty<Auriga.Model.Cs.IPhysicalLink>();

        /// <summary>
        /// Gets the realizing physical links.
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalLink> RealizingPhysicalLinks => Enumerable.Empty<Auriga.Model.Cs.IPhysicalLink>();
        ...
        /// </summary>
        public Auriga.Model.Cs.IPhysicalPort SourcePhysicalPort => default;
        ...
        /// </summary>
        public Auriga.Model.Cs.IPhysicalPort TargetPhysicalPort => default;
