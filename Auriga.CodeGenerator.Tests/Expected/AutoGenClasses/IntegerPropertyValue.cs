// ------------------------------------------------------------------------------------------------
// <copyright file="IntegerPropertyValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>IntegerPropertyValue</c> class.
    /// </summary>
    public partial class IntegerPropertyValue : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IIntegerPropertyValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>IntegerPropertyValue</c>.
        /// </summary>
