...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellamodeller
{
    ...
    /// </summary>
    public class ProjectReader : XmiElementReader<Auriga.Capellamodeller.IProject>, IXmiElementReader<Auriga.Capellamodeller.IProject>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellamodeller.IProject"/></returns>
        public Auriga.Capellamodeller.IProject Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellamodeller.Project();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedFolders":
                            {
                                ...
                                {
                                    poco.OwnedFolders.Add((Auriga.Capellamodeller.IFolder)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedModelRoots":
                            {
                                ...
                                {
                                    poco.OwnedModelRoots.Add((Auriga.Capellamodeller.IModelRoot)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
