...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa.Deployment
{
    ...
    /// </summary>
    public class PartDeploymentLinkReader : XmiElementReader<Auriga.Pa.Deployment.IPartDeploymentLink>, IXmiElementReader<Auriga.Pa.Deployment.IPartDeploymentLink>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.Deployment.IPartDeploymentLink"/></returns>
        public Auriga.Pa.Deployment.IPartDeploymentLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.Deployment.PartDeploymentLink();
