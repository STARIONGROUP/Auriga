...
namespace Auriga.Extensions
{
    ...
    /// <summary>
    /// Query extensions for <see cref="Auriga.Model.Fa.IFunctionalExchange"/> — the directed flow between two
    ...
    public static class FunctionalExchangeExtensions
    {
        ...
        public static Auriga.Model.Fa.IAbstractFunction? QuerySourceFunction(this Auriga.Model.Fa.IFunctionalExchange exchange)
        {
            if (exchange is null)
            {
            ...
            return (exchange.Source as IAurigaElement)?.Container as Auriga.Model.Fa.IAbstractFunction;
        }
        ...
        /// <exception cref="ArgumentNullException">thrown when <paramref name="exchange"/> is <c>null</c></exception>
        public static Auriga.Model.Fa.IAbstractFunction? QueryTargetFunction(this Auriga.Model.Fa.IFunctionalExchange exchange)
        {
            if (exchange is null)
            {
                throw new ArgumentNullException(nameof(exchange));
            ...
            return (exchange.Target as IAurigaElement)?.Container as Auriga.Model.Fa.IAbstractFunction;
        }
    }
}
