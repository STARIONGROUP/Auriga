...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    public class LogicalFunctionPkgReader : XmiElementReader<Auriga.La.ILogicalFunctionPkg>, IXmiElementReader<Auriga.La.ILogicalFunctionPkg>
    {
        ...
        public Auriga.La.ILogicalFunctionPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedLogicalFunctions":
                            {
                                ...
                                {
                                    poco.OwnedLogicalFunctions.Add((Auriga.La.ILogicalFunction)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
