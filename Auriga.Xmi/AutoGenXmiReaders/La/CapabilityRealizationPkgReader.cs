                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityRealizationPkgs":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityRealizationPkgs.Add((Auriga.La.ICapabilityRealizationPkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedCapabilityRealizations":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityRealizations.Add((Auriga.La.ICapabilityRealization)this.Facade.QueryElement(xmlReader));
                                }
