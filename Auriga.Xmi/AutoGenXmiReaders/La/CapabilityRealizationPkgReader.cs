...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    /// </summary>
    public class CapabilityRealizationPkgReader : XmiElementReader<Auriga.La.ICapabilityRealizationPkg>, IXmiElementReader<Auriga.La.ICapabilityRealizationPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.La.ICapabilityRealizationPkg"/></returns>
        public Auriga.La.ICapabilityRealizationPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.La.CapabilityRealizationPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityRealizationPkgs":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityRealizationPkgs.Add((Auriga.La.ICapabilityRealizationPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedCapabilityRealizations":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityRealizations.Add((Auriga.La.ICapabilityRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
