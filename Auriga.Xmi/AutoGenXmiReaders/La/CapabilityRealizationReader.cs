...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    public class CapabilityRealizationReader : XmiElementReader<Auriga.La.ICapabilityRealization>, IXmiElementReader<Auriga.La.ICapabilityRealization>
    {
        ...
        public Auriga.La.ICapabilityRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityRealizationInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityRealizationInvolvements.Add((Auriga.Capellacommon.ICapabilityRealizationInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
