...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    /// </summary>
    public class LogicalArchitecturePkgReader : XmiElementReader<Auriga.La.ILogicalArchitecturePkg>, IXmiElementReader<Auriga.La.ILogicalArchitecturePkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.La.ILogicalArchitecturePkg"/></returns>
        public Auriga.La.ILogicalArchitecturePkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.La.LogicalArchitecturePkg();
