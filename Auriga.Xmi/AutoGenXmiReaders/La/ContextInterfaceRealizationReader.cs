...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    /// </summary>
    public class ContextInterfaceRealizationReader : XmiElementReader<Auriga.La.IContextInterfaceRealization>, IXmiElementReader<Auriga.La.IContextInterfaceRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.La.IContextInterfaceRealization"/></returns>
        public Auriga.La.IContextInterfaceRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.La.ContextInterfaceRealization();
