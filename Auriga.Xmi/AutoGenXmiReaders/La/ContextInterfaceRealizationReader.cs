...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    public class ContextInterfaceRealizationReader : XmiElementReader<Auriga.La.IContextInterfaceRealization>, IXmiElementReader<Auriga.La.IContextInterfaceRealization>
    {
        ...
        public ContextInterfaceRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.La.IContextInterfaceRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of ContextInterfaceRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
