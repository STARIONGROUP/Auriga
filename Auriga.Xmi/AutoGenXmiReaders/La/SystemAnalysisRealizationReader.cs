...
namespace Auriga.Xmi.AutoGenXmiReaders.La
{
    ...
    /// </summary>
    public class SystemAnalysisRealizationReader : XmiElementReader<Auriga.La.ISystemAnalysisRealization>, IXmiElementReader<Auriga.La.ISystemAnalysisRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.La.ISystemAnalysisRealization"/></returns>
        public Auriga.La.ISystemAnalysisRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.La.SystemAnalysisRealization();
