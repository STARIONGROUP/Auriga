...
namespace Auriga.Xmi.AutoGenXmiReaders.Libraries
{
    ...
    public class LibraryReferenceReader : XmiElementReader<Auriga.Libraries.ILibraryReference>, IXmiElementReader<Auriga.Libraries.ILibraryReference>
    {
        ...
        public Auriga.Libraries.ILibraryReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Libraries.AccessPolicy>(xmlReader.GetAttribute("accessPolicy"), out var parsed))
                    {
