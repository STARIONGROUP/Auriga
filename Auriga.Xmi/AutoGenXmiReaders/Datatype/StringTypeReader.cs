...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datatype
{
    ...
    public class StringTypeReader : XmiElementReader<Auriga.Information.Datatype.IStringType>, IXmiElementReader<Auriga.Information.Datatype.IStringType>
    {
        ...
        public Auriga.Information.Datatype.IStringType Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "ownedDefaultValue":
                        {
                            ...
                            else { var contained = (Auriga.Information.Datavalue.IAbstractStringValue)this.Facade.QueryElement(xmlReader); contained.Container = poco; poco.OwnedDefaultValue = contained; }
                            break;
                        }
                            ...
                            case "ownedNullValue":
                        {
                            ...
                            else { var contained = (Auriga.Information.Datavalue.IAbstractStringValue)this.Facade.QueryElement(xmlReader); contained.Container = poco; poco.OwnedNullValue = contained; }
                            break;
                        }
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of StringType at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
