...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datatype
{
    ...
    /// </summary>
    public class StringTypeReader : XmiElementReader<Auriga.Information.Datatype.IStringType>, IXmiElementReader<Auriga.Information.Datatype.IStringType>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datatype.IStringType"/></returns>
        public Auriga.Information.Datatype.IStringType Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datatype.StringType();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDefaultValue":
                            {
                                ...
                                {
                                    poco.OwnedDefaultValue = (Auriga.Information.Datavalue.IAbstractStringValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedNullValue":
                            {
                                ...
                                {
                                    poco.OwnedNullValue = (Auriga.Information.Datavalue.IAbstractStringValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
