...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datatype
{
    ...
    public class EnumerationReader : XmiElementReader<Auriga.Information.Datatype.IEnumeration>, IXmiElementReader<Auriga.Information.Datatype.IEnumeration>
    {
        ...
        public Auriga.Information.Datatype.IEnumeration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDefaultValue":
                            {
                                ...
                                {
                                    poco.OwnedDefaultValue = (Auriga.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedLiterals":
                            {
                                ...
                                {
                                    poco.OwnedLiterals.Add((Auriga.Information.Datavalue.IEnumerationLiteral)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMaxValue":
                            {
                                ...
                                {
                                    poco.OwnedMaxValue = (Auriga.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedMinValue":
                            {
                                ...
                                {
                                    poco.OwnedMinValue = (Auriga.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedNullValue":
                            {
                                ...
                                {
                                    poco.OwnedNullValue = (Auriga.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
