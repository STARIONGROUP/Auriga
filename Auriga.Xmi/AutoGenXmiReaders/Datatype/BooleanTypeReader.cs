...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datatype
{
    ...
    public class BooleanTypeReader : XmiElementReader<Auriga.Information.Datatype.IBooleanType>, IXmiElementReader<Auriga.Information.Datatype.IBooleanType>
    {
        ...
        public Auriga.Information.Datatype.IBooleanType Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDefaultValue":
                            {
                                ...
                                {
                                    var contained = (Auriga.Information.Datavalue.IAbstractBooleanValue)this.Facade.QueryElement(xmlReader);
                            ...
                            case "ownedLiterals":
                            {
                                ...
                                {
                                    poco.OwnedLiterals.Add((Auriga.Information.Datavalue.ILiteralBooleanValue)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of BooleanType at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
