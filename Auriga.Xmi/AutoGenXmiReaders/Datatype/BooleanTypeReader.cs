                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "ownedDefaultValue":
                        {
                            ...
                            else { var contained = (Auriga.Information.Datavalue.IAbstractBooleanValue)this.Facade.QueryElement(xmlReader); contained.Container = poco; poco.OwnedDefaultValue = contained; }
                            break;
                        }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectMultiValueReferences(poco, "OwnedLiterals", href); SkipElement(xmlReader); }
                            else { poco.OwnedLiterals.Add((Auriga.Information.Datavalue.ILiteralBooleanValue)this.Facade.QueryElement(xmlReader)); }
                            break;
                        }
