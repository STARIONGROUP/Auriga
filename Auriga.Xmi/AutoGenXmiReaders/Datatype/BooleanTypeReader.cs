...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datatype
{
    ...
    /// </summary>
    public class BooleanTypeReader : XmiElementReader<Auriga.Information.Datatype.IBooleanType>, IXmiElementReader<Auriga.Information.Datatype.IBooleanType>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datatype.IBooleanType"/></returns>
        public Auriga.Information.Datatype.IBooleanType Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datatype.BooleanType();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDefaultValue":
                            {
                                ...
                                {
                                    poco.OwnedDefaultValue = (Auriga.Information.Datavalue.IAbstractBooleanValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedLiterals":
                            {
                                ...
                                {
                                    poco.OwnedLiterals.Add((Auriga.Information.Datavalue.ILiteralBooleanValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
