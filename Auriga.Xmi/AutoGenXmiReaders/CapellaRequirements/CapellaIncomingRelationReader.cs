...
namespace Auriga.Xmi.AutoGenXmiReaders.CapellaRequirements
{
    ...
    /// </summary>
    public class CapellaIncomingRelationReader : XmiElementReader<Auriga.CapellaRequirements.ICapellaIncomingRelation>, IXmiElementReader<Auriga.CapellaRequirements.ICapellaIncomingRelation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.CapellaRequirements.ICapellaIncomingRelation"/></returns>
        public Auriga.CapellaRequirements.ICapellaIncomingRelation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.CapellaRequirements.CapellaIncomingRelation();
