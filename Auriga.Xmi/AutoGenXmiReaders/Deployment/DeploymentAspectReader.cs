...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa.Deployment
{
    ...
    /// </summary>
    public class DeploymentAspectReader : XmiElementReader<Auriga.Pa.Deployment.IDeploymentAspect>, IXmiElementReader<Auriga.Pa.Deployment.IDeploymentAspect>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.Deployment.IDeploymentAspect"/></returns>
        public Auriga.Pa.Deployment.IDeploymentAspect Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.Deployment.DeploymentAspect();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConfigurations":
                            {
                                ...
                                {
                                    poco.OwnedConfigurations.Add((Auriga.Pa.Deployment.IDeploymentConfiguration)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedDeploymentAspects":
                            {
                                ...
                                {
                                    poco.OwnedDeploymentAspects.Add((Auriga.Pa.Deployment.IDeploymentAspect)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
