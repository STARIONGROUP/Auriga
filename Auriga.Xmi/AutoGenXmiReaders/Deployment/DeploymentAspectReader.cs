                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConfigurations":
                            {
                                ...
                                {
                                    poco.OwnedConfigurations.Add((Auriga.Pa.Deployment.IDeploymentConfiguration)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedDeploymentAspects":
                            {
                                ...
                                {
                                    poco.OwnedDeploymentAspects.Add((Auriga.Pa.Deployment.IDeploymentAspect)this.Facade.QueryElement(xmlReader));
                                }
