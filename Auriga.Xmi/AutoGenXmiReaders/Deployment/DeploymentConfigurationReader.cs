...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa.Deployment
{
    ...
    /// </summary>
    public class DeploymentConfigurationReader : XmiElementReader<Auriga.Pa.Deployment.IDeploymentConfiguration>, IXmiElementReader<Auriga.Pa.Deployment.IDeploymentConfiguration>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.Deployment.IDeploymentConfiguration"/></returns>
        public Auriga.Pa.Deployment.IDeploymentConfiguration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.Deployment.DeploymentConfiguration();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPhysicalInstances":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalInstances.Add((Auriga.Pa.Deployment.IAbstractPhysicalInstance)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
