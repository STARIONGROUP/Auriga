                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedAbstractPhysicalInstances":
                            {
                                ...
                                {
                                    poco.OwnedAbstractPhysicalInstances.Add((Auriga.Pa.Deployment.IAbstractPhysicalInstance)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedInstanceDeploymentLinks":
                            {
                                ...
                                {
                                    poco.OwnedInstanceDeploymentLinks.Add((Auriga.Pa.Deployment.IInstanceDeploymentLink)this.Facade.QueryElement(xmlReader));
                                }
