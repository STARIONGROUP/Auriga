...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa.Deployment
{
    ...
    /// </summary>
    public class ComponentInstanceReader : XmiElementReader<Auriga.Pa.Deployment.IComponentInstance>, IXmiElementReader<Auriga.Pa.Deployment.IComponentInstance>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.Deployment.IComponentInstance"/></returns>
        public Auriga.Pa.Deployment.IComponentInstance Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.Deployment.ComponentInstance();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedAbstractPhysicalInstances":
                            {
                                ...
                                {
                                    poco.OwnedAbstractPhysicalInstances.Add((Auriga.Pa.Deployment.IAbstractPhysicalInstance)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedInstanceDeploymentLinks":
                            {
                                ...
                                {
                                    poco.OwnedInstanceDeploymentLinks.Add((Auriga.Pa.Deployment.IInstanceDeploymentLink)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
