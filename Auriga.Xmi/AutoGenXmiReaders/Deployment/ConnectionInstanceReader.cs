...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa.Deployment
{
    ...
    /// </summary>
    public class ConnectionInstanceReader : XmiElementReader<Auriga.Pa.Deployment.IConnectionInstance>, IXmiElementReader<Auriga.Pa.Deployment.IConnectionInstance>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.Deployment.IConnectionInstance"/></returns>
        public Auriga.Pa.Deployment.IConnectionInstance Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.Deployment.ConnectionInstance();
