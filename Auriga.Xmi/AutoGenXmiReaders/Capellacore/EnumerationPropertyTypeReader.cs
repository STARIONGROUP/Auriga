...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    public class EnumerationPropertyTypeReader : XmiElementReader<Auriga.Capellacore.IEnumerationPropertyType>, IXmiElementReader<Auriga.Capellacore.IEnumerationPropertyType>
    {
        ...
        public EnumerationPropertyTypeReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Capellacore.IEnumerationPropertyType Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "ownedLiterals":
                        {
                            ...
                            else { poco.OwnedLiterals.Add((Auriga.Capellacore.IEnumerationPropertyLiteral)this.Facade.QueryElement(xmlReader)); }
                            break;
                        }
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of EnumerationPropertyType at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
