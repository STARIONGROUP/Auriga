...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class EnumerationPropertyTypeReader : XmiElementReader<Auriga.Capellacore.IEnumerationPropertyType>, IXmiElementReader<Auriga.Capellacore.IEnumerationPropertyType>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IEnumerationPropertyType"/></returns>
        public Auriga.Capellacore.IEnumerationPropertyType Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.EnumerationPropertyType();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedLiterals":
                            {
                                ...
                                {
                                    poco.OwnedLiterals.Add((Auriga.Capellacore.IEnumerationPropertyLiteral)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
