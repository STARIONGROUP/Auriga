...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class IntegerPropertyValueReader : XmiElementReader<Auriga.Capellacore.IIntegerPropertyValue>, IXmiElementReader<Auriga.Capellacore.IIntegerPropertyValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IIntegerPropertyValue"/></returns>
        public Auriga.Capellacore.IIntegerPropertyValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.IntegerPropertyValue();
