...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    public class EnumerationPropertyLiteralReader : XmiElementReader<Auriga.Capellacore.IEnumerationPropertyLiteral>, IXmiElementReader<Auriga.Capellacore.IEnumerationPropertyLiteral>
    {
        ...
        public Auriga.Capellacore.IEnumerationPropertyLiteral Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of EnumerationPropertyLiteral at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
