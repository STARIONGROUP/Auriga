...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class PropertyValuePkgReader : XmiElementReader<Auriga.Capellacore.IPropertyValuePkg>, IXmiElementReader<Auriga.Capellacore.IPropertyValuePkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IPropertyValuePkg"/></returns>
        public Auriga.Capellacore.IPropertyValuePkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.PropertyValuePkg();
