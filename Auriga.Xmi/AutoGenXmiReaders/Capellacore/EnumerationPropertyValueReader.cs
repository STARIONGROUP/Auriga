...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class EnumerationPropertyValueReader : XmiElementReader<Auriga.Capellacore.IEnumerationPropertyValue>, IXmiElementReader<Auriga.Capellacore.IEnumerationPropertyValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IEnumerationPropertyValue"/></returns>
        public Auriga.Capellacore.IEnumerationPropertyValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.EnumerationPropertyValue();
