...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class BooleanPropertyValueReader : XmiElementReader<Auriga.Capellacore.IBooleanPropertyValue>, IXmiElementReader<Auriga.Capellacore.IBooleanPropertyValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IBooleanPropertyValue"/></returns>
        public Auriga.Capellacore.IBooleanPropertyValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.BooleanPropertyValue();
