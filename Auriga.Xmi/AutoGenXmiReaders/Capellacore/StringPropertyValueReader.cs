...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class StringPropertyValueReader : XmiElementReader<Auriga.Capellacore.IStringPropertyValue>, IXmiElementReader<Auriga.Capellacore.IStringPropertyValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IStringPropertyValue"/></returns>
        public Auriga.Capellacore.IStringPropertyValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.StringPropertyValue();
