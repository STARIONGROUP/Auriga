...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacore
{
    ...
    /// </summary>
    public class PropertyValueGroupReader : XmiElementReader<Auriga.Capellacore.IPropertyValueGroup>, IXmiElementReader<Auriga.Capellacore.IPropertyValueGroup>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacore.IPropertyValueGroup"/></returns>
        public Auriga.Capellacore.IPropertyValueGroup Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacore.PropertyValueGroup();
