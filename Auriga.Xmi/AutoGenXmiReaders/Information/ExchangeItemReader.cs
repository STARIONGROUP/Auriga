...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class ExchangeItemReader : XmiElementReader<Auriga.Information.IExchangeItem>, IXmiElementReader<Auriga.Information.IExchangeItem>
    {
        ...
        public Auriga.Information.IExchangeItem Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.ExchangeMechanism>(xmlReader.GetAttribute("exchangeMechanism"), out var parsed))
                    {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedElements":
                            {
                                ...
                                {
                                    poco.OwnedElements.Add((Auriga.Information.IExchangeItemElement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExchangeItemInstances":
                            {
                                ...
                                {
                                    poco.OwnedExchangeItemInstances.Add((Auriga.Information.IExchangeItemInstance)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
