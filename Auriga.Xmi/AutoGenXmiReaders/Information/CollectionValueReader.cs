...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class CollectionValueReader : XmiElementReader<Auriga.Information.ICollectionValue>, IXmiElementReader<Auriga.Information.ICollectionValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.ICollectionValue"/></returns>
        public Auriga.Information.ICollectionValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.CollectionValue();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDefaultElement":
                            {
                                ...
                                {
                                    poco.OwnedDefaultElement = (Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedElements":
                            {
                                ...
                                {
                                    poco.OwnedElements.Add((Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
