...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class DomainElementReader : XmiElementReader<Auriga.Information.IDomainElement>, IXmiElementReader<Auriga.Information.IDomainElement>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IDomainElement"/></returns>
        public Auriga.Information.IDomainElement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.DomainElement();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "nestedGeneralClasses":
                            {
                                ...
                                {
                                    poco.NestedGeneralClasses.Add((Auriga.Capellacore.IGeneralClass)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
