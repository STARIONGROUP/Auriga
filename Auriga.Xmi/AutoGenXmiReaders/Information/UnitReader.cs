...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class UnitReader : XmiElementReader<Auriga.Information.IUnit>, IXmiElementReader<Auriga.Information.IUnit>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IUnit"/></returns>
        public Auriga.Information.IUnit Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Unit();
