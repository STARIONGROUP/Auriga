...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class CollectionReader : XmiElementReader<Auriga.Information.ICollection>, IXmiElementReader<Auriga.Information.ICollection>
    {
        ...
        public Auriga.Information.ICollection Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.CollectionKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
