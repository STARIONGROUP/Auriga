...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class OperationAllocationReader : XmiElementReader<Auriga.Information.IOperationAllocation>, IXmiElementReader<Auriga.Information.IOperationAllocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IOperationAllocation"/></returns>
        public Auriga.Information.IOperationAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.OperationAllocation();
