...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class AssociationReader : XmiElementReader<Auriga.Information.IAssociation>, IXmiElementReader<Auriga.Information.IAssociation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IAssociation"/></returns>
        public Auriga.Information.IAssociation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Association();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedMembers":
                            {
                                ...
                                {
                                    poco.OwnedMembers.Add((Auriga.Information.IProperty)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
