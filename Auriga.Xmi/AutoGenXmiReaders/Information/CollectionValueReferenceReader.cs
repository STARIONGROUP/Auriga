...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class CollectionValueReferenceReader : XmiElementReader<Auriga.Information.ICollectionValueReference>, IXmiElementReader<Auriga.Information.ICollectionValueReference>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.ICollectionValueReference"/></returns>
        public Auriga.Information.ICollectionValueReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.CollectionValueReference();
