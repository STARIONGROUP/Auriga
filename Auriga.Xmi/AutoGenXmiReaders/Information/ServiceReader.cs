...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class ServiceReader : XmiElementReader<Auriga.Information.IService>, IXmiElementReader<Auriga.Information.IService>
    {
        ...
        public Auriga.Information.IService Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.SynchronismKind>(xmlReader.GetAttribute("synchronismKind"), out var parsed))
                    {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedExchangeItemRealizations":
                            {
                                ...
                                {
                                    poco.OwnedExchangeItemRealizations.Add((Auriga.Information.IExchangeItemRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedOperationAllocation":
                            {
                                ...
                                {
                                    poco.OwnedOperationAllocation.Add((Auriga.Information.IOperationAllocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedParameters":
                            {
                                ...
                                {
                                    poco.OwnedParameters.Add((Auriga.Information.IParameter)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
