...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class InformationRealizationReader : XmiElementReader<Auriga.Information.IInformationRealization>, IXmiElementReader<Auriga.Information.IInformationRealization>
    {
        ...
        public InformationRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Information.IInformationRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of InformationRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
