...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class InformationRealizationReader : XmiElementReader<Auriga.Information.IInformationRealization>, IXmiElementReader<Auriga.Information.IInformationRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IInformationRealization"/></returns>
        public Auriga.Information.IInformationRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.InformationRealization();
