...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class ExchangeItemInstanceReader : XmiElementReader<Auriga.Information.IExchangeItemInstance>, IXmiElementReader<Auriga.Information.IExchangeItemInstance>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IExchangeItemInstance"/></returns>
        public Auriga.Information.IExchangeItemInstance Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.ExchangeItemInstance();
