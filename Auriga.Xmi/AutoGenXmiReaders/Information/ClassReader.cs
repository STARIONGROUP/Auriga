...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class ClassReader : XmiElementReader<Auriga.Information.IClass>, IXmiElementReader<Auriga.Information.IClass>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IClass"/></returns>
        public Auriga.Information.IClass Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Class();
