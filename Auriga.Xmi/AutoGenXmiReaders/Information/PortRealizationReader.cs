...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class PortRealizationReader : XmiElementReader<Auriga.Information.IPortRealization>, IXmiElementReader<Auriga.Information.IPortRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IPortRealization"/></returns>
        public Auriga.Information.IPortRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.PortRealization();
