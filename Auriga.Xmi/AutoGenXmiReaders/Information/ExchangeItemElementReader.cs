...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class ExchangeItemElementReader : XmiElementReader<Auriga.Information.IExchangeItemElement>, IXmiElementReader<Auriga.Information.IExchangeItemElement>
    {
        ...
        public Auriga.Information.IExchangeItemElement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.ElementKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
