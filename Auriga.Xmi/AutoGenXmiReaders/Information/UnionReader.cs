...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class UnionReader : XmiElementReader<Auriga.Information.IUnion>, IXmiElementReader<Auriga.Information.IUnion>
    {
        ...
        public Auriga.Information.IUnion Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.UnionKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
