...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class DataPkgReader : XmiElementReader<Auriga.Information.IDataPkg>, IXmiElementReader<Auriga.Information.IDataPkg>
    {
        ...
        public Auriga.Information.IDataPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedAssociations":
                            {
                                ...
                                {
                                    poco.OwnedAssociations.Add((Auriga.Information.IAssociation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedClasses":
                            {
                                ...
                                {
                                    poco.OwnedClasses.Add((Auriga.Information.IClass)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedCollections":
                            {
                                ...
                                {
                                    poco.OwnedCollections.Add((Auriga.Information.ICollection)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedDataPkgs":
                            {
                                ...
                                {
                                    poco.OwnedDataPkgs.Add((Auriga.Information.IDataPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedDataTypes":
                            {
                                ...
                                {
                                    poco.OwnedDataTypes.Add((Auriga.Information.Datatype.IDataType)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExceptions":
                            {
                                ...
                                {
                                    poco.OwnedExceptions.Add((Auriga.Information.Communication.IException)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExchangeItems":
                            {
                                ...
                                {
                                    poco.OwnedExchangeItems.Add((Auriga.Information.IExchangeItem)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedKeyParts":
                            {
                                ...
                                {
                                    poco.OwnedKeyParts.Add((Auriga.Information.IKeyPart)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMessageReferences":
                            {
                                ...
                                {
                                    poco.OwnedMessageReferences.Add((Auriga.Information.Communication.IMessageReference)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMessages":
                            {
                                ...
                                {
                                    poco.OwnedMessages.Add((Auriga.Information.Communication.IMessage)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSignals":
                            {
                                ...
                                {
                                    poco.OwnedSignals.Add((Auriga.Information.Communication.ISignal)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedStateEvents":
                            {
                                ...
                                {
                                    poco.OwnedStateEvents.Add((Auriga.Capellacommon.IStateEvent)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedUnits":
                            {
                                ...
                                {
                                    poco.OwnedUnits.Add((Auriga.Information.IUnit)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
