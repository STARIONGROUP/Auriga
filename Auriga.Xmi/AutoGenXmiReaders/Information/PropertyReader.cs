...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class PropertyReader : XmiElementReader<Auriga.Information.IProperty>, IXmiElementReader<Auriga.Information.IProperty>
    {
        ...
        public Auriga.Information.IProperty Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                            ...
                            case "ownedNullValue":
                    {
                        ...
                        break;
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of Property at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
