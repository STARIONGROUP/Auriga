...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class PropertyReader : XmiElementReader<Auriga.Information.IProperty>, IXmiElementReader<Auriga.Information.IProperty>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IProperty"/></returns>
        public Auriga.Information.IProperty Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Property();
