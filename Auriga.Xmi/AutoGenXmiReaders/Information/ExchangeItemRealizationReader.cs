...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class ExchangeItemRealizationReader : XmiElementReader<Auriga.Information.IExchangeItemRealization>, IXmiElementReader<Auriga.Information.IExchangeItemRealization>
    {
        ...
        public ExchangeItemRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Information.IExchangeItemRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of ExchangeItemRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
