...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    /// </summary>
    public class ExchangeItemRealizationReader : XmiElementReader<Auriga.Information.IExchangeItemRealization>, IXmiElementReader<Auriga.Information.IExchangeItemRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.IExchangeItemRealization"/></returns>
        public Auriga.Information.IExchangeItemRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.ExchangeItemRealization();
