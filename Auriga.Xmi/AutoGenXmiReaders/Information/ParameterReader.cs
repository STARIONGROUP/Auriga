...
namespace Auriga.Xmi.AutoGenXmiReaders.Information
{
    ...
    public class ParameterReader : XmiElementReader<Auriga.Information.IParameter>, IXmiElementReader<Auriga.Information.IParameter>
    {
        ...
        public Auriga.Information.IParameter Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.ParameterDirection>(xmlReader.GetAttribute("direction"), out var parsed))
                    {
                        poco.Direction = parsed;
                    }
                }
                {
                    if (TryParseEnum<Auriga.Modellingcore.ParameterEffectKind>(xmlReader.GetAttribute("effect"), out var parsed))
                    {
                        poco.Effect = parsed;
                    }
                }
                ...
                {
                    if (TryParseEnum<Auriga.Information.PassingMode>(xmlReader.GetAttribute("passingMode"), out var parsed))
                    {
