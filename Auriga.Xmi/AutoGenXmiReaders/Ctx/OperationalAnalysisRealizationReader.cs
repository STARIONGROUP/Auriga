...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    /// </summary>
    public class OperationalAnalysisRealizationReader : XmiElementReader<Auriga.Ctx.IOperationalAnalysisRealization>, IXmiElementReader<Auriga.Ctx.IOperationalAnalysisRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Ctx.IOperationalAnalysisRealization"/></returns>
        public Auriga.Ctx.IOperationalAnalysisRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Ctx.OperationalAnalysisRealization();
