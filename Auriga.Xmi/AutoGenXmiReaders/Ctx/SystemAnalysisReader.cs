...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    public class SystemAnalysisReader : XmiElementReader<Auriga.Ctx.ISystemAnalysis>, IXmiElementReader<Auriga.Ctx.ISystemAnalysis>
    {
        ...
        public Auriga.Ctx.ISystemAnalysis Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedMissionPkg":
                            {
                                ...
                                {
                                    poco.OwnedMissionPkg = (Auriga.Ctx.IMissionPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedOperationalAnalysisRealizations":
                            {
                                ...
                                {
                                    poco.OwnedOperationalAnalysisRealizations.Add((Auriga.Ctx.IOperationalAnalysisRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSystemComponentPkg":
                            {
                                ...
                                {
                                    poco.OwnedSystemComponentPkg = (Auriga.Ctx.ISystemComponentPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
