                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedMissionPkg":
                            {
                                ...
                                {
                                    var contained = (Auriga.Ctx.IMissionPkg)this.Facade.QueryElement(xmlReader);
                                    contained.Container = poco;
                                    poco.OwnedMissionPkg = contained;
                                }
                            ...
                            case "ownedOperationalAnalysisRealizations":
                            {
                                ...
                                {
                                    poco.OwnedOperationalAnalysisRealizations.Add((Auriga.Ctx.IOperationalAnalysisRealization)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedSystemComponentPkg":
                            {
                                ...
                                {
                                    var contained = (Auriga.Ctx.ISystemComponentPkg)this.Facade.QueryElement(xmlReader);
                                    contained.Container = poco;
                                    poco.OwnedSystemComponentPkg = contained;
                                }
