...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    public class CapabilityReader : XmiElementReader<Auriga.Ctx.ICapability>, IXmiElementReader<Auriga.Ctx.ICapability>
    {
        ...
        public Auriga.Ctx.ICapability Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityInvolvements.Add((Auriga.Ctx.ICapabilityInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
