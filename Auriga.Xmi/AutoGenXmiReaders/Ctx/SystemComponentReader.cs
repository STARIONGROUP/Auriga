                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedSystemComponentPkgs":
                            {
                                ...
                                {
                                    poco.OwnedSystemComponentPkgs.Add((Auriga.Ctx.ISystemComponentPkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedSystemComponents":
                            {
                                ...
                                {
                                    poco.OwnedSystemComponents.Add((Auriga.Ctx.ISystemComponent)this.Facade.QueryElement(xmlReader));
                                }
