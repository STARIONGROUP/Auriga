...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    /// </summary>
    public class MissionInvolvementReader : XmiElementReader<Auriga.Ctx.IMissionInvolvement>, IXmiElementReader<Auriga.Ctx.IMissionInvolvement>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Ctx.IMissionInvolvement"/></returns>
        public Auriga.Ctx.IMissionInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Ctx.MissionInvolvement();
