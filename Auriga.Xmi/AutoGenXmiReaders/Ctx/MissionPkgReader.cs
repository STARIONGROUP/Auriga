                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedMissionPkgs":
                            {
                                ...
                                {
                                    poco.OwnedMissionPkgs.Add((Auriga.Ctx.IMissionPkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedMissions":
                            {
                                ...
                                {
                                    poco.OwnedMissions.Add((Auriga.Ctx.IMission)this.Facade.QueryElement(xmlReader));
                                }
