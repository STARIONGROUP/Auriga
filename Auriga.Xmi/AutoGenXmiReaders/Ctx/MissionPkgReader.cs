...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    /// </summary>
    public class MissionPkgReader : XmiElementReader<Auriga.Ctx.IMissionPkg>, IXmiElementReader<Auriga.Ctx.IMissionPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Ctx.IMissionPkg"/></returns>
        public Auriga.Ctx.IMissionPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Ctx.MissionPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedMissionPkgs":
                            {
                                ...
                                {
                                    poco.OwnedMissionPkgs.Add((Auriga.Ctx.IMissionPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMissions":
                            {
                                ...
                                {
                                    poco.OwnedMissions.Add((Auriga.Ctx.IMission)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
