...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    /// </summary>
    public class SystemFunctionPkgReader : XmiElementReader<Auriga.Ctx.ISystemFunctionPkg>, IXmiElementReader<Auriga.Ctx.ISystemFunctionPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Ctx.ISystemFunctionPkg"/></returns>
        public Auriga.Ctx.ISystemFunctionPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Ctx.SystemFunctionPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedSystemFunctionPkgs":
                            {
                                ...
                                {
                                    poco.OwnedSystemFunctionPkgs.Add((Auriga.Ctx.ISystemFunctionPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSystemFunctions":
                            {
                                ...
                                {
                                    poco.OwnedSystemFunctions.Add((Auriga.Ctx.ISystemFunction)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
