...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    public class SystemComponentPkgReader : XmiElementReader<Auriga.Ctx.ISystemComponentPkg>, IXmiElementReader<Auriga.Ctx.ISystemComponentPkg>
    {
        ...
        public Auriga.Ctx.ISystemComponentPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedParts":
                            {
                                ...
                                {
                                    poco.OwnedParts.Add((Auriga.Cs.IPart)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSystemComponentPkgs":
                            {
                                ...
                                {
                                    poco.OwnedSystemComponentPkgs.Add((Auriga.Ctx.ISystemComponentPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSystemComponents":
                            {
                                ...
                                {
                                    poco.OwnedSystemComponents.Add((Auriga.Ctx.ISystemComponent)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
