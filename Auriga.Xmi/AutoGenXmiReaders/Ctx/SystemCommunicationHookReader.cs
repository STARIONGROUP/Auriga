...
namespace Auriga.Xmi.AutoGenXmiReaders.Ctx
{
    ...
    /// </summary>
    public class SystemCommunicationHookReader : XmiElementReader<Auriga.Ctx.ISystemCommunicationHook>, IXmiElementReader<Auriga.Ctx.ISystemCommunicationHook>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Ctx.ISystemCommunicationHook"/></returns>
        public Auriga.Ctx.ISystemCommunicationHook Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Ctx.SystemCommunicationHook();
