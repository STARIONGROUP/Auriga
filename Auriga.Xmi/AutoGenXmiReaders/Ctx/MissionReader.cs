                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityExploitations":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityExploitations.Add((Auriga.Ctx.ICapabilityExploitation)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedMissionInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedMissionInvolvements.Add((Auriga.Ctx.IMissionInvolvement)this.Facade.QueryElement(xmlReader));
                                }
