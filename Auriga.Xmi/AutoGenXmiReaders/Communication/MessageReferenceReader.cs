...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Communication
{
    ...
    /// </summary>
    public class MessageReferenceReader : XmiElementReader<Auriga.Information.Communication.IMessageReference>, IXmiElementReader<Auriga.Information.Communication.IMessageReference>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Communication.IMessageReference"/></returns>
        public Auriga.Information.Communication.IMessageReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Communication.MessageReference();
