...
namespace Auriga.Xmi.AutoGenXmiReaders.Epbs
{
    ...
    public class ConfigurationItemPkgReader : XmiElementReader<Auriga.Epbs.IConfigurationItemPkg>, IXmiElementReader<Auriga.Epbs.IConfigurationItemPkg>
    {
        ...
        public Auriga.Epbs.IConfigurationItemPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConfigurationItemPkgs":
                            {
                                ...
                                {
                                    poco.OwnedConfigurationItemPkgs.Add((Auriga.Epbs.IConfigurationItemPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedConfigurationItems":
                            {
                                ...
                                {
                                    poco.OwnedConfigurationItems.Add((Auriga.Epbs.IConfigurationItem)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
