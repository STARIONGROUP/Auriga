...
namespace Auriga.Xmi.AutoGenXmiReaders.Epbs
{
    ...
    /// </summary>
    public class PhysicalArchitectureRealizationReader : XmiElementReader<Auriga.Epbs.IPhysicalArchitectureRealization>, IXmiElementReader<Auriga.Epbs.IPhysicalArchitectureRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Epbs.IPhysicalArchitectureRealization"/></returns>
        public Auriga.Epbs.IPhysicalArchitectureRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Epbs.PhysicalArchitectureRealization();
