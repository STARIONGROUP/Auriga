                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConfigurationItemPkg":
                            {
                                ...
                                {
                                    var contained = (Auriga.Epbs.IConfigurationItemPkg)this.Facade.QueryElement(xmlReader);
                                    contained.Container = poco;
                                    poco.OwnedConfigurationItemPkg = contained;
                                }
                            ...
                            case "ownedPhysicalArchitectureRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalArchitectureRealizations.Add((Auriga.Epbs.IPhysicalArchitectureRealization)this.Facade.QueryElement(xmlReader));
                                }
