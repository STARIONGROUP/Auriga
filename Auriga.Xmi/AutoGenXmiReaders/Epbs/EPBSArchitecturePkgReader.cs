...
namespace Auriga.Xmi.AutoGenXmiReaders.Epbs
{
    ...
    /// </summary>
    public class EPBSArchitecturePkgReader : XmiElementReader<Auriga.Epbs.IEPBSArchitecturePkg>, IXmiElementReader<Auriga.Epbs.IEPBSArchitecturePkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Epbs.IEPBSArchitecturePkg"/></returns>
        public Auriga.Epbs.IEPBSArchitecturePkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Epbs.EPBSArchitecturePkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedEPBSArchitectures":
                            {
                                ...
                                {
                                    poco.OwnedEPBSArchitectures.Add((Auriga.Epbs.IEPBSArchitecture)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
