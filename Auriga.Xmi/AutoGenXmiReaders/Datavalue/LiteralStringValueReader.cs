...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class LiteralStringValueReader : XmiElementReader<Auriga.Information.Datavalue.ILiteralStringValue>, IXmiElementReader<Auriga.Information.Datavalue.ILiteralStringValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.ILiteralStringValue"/></returns>
        public Auriga.Information.Datavalue.ILiteralStringValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.LiteralStringValue();
