...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    public class BinaryExpressionReader : XmiElementReader<Auriga.Information.Datavalue.IBinaryExpression>, IXmiElementReader<Auriga.Information.Datavalue.IBinaryExpression>
    {
        ...
        public Auriga.Information.Datavalue.IBinaryExpression Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedLeftOperand":
                            {
                                ...
                                {
                                    poco.OwnedLeftOperand = (Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedRightOperand":
                            {
                                ...
                                {
                                    poco.OwnedRightOperand = (Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
