...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class EnumerationReferenceReader : XmiElementReader<Auriga.Information.Datavalue.IEnumerationReference>, IXmiElementReader<Auriga.Information.Datavalue.IEnumerationReference>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.IEnumerationReference"/></returns>
        public Auriga.Information.Datavalue.IEnumerationReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.EnumerationReference();
