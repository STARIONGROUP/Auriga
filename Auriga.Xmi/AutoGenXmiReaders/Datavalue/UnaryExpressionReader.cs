...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    public class UnaryExpressionReader : XmiElementReader<Auriga.Information.Datavalue.IUnaryExpression>, IXmiElementReader<Auriga.Information.Datavalue.IUnaryExpression>
    {
        ...
        public Auriga.Information.Datavalue.IUnaryExpression Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Information.Datavalue.UnaryOperator>(xmlReader.GetAttribute("operator"), out var parsed))
                    {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedOperand":
                            {
                                ...
                                {
                                    poco.OwnedOperand = (Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
