...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class EnumerationLiteralReader : XmiElementReader<Auriga.Information.Datavalue.IEnumerationLiteral>, IXmiElementReader<Auriga.Information.Datavalue.IEnumerationLiteral>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.IEnumerationLiteral"/></returns>
        public Auriga.Information.Datavalue.IEnumerationLiteral Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.EnumerationLiteral();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "domainValue":
                            {
                                ...
                                {
                                    poco.DomainValue = (Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
