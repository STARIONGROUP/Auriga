...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class NumericReferenceReader : XmiElementReader<Auriga.Information.Datavalue.INumericReference>, IXmiElementReader<Auriga.Information.Datavalue.INumericReference>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.INumericReference"/></returns>
        public Auriga.Information.Datavalue.INumericReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.NumericReference();
