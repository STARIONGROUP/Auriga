...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class ValuePartReader : XmiElementReader<Auriga.Information.Datavalue.IValuePart>, IXmiElementReader<Auriga.Information.Datavalue.IValuePart>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.IValuePart"/></returns>
        public Auriga.Information.Datavalue.IValuePart Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.ValuePart();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedValue":
                            {
                                ...
                                {
                                    poco.OwnedValue = (Auriga.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
