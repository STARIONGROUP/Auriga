...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class LiteralNumericValueReader : XmiElementReader<Auriga.Information.Datavalue.ILiteralNumericValue>, IXmiElementReader<Auriga.Information.Datavalue.ILiteralNumericValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.ILiteralNumericValue"/></returns>
        public Auriga.Information.Datavalue.ILiteralNumericValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.LiteralNumericValue();
