...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class ComplexValueReader : XmiElementReader<Auriga.Information.Datavalue.IComplexValue>, IXmiElementReader<Auriga.Information.Datavalue.IComplexValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.IComplexValue"/></returns>
        public Auriga.Information.Datavalue.IComplexValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.ComplexValue();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedParts":
                            {
                                ...
                                {
                                    poco.OwnedParts.Add((Auriga.Information.Datavalue.IValuePart)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
