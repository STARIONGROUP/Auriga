...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class LiteralBooleanValueReader : XmiElementReader<Auriga.Information.Datavalue.ILiteralBooleanValue>, IXmiElementReader<Auriga.Information.Datavalue.ILiteralBooleanValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.ILiteralBooleanValue"/></returns>
        public Auriga.Information.Datavalue.ILiteralBooleanValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.LiteralBooleanValue();
