...
namespace Auriga.Xmi.AutoGenXmiReaders.Information.Datavalue
{
    ...
    /// </summary>
    public class ComplexValueReferenceReader : XmiElementReader<Auriga.Information.Datavalue.IComplexValueReference>, IXmiElementReader<Auriga.Information.Datavalue.IComplexValueReference>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Information.Datavalue.IComplexValueReference"/></returns>
        public Auriga.Information.Datavalue.IComplexValueReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Information.Datavalue.ComplexValueReference();
