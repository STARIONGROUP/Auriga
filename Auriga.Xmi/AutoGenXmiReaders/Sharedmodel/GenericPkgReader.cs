...
namespace Auriga.Xmi.AutoGenXmiReaders.Sharedmodel
{
    ...
    public class GenericPkgReader : XmiElementReader<Auriga.Sharedmodel.IGenericPkg>, IXmiElementReader<Auriga.Sharedmodel.IGenericPkg>
    {
        ...
        public Auriga.Sharedmodel.IGenericPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "capellaElements":
                            {
                                ...
                                {
                                    poco.CapellaElements.Add((Auriga.Capellacore.ICapellaElement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "subGenericPkgs":
                            {
                                ...
                                {
                                    poco.SubGenericPkgs.Add((Auriga.Sharedmodel.IGenericPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
