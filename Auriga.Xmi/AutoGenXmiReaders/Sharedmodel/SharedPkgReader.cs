...
namespace Auriga.Xmi.AutoGenXmiReaders.Sharedmodel
{
    ...
    /// </summary>
    public class SharedPkgReader : XmiElementReader<Auriga.Sharedmodel.ISharedPkg>, IXmiElementReader<Auriga.Sharedmodel.ISharedPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sharedmodel.ISharedPkg"/></returns>
        public Auriga.Sharedmodel.ISharedPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sharedmodel.SharedPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedGenericPkg":
                            {
                                ...
                                {
                                    poco.OwnedGenericPkg = (Auriga.Sharedmodel.IGenericPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
