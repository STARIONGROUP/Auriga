...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalChainInvolvementLinkReader : XmiElementReader<Auriga.Fa.IFunctionalChainInvolvementLink>, IXmiElementReader<Auriga.Fa.IFunctionalChainInvolvementLink>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionalChainInvolvementLink"/></returns>
        public Auriga.Fa.IFunctionalChainInvolvementLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionalChainInvolvementLink();
