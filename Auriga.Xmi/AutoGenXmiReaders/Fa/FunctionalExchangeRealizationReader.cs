...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalExchangeRealizationReader : XmiElementReader<Auriga.Fa.IFunctionalExchangeRealization>, IXmiElementReader<Auriga.Fa.IFunctionalExchangeRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionalExchangeRealization"/></returns>
        public Auriga.Fa.IFunctionalExchangeRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionalExchangeRealization();
