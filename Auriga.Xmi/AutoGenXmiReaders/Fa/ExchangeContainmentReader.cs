...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ExchangeContainmentReader : XmiElementReader<Auriga.Fa.IExchangeContainment>, IXmiElementReader<Auriga.Fa.IExchangeContainment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IExchangeContainment"/></returns>
        public Auriga.Fa.IExchangeContainment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ExchangeContainment();
