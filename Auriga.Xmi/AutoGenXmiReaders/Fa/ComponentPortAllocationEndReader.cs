...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ComponentPortAllocationEndReader : XmiElementReader<Auriga.Fa.IComponentPortAllocationEnd>, IXmiElementReader<Auriga.Fa.IComponentPortAllocationEnd>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IComponentPortAllocationEnd"/></returns>
        public Auriga.Fa.IComponentPortAllocationEnd Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ComponentPortAllocationEnd();
