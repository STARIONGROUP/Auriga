...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ComponentFunctionalAllocationReader : XmiElementReader<Auriga.Fa.IComponentFunctionalAllocation>, IXmiElementReader<Auriga.Fa.IComponentFunctionalAllocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IComponentFunctionalAllocation"/></returns>
        public Auriga.Fa.IComponentFunctionalAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ComponentFunctionalAllocation();
