...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeRealizationReader : XmiElementReader<Auriga.Fa.IComponentExchangeRealization>, IXmiElementReader<Auriga.Fa.IComponentExchangeRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IComponentExchangeRealization"/></returns>
        public Auriga.Fa.IComponentExchangeRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ComponentExchangeRealization();
