...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ComponentPortReader : XmiElementReader<Auriga.Fa.IComponentPort>, IXmiElementReader<Auriga.Fa.IComponentPort>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IComponentPort"/></returns>
        public Auriga.Fa.IComponentPort Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ComponentPort();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Fa.ComponentPortKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
                ...
                {
                    if (TryParseEnum<Auriga.Fa.OrientationPortKind>(xmlReader.GetAttribute("orientation"), out var parsed))
                    {
