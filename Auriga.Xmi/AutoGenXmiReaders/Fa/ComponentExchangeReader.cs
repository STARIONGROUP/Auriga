                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComponentExchangeEnds":
                            {
                                ...
                                {
                                    poco.OwnedComponentExchangeEnds.Add((Auriga.Fa.IComponentExchangeEnd)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedComponentExchangeFunctionalExchangeAllocations":
                            {
                                ...
                                {
                                    poco.OwnedComponentExchangeFunctionalExchangeAllocations.Add((Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation)this.Facade.QueryElement(xmlReader));
                                }
