...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalChainInvolvementFunctionReader : XmiElementReader<Auriga.Fa.IFunctionalChainInvolvementFunction>, IXmiElementReader<Auriga.Fa.IFunctionalChainInvolvementFunction>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionalChainInvolvementFunction"/></returns>
        public Auriga.Fa.IFunctionalChainInvolvementFunction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionalChainInvolvementFunction();
