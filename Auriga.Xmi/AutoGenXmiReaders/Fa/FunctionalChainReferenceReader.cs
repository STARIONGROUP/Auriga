...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalChainReferenceReader : XmiElementReader<Auriga.Fa.IFunctionalChainReference>, IXmiElementReader<Auriga.Fa.IFunctionalChainReference>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionalChainReference"/></returns>
        public Auriga.Fa.IFunctionalChainReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionalChainReference();
