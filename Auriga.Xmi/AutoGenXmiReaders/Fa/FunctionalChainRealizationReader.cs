...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalChainRealizationReader : XmiElementReader<Auriga.Fa.IFunctionalChainRealization>, IXmiElementReader<Auriga.Fa.IFunctionalChainRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionalChainRealization"/></returns>
        public Auriga.Fa.IFunctionalChainRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionalChainRealization();
