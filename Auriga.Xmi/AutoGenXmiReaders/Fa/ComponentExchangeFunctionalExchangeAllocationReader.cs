...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeFunctionalExchangeAllocationReader : XmiElementReader<Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation>, IXmiElementReader<Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation"/></returns>
        public Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ComponentExchangeFunctionalExchangeAllocation();
