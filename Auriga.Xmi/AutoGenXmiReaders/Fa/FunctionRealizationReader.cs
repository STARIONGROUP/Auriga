...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionRealizationReader : XmiElementReader<Auriga.Fa.IFunctionRealization>, IXmiElementReader<Auriga.Fa.IFunctionRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionRealization"/></returns>
        public Auriga.Fa.IFunctionRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionRealization();
