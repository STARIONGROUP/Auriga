...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ControlNodeReader : XmiElementReader<Auriga.Fa.IControlNode>, IXmiElementReader<Auriga.Fa.IControlNode>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IControlNode"/></returns>
        public Auriga.Fa.IControlNode Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ControlNode();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Fa.ControlNodeKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
