...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ExchangeCategoryReader : XmiElementReader<Auriga.Fa.IExchangeCategory>, IXmiElementReader<Auriga.Fa.IExchangeCategory>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IExchangeCategory"/></returns>
        public Auriga.Fa.IExchangeCategory Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ExchangeCategory();
