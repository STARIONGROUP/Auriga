...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ExchangeLinkReader : XmiElementReader<Auriga.Fa.IExchangeLink>, IXmiElementReader<Auriga.Fa.IExchangeLink>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IExchangeLink"/></returns>
        public Auriga.Fa.IExchangeLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ExchangeLink();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedExchangeContainments":
                            {
                                ...
                                {
                                    poco.OwnedExchangeContainments.Add((Auriga.Fa.IExchangeContainment)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
