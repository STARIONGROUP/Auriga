...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalExchangeSpecificationReader : XmiElementReader<Auriga.Fa.IFunctionalExchangeSpecification>, IXmiElementReader<Auriga.Fa.IFunctionalExchangeSpecification>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IFunctionalExchangeSpecification"/></returns>
        public Auriga.Fa.IFunctionalExchangeSpecification Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.FunctionalExchangeSpecification();
