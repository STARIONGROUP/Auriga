...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeAllocationReader : XmiElementReader<Auriga.Fa.IComponentExchangeAllocation>, IXmiElementReader<Auriga.Fa.IComponentExchangeAllocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Fa.IComponentExchangeAllocation"/></returns>
        public Auriga.Fa.IComponentExchangeAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Fa.ComponentExchangeAllocation();
