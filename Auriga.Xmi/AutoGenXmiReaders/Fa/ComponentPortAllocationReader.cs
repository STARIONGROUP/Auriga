...
namespace Auriga.Xmi.AutoGenXmiReaders.Fa
{
    ...
    public class ComponentPortAllocationReader : XmiElementReader<Auriga.Fa.IComponentPortAllocation>, IXmiElementReader<Auriga.Fa.IComponentPortAllocation>
    {
        ...
        public Auriga.Fa.IComponentPortAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComponentPortAllocationEnds":
                            {
                                ...
                                {
                                    poco.OwnedComponentPortAllocationEnds.Add((Auriga.Fa.IComponentPortAllocationEnd)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
