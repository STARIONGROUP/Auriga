...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa
{
    ...
    public class LogicalArchitectureRealizationReader : XmiElementReader<Auriga.Pa.ILogicalArchitectureRealization>, IXmiElementReader<Auriga.Pa.ILogicalArchitectureRealization>
    {
        ...
        public LogicalArchitectureRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of LogicalArchitectureRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
