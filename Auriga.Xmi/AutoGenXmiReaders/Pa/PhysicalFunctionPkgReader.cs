...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa
{
    ...
    /// </summary>
    public class PhysicalFunctionPkgReader : XmiElementReader<Auriga.Pa.IPhysicalFunctionPkg>, IXmiElementReader<Auriga.Pa.IPhysicalFunctionPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.IPhysicalFunctionPkg"/></returns>
        public Auriga.Pa.IPhysicalFunctionPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.PhysicalFunctionPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCategories":
                            {
                                ...
                                {
                                    poco.OwnedCategories.Add((Auriga.Fa.IExchangeCategory)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExchangeSpecificationRealizations":
                            {
                                ...
                                {
                                    poco.OwnedExchangeSpecificationRealizations.Add((Auriga.Fa.IExchangeSpecificationRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExchanges":
                            {
                                ...
                                {
                                    poco.OwnedExchanges.Add((Auriga.Fa.IFunctionalExchangeSpecification)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedFunctionSpecifications":
                            {
                                ...
                                {
                                    poco.OwnedFunctionSpecifications.Add((Auriga.Fa.IFunctionSpecification)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalFunctionPkgs":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalFunctionPkgs.Add((Auriga.Pa.IPhysicalFunctionPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalFunctions":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalFunctions.Add((Auriga.Pa.IPhysicalFunction)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
