                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPhysicalFunctionPkgs":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalFunctionPkgs.Add((Auriga.Pa.IPhysicalFunctionPkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedPhysicalFunctions":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalFunctions.Add((Auriga.Pa.IPhysicalFunction)this.Facade.QueryElement(xmlReader));
                                }
