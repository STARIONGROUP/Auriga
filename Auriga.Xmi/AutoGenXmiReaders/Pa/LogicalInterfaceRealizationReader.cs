...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa
{
    ...
    public class LogicalInterfaceRealizationReader : XmiElementReader<Auriga.Pa.ILogicalInterfaceRealization>, IXmiElementReader<Auriga.Pa.ILogicalInterfaceRealization>
    {
        ...
        public LogicalInterfaceRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Pa.ILogicalInterfaceRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of LogicalInterfaceRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
