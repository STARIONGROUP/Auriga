                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPhysicalArchitecturePkgs":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalArchitecturePkgs.Add((Auriga.Pa.IPhysicalArchitecturePkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedPhysicalArchitectures":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalArchitectures.Add((Auriga.Pa.IPhysicalArchitecture)this.Facade.QueryElement(xmlReader));
                                }
