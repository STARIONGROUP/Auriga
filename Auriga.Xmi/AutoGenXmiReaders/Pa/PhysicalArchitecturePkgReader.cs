...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa
{
    ...
    /// </summary>
    public class PhysicalArchitecturePkgReader : XmiElementReader<Auriga.Pa.IPhysicalArchitecturePkg>, IXmiElementReader<Auriga.Pa.IPhysicalArchitecturePkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Pa.IPhysicalArchitecturePkg"/></returns>
        public Auriga.Pa.IPhysicalArchitecturePkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Pa.PhysicalArchitecturePkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPhysicalArchitecturePkgs":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalArchitecturePkgs.Add((Auriga.Pa.IPhysicalArchitecturePkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalArchitectures":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalArchitectures.Add((Auriga.Pa.IPhysicalArchitecture)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
