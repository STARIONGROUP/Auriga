...
namespace Auriga.Xmi.AutoGenXmiReaders.Pa
{
    ...
    public class PhysicalArchitectureReader : XmiElementReader<Auriga.Pa.IPhysicalArchitecture>, IXmiElementReader<Auriga.Pa.IPhysicalArchitecture>
    {
        ...
        public Auriga.Pa.IPhysicalArchitecture Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDeployments":
                            {
                                ...
                                {
                                    poco.OwnedDeployments.Add((Auriga.Cs.IAbstractDeploymentLink)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedLogicalArchitectureRealizations":
                            {
                                ...
                                {
                                    poco.OwnedLogicalArchitectureRealizations.Add((Auriga.Pa.ILogicalArchitectureRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalComponentPkg":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalComponentPkg = (Auriga.Pa.IPhysicalComponentPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
