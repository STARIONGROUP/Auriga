...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class RoundedCornersStyleReader : XmiElementReader<Auriga.Diagram.Notation.IRoundedCornersStyle>, IXmiElementReader<Auriga.Diagram.Notation.IRoundedCornersStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IRoundedCornersStyle"/></returns>
        public Auriga.Diagram.Notation.IRoundedCornersStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.RoundedCornersStyle();
