...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class IdentityAnchorReader : XmiElementReader<Auriga.Diagram.Notation.IIdentityAnchor>, IXmiElementReader<Auriga.Diagram.Notation.IIdentityAnchor>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IIdentityAnchor"/></returns>
        public Auriga.Diagram.Notation.IIdentityAnchor Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.IdentityAnchor();
