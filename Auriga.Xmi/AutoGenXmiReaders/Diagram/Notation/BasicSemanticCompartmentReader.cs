...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class BasicSemanticCompartmentReader : XmiElementReader<Auriga.Diagram.Notation.IBasicSemanticCompartment>, IXmiElementReader<Auriga.Diagram.Notation.IBasicSemanticCompartment>
    {
        ...
        /// <summary>
        /// The XML names of the attributes <c>BasicSemanticCompartment</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IBasicSemanticCompartment"/></returns>
        public Auriga.Diagram.Notation.IBasicSemanticCompartment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.BasicSemanticCompartment();
