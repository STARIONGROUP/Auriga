...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class ConnectorReader : XmiElementReader<Auriga.Diagram.Notation.IConnector>, IXmiElementReader<Auriga.Diagram.Notation.IConnector>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IConnector"/></returns>
        public Auriga.Diagram.Notation.IConnector Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.Connector();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "bendpoints":
                            {
                                ...
                                {
                                    poco.Bendpoints = (Auriga.Diagram.Notation.IBendpoints)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "sourceAnchor":
                            {
                                ...
                                {
                                    poco.SourceAnchor = (Auriga.Diagram.Notation.IAnchor)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "targetAnchor":
                            {
                                ...
                                {
                                    poco.TargetAnchor = (Auriga.Diagram.Notation.IAnchor)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
