...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class EObjectValueStyleReader : XmiElementReader<Auriga.Diagram.Notation.IEObjectValueStyle>, IXmiElementReader<Auriga.Diagram.Notation.IEObjectValueStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IEObjectValueStyle"/></returns>
        public Auriga.Diagram.Notation.IEObjectValueStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.EObjectValueStyle();
