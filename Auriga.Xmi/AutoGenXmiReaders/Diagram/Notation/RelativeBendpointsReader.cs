...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class RelativeBendpointsReader : XmiElementReader<Auriga.Diagram.Notation.IRelativeBendpoints>, IXmiElementReader<Auriga.Diagram.Notation.IRelativeBendpoints>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IRelativeBendpoints"/></returns>
        public Auriga.Diagram.Notation.IRelativeBendpoints Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.RelativeBendpoints();
