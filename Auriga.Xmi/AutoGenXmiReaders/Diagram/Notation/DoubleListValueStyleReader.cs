...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class DoubleListValueStyleReader : XmiElementReader<Auriga.Diagram.Notation.IDoubleListValueStyle>, IXmiElementReader<Auriga.Diagram.Notation.IDoubleListValueStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IDoubleListValueStyle"/></returns>
        public Auriga.Diagram.Notation.IDoubleListValueStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.DoubleListValueStyle();
