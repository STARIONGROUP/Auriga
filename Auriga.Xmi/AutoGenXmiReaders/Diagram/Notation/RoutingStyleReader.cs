...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class RoutingStyleReader : XmiElementReader<Auriga.Diagram.Notation.IRoutingStyle>, IXmiElementReader<Auriga.Diagram.Notation.IRoutingStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IRoutingStyle"/></returns>
        public Auriga.Diagram.Notation.IRoutingStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.RoutingStyle();
