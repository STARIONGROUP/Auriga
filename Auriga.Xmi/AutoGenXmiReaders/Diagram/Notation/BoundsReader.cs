...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class BoundsReader : XmiElementReader<Auriga.Diagram.Notation.IBounds>, IXmiElementReader<Auriga.Diagram.Notation.IBounds>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IBounds"/></returns>
        public Auriga.Diagram.Notation.IBounds Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.Bounds();
