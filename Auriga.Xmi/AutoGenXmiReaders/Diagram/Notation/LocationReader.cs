...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class LocationReader : XmiElementReader<Auriga.Diagram.Notation.ILocation>, IXmiElementReader<Auriga.Diagram.Notation.ILocation>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>Location</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.ILocation"/></returns>
        public Auriga.Diagram.Notation.ILocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.Location();
