...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Notation
{
    ...
    public class PageStyleReader : XmiElementReader<Auriga.Diagram.Notation.IPageStyle>, IXmiElementReader<Auriga.Diagram.Notation.IPageStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Notation.IPageStyle"/></returns>
        public Auriga.Diagram.Notation.IPageStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Notation.PageStyle();
