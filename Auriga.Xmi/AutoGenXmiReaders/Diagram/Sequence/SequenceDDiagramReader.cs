...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence
{
    using System;
    using System.Xml;
    ...
    /// </summary>
    public class SequenceDDiagramReader : XmiElementReader<Auriga.Diagram.Sequence.ISequenceDDiagram>, IXmiElementReader<Auriga.Diagram.Sequence.ISequenceDDiagram>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.ISequenceDDiagram"/></returns>
        public Auriga.Diagram.Sequence.ISequenceDDiagram Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.SequenceDDiagram();
