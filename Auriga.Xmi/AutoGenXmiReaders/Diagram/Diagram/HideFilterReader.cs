...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class HideFilterReader : XmiElementReader<Auriga.Diagram.Diagram.IHideFilter>, IXmiElementReader<Auriga.Diagram.Diagram.IHideFilter>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IHideFilter"/></returns>
        public Auriga.Diagram.Diagram.IHideFilter Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.HideFilter();
