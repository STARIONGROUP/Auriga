...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class LozengeReader : XmiElementReader<Auriga.Diagram.Diagram.ILozenge>, IXmiElementReader<Auriga.Diagram.Diagram.ILozenge>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.ILozenge"/></returns>
        public Auriga.Diagram.Diagram.ILozenge Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Lozenge();
