...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class EndLabelStyleReader : XmiElementReader<Auriga.Diagram.Diagram.IEndLabelStyle>, IXmiElementReader<Auriga.Diagram.Diagram.IEndLabelStyle>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>EndLabelStyle</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IEndLabelStyle"/></returns>
        public Auriga.Diagram.Diagram.IEndLabelStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.EndLabelStyle();
