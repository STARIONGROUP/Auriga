...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class AbsoluteBoundsFilterReader : XmiElementReader<Auriga.Diagram.Diagram.IAbsoluteBoundsFilter>, IXmiElementReader<Auriga.Diagram.Diagram.IAbsoluteBoundsFilter>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IAbsoluteBoundsFilter"/></returns>
        public Auriga.Diagram.Diagram.IAbsoluteBoundsFilter Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.AbsoluteBoundsFilter();
