...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class DragAndDropTargetReader : XmiElementReader<Auriga.Diagram.Diagram.IDragAndDropTarget>, IXmiElementReader<Auriga.Diagram.Diagram.IDragAndDropTarget>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IDragAndDropTarget"/></returns>
        public Auriga.Diagram.Diagram.IDragAndDropTarget Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.DragAndDropTarget();
