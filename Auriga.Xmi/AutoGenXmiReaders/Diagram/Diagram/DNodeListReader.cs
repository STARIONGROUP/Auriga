// ------------------------------------------------------------------------------------------------
// <copyright file="DNodeListReader.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    /// <summary>
    /// The generated XMI reader that instantiates and populates an <c>DNodeList</c> from its
    /// XMI representation. Contained elements are read recursively; cross-references are collected for the
    /// reference-resolution pass.
    /// </summary>
    public class DNodeListReader : XmiElementReader<Auriga.Diagram.Diagram.IDNodeList>, IXmiElementReader<Auriga.Diagram.Diagram.IDNodeList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DNodeListReader"/> class.
        /// </summary>
        /// <param name="cache">the element cache</param>
        /// <param name="facade">the reader facade used to read contained elements</param>
        /// <param name="settings">the reader settings (e.g. strict vs. lenient reading)</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public DNodeListReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
            : base(cache, facade, settings, loggerFactory)
        {
        }

        /// <summary>
        /// Reads an <c>DNodeList</c> from the element at the cursor of the supplied reader.
        /// </summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IDNodeList"/></returns>
        public Auriga.Diagram.Diagram.IDNodeList Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.DNodeList();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading DNodeList at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "decorations":
                            {
                                ...
                                {
                                    poco.Decorations.Add((Auriga.Diagram.Viewpoint.IDecoration)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "graphicalFilters":
                            {
                                ...
                                {
                                    poco.GraphicalFilters.Add((Auriga.Diagram.Diagram.IGraphicalFilter)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedBorderedNodes":
                            {
                                ...
                                {
                                    poco.OwnedBorderedNodes.Add((Auriga.Diagram.Diagram.IDNode)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedElements":
                            {
                                ...
                                {
                                    poco.OwnedElements.Add((Auriga.Diagram.Diagram.IDNodeListElement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedStyle":
                            {
                                ...
                                {
                                    poco.OwnedStyle = (Auriga.Diagram.Diagram.IContainerStyle)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"DNodeListReader: {xmlReader.LocalName} at line:position {xmlLineInfo?.LineNumber}:{xmlLineInfo?.LinePosition}");
                                }

                                this.Logger.LogWarning("Not supported by DNodeListReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
            ...
            {
                this.Logger.LogWarning("Expected an element to read DNodeList but found {NodeType} at line {Line}:{Position}", xmlReader.NodeType, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
            }
