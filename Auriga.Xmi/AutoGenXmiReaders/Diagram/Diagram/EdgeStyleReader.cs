...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class EdgeStyleReader : XmiElementReader<Auriga.Diagram.Diagram.IEdgeStyle>, IXmiElementReader<Auriga.Diagram.Diagram.IEdgeStyle>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>EdgeStyle</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IEdgeStyle"/></returns>
        public Auriga.Diagram.Diagram.IEdgeStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.EdgeStyle();
