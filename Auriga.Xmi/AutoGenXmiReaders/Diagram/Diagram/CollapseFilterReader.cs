...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class CollapseFilterReader : XmiElementReader<Auriga.Diagram.Diagram.ICollapseFilter>, IXmiElementReader<Auriga.Diagram.Diagram.ICollapseFilter>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.ICollapseFilter"/></returns>
        public Auriga.Diagram.Diagram.ICollapseFilter Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.CollapseFilter();
