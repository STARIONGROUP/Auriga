...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DNodeReader : XmiElementReader<Auriga.Diagram.Diagram.IDNode>, IXmiElementReader<Auriga.Diagram.Diagram.IDNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DNode</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IDNode"/></returns>
        public Auriga.Diagram.Diagram.IDNode Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.DNode();
