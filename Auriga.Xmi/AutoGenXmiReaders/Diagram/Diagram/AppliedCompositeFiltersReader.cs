...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class AppliedCompositeFiltersReader : XmiElementReader<Auriga.Diagram.Diagram.IAppliedCompositeFilters>, IXmiElementReader<Auriga.Diagram.Diagram.IAppliedCompositeFilters>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IAppliedCompositeFilters"/></returns>
        public Auriga.Diagram.Diagram.IAppliedCompositeFilters Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.AppliedCompositeFilters();
