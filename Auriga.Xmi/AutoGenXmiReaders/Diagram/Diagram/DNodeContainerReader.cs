...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class DNodeContainerReader : XmiElementReader<Auriga.Diagram.Diagram.IDNodeContainer>, IXmiElementReader<Auriga.Diagram.Diagram.IDNodeContainer>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IDNodeContainer"/></returns>
        public Auriga.Diagram.Diagram.IDNodeContainer Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.DNodeContainer();
