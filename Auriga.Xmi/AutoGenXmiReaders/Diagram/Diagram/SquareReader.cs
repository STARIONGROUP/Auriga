...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class SquareReader : XmiElementReader<Auriga.Diagram.Diagram.ISquare>, IXmiElementReader<Auriga.Diagram.Diagram.ISquare>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.ISquare"/></returns>
        public Auriga.Diagram.Diagram.ISquare Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Square();
