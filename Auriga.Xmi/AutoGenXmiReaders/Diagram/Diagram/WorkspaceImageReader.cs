...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class WorkspaceImageReader : XmiElementReader<Auriga.Diagram.Diagram.IWorkspaceImage>, IXmiElementReader<Auriga.Diagram.Diagram.IWorkspaceImage>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IWorkspaceImage"/></returns>
        public Auriga.Diagram.Diagram.IWorkspaceImage Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.WorkspaceImage();
