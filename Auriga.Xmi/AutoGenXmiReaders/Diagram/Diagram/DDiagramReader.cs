...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DDiagramReader : XmiElementReader<Auriga.Diagram.Diagram.IDDiagram>, IXmiElementReader<Auriga.Diagram.Diagram.IDDiagram>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IDDiagram"/></returns>
        public Auriga.Diagram.Diagram.IDDiagram Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.DDiagram();
