...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class BeginLabelStyleReader : XmiElementReader<Auriga.Diagram.Diagram.IBeginLabelStyle>, IXmiElementReader<Auriga.Diagram.Diagram.IBeginLabelStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IBeginLabelStyle"/></returns>
        public Auriga.Diagram.Diagram.IBeginLabelStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.BeginLabelStyle();
