...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram
{
    ...
    public class FilterVariableHistoryReader : XmiElementReader<Auriga.Diagram.Diagram.IFilterVariableHistory>, IXmiElementReader<Auriga.Diagram.Diagram.IFilterVariableHistory>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.IFilterVariableHistory"/></returns>
        public Auriga.Diagram.Diagram.IFilterVariableHistory Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.FilterVariableHistory();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "ownedValues":
                            {
                                ...
                                {
                                    poco.OwnedValues.Add((Auriga.Diagram.Diagram.IVariableValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
