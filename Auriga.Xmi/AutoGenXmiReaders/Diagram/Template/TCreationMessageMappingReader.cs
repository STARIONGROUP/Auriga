...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    /// </summary>
    public class TCreationMessageMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITCreationMessageMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITCreationMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITCreationMessageMapping"/></returns>
        public Auriga.Diagram.Sequence.Template.ITCreationMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TCreationMessageMapping();
