...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    public class TConditionalLifelineStyleReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITConditionalLifelineStyle>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITConditionalLifelineStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITConditionalLifelineStyle"/></returns>
        public Auriga.Diagram.Sequence.Template.ITConditionalLifelineStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TConditionalLifelineStyle();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "style":
                            {
                                ...
                                {
                                    poco.Style = (Auriga.Diagram.Sequence.Template.ITLifelineStyle)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
