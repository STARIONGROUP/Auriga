...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    /// </summary>
    public class TAbstractMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITAbstractMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITAbstractMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITAbstractMapping"/></returns>
        public Auriga.Diagram.Sequence.Template.ITAbstractMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TAbstractMapping();
