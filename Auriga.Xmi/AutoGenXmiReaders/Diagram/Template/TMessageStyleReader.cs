...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    public class TMessageStyleReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITMessageStyle>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITMessageStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITMessageStyle"/></returns>
        public Auriga.Diagram.Sequence.Template.ITMessageStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TMessageStyle();
