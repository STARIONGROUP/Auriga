...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    public class TConditionalMessageStyleReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITConditionalMessageStyle>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITConditionalMessageStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITConditionalMessageStyle"/></returns>
        public Auriga.Diagram.Sequence.Template.ITConditionalMessageStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TConditionalMessageStyle();
