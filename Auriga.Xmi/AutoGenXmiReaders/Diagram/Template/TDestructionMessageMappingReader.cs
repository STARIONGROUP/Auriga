...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    /// </summary>
    public class TDestructionMessageMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITDestructionMessageMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITDestructionMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITDestructionMessageMapping"/></returns>
        public Auriga.Diagram.Sequence.Template.ITDestructionMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TDestructionMessageMapping();
