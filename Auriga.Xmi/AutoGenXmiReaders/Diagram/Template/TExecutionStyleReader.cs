...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    /// </summary>
    public class TExecutionStyleReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITExecutionStyle>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITExecutionStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITExecutionStyle"/></returns>
        public Auriga.Diagram.Sequence.Template.ITExecutionStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TExecutionStyle();
