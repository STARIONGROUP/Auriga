...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Template
{
    ...
    /// </summary>
    public class TReturnMessageMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Template.ITReturnMessageMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Template.ITReturnMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Template.ITReturnMessageMapping"/></returns>
        public Auriga.Diagram.Sequence.Template.ITReturnMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Template.TReturnMessageMapping();
