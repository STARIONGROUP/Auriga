...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Validation
{
    ...
    public class ValidationFixReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Validation.IValidationFix>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Validation.IValidationFix>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Validation.IValidationFix"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Validation.IValidationFix Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Validation.ValidationFix();
