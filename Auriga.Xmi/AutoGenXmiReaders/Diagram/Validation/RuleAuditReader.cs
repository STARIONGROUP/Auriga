...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Validation
{
    ...
    public class RuleAuditReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Validation.IRuleAudit>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Validation.IRuleAudit>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Validation.IRuleAudit"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Validation.IRuleAudit Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Validation.RuleAudit();
