...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    public class EllipseNodeDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Style.EllipseNodeDescription();
