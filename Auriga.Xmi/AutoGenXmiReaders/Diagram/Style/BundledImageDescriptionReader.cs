...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    public class BundledImageDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.IBundledImageDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.IBundledImageDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Style.IBundledImageDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Style.IBundledImageDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Style.BundledImageDescription();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Diagram.Diagram.BundledImageShape>(xmlReader.GetAttribute("shape"), out var parsed))
                    {
                        poco.Shape = parsed;
                    }
                }
