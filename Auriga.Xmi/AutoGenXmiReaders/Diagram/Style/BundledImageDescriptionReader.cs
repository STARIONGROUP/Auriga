        ...
        public Auriga.Diagram.Diagram.Description.Style.IBundledImageDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                }
                {
                    ...
                    if (!string.IsNullOrEmpty(raw))
                    {
                        if (Auriga.Extensions.BundledImageShapeProvider.TryParse(raw.AsSpan(), out var parsed))
                        {
                            poco.Shape = parsed;
                        }
                        else
                        {
                            this.HandleUnknownEnumLiteral("BundledImageShape", "shape", raw, xmlLineInfo);
                        }
                    }
                }
                {
