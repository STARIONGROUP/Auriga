...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Style
{
    ...
    public class TooltipStyleDescriptionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Style.ITooltipStyleDescription>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Style.ITooltipStyleDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Style.ITooltipStyleDescription"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Style.ITooltipStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Style.TooltipStyleDescription();
