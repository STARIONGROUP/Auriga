...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    public class GaugeSectionDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Style.GaugeSectionDescription();
