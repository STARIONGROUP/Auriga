...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    public class BorderedStyleDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.IBorderedStyleDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.IBorderedStyleDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Style.IBorderedStyleDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Style.IBorderedStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Style.BorderedStyleDescription();
