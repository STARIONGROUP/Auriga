...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    public class CenterLabelStyleDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.ICenterLabelStyleDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.ICenterLabelStyleDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Style.ICenterLabelStyleDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Style.ICenterLabelStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Style.CenterLabelStyleDescription();
