...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class BracketEdgeStyleDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>BracketEdgeStyleDescription</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Style.BracketEdgeStyleDescription();
