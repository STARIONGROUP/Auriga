...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Style
{
    ...
    public class LabelStyleDescriptionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Style.ILabelStyleDescription>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Style.ILabelStyleDescription>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Style.ILabelStyleDescription"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Style.ILabelStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Style.LabelStyleDescription();
