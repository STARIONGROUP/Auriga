    ...
    public class ShapeContainerStyleDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Style.IShapeContainerStyleDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Style.IShapeContainerStyleDescription>
    {
        ...
        public Auriga.Diagram.Diagram.Description.Style.IShapeContainerStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    var raw = xmlReader.GetAttribute("shape");
                    if (!string.IsNullOrEmpty(raw))
                    {
                        if (Auriga.Extensions.ContainerShapeProvider.TryParse(raw.AsSpan(), out var parsed))
                        {
                            poco.Shape = parsed;
                        }
                        else
                        {
                            this.HandleUnknownEnumLiteral("ContainerShape", "shape", raw, xmlLineInfo);
                        }
                    }
                }
                {
