...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Concern
{
    using System;
    using System.Xml;
    ...
    /// </summary>
    public class ConcernDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Concern.IConcernDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Concern.IConcernDescription>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>ConcernDescription</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Concern.IConcernDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Concern.IConcernDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Concern.ConcernDescription();
