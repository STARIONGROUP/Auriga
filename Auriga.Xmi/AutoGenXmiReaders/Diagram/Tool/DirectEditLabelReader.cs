...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class DirectEditLabelReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel"/></returns>
        public Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Tool.DirectEditLabel();
