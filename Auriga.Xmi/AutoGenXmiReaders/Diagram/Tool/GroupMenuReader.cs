...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    public class GroupMenuReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenu>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenu>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenu"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenu Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.GroupMenu();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "itemDescriptions":
                            {
                                ...
                                {
                                    poco.ItemDescriptions.Add((Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenuItem)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
