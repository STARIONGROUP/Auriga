...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class DoubleClickDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Tool.DoubleClickDescription();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "element":
                            {
                                ...
                                {
                                    poco.Element = (Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "elementView":
                            {
                                ...
                                {
                                    poco.ElementView = (Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
