...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class ExecutionCreationToolReader : XmiElementReader<Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool>, IXmiElementReader<Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>ExecutionCreationTool</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool"/></returns>
        public Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.Tool.ExecutionCreationTool();
