...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class SelectionWizardDescriptionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.ISelectionWizardDescription>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.ISelectionWizardDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.ISelectionWizardDescription"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.ISelectionWizardDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.SelectionWizardDescription();
