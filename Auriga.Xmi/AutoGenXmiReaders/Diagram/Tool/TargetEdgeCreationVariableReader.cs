...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    public class TargetEdgeCreationVariableReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable"/></returns>
        public Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Tool.TargetEdgeCreationVariable();
