...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class ContainerDropDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IContainerDropDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IContainerDropDescription>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>ContainerDropDescription</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Tool.IContainerDropDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.Tool.IContainerDropDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Tool.ContainerDropDescription();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "element":
                            {
                                ...
                                {
                                    poco.Element = (Auriga.Diagram.Viewpoint.Description.Tool.IElementDropVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "initialOperation":
                            {
                                ...
                                {
                                    poco.InitialOperation = (Auriga.Diagram.Viewpoint.Description.Tool.IInitialContainerDropOperation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "newContainer":
                            {
                                ...
                                {
                                    poco.NewContainer = (Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "newViewContainer":
                            {
                                ...
                                {
                                    poco.NewViewContainer = (Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "oldContainer":
                            {
                                ...
                                {
                                    poco.OldContainer = (Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
