...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class SelectModelElementVariableReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.ISelectModelElementVariable>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.ISelectModelElementVariable>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>SelectModelElementVariable</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.ISelectModelElementVariable"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.ISelectModelElementVariable Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.SelectModelElementVariable();
