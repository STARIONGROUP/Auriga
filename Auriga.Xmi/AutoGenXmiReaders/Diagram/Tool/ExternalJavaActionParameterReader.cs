...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    public class ExternalJavaActionParameterReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.ExternalJavaActionParameter();
