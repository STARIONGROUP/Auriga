...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    using System;
    using System.Xml;
    ...
    /// </summary>
    public class PaneBasedSelectionWizardDescriptionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.PaneBasedSelectionWizardDescription();
