...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    public class BehaviorToolReader : XmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IBehaviorTool>, IXmiElementReader<Auriga.Diagram.Diagram.Description.Tool.IBehaviorTool>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.Tool.IBehaviorTool"/></returns>
        public Auriga.Diagram.Diagram.Description.Tool.IBehaviorTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.Tool.BehaviorTool();
