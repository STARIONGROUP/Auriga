...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class ToolDescriptionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IToolDescription>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IToolDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.IToolDescription"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.IToolDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.ToolDescription();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "element":
                            {
                                ...
                                {
                                    poco.Element = (Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "elementView":
                            {
                                ...
                                {
                                    poco.ElementView = (Auriga.Diagram.Viewpoint.Description.Tool.IElementViewVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
