...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    public class MessageCreationToolReader : XmiElementReader<Auriga.Diagram.Sequence.Description.Tool.IMessageCreationTool>, IXmiElementReader<Auriga.Diagram.Sequence.Description.Tool.IMessageCreationTool>
    {
        ...
        /// <summary>
        /// The XML names of the attributes <c>MessageCreationTool</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.Tool.IMessageCreationTool"/></returns>
        public Auriga.Diagram.Sequence.Description.Tool.IMessageCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.Tool.MessageCreationTool();
