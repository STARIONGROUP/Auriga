...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class OperationActionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IOperationAction>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IOperationAction>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.IOperationAction"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.IOperationAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.OperationAction();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "view":
                            {
                                ...
                                {
                                    poco.View = (Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
