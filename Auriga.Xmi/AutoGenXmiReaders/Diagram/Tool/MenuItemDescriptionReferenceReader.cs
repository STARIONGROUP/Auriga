...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class MenuItemDescriptionReferenceReader : XmiElementReader, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IMenuItemDescriptionReference>
    {
        /// <summary>
