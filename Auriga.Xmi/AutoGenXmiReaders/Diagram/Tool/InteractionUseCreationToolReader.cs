...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class InteractionUseCreationToolReader : XmiElementReader<Auriga.Diagram.Sequence.Description.Tool.IInteractionUseCreationTool>, IXmiElementReader<Auriga.Diagram.Sequence.Description.Tool.IInteractionUseCreationTool>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>InteractionUseCreationTool</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.Tool.IInteractionUseCreationTool"/></returns>
        public Auriga.Diagram.Sequence.Description.Tool.IInteractionUseCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.Tool.InteractionUseCreationTool();
