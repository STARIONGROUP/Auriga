...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    public class FeatureChangeListenerReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IFeatureChangeListener>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.Tool.IFeatureChangeListener>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.Tool.IFeatureChangeListener"/></returns>
        public Auriga.Diagram.Viewpoint.Description.Tool.IFeatureChangeListener Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.Tool.FeatureChangeListener();
