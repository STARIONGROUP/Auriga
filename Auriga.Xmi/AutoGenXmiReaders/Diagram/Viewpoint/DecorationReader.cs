...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint
{
    ...
    public class DecorationReader : XmiElementReader<Auriga.Diagram.Viewpoint.IDecoration>, IXmiElementReader<Auriga.Diagram.Viewpoint.IDecoration>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.IDecoration"/></returns>
        public Auriga.Diagram.Viewpoint.IDecoration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Decoration();
