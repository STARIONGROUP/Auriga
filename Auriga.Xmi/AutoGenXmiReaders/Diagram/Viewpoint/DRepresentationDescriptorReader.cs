...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint
{
    ...
    /// </summary>
    public class DRepresentationDescriptorReader : XmiElementReader<Auriga.Diagram.Viewpoint.IDRepresentationDescriptor>, IXmiElementReader<Auriga.Diagram.Viewpoint.IDRepresentationDescriptor>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DRepresentationDescriptor</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.IDRepresentationDescriptor"/></returns>
        public Auriga.Diagram.Viewpoint.IDRepresentationDescriptor Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.DRepresentationDescriptor();
