...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table
{
    ...
    /// </summary>
    public class DCellReader : XmiElementReader<Auriga.Diagram.Table.IDCell>, IXmiElementReader<Auriga.Diagram.Table.IDCell>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DCell</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.IDCell"/></returns>
        public Auriga.Diagram.Table.IDCell Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.DCell();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "currentStyle":
                            {
                                ...
                                {
                                    poco.CurrentStyle = (Auriga.Diagram.Table.IDCellStyle)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
