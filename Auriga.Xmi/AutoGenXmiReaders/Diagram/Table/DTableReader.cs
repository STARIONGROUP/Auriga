...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table
{
    ...
    public class DTableReader : XmiElementReader<Auriga.Diagram.Table.IDTable>, IXmiElementReader<Auriga.Diagram.Table.IDTable>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.IDTable"/></returns>
        public Auriga.Diagram.Table.IDTable Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.DTable();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "columns":
                            {
                                ...
                                {
                                    poco.Columns.Add((Auriga.Diagram.Table.IDColumn)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
