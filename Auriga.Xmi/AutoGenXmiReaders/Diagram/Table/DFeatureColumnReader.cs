...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table
{
    ...
    public class DFeatureColumnReader : XmiElementReader<Auriga.Diagram.Table.IDFeatureColumn>, IXmiElementReader<Auriga.Diagram.Table.IDFeatureColumn>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.IDFeatureColumn"/></returns>
        public Auriga.Diagram.Table.IDFeatureColumn Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.DFeatureColumn();
