...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    public class ObservationPointMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IObservationPointMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IObservationPointMapping>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IObservationPointMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IObservationPointMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.ObservationPointMapping();
