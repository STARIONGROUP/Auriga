// ------------------------------------------------------------------------------------------------
// <copyright file="SequenceDiagramDescriptionReader.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    using System;
    using System.Xml;
    ...
    /// <summary>
    /// The generated XMI reader that instantiates and populates an <c>SequenceDiagramDescription</c> from its
    ...
    public class SequenceDiagramDescriptionReader : XmiElementReader<Auriga.Diagram.Sequence.Description.ISequenceDiagramDescription>, IXmiElementReader<Auriga.Diagram.Sequence.Description.ISequenceDiagramDescription>
    {
        ...
        public SequenceDiagramDescriptionReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
            : base(cache, facade, settings, loggerFactory)
        {
        }

        /// <summary>
        /// Reads an <c>SequenceDiagramDescription</c> from the element at the cursor of the supplied reader.
        /// </summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.ISequenceDiagramDescription"/></returns>
        public Auriga.Diagram.Sequence.Description.ISequenceDiagramDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.SequenceDiagramDescription();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading SequenceDiagramDescription at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                ...
                poco.EndsOrdering = xmlReader.GetAttribute("endsOrdering");
                ...
                poco.InstanceRolesOrdering = xmlReader.GetAttribute("instanceRolesOrdering");
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "additionalLayers":
                            {
                                ...
                                {
                                    poco.AdditionalLayers.Add((Auriga.Diagram.Diagram.Description.IAdditionalLayer)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "concerns":
                            {
                                ...
                                {
                                    poco.Concerns = (Auriga.Diagram.Diagram.Description.Concern.IConcernSet)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "containerMappings":
                            {
                                ...
                                {
                                    poco.ContainerMappings.Add((Auriga.Diagram.Diagram.Description.IContainerMapping)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "defaultLayer":
                            {
                                ...
                                {
                                    poco.DefaultLayer = (Auriga.Diagram.Diagram.Description.ILayer)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "diagramInitialisation":
                            {
                                ...
                                {
                                    poco.DiagramInitialisation = (Auriga.Diagram.Viewpoint.Description.Tool.IInitialOperation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "edgeMappingImports":
                            {
                                ...
                                {
                                    poco.EdgeMappingImports.Add((Auriga.Diagram.Diagram.Description.IEdgeMappingImport)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "edgeMappings":
                            {
                                ...
                                {
                                    poco.EdgeMappings.Add((Auriga.Diagram.Diagram.Description.IEdgeMapping)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "filters":
                            {
                                ...
                                {
                                    poco.Filters.Add((Auriga.Diagram.Diagram.Description.Filter.IFilterDescription)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "layout":
                            {
                                ...
                                {
                                    poco.Layout = (Auriga.Diagram.Diagram.Description.ILayout)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "nodeMappings":
                            {
                                ...
                                {
                                    poco.NodeMappings.Add((Auriga.Diagram.Diagram.Description.INodeMapping)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "toolSection":
                            {
                                ...
                                {
                                    poco.ToolSection = (Auriga.Diagram.Diagram.Description.Tool.IToolSection)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"SequenceDiagramDescriptionReader: {xmlReader.LocalName} at line:position {xmlLineInfo?.LineNumber}:{xmlLineInfo?.LinePosition}");
                                }

                                this.Logger.LogWarning("Not supported by SequenceDiagramDescriptionReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
            ...
            {
                this.Logger.LogWarning("Expected an element to read SequenceDiagramDescription but found {NodeType} at line {Line}:{Position}", xmlReader.NodeType, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
            }
