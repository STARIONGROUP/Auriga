...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description
{
    ...
    /// </summary>
    public class SemanticBasedDecorationReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.ISemanticBasedDecoration>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.ISemanticBasedDecoration>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.ISemanticBasedDecoration"/></returns>
        public Auriga.Diagram.Viewpoint.Description.ISemanticBasedDecoration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.SemanticBasedDecoration();
