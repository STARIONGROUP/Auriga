...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    public class ExecutionMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IExecutionMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IExecutionMapping>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IExecutionMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IExecutionMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.ExecutionMapping();
