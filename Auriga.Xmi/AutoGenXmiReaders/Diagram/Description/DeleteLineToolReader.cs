...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table.Description
{
    ...
    public class DeleteLineToolReader : XmiElementReader<Auriga.Diagram.Table.Description.IDeleteLineTool>, IXmiElementReader<Auriga.Diagram.Table.Description.IDeleteLineTool>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.Description.IDeleteLineTool"/></returns>
        public Auriga.Diagram.Table.Description.IDeleteLineTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.Description.DeleteLineTool();
