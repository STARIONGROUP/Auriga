...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class CompositeLayoutReader : XmiElementReader<Auriga.Diagram.Diagram.Description.ICompositeLayout>, IXmiElementReader<Auriga.Diagram.Diagram.Description.ICompositeLayout>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.ICompositeLayout"/></returns>
        public Auriga.Diagram.Diagram.Description.ICompositeLayout Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.CompositeLayout();
