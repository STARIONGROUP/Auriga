...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class AdditionalLayerReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IAdditionalLayer>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IAdditionalLayer>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>AdditionalLayer</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IAdditionalLayer"/></returns>
        public Auriga.Diagram.Diagram.Description.IAdditionalLayer Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.AdditionalLayer();
