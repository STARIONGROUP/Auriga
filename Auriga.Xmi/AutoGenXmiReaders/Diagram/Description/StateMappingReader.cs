...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class StateMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IStateMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IStateMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IStateMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IStateMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.StateMapping();
