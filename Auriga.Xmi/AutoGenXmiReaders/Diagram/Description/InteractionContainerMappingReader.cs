...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class InteractionContainerMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IInteractionContainerMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IInteractionContainerMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IInteractionContainerMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IInteractionContainerMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.InteractionContainerMapping();
