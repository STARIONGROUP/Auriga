...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description
{
    ...
    public class FixedColorReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.IFixedColor>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.IFixedColor>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.IFixedColor"/></returns>
        public Auriga.Diagram.Viewpoint.Description.IFixedColor Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.FixedColor();
