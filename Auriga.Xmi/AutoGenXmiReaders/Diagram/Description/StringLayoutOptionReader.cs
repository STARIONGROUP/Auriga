...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class StringLayoutOptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IStringLayoutOption>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IStringLayoutOption>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IStringLayoutOption"/></returns>
        public Auriga.Diagram.Diagram.Description.IStringLayoutOption Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.StringLayoutOption();
