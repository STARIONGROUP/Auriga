...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description
{
    ...
    public class TypedVariableReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.ITypedVariable>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.ITypedVariable>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.ITypedVariable"/></returns>
        public Auriga.Diagram.Viewpoint.Description.ITypedVariable Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.TypedVariable();
