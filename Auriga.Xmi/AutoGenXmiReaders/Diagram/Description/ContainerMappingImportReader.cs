...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class ContainerMappingImportReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IContainerMappingImport>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IContainerMappingImport>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IContainerMappingImport"/></returns>
        public Auriga.Diagram.Diagram.Description.IContainerMappingImport Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.ContainerMappingImport();
