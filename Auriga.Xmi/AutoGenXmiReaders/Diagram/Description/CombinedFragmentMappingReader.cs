...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    public class CombinedFragmentMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.ICombinedFragmentMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.ICombinedFragmentMapping>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.ICombinedFragmentMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.ICombinedFragmentMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.CombinedFragmentMapping();
