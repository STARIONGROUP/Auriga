...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class DestructionMessageMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IDestructionMessageMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IDestructionMessageMapping>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DestructionMessageMapping</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IDestructionMessageMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IDestructionMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.DestructionMessageMapping();
