...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class GateMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IGateMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IGateMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IGateMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IGateMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.GateMapping();
