...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class DiagramImportDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IDiagramImportDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IDiagramImportDescription>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DiagramImportDescription</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IDiagramImportDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.IDiagramImportDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.DiagramImportDescription();
