...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    public class EnumLayoutValueReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IEnumLayoutValue>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IEnumLayoutValue>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IEnumLayoutValue"/></returns>
        public Auriga.Diagram.Diagram.Description.IEnumLayoutValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.EnumLayoutValue();
