...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Viewpoint.Description
{
    ...
    public class JavaExtensionReader : XmiElementReader<Auriga.Diagram.Viewpoint.Description.IJavaExtension>, IXmiElementReader<Auriga.Diagram.Viewpoint.Description.IJavaExtension>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Viewpoint.Description.IJavaExtension"/></returns>
        public Auriga.Diagram.Viewpoint.Description.IJavaExtension Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Viewpoint.Description.JavaExtension();
