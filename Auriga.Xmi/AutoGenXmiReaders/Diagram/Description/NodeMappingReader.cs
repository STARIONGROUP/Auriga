...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class NodeMappingReader : XmiElementReader<Auriga.Diagram.Diagram.Description.INodeMapping>, IXmiElementReader<Auriga.Diagram.Diagram.Description.INodeMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.INodeMapping"/></returns>
        public Auriga.Diagram.Diagram.Description.INodeMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.NodeMapping();
