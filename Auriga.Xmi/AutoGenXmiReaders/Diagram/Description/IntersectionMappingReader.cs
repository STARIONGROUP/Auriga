...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table.Description
{
    ...
    /// </summary>
    public class IntersectionMappingReader : XmiElementReader<Auriga.Diagram.Table.Description.IIntersectionMapping>, IXmiElementReader<Auriga.Diagram.Table.Description.IIntersectionMapping>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>IntersectionMapping</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.Description.IIntersectionMapping"/></returns>
        public Auriga.Diagram.Table.Description.IIntersectionMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.Description.IntersectionMapping();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "create":
                            {
                                ...
                                {
                                    poco.Create = (Auriga.Diagram.Table.Description.ICreateCellTool)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
