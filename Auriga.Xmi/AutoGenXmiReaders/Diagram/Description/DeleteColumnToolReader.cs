...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table.Description
{
    ...
    public class DeleteColumnToolReader : XmiElementReader<Auriga.Diagram.Table.Description.IDeleteColumnTool>, IXmiElementReader<Auriga.Diagram.Table.Description.IDeleteColumnTool>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.Description.IDeleteColumnTool"/></returns>
        public Auriga.Diagram.Table.Description.IDeleteColumnTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.Description.DeleteColumnTool();
