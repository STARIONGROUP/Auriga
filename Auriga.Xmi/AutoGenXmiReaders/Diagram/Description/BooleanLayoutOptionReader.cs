...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    public class BooleanLayoutOptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IBooleanLayoutOption>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IBooleanLayoutOption>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IBooleanLayoutOption"/></returns>
        public Auriga.Diagram.Diagram.Description.IBooleanLayoutOption Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.BooleanLayoutOption();
