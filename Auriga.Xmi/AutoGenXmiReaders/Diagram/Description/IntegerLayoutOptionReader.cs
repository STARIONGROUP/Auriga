...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    public class IntegerLayoutOptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IIntegerLayoutOption>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IIntegerLayoutOption>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IIntegerLayoutOption"/></returns>
        public Auriga.Diagram.Diagram.Description.IIntegerLayoutOption Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.IntegerLayoutOption();
