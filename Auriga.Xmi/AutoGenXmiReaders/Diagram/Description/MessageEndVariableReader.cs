...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    public class MessageEndVariableReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IMessageEndVariable>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IMessageEndVariable>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IMessageEndVariable"/></returns>
        public Auriga.Diagram.Sequence.Description.IMessageEndVariable Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.MessageEndVariable();
