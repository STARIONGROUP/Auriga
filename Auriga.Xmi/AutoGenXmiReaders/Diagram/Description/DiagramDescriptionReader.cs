...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class DiagramDescriptionReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IDiagramDescription>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IDiagramDescription>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DiagramDescription</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IDiagramDescription"/></returns>
        public Auriga.Diagram.Diagram.Description.IDiagramDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.DiagramDescription();
