...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    public class EndOfLifeMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IEndOfLifeMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IEndOfLifeMapping>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IEndOfLifeMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IEndOfLifeMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.EndOfLifeMapping();
