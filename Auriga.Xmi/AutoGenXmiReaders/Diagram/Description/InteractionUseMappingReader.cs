...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class InteractionUseMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IInteractionUseMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IInteractionUseMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IInteractionUseMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IInteractionUseMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.InteractionUseMapping();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "conditionnalStyles":
                            {
                                ...
                                {
                                    poco.ConditionnalStyles.Add((Auriga.Diagram.Diagram.Description.IConditionalContainerStyleDescription)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "style":
                            {
                                ...
                                {
                                    poco.Style = (Auriga.Diagram.Diagram.Description.Style.IContainerStyleDescription)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "subContainerMappings":
                            {
                                ...
                                {
                                    poco.SubContainerMappings.Add((Auriga.Diagram.Diagram.Description.IContainerMapping)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "subNodeMappings":
                            {
                                ...
                                {
                                    poco.SubNodeMappings.Add((Auriga.Diagram.Diagram.Description.INodeMapping)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
