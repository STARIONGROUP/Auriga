...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class MappingBasedDecorationReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IMappingBasedDecoration>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IMappingBasedDecoration>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IMappingBasedDecoration"/></returns>
        public Auriga.Diagram.Diagram.Description.IMappingBasedDecoration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.MappingBasedDecoration();
