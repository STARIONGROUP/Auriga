...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table.Description
{
    ...
    public class BackgroundConditionalStyleReader : XmiElementReader<Auriga.Diagram.Table.Description.IBackgroundConditionalStyle>, IXmiElementReader<Auriga.Diagram.Table.Description.IBackgroundConditionalStyle>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.Description.IBackgroundConditionalStyle"/></returns>
        public Auriga.Diagram.Table.Description.IBackgroundConditionalStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.Description.BackgroundConditionalStyle();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "style":
                            {
                                ...
                                {
                                    poco.Style = (Auriga.Diagram.Table.Description.IBackgroundStyleDescription)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
