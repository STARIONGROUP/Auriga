...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    public class InstanceRoleMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IInstanceRoleMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IInstanceRoleMapping>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IInstanceRoleMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IInstanceRoleMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.InstanceRoleMapping();
