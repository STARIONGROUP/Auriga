...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class ContainerMappingReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IContainerMapping>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IContainerMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IContainerMapping"/></returns>
        public Auriga.Diagram.Diagram.Description.IContainerMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.ContainerMapping();
