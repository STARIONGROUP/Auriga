...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class OperandMappingReader : XmiElementReader<Auriga.Diagram.Sequence.Description.IOperandMapping>, IXmiElementReader<Auriga.Diagram.Sequence.Description.IOperandMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Sequence.Description.IOperandMapping"/></returns>
        public Auriga.Diagram.Sequence.Description.IOperandMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Sequence.Description.OperandMapping();
