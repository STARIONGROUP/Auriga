...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Table.Description
{
    ...
    public class CreateColumnToolReader : XmiElementReader<Auriga.Diagram.Table.Description.ICreateColumnTool>, IXmiElementReader<Auriga.Diagram.Table.Description.ICreateColumnTool>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Table.Description.ICreateColumnTool"/></returns>
        public Auriga.Diagram.Table.Description.ICreateColumnTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Table.Description.CreateColumnTool();
