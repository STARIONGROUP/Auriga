...
namespace Auriga.Xmi.Diagram.AutoGenXmiReaders.Diagram.Description
{
    ...
    public class OrderedTreeLayoutReader : XmiElementReader<Auriga.Diagram.Diagram.Description.IOrderedTreeLayout>, IXmiElementReader<Auriga.Diagram.Diagram.Description.IOrderedTreeLayout>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Diagram.Diagram.Description.IOrderedTreeLayout"/></returns>
        public Auriga.Diagram.Diagram.Description.IOrderedTreeLayout Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Diagram.Diagram.Description.OrderedTreeLayout();
