...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    public class AbstractStateRealizationReader : XmiElementReader<Auriga.Capellacommon.IAbstractStateRealization>, IXmiElementReader<Auriga.Capellacommon.IAbstractStateRealization>
    {
        ...
        public AbstractStateRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Capellacommon.IAbstractStateRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of AbstractStateRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
