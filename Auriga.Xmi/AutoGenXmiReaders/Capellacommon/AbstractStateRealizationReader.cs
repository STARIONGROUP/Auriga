...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class AbstractStateRealizationReader : XmiElementReader<Auriga.Capellacommon.IAbstractStateRealization>, IXmiElementReader<Auriga.Capellacommon.IAbstractStateRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IAbstractStateRealization"/></returns>
        public Auriga.Capellacommon.IAbstractStateRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.AbstractStateRealization();
