...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class FinalStateReader : XmiElementReader<Auriga.Capellacommon.IFinalState>, IXmiElementReader<Auriga.Capellacommon.IFinalState>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IFinalState"/></returns>
        public Auriga.Capellacommon.IFinalState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.FinalState();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedAbstractStateRealizations":
                            {
                                ...
                                {
                                    poco.OwnedAbstractStateRealizations.Add((Auriga.Capellacommon.IAbstractStateRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "stateInvariant":
                            {
                                ...
                                {
                                    poco.StateInvariant = (Auriga.Modellingcore.IAbstractConstraint)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
