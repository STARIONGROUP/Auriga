...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class ModeReader : XmiElementReader<Auriga.Capellacommon.IMode>, IXmiElementReader<Auriga.Capellacommon.IMode>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IMode"/></returns>
        public Auriga.Capellacommon.IMode Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.Mode();
