...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class DeepHistoryPseudoStateReader : XmiElementReader<Auriga.Capellacommon.IDeepHistoryPseudoState>, IXmiElementReader<Auriga.Capellacommon.IDeepHistoryPseudoState>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IDeepHistoryPseudoState"/></returns>
        public Auriga.Capellacommon.IDeepHistoryPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.DeepHistoryPseudoState();
