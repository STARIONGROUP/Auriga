...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    public class DeepHistoryPseudoStateReader : XmiElementReader<Auriga.Capellacommon.IDeepHistoryPseudoState>, IXmiElementReader<Auriga.Capellacommon.IDeepHistoryPseudoState>
    {
        ...
        public Auriga.Capellacommon.IDeepHistoryPseudoState Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of DeepHistoryPseudoState at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
