...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class InitialPseudoStateReader : XmiElementReader<Auriga.Capellacommon.IInitialPseudoState>, IXmiElementReader<Auriga.Capellacommon.IInitialPseudoState>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IInitialPseudoState"/></returns>
        public Auriga.Capellacommon.IInitialPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.InitialPseudoState();
