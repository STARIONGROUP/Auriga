...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class EntryPointPseudoStateReader : XmiElementReader<Auriga.Capellacommon.IEntryPointPseudoState>, IXmiElementReader<Auriga.Capellacommon.IEntryPointPseudoState>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IEntryPointPseudoState"/></returns>
        public Auriga.Capellacommon.IEntryPointPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.EntryPointPseudoState();
