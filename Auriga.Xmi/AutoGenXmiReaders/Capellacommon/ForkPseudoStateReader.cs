...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class ForkPseudoStateReader : XmiElementReader<Auriga.Capellacommon.IForkPseudoState>, IXmiElementReader<Auriga.Capellacommon.IForkPseudoState>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IForkPseudoState"/></returns>
        public Auriga.Capellacommon.IForkPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.ForkPseudoState();
