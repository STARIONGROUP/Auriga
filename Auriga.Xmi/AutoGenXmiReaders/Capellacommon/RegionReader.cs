                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedStates":
                            {
                                ...
                                {
                                    poco.OwnedStates.Add((Auriga.Capellacommon.IAbstractState)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedTransitions":
                            {
                                ...
                                {
                                    poco.OwnedTransitions.Add((Auriga.Capellacommon.IStateTransition)this.Facade.QueryElement(xmlReader));
                                }
