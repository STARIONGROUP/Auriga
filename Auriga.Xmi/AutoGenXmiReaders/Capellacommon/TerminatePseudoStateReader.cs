...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class TerminatePseudoStateReader : XmiElementReader<Auriga.Capellacommon.ITerminatePseudoState>, IXmiElementReader<Auriga.Capellacommon.ITerminatePseudoState>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.ITerminatePseudoState"/></returns>
        public Auriga.Capellacommon.ITerminatePseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.TerminatePseudoState();
