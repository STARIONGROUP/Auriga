...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    public class TerminatePseudoStateReader : XmiElementReader<Auriga.Capellacommon.ITerminatePseudoState>, IXmiElementReader<Auriga.Capellacommon.ITerminatePseudoState>
    {
        ...
        public Auriga.Capellacommon.ITerminatePseudoState Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of TerminatePseudoState at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
