...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    public class CapabilityRealizationInvolvementReader : XmiElementReader<Auriga.Capellacommon.ICapabilityRealizationInvolvement>, IXmiElementReader<Auriga.Capellacommon.ICapabilityRealizationInvolvement>
    {
        ...
        public CapabilityRealizationInvolvementReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Capellacommon.ICapabilityRealizationInvolvement Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of CapabilityRealizationInvolvement at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
