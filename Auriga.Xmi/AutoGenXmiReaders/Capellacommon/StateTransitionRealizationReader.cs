...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    public class StateTransitionRealizationReader : XmiElementReader<Auriga.Capellacommon.IStateTransitionRealization>, IXmiElementReader<Auriga.Capellacommon.IStateTransitionRealization>
    {
        ...
        public StateTransitionRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Capellacommon.IStateTransitionRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of StateTransitionRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
