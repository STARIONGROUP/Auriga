...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class StateTransitionRealizationReader : XmiElementReader<Auriga.Capellacommon.IStateTransitionRealization>, IXmiElementReader<Auriga.Capellacommon.IStateTransitionRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IStateTransitionRealization"/></returns>
        public Auriga.Capellacommon.IStateTransitionRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.StateTransitionRealization();
