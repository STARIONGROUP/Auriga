...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class TimeEventReader : XmiElementReader<Auriga.Capellacommon.ITimeEvent>, IXmiElementReader<Auriga.Capellacommon.ITimeEvent>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.ITimeEvent"/></returns>
        public Auriga.Capellacommon.ITimeEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.TimeEvent();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Capellacommon.TimeEventKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
