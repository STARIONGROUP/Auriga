...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    /// </summary>
    public class StateEventRealizationReader : XmiElementReader<Auriga.Capellacommon.IStateEventRealization>, IXmiElementReader<Auriga.Capellacommon.IStateEventRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellacommon.IStateEventRealization"/></returns>
        public Auriga.Capellacommon.IStateEventRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellacommon.StateEventRealization();
