...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellacommon
{
    ...
    public class StateEventRealizationReader : XmiElementReader<Auriga.Capellacommon.IStateEventRealization>, IXmiElementReader<Auriga.Capellacommon.IStateEventRealization>
    {
        ...
        public StateEventRealizationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Capellacommon.IStateEventRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of StateEventRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
