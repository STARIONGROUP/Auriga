...
namespace Auriga.Xmi.AutoGenXmiReaders.Re
{
    ...
    /// </summary>
    public class CatalogElementPkgReader : XmiElementReader<Auriga.Re.ICatalogElementPkg>, IXmiElementReader<Auriga.Re.ICatalogElementPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Re.ICatalogElementPkg"/></returns>
        public Auriga.Re.ICatalogElementPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Re.CatalogElementPkg();
