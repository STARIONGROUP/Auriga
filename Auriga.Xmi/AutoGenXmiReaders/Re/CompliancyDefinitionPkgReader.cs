...
namespace Auriga.Xmi.AutoGenXmiReaders.Re
{
    ...
    public class CompliancyDefinitionPkgReader : XmiElementReader<Auriga.Re.ICompliancyDefinitionPkg>, IXmiElementReader<Auriga.Re.ICompliancyDefinitionPkg>
    {
        ...
        public Auriga.Re.ICompliancyDefinitionPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "ownedDefinitions":
                            {
                                ...
                                {
                                    poco.OwnedDefinitions.Add((Auriga.Re.ICompliancyDefinition)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
