...
namespace Auriga.Xmi.AutoGenXmiReaders.Re
{
    ...
    public class GroupingElementPkgReader : XmiElementReader<Auriga.Re.IGroupingElementPkg>, IXmiElementReader<Auriga.Re.IGroupingElementPkg>
    {
        ...
        public GroupingElementPkgReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "ownedExtensions":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of GroupingElementPkg at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
