// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalLinkRealizationReader.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// <summary>
    /// The generated XMI reader that instantiates and populates an <c>PhysicalLinkRealization</c> from its
    /// XMI representation. Contained elements are read recursively; cross-references are collected for the
    /// reference-resolution pass.
    /// </summary>
    public class PhysicalLinkRealizationReader : XmiElementReader<Auriga.Cs.IPhysicalLinkRealization>, IXmiElementReader<Auriga.Cs.IPhysicalLinkRealization>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalLinkRealizationReader"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Reads an <c>PhysicalLinkRealization</c> from the element at the cursor of the supplied reader.
        /// </summary>
        /// <param name="xmlReader">the reader positioned on the element</param>
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalLinkRealization"/></returns>
        public Auriga.Cs.IPhysicalLinkRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalLinkRealization();
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of PhysicalLinkRealization at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
            ...
            {
                this.Logger.LogWarning("Expected an element to read PhysicalLinkRealization but found {NodeType} at line {Line}:{Position}", xmlReader.NodeType, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
            }
