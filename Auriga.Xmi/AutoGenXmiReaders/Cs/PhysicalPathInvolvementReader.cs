...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalPathInvolvementReader : XmiElementReader<Auriga.Cs.IPhysicalPathInvolvement>, IXmiElementReader<Auriga.Cs.IPhysicalPathInvolvement>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalPathInvolvement"/></returns>
        public Auriga.Cs.IPhysicalPathInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalPathInvolvement();
