                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPhysicalPathInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalPathInvolvements.Add((Auriga.Cs.IPhysicalPathInvolvement)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedPhysicalPathRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalPathRealizations.Add((Auriga.Cs.IPhysicalPathRealization)this.Facade.QueryElement(xmlReader));
                                }
