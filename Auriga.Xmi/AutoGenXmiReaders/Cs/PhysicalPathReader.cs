...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalPathReader : XmiElementReader<Auriga.Cs.IPhysicalPath>, IXmiElementReader<Auriga.Cs.IPhysicalPath>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalPath"/></returns>
        public Auriga.Cs.IPhysicalPath Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalPath();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPhysicalPathInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalPathInvolvements.Add((Auriga.Cs.IPhysicalPathInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalPathRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalPathRealizations.Add((Auriga.Cs.IPhysicalPathRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
