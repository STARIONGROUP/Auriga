...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    public class InterfaceReader : XmiElementReader<Auriga.Cs.IInterface>, IXmiElementReader<Auriga.Cs.IInterface>
    {
        ...
        public Auriga.Cs.IInterface Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedExchangeItemAllocations":
                            {
                                ...
                                {
                                    poco.OwnedExchangeItemAllocations.Add((Auriga.Cs.IExchangeItemAllocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
