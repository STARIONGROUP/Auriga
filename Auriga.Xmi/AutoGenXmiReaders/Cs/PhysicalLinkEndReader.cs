...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkEndReader : XmiElementReader<Auriga.Cs.IPhysicalLinkEnd>, IXmiElementReader<Auriga.Cs.IPhysicalLinkEnd>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalLinkEnd"/></returns>
        public Auriga.Cs.IPhysicalLinkEnd Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalLinkEnd();
