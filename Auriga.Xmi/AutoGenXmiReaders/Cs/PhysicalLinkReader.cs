...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkReader : XmiElementReader<Auriga.Cs.IPhysicalLink>, IXmiElementReader<Auriga.Cs.IPhysicalLink>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalLink"/></returns>
        public Auriga.Cs.IPhysicalLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalLink();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComponentExchangeAllocations":
                            {
                                ...
                                {
                                    poco.OwnedComponentExchangeAllocations.Add((Auriga.Fa.IComponentExchangeAllocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalLinkEnds":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalLinkEnds.Add((Auriga.Cs.IPhysicalLinkEnd)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalLinkRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalLinkRealizations.Add((Auriga.Cs.IPhysicalLinkRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
