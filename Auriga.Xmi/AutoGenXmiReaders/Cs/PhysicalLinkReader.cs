                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComponentExchangeAllocations":
                            {
                                ...
                                {
                                    poco.OwnedComponentExchangeAllocations.Add((Auriga.Fa.IComponentExchangeAllocation)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedPhysicalLinkEnds":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalLinkEnds.Add((Auriga.Cs.IPhysicalLinkEnd)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedPhysicalLinkRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalLinkRealizations.Add((Auriga.Cs.IPhysicalLinkRealization)this.Facade.QueryElement(xmlReader));
                                }
