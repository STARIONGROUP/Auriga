...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalPortRealizationReader : XmiElementReader<Auriga.Cs.IPhysicalPortRealization>, IXmiElementReader<Auriga.Cs.IPhysicalPortRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalPortRealization"/></returns>
        public Auriga.Cs.IPhysicalPortRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalPortRealization();
