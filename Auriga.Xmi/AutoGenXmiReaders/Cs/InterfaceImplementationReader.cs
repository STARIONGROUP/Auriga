...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class InterfaceImplementationReader : XmiElementReader<Auriga.Cs.IInterfaceImplementation>, IXmiElementReader<Auriga.Cs.IInterfaceImplementation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IInterfaceImplementation"/></returns>
        public Auriga.Cs.IInterfaceImplementation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.InterfaceImplementation();
