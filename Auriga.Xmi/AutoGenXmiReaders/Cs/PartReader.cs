...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PartReader : XmiElementReader<Auriga.Cs.IPart>, IXmiElementReader<Auriga.Cs.IPart>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPart"/></returns>
        public Auriga.Cs.IPart Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedAbstractType":
                            {
                                ...
                                {
                                    poco.OwnedAbstractType = (Auriga.Modellingcore.IAbstractType)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
