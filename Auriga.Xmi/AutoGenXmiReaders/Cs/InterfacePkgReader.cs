                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedInterfacePkgs":
                            {
                                ...
                                {
                                    poco.OwnedInterfacePkgs.Add((Auriga.Cs.IInterfacePkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedInterfaces":
                            {
                                ...
                                {
                                    poco.OwnedInterfaces.Add((Auriga.Cs.IInterface)this.Facade.QueryElement(xmlReader));
                                }
