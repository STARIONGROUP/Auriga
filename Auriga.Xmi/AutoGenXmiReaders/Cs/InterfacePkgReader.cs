...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class InterfacePkgReader : XmiElementReader<Auriga.Cs.IInterfacePkg>, IXmiElementReader<Auriga.Cs.IInterfacePkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IInterfacePkg"/></returns>
        public Auriga.Cs.IInterfacePkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.InterfacePkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedInterfacePkgs":
                            {
                                ...
                                {
                                    poco.OwnedInterfacePkgs.Add((Auriga.Cs.IInterfacePkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedInterfaces":
                            {
                                ...
                                {
                                    poco.OwnedInterfaces.Add((Auriga.Cs.IInterface)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
