...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkCategoryReader : XmiElementReader<Auriga.Cs.IPhysicalLinkCategory>, IXmiElementReader<Auriga.Cs.IPhysicalLinkCategory>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalLinkCategory"/></returns>
        public Auriga.Cs.IPhysicalLinkCategory Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalLinkCategory();
