...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalPathRealizationReader : XmiElementReader<Auriga.Cs.IPhysicalPathRealization>, IXmiElementReader<Auriga.Cs.IPhysicalPathRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IPhysicalPathRealization"/></returns>
        public Auriga.Cs.IPhysicalPathRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.PhysicalPathRealization();
