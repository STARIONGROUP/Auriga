...
namespace Auriga.Xmi.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class InterfaceUseReader : XmiElementReader<Auriga.Cs.IInterfaceUse>, IXmiElementReader<Auriga.Cs.IInterfaceUse>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Cs.IInterfaceUse"/></returns>
        public Auriga.Cs.IInterfaceUse Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Cs.InterfaceUse();
