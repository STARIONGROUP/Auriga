...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class ConstraintDurationReader : XmiElementReader<Auriga.Interaction.IConstraintDuration>, IXmiElementReader<Auriga.Interaction.IConstraintDuration>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IConstraintDuration"/></returns>
        public Auriga.Interaction.IConstraintDuration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.ConstraintDuration();
