...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class CancelTimerEventReader : XmiElementReader<Auriga.Interaction.ICancelTimerEvent>, IXmiElementReader<Auriga.Interaction.ICancelTimerEvent>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.ICancelTimerEvent"/></returns>
        public Auriga.Interaction.ICancelTimerEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.CancelTimerEvent();
