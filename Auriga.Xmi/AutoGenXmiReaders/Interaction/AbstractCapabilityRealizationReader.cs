...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityRealizationReader : XmiElementReader<Auriga.Interaction.IAbstractCapabilityRealization>, IXmiElementReader<Auriga.Interaction.IAbstractCapabilityRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IAbstractCapabilityRealization"/></returns>
        public Auriga.Interaction.IAbstractCapabilityRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.AbstractCapabilityRealization();
