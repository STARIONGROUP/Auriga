...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class MessageEndReader : XmiElementReader<Auriga.Interaction.IMessageEnd>, IXmiElementReader<Auriga.Interaction.IMessageEnd>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IMessageEnd"/></returns>
        public Auriga.Interaction.IMessageEnd Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.MessageEnd();
