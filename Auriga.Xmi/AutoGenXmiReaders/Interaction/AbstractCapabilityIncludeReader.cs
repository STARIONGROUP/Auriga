...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityIncludeReader : XmiElementReader<Auriga.Interaction.IAbstractCapabilityInclude>, IXmiElementReader<Auriga.Interaction.IAbstractCapabilityInclude>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IAbstractCapabilityInclude"/></returns>
        public Auriga.Interaction.IAbstractCapabilityInclude Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.AbstractCapabilityInclude();
