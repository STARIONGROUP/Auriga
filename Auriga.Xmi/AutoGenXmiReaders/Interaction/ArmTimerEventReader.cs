...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class ArmTimerEventReader : XmiElementReader<Auriga.Interaction.IArmTimerEvent>, IXmiElementReader<Auriga.Interaction.IArmTimerEvent>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IArmTimerEvent"/></returns>
        public Auriga.Interaction.IArmTimerEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.ArmTimerEvent();
