...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class ScenarioRealizationReader : XmiElementReader<Auriga.Interaction.IScenarioRealization>, IXmiElementReader<Auriga.Interaction.IScenarioRealization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IScenarioRealization"/></returns>
        public Auriga.Interaction.IScenarioRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.ScenarioRealization();
