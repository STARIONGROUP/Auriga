...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class SequenceMessageReader : XmiElementReader<Auriga.Interaction.ISequenceMessage>, IXmiElementReader<Auriga.Interaction.ISequenceMessage>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.ISequenceMessage"/></returns>
        public Auriga.Interaction.ISequenceMessage Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.SequenceMessage();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Interaction.MessageKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedSequenceMessageValuations":
                            {
                                ...
                                {
                                    poco.OwnedSequenceMessageValuations.Add((Auriga.Interaction.ISequenceMessageValuation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
