...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class GateReader : XmiElementReader<Auriga.Interaction.IGate>, IXmiElementReader<Auriga.Interaction.IGate>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IGate"/></returns>
        public Auriga.Interaction.IGate Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.Gate();
