...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityExtensionPointReader : XmiElementReader<Auriga.Interaction.IAbstractCapabilityExtensionPoint>, IXmiElementReader<Auriga.Interaction.IAbstractCapabilityExtensionPoint>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IAbstractCapabilityExtensionPoint"/></returns>
        public Auriga.Interaction.IAbstractCapabilityExtensionPoint Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.AbstractCapabilityExtensionPoint();
