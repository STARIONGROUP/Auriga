...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class SequenceMessageValuationReader : XmiElementReader<Auriga.Interaction.ISequenceMessageValuation>, IXmiElementReader<Auriga.Interaction.ISequenceMessageValuation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.ISequenceMessageValuation"/></returns>
        public Auriga.Interaction.ISequenceMessageValuation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.SequenceMessageValuation();
