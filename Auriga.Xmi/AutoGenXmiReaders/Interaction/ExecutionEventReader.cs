...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class ExecutionEventReader : XmiElementReader<Auriga.Interaction.IExecutionEvent>, IXmiElementReader<Auriga.Interaction.IExecutionEvent>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IExecutionEvent"/></returns>
        public Auriga.Interaction.IExecutionEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.ExecutionEvent();
