...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class InteractionUseReader : XmiElementReader<Auriga.Interaction.IInteractionUse>, IXmiElementReader<Auriga.Interaction.IInteractionUse>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IInteractionUse"/></returns>
        public Auriga.Interaction.IInteractionUse Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.InteractionUse();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedGates":
                            {
                                ...
                                {
                                    poco.OwnedGates.Add((Auriga.Interaction.IGate)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
