...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityGeneralizationReader : XmiElementReader<Auriga.Interaction.IAbstractCapabilityGeneralization>, IXmiElementReader<Auriga.Interaction.IAbstractCapabilityGeneralization>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IAbstractCapabilityGeneralization"/></returns>
        public Auriga.Interaction.IAbstractCapabilityGeneralization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.AbstractCapabilityGeneralization();
