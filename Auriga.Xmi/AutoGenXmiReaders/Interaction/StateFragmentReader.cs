...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class StateFragmentReader : XmiElementReader<Auriga.Interaction.IStateFragment>, IXmiElementReader<Auriga.Interaction.IStateFragment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IStateFragment"/></returns>
        public Auriga.Interaction.IStateFragment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.StateFragment();
