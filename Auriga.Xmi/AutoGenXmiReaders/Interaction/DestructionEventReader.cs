...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class DestructionEventReader : XmiElementReader<Auriga.Interaction.IDestructionEvent>, IXmiElementReader<Auriga.Interaction.IDestructionEvent>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IDestructionEvent"/></returns>
        public Auriga.Interaction.IDestructionEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.DestructionEvent();
