...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class EventSentOperationReader : XmiElementReader<Auriga.Interaction.IEventSentOperation>, IXmiElementReader<Auriga.Interaction.IEventSentOperation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IEventSentOperation"/></returns>
        public Auriga.Interaction.IEventSentOperation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.EventSentOperation();
