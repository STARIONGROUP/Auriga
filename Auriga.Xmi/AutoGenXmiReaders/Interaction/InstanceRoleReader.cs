...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class InstanceRoleReader : XmiElementReader<Auriga.Interaction.IInstanceRole>, IXmiElementReader<Auriga.Interaction.IInstanceRole>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IInstanceRole"/></returns>
        public Auriga.Interaction.IInstanceRole Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.InstanceRole();
