...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityExtendReader : XmiElementReader<Auriga.Interaction.IAbstractCapabilityExtend>, IXmiElementReader<Auriga.Interaction.IAbstractCapabilityExtend>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IAbstractCapabilityExtend"/></returns>
        public Auriga.Interaction.IAbstractCapabilityExtend Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.AbstractCapabilityExtend();
