...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class AbstractFunctionAbstractCapabilityInvolvementReader : XmiElementReader<Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement>, IXmiElementReader<Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement"/></returns>
        public Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.AbstractFunctionAbstractCapabilityInvolvement();
