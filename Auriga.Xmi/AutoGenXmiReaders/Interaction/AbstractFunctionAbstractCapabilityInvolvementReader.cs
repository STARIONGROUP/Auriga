...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    public class AbstractFunctionAbstractCapabilityInvolvementReader : XmiElementReader<Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement>, IXmiElementReader<Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement>
    {
        ...
        public AbstractFunctionAbstractCapabilityInvolvementReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of AbstractFunctionAbstractCapabilityInvolvement at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
