...
namespace Auriga.Xmi.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class ExecutionReader : XmiElementReader<Auriga.Interaction.IExecution>, IXmiElementReader<Auriga.Interaction.IExecution>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Interaction.IExecution"/></returns>
        public Auriga.Interaction.IExecution Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Interaction.Execution();
