...
namespace Auriga.Xmi.AutoGenXmiReaders.Requirements
{
    ...
    public class AttributeDefinitionEnumerationReader : XmiElementReader<Auriga.Requirements.IAttributeDefinitionEnumeration>, IXmiElementReader<Auriga.Requirements.IAttributeDefinitionEnumeration>
    {
        ...
        public Auriga.Requirements.IAttributeDefinitionEnumeration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "defaultValue":
                            {
                                ...
                                {
                                    poco.DefaultValue = (Auriga.Requirements.IAttribute)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
