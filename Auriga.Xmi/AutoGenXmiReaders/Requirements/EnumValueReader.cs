...
namespace Auriga.Xmi.AutoGenXmiReaders.Requirements
{
    ...
    /// </summary>
    public class EnumValueReader : XmiElementReader<Auriga.Requirements.IEnumValue>, IXmiElementReader<Auriga.Requirements.IEnumValue>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Requirements.IEnumValue"/></returns>
        public Auriga.Requirements.IEnumValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Requirements.EnumValue();
