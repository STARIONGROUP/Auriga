...
namespace Auriga.Xmi.AutoGenXmiReaders.Requirements
{
    ...
    /// </summary>
    public class BooleanValueAttributeReader : XmiElementReader<Auriga.Requirements.IBooleanValueAttribute>, IXmiElementReader<Auriga.Requirements.IBooleanValueAttribute>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Requirements.IBooleanValueAttribute"/></returns>
        public Auriga.Requirements.IBooleanValueAttribute Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Requirements.BooleanValueAttribute();
