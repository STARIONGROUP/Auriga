...
namespace Auriga.Xmi.AutoGenXmiReaders.Requirements
{
    ...
    /// </summary>
    public class InternalRelationReader : XmiElementReader<Auriga.Requirements.IInternalRelation>, IXmiElementReader<Auriga.Requirements.IInternalRelation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Requirements.IInternalRelation"/></returns>
        public Auriga.Requirements.IInternalRelation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Requirements.InternalRelation();
