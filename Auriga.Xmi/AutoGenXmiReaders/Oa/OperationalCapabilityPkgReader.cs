...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class OperationalCapabilityPkgReader : XmiElementReader<Auriga.Oa.IOperationalCapabilityPkg>, IXmiElementReader<Auriga.Oa.IOperationalCapabilityPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IOperationalCapabilityPkg"/></returns>
        public Auriga.Oa.IOperationalCapabilityPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.OperationalCapabilityPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityConfigurations":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityConfigurations.Add((Auriga.Oa.ICapabilityConfiguration)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedConceptCompliances":
                            {
                                ...
                                {
                                    poco.OwnedConceptCompliances.Add((Auriga.Oa.IConceptCompliance)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedOperationalCapabilities":
                            {
                                ...
                                {
                                    poco.OwnedOperationalCapabilities.Add((Auriga.Oa.IOperationalCapability)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedOperationalCapabilityPkgs":
                            {
                                ...
                                {
                                    poco.OwnedOperationalCapabilityPkgs.Add((Auriga.Oa.IOperationalCapabilityPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
