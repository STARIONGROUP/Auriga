                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCapabilityConfigurations":
                            {
                                ...
                                {
                                    poco.OwnedCapabilityConfigurations.Add((Auriga.Oa.ICapabilityConfiguration)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedConceptCompliances":
                            {
                                ...
                                {
                                    poco.OwnedConceptCompliances.Add((Auriga.Oa.IConceptCompliance)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedOperationalCapabilities":
                            {
                                ...
                                {
                                    poco.OwnedOperationalCapabilities.Add((Auriga.Oa.IOperationalCapability)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedOperationalCapabilityPkgs":
                            {
                                ...
                                {
                                    poco.OwnedOperationalCapabilityPkgs.Add((Auriga.Oa.IOperationalCapabilityPkg)this.Facade.QueryElement(xmlReader));
                                }
