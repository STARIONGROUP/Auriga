...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class RolePkgReader : XmiElementReader<Auriga.Oa.IRolePkg>, IXmiElementReader<Auriga.Oa.IRolePkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IRolePkg"/></returns>
        public Auriga.Oa.IRolePkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.RolePkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedRolePkgs":
                            {
                                ...
                                {
                                    poco.OwnedRolePkgs.Add((Auriga.Oa.IRolePkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedRoles":
                            {
                                ...
                                {
                                    poco.OwnedRoles.Add((Auriga.Oa.IRole)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
