                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConceptPkgs":
                            {
                                ...
                                {
                                    poco.OwnedConceptPkgs.Add((Auriga.Oa.IConceptPkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedConcepts":
                            {
                                ...
                                {
                                    poco.OwnedConcepts.Add((Auriga.Oa.IConcept)this.Facade.QueryElement(xmlReader));
                                }
