...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class ConceptPkgReader : XmiElementReader<Auriga.Oa.IConceptPkg>, IXmiElementReader<Auriga.Oa.IConceptPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IConceptPkg"/></returns>
        public Auriga.Oa.IConceptPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.ConceptPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConceptPkgs":
                            {
                                ...
                                {
                                    poco.OwnedConceptPkgs.Add((Auriga.Oa.IConceptPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedConcepts":
                            {
                                ...
                                {
                                    poco.OwnedConcepts.Add((Auriga.Oa.IConcept)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
