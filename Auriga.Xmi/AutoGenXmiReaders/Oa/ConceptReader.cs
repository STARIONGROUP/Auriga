...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class ConceptReader : XmiElementReader<Auriga.Oa.IConcept>, IXmiElementReader<Auriga.Oa.IConcept>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IConcept"/></returns>
        public Auriga.Oa.IConcept Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.Concept();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "compositeLinks":
                            {
                                ...
                                {
                                    poco.CompositeLinks.Add((Auriga.Oa.IItemInConcept)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
