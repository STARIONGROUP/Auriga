...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class OperationalActivityPkgReader : XmiElementReader<Auriga.Oa.IOperationalActivityPkg>, IXmiElementReader<Auriga.Oa.IOperationalActivityPkg>
    {
        ...
        public Auriga.Oa.IOperationalActivityPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedOperationalActivities":
                            {
                                ...
                                {
                                    poco.OwnedOperationalActivities.Add((Auriga.Oa.IOperationalActivity)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedOperationalActivityPkgs":
                            {
                                ...
                                {
                                    poco.OwnedOperationalActivityPkgs.Add((Auriga.Oa.IOperationalActivityPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
