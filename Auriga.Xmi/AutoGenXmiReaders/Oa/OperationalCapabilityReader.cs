...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class OperationalCapabilityReader : XmiElementReader<Auriga.Oa.IOperationalCapability>, IXmiElementReader<Auriga.Oa.IOperationalCapability>
    {
        ...
        public Auriga.Oa.IOperationalCapability Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "abstractCapabilityExtensionPoints":
                            {
                                ...
                                {
                                    poco.AbstractCapabilityExtensionPoints.Add((Auriga.Interaction.IAbstractCapabilityExtensionPoint)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "extends":
                            {
                                ...
                                {
                                    poco.Extends.Add((Auriga.Interaction.IAbstractCapabilityExtend)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "includes":
                            {
                                ...
                                {
                                    poco.Includes.Add((Auriga.Interaction.IAbstractCapabilityInclude)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedAbstractCapabilityRealizations":
                            {
                                ...
                                {
                                    poco.OwnedAbstractCapabilityRealizations.Add((Auriga.Interaction.IAbstractCapabilityRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedAbstractFunctionAbstractCapabilityInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedAbstractFunctionAbstractCapabilityInvolvements.Add((Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedEntityOperationalCapabilityInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedEntityOperationalCapabilityInvolvements.Add((Auriga.Oa.IEntityOperationalCapabilityInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedFunctionalChainAbstractCapabilityInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedFunctionalChainAbstractCapabilityInvolvements.Add((Auriga.Interaction.IFunctionalChainAbstractCapabilityInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedScenarios":
                            {
                                ...
                                {
                                    poco.OwnedScenarios.Add((Auriga.Interaction.IScenario)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "superGeneralizations":
                            {
                                ...
                                {
                                    poco.SuperGeneralizations.Add((Auriga.Interaction.IAbstractCapabilityGeneralization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
