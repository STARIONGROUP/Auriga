            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectSingleValueReference(poco, "OwnedConceptPkg", href); SkipElement(xmlReader); }
                            else { var contained = (Auriga.Oa.IConceptPkg)this.Facade.QueryElement(xmlReader); contained.Container = poco; poco.OwnedConceptPkg = contained; }
                            break;
                        }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectSingleValueReference(poco, "OwnedEntityPkg", href); SkipElement(xmlReader); }
                            else { var contained = (Auriga.Oa.IEntityPkg)this.Facade.QueryElement(xmlReader); contained.Container = poco; poco.OwnedEntityPkg = contained; }
                            break;
                        }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectSingleValueReference(poco, "OwnedRolePkg", href); SkipElement(xmlReader); }
                            else { var contained = (Auriga.Oa.IRolePkg)this.Facade.QueryElement(xmlReader); contained.Container = poco; poco.OwnedRolePkg = contained; }
                            break;
                        }
                            case "ownedTraces":
                        {
