...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class OperationalAnalysisReader : XmiElementReader<Auriga.Oa.IOperationalAnalysis>, IXmiElementReader<Auriga.Oa.IOperationalAnalysis>
    {
        ...
        public Auriga.Oa.IOperationalAnalysis Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConceptPkg":
                            {
                                ...
                                {
                                    poco.OwnedConceptPkg = (Auriga.Oa.IConceptPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedEntityPkg":
                            {
                                ...
                                {
                                    poco.OwnedEntityPkg = (Auriga.Oa.IEntityPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedRolePkg":
                            {
                                ...
                                {
                                    poco.OwnedRolePkg = (Auriga.Oa.IRolePkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
