                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedCommunicationMeans":
                            {
                                ...
                                {
                                    poco.OwnedCommunicationMeans.Add((Auriga.Oa.ICommunicationMean)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedEntities":
                            {
                                ...
                                {
                                    poco.OwnedEntities.Add((Auriga.Oa.IEntity)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedEntityPkgs":
                            {
                                ...
                                {
                                    poco.OwnedEntityPkgs.Add((Auriga.Oa.IEntityPkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedLocations":
                            {
                                ...
                                {
                                    poco.OwnedLocations.Add((Auriga.Oa.ILocation)this.Facade.QueryElement(xmlReader));
                                }
