...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class EntityPkgReader : XmiElementReader<Auriga.Oa.IEntityPkg>, IXmiElementReader<Auriga.Oa.IEntityPkg>
    {
        ...
        public Auriga.Oa.IEntityPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedEntityPkgs":
                            {
                                ...
                                {
                                    poco.OwnedEntityPkgs.Add((Auriga.Oa.IEntityPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedLocations":
                            {
                                ...
                                {
                                    poco.OwnedLocations.Add((Auriga.Oa.ILocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
