...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class ConceptComplianceReader : XmiElementReader<Auriga.Oa.IConceptCompliance>, IXmiElementReader<Auriga.Oa.IConceptCompliance>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IConceptCompliance"/></returns>
        public Auriga.Oa.IConceptCompliance Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.ConceptCompliance();
