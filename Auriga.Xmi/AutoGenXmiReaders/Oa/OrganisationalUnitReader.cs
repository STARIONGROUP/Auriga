...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class OrganisationalUnitReader : XmiElementReader<Auriga.Oa.IOrganisationalUnit>, IXmiElementReader<Auriga.Oa.IOrganisationalUnit>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IOrganisationalUnit"/></returns>
        public Auriga.Oa.IOrganisationalUnit Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.OrganisationalUnit();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "organisationalUnitCompositions":
                            {
                                ...
                                {
                                    poco.OrganisationalUnitCompositions.Add((Auriga.Oa.IOrganisationalUnitComposition)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
