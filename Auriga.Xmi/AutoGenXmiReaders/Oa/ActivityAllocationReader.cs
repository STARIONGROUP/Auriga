...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class ActivityAllocationReader : XmiElementReader<Auriga.Oa.IActivityAllocation>, IXmiElementReader<Auriga.Oa.IActivityAllocation>
    {
        ...
        public ActivityAllocationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Oa.IActivityAllocation Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of ActivityAllocation at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
