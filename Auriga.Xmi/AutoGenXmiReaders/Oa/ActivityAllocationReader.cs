...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class ActivityAllocationReader : XmiElementReader<Auriga.Oa.IActivityAllocation>, IXmiElementReader<Auriga.Oa.IActivityAllocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IActivityAllocation"/></returns>
        public Auriga.Oa.IActivityAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.ActivityAllocation();
