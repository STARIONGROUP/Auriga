...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class SwimlaneReader : XmiElementReader<Auriga.Oa.ISwimlane>, IXmiElementReader<Auriga.Oa.ISwimlane>
    {
        ...
        public Auriga.Oa.ISwimlane Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "subGroups":
                            {
                                ...
                                {
                                    poco.SubGroups.Add((Auriga.Activity.IActivityGroup)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
