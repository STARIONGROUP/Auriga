...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class CommunityOfInterestReader : XmiElementReader<Auriga.Oa.ICommunityOfInterest>, IXmiElementReader<Auriga.Oa.ICommunityOfInterest>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.ICommunityOfInterest"/></returns>
        public Auriga.Oa.ICommunityOfInterest Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.CommunityOfInterest();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "communityOfInterestCompositions":
                            {
                                ...
                                {
                                    poco.CommunityOfInterestCompositions.Add((Auriga.Oa.ICommunityOfInterestComposition)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
