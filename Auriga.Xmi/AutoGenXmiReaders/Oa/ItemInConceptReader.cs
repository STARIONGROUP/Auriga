...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class ItemInConceptReader : XmiElementReader<Auriga.Oa.IItemInConcept>, IXmiElementReader<Auriga.Oa.IItemInConcept>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IItemInConcept"/></returns>
        public Auriga.Oa.IItemInConcept Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.ItemInConcept();
