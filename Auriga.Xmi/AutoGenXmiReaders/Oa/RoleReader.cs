...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class RoleReader : XmiElementReader<Auriga.Oa.IRole>, IXmiElementReader<Auriga.Oa.IRole>
    {
        ...
        public Auriga.Oa.IRole Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedActivityAllocations":
                            {
                                ...
                                {
                                    poco.OwnedActivityAllocations.Add((Auriga.Oa.IActivityAllocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedRoleAssemblyUsages":
                            {
                                ...
                                {
                                    poco.OwnedRoleAssemblyUsages.Add((Auriga.Oa.IRoleAssemblyUsage)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
