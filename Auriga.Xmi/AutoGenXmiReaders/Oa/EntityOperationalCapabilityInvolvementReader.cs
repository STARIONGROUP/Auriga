...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class EntityOperationalCapabilityInvolvementReader : XmiElementReader<Auriga.Oa.IEntityOperationalCapabilityInvolvement>, IXmiElementReader<Auriga.Oa.IEntityOperationalCapabilityInvolvement>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IEntityOperationalCapabilityInvolvement"/></returns>
        public Auriga.Oa.IEntityOperationalCapabilityInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.EntityOperationalCapabilityInvolvement();
