...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class EntityOperationalCapabilityInvolvementReader : XmiElementReader<Auriga.Oa.IEntityOperationalCapabilityInvolvement>, IXmiElementReader<Auriga.Oa.IEntityOperationalCapabilityInvolvement>
    {
        ...
        public EntityOperationalCapabilityInvolvementReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Oa.IEntityOperationalCapabilityInvolvement Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of EntityOperationalCapabilityInvolvement at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
