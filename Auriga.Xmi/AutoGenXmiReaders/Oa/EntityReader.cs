...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class EntityReader : XmiElementReader<Auriga.Oa.IEntity>, IXmiElementReader<Auriga.Oa.IEntity>
    {
        ...
        public Auriga.Oa.IEntity Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "actualLocation":
                        {
                            ...
                            if (!string.IsNullOrEmpty(href)) { CollectSingleValueReference(poco, "ActualLocation", href); SkipElement(xmlReader); }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectMultiValueReferences(poco, "ComposingLinks", href); SkipElement(xmlReader); }
                            else { SkipElement(xmlReader); }
                            break;
                        }
                            case "features":
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectMultiValueReferences(poco, "OrganisationalUnitMemberships", href); SkipElement(xmlReader); }
                            else { SkipElement(xmlReader); }
                            break;
                        }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectMultiValueReferences(poco, "OwnedCommunicationMeans", href); SkipElement(xmlReader); }
                            else { poco.OwnedCommunicationMeans.Add((Auriga.Oa.ICommunicationMean)this.Facade.QueryElement(xmlReader)); }
                            break;
                        }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectMultiValueReferences(poco, "OwnedEntities", href); SkipElement(xmlReader); }
                            else { poco.OwnedEntities.Add((Auriga.Oa.IEntity)this.Facade.QueryElement(xmlReader)); }
                            break;
                        }
                        ...
                        {
                            var href = xmlReader.GetAttribute("href");
                            if (!string.IsNullOrEmpty(href)) { CollectMultiValueReferences(poco, "OwnedRoleAllocations", href); SkipElement(xmlReader); }
                            else { poco.OwnedRoleAllocations.Add((Auriga.Oa.IRoleAllocation)this.Facade.QueryElement(xmlReader)); }
                            break;
                        }
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of Entity at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
