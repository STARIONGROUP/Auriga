...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class OperationalProcessReader : XmiElementReader<Auriga.Oa.IOperationalProcess>, IXmiElementReader<Auriga.Oa.IOperationalProcess>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IOperationalProcess"/></returns>
        public Auriga.Oa.IOperationalProcess Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.OperationalProcess();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Fa.FunctionalChainKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedFunctionalChainInvolvements":
                            {
                                ...
                                {
                                    poco.OwnedFunctionalChainInvolvements.Add((Auriga.Fa.IFunctionalChainInvolvement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedFunctionalChainRealizations":
                            {
                                ...
                                {
                                    poco.OwnedFunctionalChainRealizations.Add((Auriga.Fa.IFunctionalChainRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSequenceLinks":
                            {
                                ...
                                {
                                    poco.OwnedSequenceLinks.Add((Auriga.Fa.ISequenceLink)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSequenceNodes":
                            {
                                ...
                                {
                                    poco.OwnedSequenceNodes.Add((Auriga.Fa.IControlNode)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
