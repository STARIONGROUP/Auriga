...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class RoleAllocationReader : XmiElementReader<Auriga.Oa.IRoleAllocation>, IXmiElementReader<Auriga.Oa.IRoleAllocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Oa.IRoleAllocation"/></returns>
        public Auriga.Oa.IRoleAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Oa.RoleAllocation();
