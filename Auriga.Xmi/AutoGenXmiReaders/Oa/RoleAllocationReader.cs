...
namespace Auriga.Xmi.AutoGenXmiReaders.Oa
{
    ...
    public class RoleAllocationReader : XmiElementReader<Auriga.Oa.IRoleAllocation>, IXmiElementReader<Auriga.Oa.IRoleAllocation>
    {
        ...
        public RoleAllocationReader(IXmiElementCache cache, IXmiReaderFacade facade, ILoggerFactory loggerFactory)
        ...
        public Auriga.Oa.IRoleAllocation Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "targetElement":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of RoleAllocation at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
