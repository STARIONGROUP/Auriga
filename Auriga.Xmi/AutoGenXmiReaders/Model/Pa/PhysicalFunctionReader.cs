...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Pa
{
    using System;
    using System.Xml;
    ...
    /// </summary>
    public class PhysicalFunctionReader : XmiElementReader<Auriga.Model.Pa.IPhysicalFunction>, IXmiElementReader<Auriga.Model.Pa.IPhysicalFunction>
    {
        /// <summary>
        ...
        public PhysicalFunctionReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
        ...
        /// <returns>the populated <see cref="Auriga.Model.Pa.IPhysicalFunction"/></returns>
        public Auriga.Model.Pa.IPhysicalFunction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Pa.PhysicalFunction();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading PhysicalFunction at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                ...
                }
                {
                    ...
                    if (!string.IsNullOrEmpty(raw))
                    {
                        if (Auriga.Extensions.FunctionKindProvider.TryParse(raw.AsSpan(), out var parsed))
                        {
                            poco.Kind = parsed;
                        }
                        else
                        {
                            this.HandleUnknownEnumLiteral("FunctionKind", "kind", raw, xmlLineInfo);
                        }
                    }
                }
                {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "arguments":
                            {
                                ...
                                {
                                    poco.Arguments.Add((Auriga.Model.Activity.IInputPin)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "inputs":
                            {
                                ...
                                {
                                    poco.Inputs.Add((Auriga.Model.Activity.IInputPin)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "localPostcondition":
                            {
                                ...
                                {
                                    poco.LocalPostcondition = (Auriga.Model.Modellingcore.IAbstractConstraint)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "localPrecondition":
                            {
                                ...
                                {
                                    poco.LocalPrecondition = (Auriga.Model.Modellingcore.IAbstractConstraint)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "outputs":
                            {
                                ...
                                {
                                    poco.Outputs.Add((Auriga.Model.Activity.IOutputPin)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedFunctionRealizations":
                            {
                                ...
                                {
                                    poco.OwnedFunctionRealizations.Add((Auriga.Model.Fa.IFunctionRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedFunctionalExchanges":
                            {
                                ...
                                {
                                    poco.OwnedFunctionalExchanges.Add((Auriga.Model.Fa.IFunctionalExchange)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedFunctions":
                            {
                                ...
                                {
                                    poco.OwnedFunctions.Add((Auriga.Model.Fa.IAbstractFunction)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedHandlers":
                            {
                                ...
                                {
                                    poco.OwnedHandlers.Add((Auriga.Model.Activity.IExceptionHandler)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalFunctionPkgs":
                            {
                                ...
                                if (!string.IsNullOrEmpty(href))
                                {
                                    CollectMultiValueReferences(poco, "OwnedPhysicalFunctionPkgs", href);
                                    SkipElement(xmlReader);
                                }
                                else
                                {
                                    poco.OwnedPhysicalFunctionPkgs.Add((Auriga.Model.Pa.IPhysicalFunctionPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "results":
                            {
                                ...
                                {
                                    poco.Results.Add((Auriga.Model.Activity.IOutputPin)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"PhysicalFunctionReader: {xmlReader.LocalName} at line:position {xmlLineInfo?.LineNumber}:{xmlLineInfo?.LinePosition}");
                                }

                                this.Logger.LogWarning("Not supported by PhysicalFunctionReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
