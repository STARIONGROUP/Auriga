...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Pa
{
    ...
    public class LogicalInterfaceRealizationReader : XmiElementReader<Auriga.Model.Pa.ILogicalInterfaceRealization>, IXmiElementReader<Auriga.Model.Pa.ILogicalInterfaceRealization>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Pa.ILogicalInterfaceRealization"/></returns>
        public Auriga.Model.Pa.ILogicalInterfaceRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Pa.LogicalInterfaceRealization();
