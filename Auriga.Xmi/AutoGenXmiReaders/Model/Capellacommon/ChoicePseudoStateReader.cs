...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class ChoicePseudoStateReader : XmiElementReader<Auriga.Model.Capellacommon.IChoicePseudoState>, IXmiElementReader<Auriga.Model.Capellacommon.IChoicePseudoState>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IChoicePseudoState"/></returns>
        public Auriga.Model.Capellacommon.IChoicePseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.ChoicePseudoState();
