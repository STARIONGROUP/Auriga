...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class ChangeEventReader : XmiElementReader<Auriga.Model.Capellacommon.IChangeEvent>, IXmiElementReader<Auriga.Model.Capellacommon.IChangeEvent>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IChangeEvent"/></returns>
        public Auriga.Model.Capellacommon.IChangeEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.ChangeEvent();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                CollectMultiValueReferences(poco, "Features", xmlReader.GetAttribute("features"));
                {
                    ...
                    {
                        if (Auriga.Extensions.ChangeEventKindProvider.TryParse(raw.AsSpan(), out var parsed))
                        {
                            poco.Kind = parsed;
                        }
                        else
                        {
                            this.HandleUnknownEnumLiteral("ChangeEventKind", "kind", raw, xmlLineInfo);
                        }
                    }
                }
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedStateEventRealizations":
                            {
                                ...
                                {
                                    poco.OwnedStateEventRealizations.Add((Auriga.Model.Capellacommon.IStateEventRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
