...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class RegionReader : XmiElementReader<Auriga.Model.Capellacommon.IRegion>, IXmiElementReader<Auriga.Model.Capellacommon.IRegion>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IRegion"/></returns>
        public Auriga.Model.Capellacommon.IRegion Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.Region();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedStates":
                            {
                                ...
                                {
                                    poco.OwnedStates.Add((Auriga.Model.Capellacommon.IAbstractState)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedTransitions":
                            {
                                ...
                                {
                                    poco.OwnedTransitions.Add((Auriga.Model.Capellacommon.IStateTransition)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
