...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class CapabilityRealizationInvolvementReader : XmiElementReader<Auriga.Model.Capellacommon.ICapabilityRealizationInvolvement>, IXmiElementReader<Auriga.Model.Capellacommon.ICapabilityRealizationInvolvement>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.ICapabilityRealizationInvolvement"/></returns>
        public Auriga.Model.Capellacommon.ICapabilityRealizationInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.CapabilityRealizationInvolvement();
