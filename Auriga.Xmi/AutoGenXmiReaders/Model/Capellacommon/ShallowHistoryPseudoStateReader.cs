...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class ShallowHistoryPseudoStateReader : XmiElementReader<Auriga.Model.Capellacommon.IShallowHistoryPseudoState>, IXmiElementReader<Auriga.Model.Capellacommon.IShallowHistoryPseudoState>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IShallowHistoryPseudoState"/></returns>
        public Auriga.Model.Capellacommon.IShallowHistoryPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.ShallowHistoryPseudoState();
