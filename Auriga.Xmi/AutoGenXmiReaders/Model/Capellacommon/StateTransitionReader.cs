...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class StateTransitionReader : XmiElementReader<Auriga.Model.Capellacommon.IStateTransition>, IXmiElementReader<Auriga.Model.Capellacommon.IStateTransition>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IStateTransition"/></returns>
        public Auriga.Model.Capellacommon.IStateTransition Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.StateTransition();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                CollectSingleValueReference(poco, "Guard", xmlReader.GetAttribute("guard"));
                {
                    ...
                    {
                        if (Auriga.Extensions.TransitionKindProvider.TryParse(raw.AsSpan(), out var parsed))
                        {
                            poco.Kind = parsed;
                        }
                        else
                        {
                            this.HandleUnknownEnumLiteral("TransitionKind", "kind", raw, xmlLineInfo);
                        }
                    }
                }
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedStateTransitionRealizations":
                            {
                                ...
                                {
                                    poco.OwnedStateTransitionRealizations.Add((Auriga.Model.Capellacommon.IStateTransitionRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
