...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class JoinPseudoStateReader : XmiElementReader<Auriga.Model.Capellacommon.IJoinPseudoState>, IXmiElementReader<Auriga.Model.Capellacommon.IJoinPseudoState>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IJoinPseudoState"/></returns>
        public Auriga.Model.Capellacommon.IJoinPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.JoinPseudoState();
