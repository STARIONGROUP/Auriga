...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class GenericTraceReader : XmiElementReader<Auriga.Model.Capellacommon.IGenericTrace>, IXmiElementReader<Auriga.Model.Capellacommon.IGenericTrace>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IGenericTrace"/></returns>
        public Auriga.Model.Capellacommon.IGenericTrace Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.GenericTrace();
