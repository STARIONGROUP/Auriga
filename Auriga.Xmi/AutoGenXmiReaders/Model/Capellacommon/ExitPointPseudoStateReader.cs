...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class ExitPointPseudoStateReader : XmiElementReader<Auriga.Model.Capellacommon.IExitPointPseudoState>, IXmiElementReader<Auriga.Model.Capellacommon.IExitPointPseudoState>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.IExitPointPseudoState"/></returns>
        public Auriga.Model.Capellacommon.IExitPointPseudoState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.ExitPointPseudoState();
