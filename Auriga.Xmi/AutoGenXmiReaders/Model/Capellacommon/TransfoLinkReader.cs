...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacommon
{
    ...
    public class TransfoLinkReader : XmiElementReader<Auriga.Model.Capellacommon.ITransfoLink>, IXmiElementReader<Auriga.Model.Capellacommon.ITransfoLink>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacommon.ITransfoLink"/></returns>
        public Auriga.Model.Capellacommon.ITransfoLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacommon.TransfoLink();
