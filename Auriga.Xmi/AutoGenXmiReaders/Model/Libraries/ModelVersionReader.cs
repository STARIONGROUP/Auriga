...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Libraries
{
    ...
    /// </summary>
    public class ModelVersionReader : XmiElementReader<Auriga.Model.Libraries.IModelVersion>, IXmiElementReader<Auriga.Model.Libraries.IModelVersion>
    {
        /// <summary>
        ...
        public ModelVersionReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
        ...
        /// <returns>the populated <see cref="Auriga.Model.Libraries.IModelVersion"/></returns>
        public Auriga.Model.Libraries.IModelVersion Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Libraries.ModelVersion();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading ModelVersion at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
