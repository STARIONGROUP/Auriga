...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Libraries
{
    ...
    /// </summary>
    public class LibraryReferenceReader : XmiElementReader<Auriga.Model.Libraries.ILibraryReference>, IXmiElementReader<Auriga.Model.Libraries.ILibraryReference>
    {
        /// <summary>
        ...
        public LibraryReferenceReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
        ...
        /// <returns>the populated <see cref="Auriga.Model.Libraries.ILibraryReference"/></returns>
        public Auriga.Model.Libraries.ILibraryReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Libraries.LibraryReference();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading LibraryReference at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "library":
                            {
                                ...
                                {
                                    CollectSingleValueReference(poco, "Library", href);
