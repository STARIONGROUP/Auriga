...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.La
{
    ...
    /// </summary>
    public class LogicalFunctionReader : XmiElementReader<Auriga.Model.La.ILogicalFunction>, IXmiElementReader<Auriga.Model.La.ILogicalFunction>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>LogicalFunction</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Model.La.ILogicalFunction"/></returns>
        public Auriga.Model.La.ILogicalFunction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.La.LogicalFunction();
