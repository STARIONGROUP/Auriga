...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.La
{
    ...
    public class LogicalComponentReader : XmiElementReader<Auriga.Model.La.ILogicalComponent>, IXmiElementReader<Auriga.Model.La.ILogicalComponent>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.La.ILogicalComponent"/></returns>
        public Auriga.Model.La.ILogicalComponent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.La.LogicalComponent();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedLogicalArchitectures":
                            {
                                ...
                                {
                                    poco.OwnedLogicalArchitectures.Add((Auriga.Model.La.ILogicalArchitecture)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
