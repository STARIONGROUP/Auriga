...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Pa.Deployment
{
    ...
    public class InstanceDeploymentLinkReader : XmiElementReader<Auriga.Model.Pa.Deployment.IInstanceDeploymentLink>, IXmiElementReader<Auriga.Model.Pa.Deployment.IInstanceDeploymentLink>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Pa.Deployment.IInstanceDeploymentLink"/></returns>
        public Auriga.Model.Pa.Deployment.IInstanceDeploymentLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Pa.Deployment.InstanceDeploymentLink();
