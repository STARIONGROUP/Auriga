...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Pa.Deployment
{
    ...
    public class PortInstanceReader : XmiElementReader<Auriga.Model.Pa.Deployment.IPortInstance>, IXmiElementReader<Auriga.Model.Pa.Deployment.IPortInstance>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Pa.Deployment.IPortInstance"/></returns>
        public Auriga.Model.Pa.Deployment.IPortInstance Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Pa.Deployment.PortInstance();
