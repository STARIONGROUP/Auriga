...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class CreationEventReader : XmiElementReader<Auriga.Model.Interaction.ICreationEvent>, IXmiElementReader<Auriga.Model.Interaction.ICreationEvent>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.ICreationEvent"/></returns>
        public Auriga.Model.Interaction.ICreationEvent Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.CreationEvent();
