...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    /// </summary>
    public class CombinedFragmentReader : XmiElementReader<Auriga.Model.Interaction.ICombinedFragment>, IXmiElementReader<Auriga.Model.Interaction.ICombinedFragment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.ICombinedFragment"/></returns>
        public Auriga.Model.Interaction.ICombinedFragment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.CombinedFragment();
