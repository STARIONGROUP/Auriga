...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class EventReceiptOperationReader : XmiElementReader<Auriga.Model.Interaction.IEventReceiptOperation>, IXmiElementReader<Auriga.Model.Interaction.IEventReceiptOperation>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.IEventReceiptOperation"/></returns>
        public Auriga.Model.Interaction.IEventReceiptOperation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.EventReceiptOperation();
