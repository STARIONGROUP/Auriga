...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class InteractionStateReader : XmiElementReader<Auriga.Model.Interaction.IInteractionState>, IXmiElementReader<Auriga.Model.Interaction.IInteractionState>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.IInteractionState"/></returns>
        public Auriga.Model.Interaction.IInteractionState Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.InteractionState();
