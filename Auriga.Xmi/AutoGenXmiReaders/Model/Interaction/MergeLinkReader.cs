...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class MergeLinkReader : XmiElementReader<Auriga.Model.Interaction.IMergeLink>, IXmiElementReader<Auriga.Model.Interaction.IMergeLink>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.IMergeLink"/></returns>
        public Auriga.Model.Interaction.IMergeLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.MergeLink();
