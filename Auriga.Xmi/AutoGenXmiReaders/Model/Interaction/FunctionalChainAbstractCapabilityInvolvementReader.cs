...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class FunctionalChainAbstractCapabilityInvolvementReader : XmiElementReader<Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement>, IXmiElementReader<Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement"/></returns>
        public Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.FunctionalChainAbstractCapabilityInvolvement();
