...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class ExecutionEndReader : XmiElementReader<Auriga.Model.Interaction.IExecutionEnd>, IXmiElementReader<Auriga.Model.Interaction.IExecutionEnd>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.IExecutionEnd"/></returns>
        public Auriga.Model.Interaction.IExecutionEnd Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.ExecutionEnd();
