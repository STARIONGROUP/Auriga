...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Interaction
{
    ...
    public class RefinementLinkReader : XmiElementReader<Auriga.Model.Interaction.IRefinementLink>, IXmiElementReader<Auriga.Model.Interaction.IRefinementLink>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Interaction.IRefinementLink"/></returns>
        public Auriga.Model.Interaction.IRefinementLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Interaction.RefinementLink();
