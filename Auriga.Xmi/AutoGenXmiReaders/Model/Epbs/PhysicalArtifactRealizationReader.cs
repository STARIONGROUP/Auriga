...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Epbs
{
    ...
    public class PhysicalArtifactRealizationReader : XmiElementReader<Auriga.Model.Epbs.IPhysicalArtifactRealization>, IXmiElementReader<Auriga.Model.Epbs.IPhysicalArtifactRealization>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Epbs.IPhysicalArtifactRealization"/></returns>
        public Auriga.Model.Epbs.IPhysicalArtifactRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Epbs.PhysicalArtifactRealization();
