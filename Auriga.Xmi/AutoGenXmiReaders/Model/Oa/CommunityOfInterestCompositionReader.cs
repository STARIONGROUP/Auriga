...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Oa
{
    ...
    public class CommunityOfInterestCompositionReader : XmiElementReader<Auriga.Model.Oa.ICommunityOfInterestComposition>, IXmiElementReader<Auriga.Model.Oa.ICommunityOfInterestComposition>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Oa.ICommunityOfInterestComposition"/></returns>
        public Auriga.Model.Oa.ICommunityOfInterestComposition Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Oa.CommunityOfInterestComposition();
