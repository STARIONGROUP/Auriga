...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Oa
{
    ...
    /// </summary>
    public class OperationalAnalysisReader : XmiElementReader<Auriga.Model.Oa.IOperationalAnalysis>, IXmiElementReader<Auriga.Model.Oa.IOperationalAnalysis>
    {
        /// <summary>
        ...
        public OperationalAnalysisReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
        ...
        /// <returns>the populated <see cref="Auriga.Model.Oa.IOperationalAnalysis"/></returns>
        public Auriga.Model.Oa.IOperationalAnalysis Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Oa.OperationalAnalysis();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading OperationalAnalysis at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConceptPkg":
                            {
                                ...
                                {
                                    poco.OwnedConceptPkg = (Auriga.Model.Oa.IConceptPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedEntityPkg":
                            {
                                ...
                                {
                                    poco.OwnedEntityPkg = (Auriga.Model.Oa.IEntityPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedRolePkg":
                            {
                                ...
                                {
                                    poco.OwnedRolePkg = (Auriga.Model.Oa.IRolePkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"OperationalAnalysisReader: {xmlReader.LocalName} at line:position {xmlLineInfo?.LineNumber}:{xmlLineInfo?.LinePosition}");
                                }

                                this.Logger.LogWarning("Not supported by OperationalAnalysisReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
