...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Oa
{
    ...
    public class CapabilityConfigurationReader : XmiElementReader<Auriga.Model.Oa.ICapabilityConfiguration>, IXmiElementReader<Auriga.Model.Oa.ICapabilityConfiguration>
    {
        ...
        /// <summary>
        /// The XML names of the attributes <c>CapabilityConfiguration</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Model.Oa.ICapabilityConfiguration"/></returns>
        public Auriga.Model.Oa.ICapabilityConfiguration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Oa.CapabilityConfiguration();
