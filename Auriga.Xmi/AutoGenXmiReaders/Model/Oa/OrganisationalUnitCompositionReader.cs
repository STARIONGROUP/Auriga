...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Oa
{
    ...
    public class OrganisationalUnitCompositionReader : XmiElementReader<Auriga.Model.Oa.IOrganisationalUnitComposition>, IXmiElementReader<Auriga.Model.Oa.IOrganisationalUnitComposition>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Oa.IOrganisationalUnitComposition"/></returns>
        public Auriga.Model.Oa.IOrganisationalUnitComposition Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Oa.OrganisationalUnitComposition();
