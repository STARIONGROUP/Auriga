...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Oa
{
    ...
    public class RoleAssemblyUsageReader : XmiElementReader<Auriga.Model.Oa.IRoleAssemblyUsage>, IXmiElementReader<Auriga.Model.Oa.IRoleAssemblyUsage>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Oa.IRoleAssemblyUsage"/></returns>
        public Auriga.Model.Oa.IRoleAssemblyUsage Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Oa.RoleAssemblyUsage();
