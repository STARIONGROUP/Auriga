...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Ctx
{
    ...
    public class CapabilityInvolvementReader : XmiElementReader<Auriga.Model.Ctx.ICapabilityInvolvement>, IXmiElementReader<Auriga.Model.Ctx.ICapabilityInvolvement>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Ctx.ICapabilityInvolvement"/></returns>
        public Auriga.Model.Ctx.ICapabilityInvolvement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Ctx.CapabilityInvolvement();
