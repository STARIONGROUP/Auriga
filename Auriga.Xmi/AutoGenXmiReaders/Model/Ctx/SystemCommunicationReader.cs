...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Ctx
{
    ...
    public class SystemCommunicationReader : XmiElementReader<Auriga.Model.Ctx.ISystemCommunication>, IXmiElementReader<Auriga.Model.Ctx.ISystemCommunication>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Ctx.ISystemCommunication"/></returns>
        public Auriga.Model.Ctx.ISystemCommunication Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Ctx.SystemCommunication();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ends":
                            {
                                ...
                                {
                                    poco.Ends.Add((Auriga.Model.Ctx.ISystemCommunicationHook)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
