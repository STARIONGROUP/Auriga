...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information
{
    ...
    public class PortAllocationReader : XmiElementReader<Auriga.Model.Information.IPortAllocation>, IXmiElementReader<Auriga.Model.Information.IPortAllocation>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.IPortAllocation"/></returns>
        public Auriga.Model.Information.IPortAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.PortAllocation();
