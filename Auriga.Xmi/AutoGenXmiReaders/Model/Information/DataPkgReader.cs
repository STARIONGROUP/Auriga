...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information
{
    using System;
    using System.Xml;
    ...
    /// </summary>
    public class DataPkgReader : XmiElementReader<Auriga.Model.Information.IDataPkg>, IXmiElementReader<Auriga.Model.Information.IDataPkg>
    {
        /// <summary>
        ...
        public DataPkgReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.IDataPkg"/></returns>
        public Auriga.Model.Information.IDataPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.DataPkg();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading DataPkg at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedAssociations":
                            {
                                ...
                                {
                                    poco.OwnedAssociations.Add((Auriga.Model.Information.IAssociation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedClasses":
                            {
                                ...
                                {
                                    poco.OwnedClasses.Add((Auriga.Model.Information.IClass)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedCollections":
                            {
                                ...
                                {
                                    poco.OwnedCollections.Add((Auriga.Model.Information.ICollection)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedDataPkgs":
                            {
                                ...
                                {
                                    poco.OwnedDataPkgs.Add((Auriga.Model.Information.IDataPkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedDataTypes":
                            {
                                ...
                                {
                                    poco.OwnedDataTypes.Add((Auriga.Model.Information.Datatype.IDataType)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedDataValues":
                            {
                                ...
                                {
                                    poco.OwnedDataValues.Add((Auriga.Model.Information.Datavalue.IDataValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExceptions":
                            {
                                ...
                                {
                                    poco.OwnedExceptions.Add((Auriga.Model.Information.Communication.IException)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedExchangeItems":
                            {
                                ...
                                {
                                    poco.OwnedExchangeItems.Add((Auriga.Model.Information.IExchangeItem)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedKeyParts":
                            {
                                ...
                                {
                                    poco.OwnedKeyParts.Add((Auriga.Model.Information.IKeyPart)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMessageReferences":
                            {
                                ...
                                {
                                    poco.OwnedMessageReferences.Add((Auriga.Model.Information.Communication.IMessageReference)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMessages":
                            {
                                ...
                                {
                                    poco.OwnedMessages.Add((Auriga.Model.Information.Communication.IMessage)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedSignals":
                            {
                                ...
                                {
                                    poco.OwnedSignals.Add((Auriga.Model.Information.Communication.ISignal)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedStateEvents":
                            {
                                ...
                                {
                                    poco.OwnedStateEvents.Add((Auriga.Model.Capellacommon.IStateEvent)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedUnits":
                            {
                                ...
                                {
                                    poco.OwnedUnits.Add((Auriga.Model.Information.IUnit)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"DataPkgReader: {xmlReader.LocalName} at line:position {xmlLineInfo?.LineNumber}:{xmlLineInfo?.LinePosition}");
                                }

                                this.Logger.LogWarning("Not supported by DataPkgReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
