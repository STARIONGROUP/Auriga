// ------------------------------------------------------------------------------------------------
// <copyright file="LibraryReader.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellamodeller
{
    ...
    /// <summary>
    /// The generated XMI reader that instantiates and populates an <c>Library</c> from its
    /// XMI representation. Contained elements are read recursively; cross-references are collected for the
    /// reference-resolution pass.
    /// </summary>
    public class LibraryReader : XmiElementReader<Auriga.Model.Capellamodeller.ILibrary>, IXmiElementReader<Auriga.Model.Capellamodeller.ILibrary>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>Library</c> declares. An attribute outside this
        ...
        /// <summary>
        /// Reads an <c>Library</c> from the element at the cursor of the supplied reader.
        /// </summary>
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellamodeller.ILibrary"/></returns>
        public Auriga.Model.Capellamodeller.ILibrary Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellamodeller.Library();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading Library at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
            ...
            {
                this.Logger.LogWarning("Expected an element to read Library but found {NodeType} at line {Line}:{Position}", xmlReader.NodeType, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
            }
