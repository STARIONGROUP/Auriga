...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information.Datatype
{
    using System;
    using System.Xml;
    ...
    public class PhysicalQuantityReader : XmiElementReader<Auriga.Model.Information.Datatype.IPhysicalQuantity>, IXmiElementReader<Auriga.Model.Information.Datatype.IPhysicalQuantity>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.Datatype.IPhysicalQuantity"/></returns>
        public Auriga.Model.Information.Datatype.IPhysicalQuantity Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.Datatype.PhysicalQuantity();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedDefaultValue":
                            {
                                ...
                                {
                                    poco.OwnedDefaultValue = (Auriga.Model.Information.Datavalue.INumericValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedInformationRealizations":
                            {
                                ...
                                {
                                    poco.OwnedInformationRealizations.Add((Auriga.Model.Information.IInformationRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMaxValue":
                            {
                                ...
                                {
                                    poco.OwnedMaxValue = (Auriga.Model.Information.Datavalue.INumericValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedMinValue":
                            {
                                ...
                                {
                                    poco.OwnedMinValue = (Auriga.Model.Information.Datavalue.INumericValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedNullValue":
                            {
                                ...
                                {
                                    poco.OwnedNullValue = (Auriga.Model.Information.Datavalue.INumericValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
