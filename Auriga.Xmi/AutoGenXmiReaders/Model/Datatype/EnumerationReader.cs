...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information.Datatype
{
    ...
    /// </summary>
    public class EnumerationReader : XmiElementReader<Auriga.Model.Information.Datatype.IEnumeration>, IXmiElementReader<Auriga.Model.Information.Datatype.IEnumeration>
    {
        /// <summary>
        ...
        public EnumerationReader(IXmiElementCache cache, IXmiReaderFacade facade, IXmiReaderSettings settings, ILoggerFactory loggerFactory)
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.Datatype.IEnumeration"/></returns>
        public Auriga.Model.Information.Datatype.IEnumeration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.Datatype.Enumeration();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading Enumeration at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "domainType":
                            {
                                ...
                                if (!string.IsNullOrEmpty(href))
                                {
                                    CollectSingleValueReference(poco, "DomainType", href);
                                    SkipElement(xmlReader);
                                }
                                else
                                {
                            ...
                            case "ownedDefaultValue":
                            {
                                ...
                                {
                                    poco.OwnedDefaultValue = (Auriga.Model.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedLiterals":
                            {
                                ...
                                if (!string.IsNullOrEmpty(href))
                                {
                                    CollectMultiValueReferences(poco, "OwnedLiterals", href);
                                    SkipElement(xmlReader);
                                }
                                else
                                {
                                    poco.OwnedLiterals.Add((Auriga.Model.Information.Datavalue.IEnumerationLiteral)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedMaxValue":
                            {
                                ...
                                {
                                    poco.OwnedMaxValue = (Auriga.Model.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedMinValue":
                            {
                                ...
                                {
                                    poco.OwnedMinValue = (Auriga.Model.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedNullValue":
                            {
                                ...
                                {
                                    poco.OwnedNullValue = (Auriga.Model.Information.Datavalue.IAbstractEnumerationValue)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"EnumerationReader: {xmlReader.LocalName} at line:position {xmlLineInfo?.LineNumber}:{xmlLineInfo?.LinePosition}");
                                }

                                this.Logger.LogWarning("Not supported by EnumerationReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
