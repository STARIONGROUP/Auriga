...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Fa
{
    ...
    public class ComponentExchangeEndReader : XmiElementReader<Auriga.Model.Fa.IComponentExchangeEnd>, IXmiElementReader<Auriga.Model.Fa.IComponentExchangeEnd>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Fa.IComponentExchangeEnd"/></returns>
        public Auriga.Model.Fa.IComponentExchangeEnd Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Fa.ComponentExchangeEnd();
