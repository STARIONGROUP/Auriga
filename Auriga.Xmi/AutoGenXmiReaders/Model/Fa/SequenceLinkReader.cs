...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Fa
{
    ...
    public class SequenceLinkReader : XmiElementReader<Auriga.Model.Fa.ISequenceLink>, IXmiElementReader<Auriga.Model.Fa.ISequenceLink>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Fa.ISequenceLink"/></returns>
        public Auriga.Model.Fa.ISequenceLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Fa.SequenceLink();
