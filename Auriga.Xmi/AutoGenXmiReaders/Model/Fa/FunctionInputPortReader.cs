...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Fa
{
    ...
    public class FunctionInputPortReader : XmiElementReader<Auriga.Model.Fa.IFunctionInputPort>, IXmiElementReader<Auriga.Model.Fa.IFunctionInputPort>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Fa.IFunctionInputPort"/></returns>
        public Auriga.Model.Fa.IFunctionInputPort Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Fa.FunctionInputPort();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedPortAllocations":
                            {
                                ...
                                {
                                    poco.OwnedPortAllocations.Add((Auriga.Model.Information.IPortAllocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPortRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPortRealizations.Add((Auriga.Model.Information.IPortRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedProtocols":
                            {
                                ...
                                {
                                    poco.OwnedProtocols.Add((Auriga.Model.Capellacommon.IStateMachine)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "upperBound":
                            {
                                ...
                                {
                                    poco.UpperBound = (Auriga.Model.Modellingcore.IValueSpecification)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
