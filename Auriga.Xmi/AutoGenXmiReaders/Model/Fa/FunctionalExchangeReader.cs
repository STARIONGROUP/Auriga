...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Fa
{
    ...
    /// </summary>
    public class FunctionalExchangeReader : XmiElementReader<Auriga.Model.Fa.IFunctionalExchange>, IXmiElementReader<Auriga.Model.Fa.IFunctionalExchange>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>FunctionalExchange</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Model.Fa.IFunctionalExchange"/></returns>
        public Auriga.Model.Fa.IFunctionalExchange Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Fa.FunctionalExchange();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "guard":
                            {
                                ...
                                {
                                    poco.Guard = (Auriga.Model.Modellingcore.IValueSpecification)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedFunctionalExchangeRealizations":
                            {
                                ...
                                {
                                    poco.OwnedFunctionalExchangeRealizations.Add((Auriga.Model.Fa.IFunctionalExchangeRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "weight":
                            {
                                ...
                                {
                                    poco.Weight = (Auriga.Model.Modellingcore.IValueSpecification)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
