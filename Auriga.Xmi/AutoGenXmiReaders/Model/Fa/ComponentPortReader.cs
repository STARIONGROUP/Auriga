    ...
    public class ComponentPortReader : XmiElementReader<Auriga.Model.Fa.IComponentPort>, IXmiElementReader<Auriga.Model.Fa.IComponentPort>
    {
        ...
        public Auriga.Model.Fa.IComponentPort Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Model.Fa.ComponentPortKind>(xmlReader.GetAttribute("kind"), out var parsed))
                    {
                        poco.Kind = parsed;
                    }
                }
                ...
                {
                    if (TryParseEnum<Auriga.Model.Fa.OrientationPortKind>(xmlReader.GetAttribute("orientation"), out var parsed))
                    {
