...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information.Datavalue
{
    ...
    public class BooleanReferenceReader : XmiElementReader<Auriga.Model.Information.Datavalue.IBooleanReference>, IXmiElementReader<Auriga.Model.Information.Datavalue.IBooleanReference>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.Datavalue.IBooleanReference"/></returns>
        public Auriga.Model.Information.Datavalue.IBooleanReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.Datavalue.BooleanReference();
