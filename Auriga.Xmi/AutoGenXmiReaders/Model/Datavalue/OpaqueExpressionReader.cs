...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information.Datavalue
{
    ...
    public class OpaqueExpressionReader : XmiElementReader<Auriga.Model.Information.Datavalue.IOpaqueExpression>, IXmiElementReader<Auriga.Model.Information.Datavalue.IOpaqueExpression>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.Datavalue.IOpaqueExpression"/></returns>
        public Auriga.Model.Information.Datavalue.IOpaqueExpression Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.Datavalue.OpaqueExpression();
