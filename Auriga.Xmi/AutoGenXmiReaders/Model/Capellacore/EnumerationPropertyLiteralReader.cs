...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacore
{
    ...
    public class EnumerationPropertyLiteralReader : XmiElementReader<Auriga.Model.Capellacore.IEnumerationPropertyLiteral>, IXmiElementReader<Auriga.Model.Capellacore.IEnumerationPropertyLiteral>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacore.IEnumerationPropertyLiteral"/></returns>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacore.EnumerationPropertyLiteral();
