...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacore
{
    ...
    public class ReuseLinkReader : XmiElementReader<Auriga.Model.Capellacore.IReuseLink>, IXmiElementReader<Auriga.Model.Capellacore.IReuseLink>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacore.IReuseLink"/></returns>
        public Auriga.Model.Capellacore.IReuseLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacore.ReuseLink();
