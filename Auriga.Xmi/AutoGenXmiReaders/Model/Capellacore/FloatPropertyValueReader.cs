...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacore
{
    ...
    public class FloatPropertyValueReader : XmiElementReader<Auriga.Model.Capellacore.IFloatPropertyValue>, IXmiElementReader<Auriga.Model.Capellacore.IFloatPropertyValue>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacore.IFloatPropertyValue"/></returns>
        public Auriga.Model.Capellacore.IFloatPropertyValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacore.FloatPropertyValue();
