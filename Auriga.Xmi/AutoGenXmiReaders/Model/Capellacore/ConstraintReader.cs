...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacore
{
    ...
    public class ConstraintReader : XmiElementReader<Auriga.Model.Capellacore.IConstraint>, IXmiElementReader<Auriga.Model.Capellacore.IConstraint>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacore.IConstraint"/></returns>
        public Auriga.Model.Capellacore.IConstraint Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacore.Constraint();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedSpecification":
                            {
                                ...
                                {
                                    poco.OwnedSpecification = (Auriga.Model.Modellingcore.IValueSpecification)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
