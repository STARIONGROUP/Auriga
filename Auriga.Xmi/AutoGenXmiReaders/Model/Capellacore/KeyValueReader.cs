...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacore
{
    ...
    public class KeyValueReader : XmiElementReader<Auriga.Model.Capellacore.IKeyValue>, IXmiElementReader<Auriga.Model.Capellacore.IKeyValue>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacore.IKeyValue"/></returns>
        public Auriga.Model.Capellacore.IKeyValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacore.KeyValue();
