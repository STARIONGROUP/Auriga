...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Capellacore
{
    ...
    public class NamingRuleReader : XmiElementReader<Auriga.Model.Capellacore.INamingRule>, IXmiElementReader<Auriga.Model.Capellacore.INamingRule>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Capellacore.INamingRule"/></returns>
        public Auriga.Model.Capellacore.INamingRule Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Capellacore.NamingRule();
