...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Cs
{
    ...
    public class ExchangeItemAllocationReader : XmiElementReader<Auriga.Model.Cs.IExchangeItemAllocation>, IXmiElementReader<Auriga.Model.Cs.IExchangeItemAllocation>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Cs.IExchangeItemAllocation"/></returns>
        public Auriga.Model.Cs.IExchangeItemAllocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Cs.ExchangeItemAllocation();
