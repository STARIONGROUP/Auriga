...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkRealizationReader : XmiElementReader<Auriga.Model.Cs.IPhysicalLinkRealization>, IXmiElementReader<Auriga.Model.Cs.IPhysicalLinkRealization>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>PhysicalLinkRealization</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Model.Cs.IPhysicalLinkRealization"/></returns>
        public Auriga.Model.Cs.IPhysicalLinkRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Cs.PhysicalLinkRealization();

            var xmlLineInfo = xmlReader as IXmlLineInfo;

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.Logger.LogTrace("reading PhysicalLinkRealization at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
