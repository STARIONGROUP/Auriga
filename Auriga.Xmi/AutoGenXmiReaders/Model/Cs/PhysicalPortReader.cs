...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Cs
{
    ...
    public class PhysicalPortReader : XmiElementReader<Auriga.Model.Cs.IPhysicalPort>, IXmiElementReader<Auriga.Model.Cs.IPhysicalPort>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Cs.IPhysicalPort"/></returns>
        public Auriga.Model.Cs.IPhysicalPort Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Cs.PhysicalPort();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComponentPortAllocations":
                            {
                                ...
                                {
                                    poco.OwnedComponentPortAllocations.Add((Auriga.Model.Fa.IComponentPortAllocation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedPhysicalPortRealizations":
                            {
                                ...
                                {
                                    poco.OwnedPhysicalPortRealizations.Add((Auriga.Model.Cs.IPhysicalPortRealization)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
