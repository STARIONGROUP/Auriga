...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Cs
{
    ...
    public class PhysicalPathReferenceReader : XmiElementReader<Auriga.Model.Cs.IPhysicalPathReference>, IXmiElementReader<Auriga.Model.Cs.IPhysicalPathReference>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Cs.IPhysicalPathReference"/></returns>
        public Auriga.Model.Cs.IPhysicalPathReference Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Cs.PhysicalPathReference();
