...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Information.Communication
{
    ...
    /// </summary>
    public class CommunicationLinkReader : XmiElementReader<Auriga.Model.Information.Communication.ICommunicationLink>, IXmiElementReader<Auriga.Model.Information.Communication.ICommunicationLink>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Model.Information.Communication.ICommunicationLink"/></returns>
        public Auriga.Model.Information.Communication.ICommunicationLink Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Information.Communication.CommunicationLink();
