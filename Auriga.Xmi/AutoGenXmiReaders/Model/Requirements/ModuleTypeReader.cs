...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Requirements
{
    ...
    public class ModuleTypeReader : XmiElementReader<Auriga.Model.Requirements.IModuleType>, IXmiElementReader<Auriga.Model.Requirements.IModuleType>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Requirements.IModuleType"/></returns>
        public Auriga.Model.Requirements.IModuleType Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Requirements.ModuleType();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "ownedAttributes":
                            {
                                ...
                                {
                                    poco.OwnedAttributes.Add((Auriga.Model.Requirements.IAttributeDefinition)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
