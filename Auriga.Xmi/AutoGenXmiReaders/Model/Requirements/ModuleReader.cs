...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Requirements
{
    ...
    /// </summary>
    public class ModuleReader : XmiElementReader<Auriga.Model.Requirements.IModule>, IXmiElementReader<Auriga.Model.Requirements.IModule>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>Module</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Model.Requirements.IModule"/></returns>
        public Auriga.Model.Requirements.IModule Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Requirements.Module();
