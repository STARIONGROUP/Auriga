...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Requirements
{
    ...
    public class FolderReader : XmiElementReader<Auriga.Model.Requirements.IFolder>, IXmiElementReader<Auriga.Model.Requirements.IFolder>
    {
        ...
        /// <returns>the populated <see cref="Auriga.Model.Requirements.IFolder"/></returns>
        public Auriga.Model.Requirements.IFolder Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Requirements.Folder();
