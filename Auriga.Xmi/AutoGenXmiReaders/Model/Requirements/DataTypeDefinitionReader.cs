...
namespace Auriga.Xmi.Model.AutoGenXmiReaders.Requirements
{
    ...
    /// </summary>
    public class DataTypeDefinitionReader : XmiElementReader<Auriga.Model.Requirements.IDataTypeDefinition>, IXmiElementReader<Auriga.Model.Requirements.IDataTypeDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// The XML names of the attributes <c>DataTypeDefinition</c> declares. An attribute outside this
        ...
        /// <returns>the populated <see cref="Auriga.Model.Requirements.IDataTypeDefinition"/></returns>
        public Auriga.Model.Requirements.IDataTypeDefinition Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Model.Requirements.DataTypeDefinition();
