...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellamodeller
{
    ...
    /// </summary>
    public class SystemEngineeringPkgReader : XmiElementReader<Auriga.Capellamodeller.ISystemEngineeringPkg>, IXmiElementReader<Auriga.Capellamodeller.ISystemEngineeringPkg>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellamodeller.ISystemEngineeringPkg"/></returns>
        public Auriga.Capellamodeller.ISystemEngineeringPkg Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellamodeller.SystemEngineeringPkg();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedSystemEngineerings":
                            {
                                ...
                                {
                                    poco.OwnedSystemEngineerings.Add((Auriga.Capellamodeller.ISystemEngineering)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
