...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellamodeller
{
    ...
    /// </summary>
    public class LibraryReader : XmiElementReader<Auriga.Capellamodeller.ILibrary>, IXmiElementReader<Auriga.Capellamodeller.ILibrary>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Capellamodeller.ILibrary"/></returns>
        public Auriga.Capellamodeller.ILibrary Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Capellamodeller.Library();
                ...
                if (!xmlReader.IsEmptyElement)
                {
                    while (xmlReader.Read())
                    {
                            ...
                            case "status":
                        {
                            ...
                            default:
                                this.Logger.LogTrace("Skipping unmapped element '{Element}' of Library at line {Line}:{Position}", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
