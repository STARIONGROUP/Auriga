                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedArchitecturePkgs":
                            {
                                ...
                                {
                                    poco.OwnedArchitecturePkgs.Add((Auriga.Capellacore.IModellingArchitecturePkg)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedArchitectures":
                            {
                                ...
                                {
                                    poco.OwnedArchitectures.Add((Auriga.Capellacore.IModellingArchitecture)this.Facade.QueryElement(xmlReader));
                                }
                            ...
                            case "ownedReuseLinks":
                            {
                                ...
                                {
                                    poco.OwnedReuseLinks.Add((Auriga.Capellacore.IReuseLink)this.Facade.QueryElement(xmlReader));
                                }
