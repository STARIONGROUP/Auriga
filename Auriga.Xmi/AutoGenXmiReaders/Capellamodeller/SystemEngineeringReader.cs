...
namespace Auriga.Xmi.AutoGenXmiReaders.Capellamodeller
{
    ...
    public class SystemEngineeringReader : XmiElementReader<Auriga.Capellamodeller.ISystemEngineering>, IXmiElementReader<Auriga.Capellamodeller.ISystemEngineering>
    {
        ...
        public Auriga.Capellamodeller.ISystemEngineering Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedArchitecturePkgs":
                            {
                                ...
                                {
                                    poco.OwnedArchitecturePkgs.Add((Auriga.Capellacore.IModellingArchitecturePkg)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedArchitectures":
                            {
                                ...
                                {
                                    poco.OwnedArchitectures.Add((Auriga.Capellacore.IModellingArchitecture)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "ownedReuseLinks":
                            {
                                ...
                                {
                                    poco.OwnedReuseLinks.Add((Auriga.Capellacore.IReuseLink)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            default:
                                ...
                                this.Logger.LogWarning("Not supported by SystemEngineeringReader: the '{LocalName}' element at line:position {LineNumber}:{LinePosition} is not part of the metamodel and was skipped", xmlReader.LocalName, xmlLineInfo?.LineNumber ?? -1, xmlLineInfo?.LinePosition ?? -1);
                                SkipElement(xmlReader);
                                break;
                        }
                    }
