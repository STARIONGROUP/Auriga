...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class CapabilityWriter : XmiElementWriter<Auriga.Ctx.ICapability>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ICapability poco, IXmiWriteContext context)
        {
