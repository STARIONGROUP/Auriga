...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class MissionInvolvementWriter : XmiElementWriter<Auriga.Ctx.IMissionInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.IMissionInvolvement poco, IXmiWriteContext context)
        {
