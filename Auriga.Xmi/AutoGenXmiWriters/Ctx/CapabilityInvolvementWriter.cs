...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class CapabilityInvolvementWriter : XmiElementWriter<Auriga.Ctx.ICapabilityInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ICapabilityInvolvement poco, IXmiWriteContext context)
        {
