...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemFunctionWriter : XmiElementWriter<Auriga.Ctx.ISystemFunction>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ISystemFunction poco, IXmiWriteContext context)
        {
