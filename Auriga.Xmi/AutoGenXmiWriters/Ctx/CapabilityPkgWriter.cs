...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class CapabilityPkgWriter : XmiElementWriter<Auriga.Ctx.ICapabilityPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ICapabilityPkg poco, IXmiWriteContext context)
        {
