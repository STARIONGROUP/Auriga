...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemFunctionPkgWriter : XmiElementWriter<Auriga.Ctx.ISystemFunctionPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ISystemFunctionPkg poco, IXmiWriteContext context)
        {
