...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemCommunicationWriter : XmiElementWriter<Auriga.Ctx.ISystemCommunication>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ISystemCommunication poco, IXmiWriteContext context)
        {
