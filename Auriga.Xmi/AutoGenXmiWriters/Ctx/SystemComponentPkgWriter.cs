...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemComponentPkgWriter : XmiElementWriter<Auriga.Ctx.ISystemComponentPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ISystemComponentPkg poco, IXmiWriteContext context)
        {
