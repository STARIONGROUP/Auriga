...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class MissionPkgWriter : XmiElementWriter<Auriga.Ctx.IMissionPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.IMissionPkg poco, IXmiWriteContext context)
        {
