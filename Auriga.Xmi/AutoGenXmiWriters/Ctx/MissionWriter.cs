...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class MissionWriter : XmiElementWriter<Auriga.Ctx.IMission>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.IMission poco, IXmiWriteContext context)
        {
