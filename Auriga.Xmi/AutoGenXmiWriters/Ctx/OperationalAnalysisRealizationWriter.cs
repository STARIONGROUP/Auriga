...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class OperationalAnalysisRealizationWriter : XmiElementWriter<Auriga.Ctx.IOperationalAnalysisRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.IOperationalAnalysisRealization poco, IXmiWriteContext context)
        {
