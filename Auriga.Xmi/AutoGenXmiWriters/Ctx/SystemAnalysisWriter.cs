...
namespace Auriga.Xmi.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemAnalysisWriter : XmiElementWriter<Auriga.Ctx.ISystemAnalysis>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Ctx.ISystemAnalysis poco, IXmiWriteContext context)
        {
