...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Communication
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Signal</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class SignalWriter : XmiElementWriter<Auriga.Information.Communication.ISignal>
    {
        /// <summary>
        ...
        public SignalWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>Signal</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Signal</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Communication.ISignal poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElements(xmlWriter, "signalInstances", poco.SignalInstances, poco, "SignalInstances", context);
        }
    }
}
