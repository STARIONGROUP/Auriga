...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Communication
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Message</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class MessageWriter : XmiElementWriter<Auriga.Information.Communication.IMessage>
    {
        /// <summary>
        ...
        public MessageWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Message</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Communication.IMessage poco, IXmiWriteContext context)
        {
