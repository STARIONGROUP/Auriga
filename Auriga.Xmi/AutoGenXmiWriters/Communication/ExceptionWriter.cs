// ------------------------------------------------------------------------------------------------
// <copyright file="ExceptionWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Communication
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Exception</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ExceptionWriter : XmiElementWriter<Auriga.Information.Communication.IException>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExceptionWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ExceptionWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>Exception</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information.communication";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Exception</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Exception";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Exception</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Communication.IException poco, IXmiWriteContext context)
        {
