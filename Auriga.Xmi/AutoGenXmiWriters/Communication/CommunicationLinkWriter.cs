...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Communication
{
    using System.Xml;
    ...
    /// </summary>
    public class CommunicationLinkWriter : XmiElementWriter<Auriga.Information.Communication.ICommunicationLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Communication.ICommunicationLink poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Information.Communication.CommunicationLinkKind>(xmlWriter, "kind", poco.Kind);
            WriteEnumAttribute<Auriga.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "protocol", poco.Protocol);
