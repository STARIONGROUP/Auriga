...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Communication
{
    ...
    /// </summary>
    public class SignalInstanceWriter : XmiElementWriter<Auriga.Information.Communication.ISignalInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Communication.ISignalInstance poco, IXmiWriteContext context)
        {
