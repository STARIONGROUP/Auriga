...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class ComponentInstanceWriter : XmiElementWriter<Auriga.Pa.Deployment.IComponentInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.Deployment.IComponentInstance poco, IXmiWriteContext context)
        {
