...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class ConnectionInstanceWriter : XmiElementWriter<Auriga.Pa.Deployment.IConnectionInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.Deployment.IConnectionInstance poco, IXmiWriteContext context)
        {
