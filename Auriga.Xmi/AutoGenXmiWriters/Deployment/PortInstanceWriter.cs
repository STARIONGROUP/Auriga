...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class PortInstanceWriter : XmiElementWriter<Auriga.Pa.Deployment.IPortInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.Deployment.IPortInstance poco, IXmiWriteContext context)
        {
