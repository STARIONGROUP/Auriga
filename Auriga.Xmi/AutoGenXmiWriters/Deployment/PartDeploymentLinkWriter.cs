...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class PartDeploymentLinkWriter : XmiElementWriter<Auriga.Pa.Deployment.IPartDeploymentLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.Deployment.IPartDeploymentLink poco, IXmiWriteContext context)
        {
