...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class InstanceDeploymentLinkWriter : XmiElementWriter<Auriga.Pa.Deployment.IInstanceDeploymentLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.Deployment.IInstanceDeploymentLink poco, IXmiWriteContext context)
        {
