...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ExchangeCategoryWriter : XmiElementWriter<Auriga.Fa.IExchangeCategory>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IExchangeCategory poco, IXmiWriteContext context)
        {
