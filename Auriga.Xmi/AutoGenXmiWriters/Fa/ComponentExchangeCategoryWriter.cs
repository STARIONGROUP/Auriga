...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeCategoryWriter : XmiElementWriter<Auriga.Fa.IComponentExchangeCategory>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentExchangeCategory poco, IXmiWriteContext context)
        {
