...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentFunctionalAllocationWriter : XmiElementWriter<Auriga.Fa.IComponentFunctionalAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentFunctionalAllocation poco, IXmiWriteContext context)
        {
