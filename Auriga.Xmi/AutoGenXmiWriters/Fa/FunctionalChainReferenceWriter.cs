...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionalChainReferenceWriter : XmiElementWriter<Auriga.Fa.IFunctionalChainReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionalChainReference poco, IXmiWriteContext context)
        {
