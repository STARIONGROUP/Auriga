...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionalChainInvolvementFunctionWriter : XmiElementWriter<Auriga.Fa.IFunctionalChainInvolvementFunction>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionalChainInvolvementFunction poco, IXmiWriteContext context)
        {
