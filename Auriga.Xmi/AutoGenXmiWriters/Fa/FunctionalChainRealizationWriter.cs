...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionalChainRealizationWriter : XmiElementWriter<Auriga.Fa.IFunctionalChainRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionalChainRealization poco, IXmiWriteContext context)
        {
