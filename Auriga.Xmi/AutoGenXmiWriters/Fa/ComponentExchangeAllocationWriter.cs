...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeAllocationWriter : XmiElementWriter<Auriga.Fa.IComponentExchangeAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentExchangeAllocation poco, IXmiWriteContext context)
        {
