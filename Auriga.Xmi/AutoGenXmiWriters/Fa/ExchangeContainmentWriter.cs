...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ExchangeContainmentWriter : XmiElementWriter<Auriga.Fa.IExchangeContainment>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IExchangeContainment poco, IXmiWriteContext context)
        {
