...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionalChainWriter : XmiElementWriter<Auriga.Fa.IFunctionalChain>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionalChain poco, IXmiWriteContext context)
        {
