...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionRealizationWriter : XmiElementWriter<Auriga.Fa.IFunctionRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionRealization poco, IXmiWriteContext context)
        {
