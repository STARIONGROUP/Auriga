...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionalExchangeSpecificationWriter : XmiElementWriter<Auriga.Fa.IFunctionalExchangeSpecification>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionalExchangeSpecification poco, IXmiWriteContext context)
        {
