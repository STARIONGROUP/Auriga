...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionInputPortWriter : XmiElementWriter<Auriga.Fa.IFunctionInputPort>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IFunctionInputPort poco, IXmiWriteContext context)
        {
