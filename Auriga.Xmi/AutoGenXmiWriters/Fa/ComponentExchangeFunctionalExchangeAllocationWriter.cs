...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeFunctionalExchangeAllocationWriter : XmiElementWriter<Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentExchangeFunctionalExchangeAllocation poco, IXmiWriteContext context)
        {
