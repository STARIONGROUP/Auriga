...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ControlNodeWriter : XmiElementWriter<Auriga.Fa.IControlNode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IControlNode poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Fa.ControlNodeKind>(xmlWriter, "kind", poco.Kind);
