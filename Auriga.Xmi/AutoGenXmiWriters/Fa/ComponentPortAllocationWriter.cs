...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentPortAllocationWriter : XmiElementWriter<Auriga.Fa.IComponentPortAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentPortAllocation poco, IXmiWriteContext context)
        {
