...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ExchangeLinkWriter : XmiElementWriter<Auriga.Fa.IExchangeLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IExchangeLink poco, IXmiWriteContext context)
        {
