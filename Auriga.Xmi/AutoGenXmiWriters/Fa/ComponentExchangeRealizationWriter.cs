...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeRealizationWriter : XmiElementWriter<Auriga.Fa.IComponentExchangeRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentExchangeRealization poco, IXmiWriteContext context)
        {
