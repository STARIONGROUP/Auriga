...
namespace Auriga.Xmi.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentPortAllocationEndWriter : XmiElementWriter<Auriga.Fa.IComponentPortAllocationEnd>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Fa.IComponentPortAllocationEnd poco, IXmiWriteContext context)
        {
