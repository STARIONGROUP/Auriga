...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Validation
{
    ...
    /// </summary>
    public class ValidationSetWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Validation.IValidationSet>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Validation.IValidationSet poco, IXmiWriteContext context)
        {
