...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Validation
{
    ...
    /// </summary>
    public class ValidationFixWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Validation.IValidationFix>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Validation.IValidationFix poco, IXmiWriteContext context)
        {
