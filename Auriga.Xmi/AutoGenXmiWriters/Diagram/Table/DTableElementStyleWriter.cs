// ------------------------------------------------------------------------------------------------
// <copyright file="DTableElementStyleWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Table
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>DTableElementStyle</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class DTableElementStyleWriter : XmiElementWriter<Auriga.Diagram.Table.IDTableElementStyle>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DTableElementStyleWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public DTableElementStyleWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>DTableElementStyle</c>.
        /// </summary>
        public override string NamespacePrefix => "table";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>DTableElementStyle</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "DTableElementStyle";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.eclipse.org/sirius/table/1.1.0</c>) of the package that declares
        /// <c>DTableElementStyle</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.eclipse.org/sirius/table/1.1.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>DTableElementStyle</c>.
        /// </summary>
