...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Table
{
    ...
    /// </summary>
    public class DTargetColumnWriter : XmiElementWriter<Auriga.Diagram.Table.IDTargetColumn>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Table.IDTargetColumn poco, IXmiWriteContext context)
        {
