...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    public class PaneBasedSelectionWizardDescriptionWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription poco, IXmiWriteContext context)
        {
            ...
            WriteStringAttribute(xmlWriter, "choiceOfValuesMessage", poco.ChoiceOfValuesMessage);
            ...
            WriteStringAttribute(xmlWriter, "selectedValuesMessage", poco.SelectedValuesMessage);
