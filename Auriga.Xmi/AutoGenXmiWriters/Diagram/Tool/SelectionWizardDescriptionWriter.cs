...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class SelectionWizardDescriptionWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.ISelectionWizardDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.ISelectionWizardDescription poco, IXmiWriteContext context)
        {
            ...
            WriteStringAttribute(xmlWriter, "iconPath", poco.IconPath, "/org.eclipse.sirius.ui/icons/full/obj16/SelectionWizardDescription.gif");
