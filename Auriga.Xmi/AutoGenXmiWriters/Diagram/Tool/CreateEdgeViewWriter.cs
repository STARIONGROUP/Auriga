...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class CreateEdgeViewWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Tool.ICreateEdgeView>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Tool.ICreateEdgeView poco, IXmiWriteContext context)
        {
