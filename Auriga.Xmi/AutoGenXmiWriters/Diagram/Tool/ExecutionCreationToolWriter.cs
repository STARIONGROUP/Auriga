...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class ExecutionCreationToolWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool poco, IXmiWriteContext context)
        {
