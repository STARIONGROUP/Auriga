...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class ToolFilterDescriptionWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.IToolFilterDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.IToolFilterDescription poco, IXmiWriteContext context)
        {
