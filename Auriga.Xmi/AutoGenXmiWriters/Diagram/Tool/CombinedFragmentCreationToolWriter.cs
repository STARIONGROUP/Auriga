// ------------------------------------------------------------------------------------------------
// <copyright file="CombinedFragmentCreationToolWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>CombinedFragmentCreationTool</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class CombinedFragmentCreationToolWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.Tool.ICombinedFragmentCreationTool>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CombinedFragmentCreationToolWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public CombinedFragmentCreationToolWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>CombinedFragmentCreationTool</c>.
        /// </summary>
        public override string NamespacePrefix => "tool";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>CombinedFragmentCreationTool</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "CombinedFragmentCreationTool";
        ...
        /// <c>CombinedFragmentCreationTool</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.eclipse.org/sirius/diagram/sequence/description/tool/2.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>CombinedFragmentCreationTool</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.Tool.ICombinedFragmentCreationTool poco, IXmiWriteContext context)
        {
