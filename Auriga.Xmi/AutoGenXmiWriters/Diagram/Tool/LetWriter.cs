...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class LetWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.ILet>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.ILet poco, IXmiWriteContext context)
        {
