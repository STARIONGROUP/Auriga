...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class PasteDescriptionWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.IPasteDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.IPasteDescription poco, IXmiWriteContext context)
        {
