// ------------------------------------------------------------------------------------------------
// <copyright file="DirectEditLabelWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>DirectEditLabel</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class DirectEditLabelWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectEditLabelWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public DirectEditLabelWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>DirectEditLabel</c>.
        /// </summary>
        public override string NamespacePrefix => "tool";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>DirectEditLabel</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "DirectEditLabel";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>DirectEditLabel</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel poco, IXmiWriteContext context)
        {
            ...
            WriteStringAttribute(xmlWriter, "inputLabelExpression", poco.InputLabelExpression);
