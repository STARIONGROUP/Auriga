...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class NameVariableWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.INameVariable>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.INameVariable poco, IXmiWriteContext context)
        {
