...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class SourceEdgeViewCreationVariableWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeViewCreationVariable>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeViewCreationVariable poco, IXmiWriteContext context)
        {
