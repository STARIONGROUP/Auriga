...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class DiagramCreationDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Tool.IDiagramCreationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Tool.IDiagramCreationDescription poco, IXmiWriteContext context)
        {
