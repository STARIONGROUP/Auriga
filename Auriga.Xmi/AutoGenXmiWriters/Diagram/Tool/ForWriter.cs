...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class ForWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.IFor>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.IFor poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteStringAttribute(xmlWriter, "expression", poco.Expression);
            WriteStringAttribute(xmlWriter, "iteratorName", poco.IteratorName, "i");
