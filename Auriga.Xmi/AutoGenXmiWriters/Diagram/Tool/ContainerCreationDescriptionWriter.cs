...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class ContainerCreationDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Tool.IContainerCreationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Tool.IContainerCreationDescription poco, IXmiWriteContext context)
        {
