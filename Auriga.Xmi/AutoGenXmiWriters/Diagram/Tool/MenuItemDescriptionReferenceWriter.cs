...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class MenuItemDescriptionReferenceWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Tool.IMenuItemDescriptionReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Tool.IMenuItemDescriptionReference poco, IXmiWriteContext context)
        {
