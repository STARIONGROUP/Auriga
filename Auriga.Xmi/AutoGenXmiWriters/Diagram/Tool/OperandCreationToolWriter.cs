...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class OperandCreationToolWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.Tool.IOperandCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.Tool.IOperandCreationTool poco, IXmiWriteContext context)
        {
