...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class DoubleClickDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription poco, IXmiWriteContext context)
        {
