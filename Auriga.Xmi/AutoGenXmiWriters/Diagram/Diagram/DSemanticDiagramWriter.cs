...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class DSemanticDiagramWriter : XmiElementWriter<Auriga.Diagram.Diagram.IDSemanticDiagram>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.IDSemanticDiagram poco, IXmiWriteContext context)
        {
