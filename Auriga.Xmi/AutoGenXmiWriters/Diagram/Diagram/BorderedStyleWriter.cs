// ------------------------------------------------------------------------------------------------
// <copyright file="BorderedStyleWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>BorderedStyle</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class BorderedStyleWriter : XmiElementWriter<Auriga.Diagram.Diagram.IBorderedStyle>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BorderedStyleWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public BorderedStyleWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>BorderedStyle</c>.
        /// </summary>
        public override string NamespacePrefix => "diagram";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>BorderedStyle</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "BorderedStyle";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>BorderedStyle</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.IBorderedStyle poco, IXmiWriteContext context)
        {
