...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class BeginLabelStyleWriter : XmiElementWriter<Auriga.Diagram.Diagram.IBeginLabelStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.IBeginLabelStyle poco, IXmiWriteContext context)
        {
