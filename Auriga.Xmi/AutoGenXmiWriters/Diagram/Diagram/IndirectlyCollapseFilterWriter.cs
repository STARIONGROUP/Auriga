...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class IndirectlyCollapseFilterWriter : XmiElementWriter<Auriga.Diagram.Diagram.IIndirectlyCollapseFilter>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.IIndirectlyCollapseFilter poco, IXmiWriteContext context)
        {
