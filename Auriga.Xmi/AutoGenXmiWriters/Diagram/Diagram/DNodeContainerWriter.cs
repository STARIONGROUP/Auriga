...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class DNodeContainerWriter : XmiElementWriter<Auriga.Diagram.Diagram.IDNodeContainer>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.IDNodeContainer poco, IXmiWriteContext context)
        {
