...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class SequenceDiagramDescriptionWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.ISequenceDiagramDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.ISequenceDiagramDescription poco, IXmiWriteContext context)
        {
