...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class CustomLayoutConfigurationWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.ICustomLayoutConfiguration>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.ICustomLayoutConfiguration poco, IXmiWriteContext context)
        {
