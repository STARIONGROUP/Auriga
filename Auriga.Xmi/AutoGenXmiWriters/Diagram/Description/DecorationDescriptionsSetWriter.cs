...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class DecorationDescriptionsSetWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.IDecorationDescriptionsSet>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.IDecorationDescriptionsSet poco, IXmiWriteContext context)
        {
