...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class IntegerLayoutOptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.IIntegerLayoutOption>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.IIntegerLayoutOption poco, IXmiWriteContext context)
        {
