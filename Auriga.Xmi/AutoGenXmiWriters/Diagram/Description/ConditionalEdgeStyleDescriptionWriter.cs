...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class ConditionalEdgeStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.IConditionalEdgeStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.IConditionalEdgeStyleDescription poco, IXmiWriteContext context)
        {
