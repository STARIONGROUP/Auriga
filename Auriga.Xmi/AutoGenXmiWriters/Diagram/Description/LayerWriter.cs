...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class LayerWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.ILayer>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.ILayer poco, IXmiWriteContext context)
        {
