...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class TypedVariableWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.ITypedVariable>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.ITypedVariable poco, IXmiWriteContext context)
        {
