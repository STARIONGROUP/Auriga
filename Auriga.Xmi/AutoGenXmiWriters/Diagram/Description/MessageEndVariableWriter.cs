...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class MessageEndVariableWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.IMessageEndVariable>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.IMessageEndVariable poco, IXmiWriteContext context)
        {
