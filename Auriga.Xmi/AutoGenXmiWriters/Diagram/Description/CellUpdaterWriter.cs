...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class CellUpdaterWriter : XmiElementWriter<Auriga.Diagram.Table.Description.ICellUpdater>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Table.Description.ICellUpdater poco, IXmiWriteContext context)
        {
