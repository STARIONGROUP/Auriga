// ------------------------------------------------------------------------------------------------
// <copyright file="GateMappingWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>GateMapping</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class GateMappingWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.IGateMapping>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GateMappingWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public GateMappingWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>GateMapping</c>.
        /// </summary>
        public override string NamespacePrefix => "description";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>GateMapping</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "GateMapping";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>GateMapping</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.IGateMapping poco, IXmiWriteContext context)
        {
