...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class CreateCellToolWriter : XmiElementWriter<Auriga.Diagram.Table.Description.ICreateCellTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Table.Description.ICreateCellTool poco, IXmiWriteContext context)
        {
