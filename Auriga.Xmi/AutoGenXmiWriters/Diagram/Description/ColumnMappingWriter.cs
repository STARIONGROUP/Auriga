...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class ColumnMappingWriter : XmiElementWriter<Auriga.Diagram.Table.Description.IColumnMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Table.Description.IColumnMapping poco, IXmiWriteContext context)
        {
