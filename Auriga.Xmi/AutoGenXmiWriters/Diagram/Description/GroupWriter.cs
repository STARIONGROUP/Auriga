...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class GroupWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.IGroup>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.IGroup poco, IXmiWriteContext context)
        {
