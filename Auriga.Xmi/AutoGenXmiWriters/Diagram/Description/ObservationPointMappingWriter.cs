...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class ObservationPointMappingWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.IObservationPointMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.IObservationPointMapping poco, IXmiWriteContext context)
        {
