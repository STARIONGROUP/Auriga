...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class AdditionalLayerWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.IAdditionalLayer>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.IAdditionalLayer poco, IXmiWriteContext context)
        {
