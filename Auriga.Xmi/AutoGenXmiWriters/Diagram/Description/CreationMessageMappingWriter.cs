...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class CreationMessageMappingWriter : XmiElementWriter<Auriga.Diagram.Sequence.Description.ICreationMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Description.ICreationMessageMapping poco, IXmiWriteContext context)
        {
