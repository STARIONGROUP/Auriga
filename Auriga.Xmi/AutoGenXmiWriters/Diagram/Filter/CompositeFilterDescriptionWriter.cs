...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Filter
{
    ...
    /// </summary>
    public class CompositeFilterDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Filter.ICompositeFilterDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Filter.ICompositeFilterDescription poco, IXmiWriteContext context)
        {
