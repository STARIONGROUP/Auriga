...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TConditionalLifelineStyleWriter : XmiElementWriter<Auriga.Diagram.Sequence.Template.ITConditionalLifelineStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Template.ITConditionalLifelineStyle poco, IXmiWriteContext context)
        {
