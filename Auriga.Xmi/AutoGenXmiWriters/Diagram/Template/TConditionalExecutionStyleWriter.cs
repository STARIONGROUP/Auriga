...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TConditionalExecutionStyleWriter : XmiElementWriter<Auriga.Diagram.Sequence.Template.ITConditionalExecutionStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Template.ITConditionalExecutionStyle poco, IXmiWriteContext context)
        {
