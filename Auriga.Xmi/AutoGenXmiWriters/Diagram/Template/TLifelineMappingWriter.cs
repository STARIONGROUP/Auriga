...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TLifelineMappingWriter : XmiElementWriter<Auriga.Diagram.Sequence.Template.ITLifelineMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Template.ITLifelineMapping poco, IXmiWriteContext context)
        {
