...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TBasicMessageMappingWriter : XmiElementWriter<Auriga.Diagram.Sequence.Template.ITBasicMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Template.ITBasicMessageMapping poco, IXmiWriteContext context)
        {
