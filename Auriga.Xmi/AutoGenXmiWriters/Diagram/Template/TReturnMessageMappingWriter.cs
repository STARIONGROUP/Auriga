...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TReturnMessageMappingWriter : XmiElementWriter<Auriga.Diagram.Sequence.Template.ITReturnMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Sequence.Template.ITReturnMessageMapping poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteStringAttribute(xmlWriter, "domainClass", poco.DomainClass);
            WriteReferenceAttribute(xmlWriter, "invocationMapping", poco.InvocationMapping, poco, "InvocationMapping", context);
