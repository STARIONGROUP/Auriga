...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class EllipseNodeDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription poco, IXmiWriteContext context)
        {
            ...
            WriteStringAttribute(xmlWriter, "horizontalDiameterComputationExpression", poco.HorizontalDiameterComputationExpression, "0");
            ...
            WriteStringAttribute(xmlWriter, "verticalDiameterComputationExpression", poco.VerticalDiameterComputationExpression, "0");
