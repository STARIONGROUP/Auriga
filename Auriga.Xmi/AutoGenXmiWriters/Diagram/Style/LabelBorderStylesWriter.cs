...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Style
{
    ...
    /// </summary>
    public class LabelBorderStylesWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Style.ILabelBorderStyles>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Style.ILabelBorderStyles poco, IXmiWriteContext context)
        {
