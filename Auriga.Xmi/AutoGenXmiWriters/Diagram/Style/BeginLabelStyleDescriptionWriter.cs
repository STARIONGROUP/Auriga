...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class BeginLabelStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Style.IBeginLabelStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Style.IBeginLabelStyleDescription poco, IXmiWriteContext context)
        {
