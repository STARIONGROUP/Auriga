...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint.Description.Style
{
    ...
    /// </summary>
    public class LabelBorderStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.Description.Style.ILabelBorderStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.Description.Style.ILabelBorderStyleDescription poco, IXmiWriteContext context)
        {
