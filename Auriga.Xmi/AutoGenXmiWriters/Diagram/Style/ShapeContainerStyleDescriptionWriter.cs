...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class ShapeContainerStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Style.IShapeContainerStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Style.IShapeContainerStyleDescription poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Diagram.Diagram.ContainerShape>(xmlWriter, "shape", poco.Shape, Auriga.Extensions.ContainerShapeProvider.ToXmlLiteral);
