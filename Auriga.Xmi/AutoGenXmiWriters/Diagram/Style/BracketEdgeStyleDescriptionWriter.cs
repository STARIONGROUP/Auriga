...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class BracketEdgeStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Diagram.Diagram.Description.CenteringStyle>(xmlWriter, "endsCentering", poco.EndsCentering, Auriga.Extensions.CenteringStyleProvider.ToXmlLiteral, Auriga.Diagram.Diagram.Description.CenteringStyle.None);
            WriteEnumAttribute<Auriga.Diagram.Diagram.Description.FoldingStyle>(xmlWriter, "foldingStyle", poco.FoldingStyle, Auriga.Extensions.FoldingStyleProvider.ToXmlLiteral);
