...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    public class BracketEdgeStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Style.IBracketEdgeStyleDescription poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Diagram.Diagram.Description.CenteringStyle>(xmlWriter, "endsCentering", poco.EndsCentering, Auriga.Diagram.Diagram.Description.CenteringStyle.None);
