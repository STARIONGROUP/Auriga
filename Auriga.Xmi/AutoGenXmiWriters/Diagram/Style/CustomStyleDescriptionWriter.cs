...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class CustomStyleDescriptionWriter : XmiElementWriter<Auriga.Diagram.Diagram.Description.Style.ICustomStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Diagram.Description.Style.ICustomStyleDescription poco, IXmiWriteContext context)
        {
