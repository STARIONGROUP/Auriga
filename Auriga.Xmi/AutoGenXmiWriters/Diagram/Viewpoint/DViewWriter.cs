...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class DViewWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.IDView>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.IDView poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteStringAttribute(xmlWriter, "uid", poco.Uid);
            WriteReferenceAttribute(xmlWriter, "viewpoint", poco.Viewpoint, poco, "Viewpoint", context);
