...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class ToolSectionInstanceWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.IToolSectionInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.IToolSectionInstance poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteBooleanAttribute(xmlWriter, "enabled", poco.Enabled, true);
            WriteBooleanAttribute(xmlWriter, "filtered", poco.Filtered);
            WriteReferenceAttribute(xmlWriter, "section", poco.Section as Auriga.Core.IAurigaElement, poco, "Section", context);
            WriteReferenceAttribute(xmlWriter, "toolEntry", poco.ToolEntry, poco, "ToolEntry", context);
