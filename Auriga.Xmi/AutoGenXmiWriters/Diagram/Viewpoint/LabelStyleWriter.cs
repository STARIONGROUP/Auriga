...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class LabelStyleWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.ILabelStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.ILabelStyle poco, IXmiWriteContext context)
        {
