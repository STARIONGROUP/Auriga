...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class SessionManagerEObjectWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.ISessionManagerEObject>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.ISessionManagerEObject poco, IXmiWriteContext context)
        {
