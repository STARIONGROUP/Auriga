...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class BasicLabelStyleWriter : XmiElementWriter<Auriga.Diagram.Viewpoint.IBasicLabelStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Viewpoint.IBasicLabelStyle poco, IXmiWriteContext context)
        {
