...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class DescriptionStyleWriter : XmiElementWriter<Auriga.Diagram.Notation.IDescriptionStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.IDescriptionStyle poco, IXmiWriteContext context)
        {
