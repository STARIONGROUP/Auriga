...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class BasicSemanticCompartmentWriter : XmiElementWriter<Auriga.Diagram.Notation.IBasicSemanticCompartment>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.IBasicSemanticCompartment poco, IXmiWriteContext context)
        {
