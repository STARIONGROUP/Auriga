...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class DiagramLinkStyleWriter : XmiElementWriter<Auriga.Diagram.Notation.IDiagramLinkStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.IDiagramLinkStyle poco, IXmiWriteContext context)
        {
