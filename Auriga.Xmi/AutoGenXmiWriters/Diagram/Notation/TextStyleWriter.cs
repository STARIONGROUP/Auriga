...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    public class TextStyleWriter : XmiElementWriter<Auriga.Diagram.Notation.ITextStyle>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.ITextStyle poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Diagram.Notation.TextAlignment>(xmlWriter, "textAlignment", poco.TextAlignment, Auriga.Extensions.TextAlignmentProvider.ToXmlLiteral, Auriga.Diagram.Notation.TextAlignment.Left);
        }
    }
}
