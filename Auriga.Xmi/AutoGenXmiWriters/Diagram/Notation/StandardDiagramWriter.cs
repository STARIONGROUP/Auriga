...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class StandardDiagramWriter : XmiElementWriter<Auriga.Diagram.Notation.IStandardDiagram>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.IStandardDiagram poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Diagram.Notation.MeasurementUnit>(xmlWriter, "measurementUnit", poco.MeasurementUnit, Auriga.Extensions.MeasurementUnitProvider.ToXmlLiteral, Auriga.Diagram.Notation.MeasurementUnit.Himetric);
