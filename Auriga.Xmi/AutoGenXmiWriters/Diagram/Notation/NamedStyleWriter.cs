...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class NamedStyleWriter : XmiElementWriter<Auriga.Diagram.Notation.INamedStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.INamedStyle poco, IXmiWriteContext context)
        {
