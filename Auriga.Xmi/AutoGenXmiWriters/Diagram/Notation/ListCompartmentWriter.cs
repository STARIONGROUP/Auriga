...
namespace Auriga.Xmi.Diagram.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class ListCompartmentWriter : XmiElementWriter<Auriga.Diagram.Notation.IListCompartment>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Diagram.Notation.IListCompartment poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "sortedObjects", poco.SortedObjects, poco, "SortedObjects", context);
