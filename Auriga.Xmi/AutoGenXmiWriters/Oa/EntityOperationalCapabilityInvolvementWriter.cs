...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class EntityOperationalCapabilityInvolvementWriter : XmiElementWriter<Auriga.Oa.IEntityOperationalCapabilityInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IEntityOperationalCapabilityInvolvement poco, IXmiWriteContext context)
        {
