...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class CommunityOfInterestCompositionWriter : XmiElementWriter<Auriga.Oa.ICommunityOfInterestComposition>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.ICommunityOfInterestComposition poco, IXmiWriteContext context)
        {
