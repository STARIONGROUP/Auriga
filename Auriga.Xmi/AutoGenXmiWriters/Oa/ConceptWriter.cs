...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class ConceptWriter : XmiElementWriter<Auriga.Oa.IConcept>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IConcept poco, IXmiWriteContext context)
        {
