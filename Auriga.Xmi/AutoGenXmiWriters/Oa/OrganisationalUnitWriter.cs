...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OrganisationalUnitWriter : XmiElementWriter<Auriga.Oa.IOrganisationalUnit>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IOrganisationalUnit poco, IXmiWriteContext context)
        {
