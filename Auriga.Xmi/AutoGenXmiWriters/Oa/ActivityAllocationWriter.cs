...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class ActivityAllocationWriter : XmiElementWriter<Auriga.Oa.IActivityAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IActivityAllocation poco, IXmiWriteContext context)
        {
