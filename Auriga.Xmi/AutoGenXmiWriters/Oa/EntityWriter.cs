...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class EntityWriter : XmiElementWriter<Auriga.Oa.IEntity>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IEntity poco, IXmiWriteContext context)
        {
