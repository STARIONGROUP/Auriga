...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class ConceptComplianceWriter : XmiElementWriter<Auriga.Oa.IConceptCompliance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IConceptCompliance poco, IXmiWriteContext context)
        {
