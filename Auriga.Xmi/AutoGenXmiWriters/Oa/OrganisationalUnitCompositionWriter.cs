...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OrganisationalUnitCompositionWriter : XmiElementWriter<Auriga.Oa.IOrganisationalUnitComposition>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IOrganisationalUnitComposition poco, IXmiWriteContext context)
        {
