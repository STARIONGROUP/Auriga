...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OperationalAnalysisWriter : XmiElementWriter<Auriga.Oa.IOperationalAnalysis>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IOperationalAnalysis poco, IXmiWriteContext context)
        {
