...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class ConceptPkgWriter : XmiElementWriter<Auriga.Oa.IConceptPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IConceptPkg poco, IXmiWriteContext context)
        {
