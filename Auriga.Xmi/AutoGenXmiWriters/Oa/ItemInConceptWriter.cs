...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class ItemInConceptWriter : XmiElementWriter<Auriga.Oa.IItemInConcept>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IItemInConcept poco, IXmiWriteContext context)
        {
