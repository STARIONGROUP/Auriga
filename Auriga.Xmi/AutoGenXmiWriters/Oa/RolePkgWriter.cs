...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class RolePkgWriter : XmiElementWriter<Auriga.Oa.IRolePkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IRolePkg poco, IXmiWriteContext context)
        {
