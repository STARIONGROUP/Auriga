...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OperationalActivityPkgWriter : XmiElementWriter<Auriga.Oa.IOperationalActivityPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IOperationalActivityPkg poco, IXmiWriteContext context)
        {
