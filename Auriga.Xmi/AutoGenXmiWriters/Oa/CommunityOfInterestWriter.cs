...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class CommunityOfInterestWriter : XmiElementWriter<Auriga.Oa.ICommunityOfInterest>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.ICommunityOfInterest poco, IXmiWriteContext context)
        {
