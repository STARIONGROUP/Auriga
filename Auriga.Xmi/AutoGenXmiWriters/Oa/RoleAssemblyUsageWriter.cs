...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class RoleAssemblyUsageWriter : XmiElementWriter<Auriga.Oa.IRoleAssemblyUsage>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IRoleAssemblyUsage poco, IXmiWriteContext context)
        {
