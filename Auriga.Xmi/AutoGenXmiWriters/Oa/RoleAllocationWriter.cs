...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class RoleAllocationWriter : XmiElementWriter<Auriga.Oa.IRoleAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IRoleAllocation poco, IXmiWriteContext context)
        {
