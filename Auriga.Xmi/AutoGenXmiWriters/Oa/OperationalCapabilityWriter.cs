...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OperationalCapabilityWriter : XmiElementWriter<Auriga.Oa.IOperationalCapability>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IOperationalCapability poco, IXmiWriteContext context)
        {
