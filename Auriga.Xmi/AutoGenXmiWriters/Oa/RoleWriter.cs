...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class RoleWriter : XmiElementWriter<Auriga.Oa.IRole>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IRole poco, IXmiWriteContext context)
        {
