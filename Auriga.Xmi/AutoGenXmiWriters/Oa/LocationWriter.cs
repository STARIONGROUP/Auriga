...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class LocationWriter : XmiElementWriter<Auriga.Oa.ILocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.ILocation poco, IXmiWriteContext context)
        {
