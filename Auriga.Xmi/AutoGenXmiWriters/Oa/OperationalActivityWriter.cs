...
namespace Auriga.Xmi.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OperationalActivityWriter : XmiElementWriter<Auriga.Oa.IOperationalActivity>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Oa.IOperationalActivity poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Fa.FunctionKind>(xmlWriter, "kind", poco.Kind);
