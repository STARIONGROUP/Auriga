...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacore
{
    ...
    /// </summary>
    public class PropertyValuePkgWriter : XmiElementWriter<Auriga.Capellacore.IPropertyValuePkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacore.IPropertyValuePkg poco, IXmiWriteContext context)
        {
