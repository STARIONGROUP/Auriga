...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacore
{
    ...
    /// </summary>
    public class GeneralizationWriter : XmiElementWriter<Auriga.Capellacore.IGeneralization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacore.IGeneralization poco, IXmiWriteContext context)
        {
