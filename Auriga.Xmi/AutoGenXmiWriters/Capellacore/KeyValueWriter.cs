...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacore
{
    ...
    /// </summary>
    public class KeyValueWriter : XmiElementWriter<Auriga.Capellacore.IKeyValue>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacore.IKeyValue poco, IXmiWriteContext context)
        {
