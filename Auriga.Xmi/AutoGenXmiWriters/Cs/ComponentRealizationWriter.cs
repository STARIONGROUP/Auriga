...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class ComponentRealizationWriter : XmiElementWriter<Auriga.Cs.IComponentRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IComponentRealization poco, IXmiWriteContext context)
        {
