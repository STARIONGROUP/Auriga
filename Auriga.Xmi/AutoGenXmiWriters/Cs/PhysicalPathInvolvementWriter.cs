...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalPathInvolvementWriter : XmiElementWriter<Auriga.Cs.IPhysicalPathInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalPathInvolvement poco, IXmiWriteContext context)
        {
