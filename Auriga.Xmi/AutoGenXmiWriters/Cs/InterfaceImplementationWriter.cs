...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class InterfaceImplementationWriter : XmiElementWriter<Auriga.Cs.IInterfaceImplementation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IInterfaceImplementation poco, IXmiWriteContext context)
        {
