...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class InterfacePkgWriter : XmiElementWriter<Auriga.Cs.IInterfacePkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IInterfacePkg poco, IXmiWriteContext context)
        {
