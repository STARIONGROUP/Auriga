...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkCategoryWriter : XmiElementWriter<Auriga.Cs.IPhysicalLinkCategory>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalLinkCategory poco, IXmiWriteContext context)
        {
