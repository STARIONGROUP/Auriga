...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalPathReferenceWriter : XmiElementWriter<Auriga.Cs.IPhysicalPathReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalPathReference poco, IXmiWriteContext context)
        {
