...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalPortRealizationWriter : XmiElementWriter<Auriga.Cs.IPhysicalPortRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalPortRealization poco, IXmiWriteContext context)
        {
