...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalPathRealizationWriter : XmiElementWriter<Auriga.Cs.IPhysicalPathRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalPathRealization poco, IXmiWriteContext context)
        {
