...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalPathWriter : XmiElementWriter<Auriga.Cs.IPhysicalPath>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalPath poco, IXmiWriteContext context)
        {
