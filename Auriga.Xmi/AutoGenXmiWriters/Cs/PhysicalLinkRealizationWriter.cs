...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalLinkRealizationWriter : XmiElementWriter<Auriga.Cs.IPhysicalLinkRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalLinkRealization poco, IXmiWriteContext context)
        {
