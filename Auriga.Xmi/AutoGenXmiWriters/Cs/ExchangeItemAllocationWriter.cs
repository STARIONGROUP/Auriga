...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class ExchangeItemAllocationWriter : XmiElementWriter<Auriga.Cs.IExchangeItemAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IExchangeItemAllocation poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "receiveProtocol", poco.ReceiveProtocol);
            WriteStringAttribute(xmlWriter, "review", poco.Review);
            WriteEnumAttribute<Auriga.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "sendProtocol", poco.SendProtocol);
