...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class InterfaceUseWriter : XmiElementWriter<Auriga.Cs.IInterfaceUse>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IInterfaceUse poco, IXmiWriteContext context)
        {
