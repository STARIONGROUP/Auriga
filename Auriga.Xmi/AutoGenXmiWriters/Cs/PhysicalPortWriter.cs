...
namespace Auriga.Xmi.AutoGenXmiWriters.Cs
{
    ...
    /// </summary>
    public class PhysicalPortWriter : XmiElementWriter<Auriga.Cs.IPhysicalPort>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Cs.IPhysicalPort poco, IXmiWriteContext context)
        {
