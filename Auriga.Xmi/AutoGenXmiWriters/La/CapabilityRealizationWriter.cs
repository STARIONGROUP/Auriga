...
namespace Auriga.Xmi.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class CapabilityRealizationWriter : XmiElementWriter<Auriga.La.ICapabilityRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.La.ICapabilityRealization poco, IXmiWriteContext context)
        {
