...
namespace Auriga.Xmi.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class ContextInterfaceRealizationWriter : XmiElementWriter<Auriga.La.IContextInterfaceRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.La.IContextInterfaceRealization poco, IXmiWriteContext context)
        {
