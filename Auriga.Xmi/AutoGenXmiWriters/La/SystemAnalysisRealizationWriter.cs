...
namespace Auriga.Xmi.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class SystemAnalysisRealizationWriter : XmiElementWriter<Auriga.La.ISystemAnalysisRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.La.ISystemAnalysisRealization poco, IXmiWriteContext context)
        {
