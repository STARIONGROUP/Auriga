...
namespace Auriga.Xmi.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class LogicalComponentWriter : XmiElementWriter<Auriga.La.ILogicalComponent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.La.ILogicalComponent poco, IXmiWriteContext context)
        {
