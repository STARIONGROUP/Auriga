...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class EnumerationReferenceWriter : XmiElementWriter<Auriga.Information.Datavalue.IEnumerationReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.IEnumerationReference poco, IXmiWriteContext context)
        {
