...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class StringReferenceWriter : XmiElementWriter<Auriga.Information.Datavalue.IStringReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.IStringReference poco, IXmiWriteContext context)
        {
