...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class NumericReferenceWriter : XmiElementWriter<Auriga.Information.Datavalue.INumericReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.INumericReference poco, IXmiWriteContext context)
        {
