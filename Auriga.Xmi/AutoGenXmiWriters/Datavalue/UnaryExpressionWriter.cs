...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class UnaryExpressionWriter : XmiElementWriter<Auriga.Information.Datavalue.IUnaryExpression>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.IUnaryExpression poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Information.Datavalue.UnaryOperator>(xmlWriter, "operator", poco.Operator);
