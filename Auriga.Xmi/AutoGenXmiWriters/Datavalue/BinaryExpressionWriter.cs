...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class BinaryExpressionWriter : XmiElementWriter<Auriga.Information.Datavalue.IBinaryExpression>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.IBinaryExpression poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Information.Datavalue.BinaryOperator>(xmlWriter, "operator", poco.Operator);
