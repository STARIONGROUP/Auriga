// ------------------------------------------------------------------------------------------------
// <copyright file="LiteralStringValueWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>LiteralStringValue</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class LiteralStringValueWriter : XmiElementWriter<Auriga.Information.Datavalue.ILiteralStringValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiteralStringValueWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public LiteralStringValueWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>LiteralStringValue</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information.datavalue";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>LiteralStringValue</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "LiteralStringValue";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/information/datavalue/7.0.0</c>) of the package that declares
        /// <c>LiteralStringValue</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/information/datavalue/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>LiteralStringValue</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.ILiteralStringValue poco, IXmiWriteContext context)
        {
