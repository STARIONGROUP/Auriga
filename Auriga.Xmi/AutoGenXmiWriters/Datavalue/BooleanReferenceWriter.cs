...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class BooleanReferenceWriter : XmiElementWriter<Auriga.Information.Datavalue.IBooleanReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datavalue.IBooleanReference poco, IXmiWriteContext context)
        {
