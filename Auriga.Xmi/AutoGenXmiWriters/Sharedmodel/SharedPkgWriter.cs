...
namespace Auriga.Xmi.AutoGenXmiWriters.Sharedmodel
{
    ...
    /// </summary>
    public class SharedPkgWriter : XmiElementWriter<Auriga.Sharedmodel.ISharedPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sharedmodel.ISharedPkg poco, IXmiWriteContext context)
        {
