...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class LogicalArchitectureRealizationWriter : XmiElementWriter<Auriga.Pa.ILogicalArchitectureRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.ILogicalArchitectureRealization poco, IXmiWriteContext context)
        {
