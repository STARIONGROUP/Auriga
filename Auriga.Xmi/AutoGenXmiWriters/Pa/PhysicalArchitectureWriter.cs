...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class PhysicalArchitectureWriter : XmiElementWriter<Auriga.Pa.IPhysicalArchitecture>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.IPhysicalArchitecture poco, IXmiWriteContext context)
        {
