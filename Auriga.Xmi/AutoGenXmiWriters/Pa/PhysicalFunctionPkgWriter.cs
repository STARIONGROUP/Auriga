...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class PhysicalFunctionPkgWriter : XmiElementWriter<Auriga.Pa.IPhysicalFunctionPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.IPhysicalFunctionPkg poco, IXmiWriteContext context)
        {
