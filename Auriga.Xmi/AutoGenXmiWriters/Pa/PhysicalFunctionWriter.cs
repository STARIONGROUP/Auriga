...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class PhysicalFunctionWriter : XmiElementWriter<Auriga.Pa.IPhysicalFunction>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.IPhysicalFunction poco, IXmiWriteContext context)
        {
