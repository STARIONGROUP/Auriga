...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class PhysicalArchitecturePkgWriter : XmiElementWriter<Auriga.Pa.IPhysicalArchitecturePkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.IPhysicalArchitecturePkg poco, IXmiWriteContext context)
        {
