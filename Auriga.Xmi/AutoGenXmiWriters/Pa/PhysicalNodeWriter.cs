...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class PhysicalNodeWriter : XmiElementWriter<Auriga.Pa.IPhysicalNode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.IPhysicalNode poco, IXmiWriteContext context)
        {
