...
namespace Auriga.Xmi.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class LogicalInterfaceRealizationWriter : XmiElementWriter<Auriga.Pa.ILogicalInterfaceRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Pa.ILogicalInterfaceRealization poco, IXmiWriteContext context)
        {
