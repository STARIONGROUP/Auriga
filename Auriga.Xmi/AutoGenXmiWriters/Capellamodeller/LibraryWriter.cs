...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellamodeller
{
    ...
    /// </summary>
    public class LibraryWriter : XmiElementWriter<Auriga.Capellamodeller.ILibrary>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellamodeller.ILibrary poco, IXmiWriteContext context)
        {
