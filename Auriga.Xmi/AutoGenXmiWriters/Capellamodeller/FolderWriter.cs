...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellamodeller
{
    ...
    /// </summary>
    public class FolderWriter : XmiElementWriter<Auriga.Capellamodeller.IFolder>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellamodeller.IFolder poco, IXmiWriteContext context)
        {
