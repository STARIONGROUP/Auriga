...
namespace Auriga.Xmi.AutoGenXmiWriters.Epbs
{
    ...
    /// </summary>
    public class PhysicalArchitectureRealizationWriter : XmiElementWriter<Auriga.Epbs.IPhysicalArchitectureRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Epbs.IPhysicalArchitectureRealization poco, IXmiWriteContext context)
        {
