...
namespace Auriga.Xmi.AutoGenXmiWriters.Epbs
{
    ...
    /// </summary>
    public class PhysicalArtifactRealizationWriter : XmiElementWriter<Auriga.Epbs.IPhysicalArtifactRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Epbs.IPhysicalArtifactRealization poco, IXmiWriteContext context)
        {
