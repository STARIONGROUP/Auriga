...
namespace Auriga.Xmi.AutoGenXmiWriters.Epbs
{
    ...
    /// </summary>
    public class EPBSArchitecturePkgWriter : XmiElementWriter<Auriga.Epbs.IEPBSArchitecturePkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Epbs.IEPBSArchitecturePkg poco, IXmiWriteContext context)
        {
