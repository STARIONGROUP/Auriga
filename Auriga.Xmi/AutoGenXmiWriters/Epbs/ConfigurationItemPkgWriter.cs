...
namespace Auriga.Xmi.AutoGenXmiWriters.Epbs
{
    ...
    /// </summary>
    public class ConfigurationItemPkgWriter : XmiElementWriter<Auriga.Epbs.IConfigurationItemPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Epbs.IConfigurationItemPkg poco, IXmiWriteContext context)
        {
