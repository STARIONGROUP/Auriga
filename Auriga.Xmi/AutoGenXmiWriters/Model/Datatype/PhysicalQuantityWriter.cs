...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Datatype
{
    ...
    /// </summary>
    public class PhysicalQuantityWriter : XmiElementWriter<Auriga.Model.Information.Datatype.IPhysicalQuantity>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Datatype.IPhysicalQuantity poco, IXmiWriteContext context)
        {
