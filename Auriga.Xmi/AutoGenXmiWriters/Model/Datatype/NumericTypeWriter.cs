// ------------------------------------------------------------------------------------------------
// <copyright file="NumericTypeWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Datatype
{
    using System.Xml;
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>NumericType</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class NumericTypeWriter : XmiElementWriter<Auriga.Model.Information.Datatype.INumericType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumericTypeWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public NumericTypeWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>NumericType</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information.datatype";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>NumericType</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "NumericType";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>NumericType</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Datatype.INumericType poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Information.Datatype.NumericTypeKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.NumericTypeKindProvider.ToXmlLiteral, Auriga.Model.Information.Datatype.NumericTypeKind.INTEGER);
