...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Datatype
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Enumeration</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class EnumerationWriter : XmiElementWriter<Auriga.Model.Information.Datatype.IEnumeration>
    {
        /// <summary>
        ...
        public EnumerationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>Enumeration</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information.datatype";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Enumeration</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Enumeration";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Enumeration</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Datatype.IEnumeration poco, IXmiWriteContext context)
        {
            ...
            this.WriteReferenceAttribute(xmlWriter, "domainType", poco.DomainType, poco, "DomainType", context);
