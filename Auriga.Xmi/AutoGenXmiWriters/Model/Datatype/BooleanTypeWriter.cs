// ------------------------------------------------------------------------------------------------
// <copyright file="BooleanTypeWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Datatype
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>BooleanType</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class BooleanTypeWriter : XmiElementWriter<Auriga.Model.Information.Datatype.IBooleanType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanTypeWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public BooleanTypeWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>BooleanType</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information.datatype";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>BooleanType</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "BooleanType";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>BooleanType</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Datatype.IBooleanType poco, IXmiWriteContext context)
        {
