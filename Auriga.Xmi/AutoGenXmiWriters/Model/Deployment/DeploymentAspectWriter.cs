...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class DeploymentAspectWriter : XmiElementWriter<Auriga.Model.Pa.Deployment.IDeploymentAspect>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.Deployment.IDeploymentAspect poco, IXmiWriteContext context)
        {
