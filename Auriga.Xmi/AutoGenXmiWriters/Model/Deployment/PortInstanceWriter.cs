// ------------------------------------------------------------------------------------------------
// <copyright file="PortInstanceWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PortInstance</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PortInstanceWriter : XmiElementWriter<Auriga.Model.Pa.Deployment.IPortInstance>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortInstanceWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PortInstanceWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>PortInstance</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.pa.deployment";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PortInstance</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PortInstance";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PortInstance</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.Deployment.IPortInstance poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "connections", poco.Connections, poco, "Connections", context);
