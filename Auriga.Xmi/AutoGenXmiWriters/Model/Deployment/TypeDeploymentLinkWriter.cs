...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// </summary>
    public class TypeDeploymentLinkWriter : XmiElementWriter<Auriga.Model.Pa.Deployment.ITypeDeploymentLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.Deployment.ITypeDeploymentLink poco, IXmiWriteContext context)
        {
