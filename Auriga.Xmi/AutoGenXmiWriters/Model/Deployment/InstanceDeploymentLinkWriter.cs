// ------------------------------------------------------------------------------------------------
// <copyright file="InstanceDeploymentLinkWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa.Deployment
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>InstanceDeploymentLink</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class InstanceDeploymentLinkWriter : XmiElementWriter<Auriga.Model.Pa.Deployment.IInstanceDeploymentLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstanceDeploymentLinkWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public InstanceDeploymentLinkWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>InstanceDeploymentLink</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.pa.deployment";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>InstanceDeploymentLink</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "InstanceDeploymentLink";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/pa/deployment/7.0.0</c>) of the package that declares
        /// <c>InstanceDeploymentLink</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/pa/deployment/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>InstanceDeploymentLink</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.Deployment.IInstanceDeploymentLink poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "deployedElement", poco.DeployedElement, poco, "DeployedElement", context);
            WriteStringAttribute(xmlWriter, "description", poco.Description);
            WriteReferenceListAttribute(xmlWriter, "features", poco.Features, poco, "Features", context);
            WriteReferenceAttribute(xmlWriter, "location", poco.Location, poco, "Location", context);
