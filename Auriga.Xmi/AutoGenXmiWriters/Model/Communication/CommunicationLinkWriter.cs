// ------------------------------------------------------------------------------------------------
// <copyright file="CommunicationLinkWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Communication
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>CommunicationLink</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class CommunicationLinkWriter : XmiElementWriter<Auriga.Model.Information.Communication.ICommunicationLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationLinkWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public CommunicationLinkWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>CommunicationLink</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information.communication";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>CommunicationLink</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "CommunicationLink";
        ...
        /// <c>CommunicationLink</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/information/communication/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>CommunicationLink</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Communication.ICommunicationLink poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "exchangeItem", poco.ExchangeItem, poco, "ExchangeItem", context);
            WriteReferenceListAttribute(xmlWriter, "features", poco.Features, poco, "Features", context);
            WriteEnumAttribute<Auriga.Model.Information.Communication.CommunicationLinkKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.CommunicationLinkKindProvider.ToLiteralString);
            WriteEnumAttribute<Auriga.Model.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "protocol", poco.Protocol, Auriga.Extensions.CommunicationLinkProtocolProvider.ToLiteralString);
