...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Communication
{
    ...
    /// </summary>
    public class SignalWriter : XmiElementWriter<Auriga.Model.Information.Communication.ISignal>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Communication.ISignal poco, IXmiWriteContext context)
        {
