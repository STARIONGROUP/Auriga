...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Communication
{
    ...
    /// </summary>
    public class MessageReferenceWriter : XmiElementWriter<Auriga.Model.Information.Communication.IMessageReference>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Communication.IMessageReference poco, IXmiWriteContext context)
        {
