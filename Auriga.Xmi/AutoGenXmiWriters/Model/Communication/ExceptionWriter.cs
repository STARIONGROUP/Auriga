...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Communication
{
    ...
    /// </summary>
    public class ExceptionWriter : XmiElementWriter<Auriga.Model.Information.Communication.IException>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Communication.IException poco, IXmiWriteContext context)
        {
