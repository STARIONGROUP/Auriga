...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Communication
{
    ...
    /// </summary>
    public class MessageWriter : XmiElementWriter<Auriga.Model.Information.Communication.IMessage>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Communication.IMessage poco, IXmiWriteContext context)
        {
