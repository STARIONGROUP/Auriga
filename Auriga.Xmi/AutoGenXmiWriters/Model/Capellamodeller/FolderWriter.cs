...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellamodeller
{
    ...
    /// </summary>
    public class FolderWriter : XmiElementWriter<Auriga.Model.Capellamodeller.IFolder>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellamodeller.IFolder poco, IXmiWriteContext context)
        {
