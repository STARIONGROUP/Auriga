// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalChainWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>FunctionalChain</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class FunctionalChainWriter : XmiElementWriter<Auriga.Model.Fa.IFunctionalChain>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionalChainWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public FunctionalChainWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>FunctionalChain</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.fa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>FunctionalChain</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "FunctionalChain";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>FunctionalChain</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IFunctionalChain poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Fa.FunctionalChainKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.FunctionalChainKindProvider.ToLiteralString);
