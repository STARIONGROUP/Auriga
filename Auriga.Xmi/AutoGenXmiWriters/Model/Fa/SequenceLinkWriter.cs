...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class SequenceLinkWriter : XmiElementWriter<Auriga.Model.Fa.ISequenceLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.ISequenceLink poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "condition", poco.Condition, poco, "Condition", context);
