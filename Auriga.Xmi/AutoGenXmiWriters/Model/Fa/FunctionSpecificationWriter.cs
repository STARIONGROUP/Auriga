...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class FunctionSpecificationWriter : XmiElementWriter<Auriga.Model.Fa.IFunctionSpecification>
    {
        /// <summary>
        ...
        /// declares <c>FunctionSpecification</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.fa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>FunctionSpecification</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IFunctionSpecification poco, IXmiWriteContext context)
        {
