...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    public class ExchangeLinkWriter : XmiElementWriter<Auriga.Model.Fa.IExchangeLink>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IExchangeLink poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "destinations", poco.Destinations, poco, "Destinations", context);
            WriteReferenceListAttribute(xmlWriter, "exchangeContainmentLinks", poco.ExchangeContainmentLinks, poco, "ExchangeContainmentLinks", context);
            ...
            WriteReferenceListAttribute(xmlWriter, "sources", poco.Sources, poco, "Sources", context);
