// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeLinkWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ExchangeLink</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ExchangeLinkWriter : XmiElementWriter<Auriga.Model.Fa.IExchangeLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeLinkWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ExchangeLinkWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ExchangeLink</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.fa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ExchangeLink</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ExchangeLink";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ExchangeLink</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IExchangeLink poco, IXmiWriteContext context)
        {
            ...
            this.WriteReferenceListAttribute(xmlWriter, "destinations", poco.Destinations, poco, "Destinations", context);
            this.WriteReferenceListAttribute(xmlWriter, "exchangeContainmentLinks", poco.ExchangeContainmentLinks, poco, "ExchangeContainmentLinks", context);
            ...
            this.WriteReferenceListAttribute(xmlWriter, "sources", poco.Sources, poco, "Sources", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedExchangeContainments", poco.OwnedExchangeContainments, poco, "OwnedExchangeContainments", context);
