...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentPortWriter : XmiElementWriter<Auriga.Model.Fa.IComponentPort>
    {
        /// <summary>
        ...
        /// declares <c>ComponentPort</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.fa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ComponentPort</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IComponentPort poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Fa.ComponentPortKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.ComponentPortKindProvider.ToLiteralString);
            ...
            WriteEnumAttribute<Auriga.Model.Fa.OrientationPortKind>(xmlWriter, "orientation", poco.Orientation, Auriga.Extensions.OrientationPortKindProvider.ToLiteralString);
