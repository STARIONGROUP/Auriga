// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalChainInvolvementLinkWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>FunctionalChainInvolvementLink</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class FunctionalChainInvolvementLinkWriter : XmiElementWriter<Auriga.Model.Fa.IFunctionalChainInvolvementLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionalChainInvolvementLinkWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public FunctionalChainInvolvementLinkWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>FunctionalChainInvolvementLink</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.fa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>FunctionalChainInvolvementLink</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "FunctionalChainInvolvementLink";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/fa/7.0.0</c>) of the package that declares
        /// <c>FunctionalChainInvolvementLink</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/fa/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>FunctionalChainInvolvementLink</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IFunctionalChainInvolvementLink poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "exchangeContext", poco.ExchangeContext, poco, "ExchangeContext", context);
            WriteReferenceListAttribute(xmlWriter, "exchangedItems", poco.ExchangedItems, poco, "ExchangedItems", context);
            WriteReferenceListAttribute(xmlWriter, "features", poco.Features, poco, "Features", context);
            WriteReferenceAttribute(xmlWriter, "involved", poco.Involved, poco, "Involved", context);
            ...
            WriteReferenceListAttribute(xmlWriter, "sourceReferenceHierarchy", poco.SourceReferenceHierarchy, poco, "SourceReferenceHierarchy", context);
            ...
            WriteReferenceListAttribute(xmlWriter, "targetReferenceHierarchy", poco.TargetReferenceHierarchy, poco, "TargetReferenceHierarchy", context);
