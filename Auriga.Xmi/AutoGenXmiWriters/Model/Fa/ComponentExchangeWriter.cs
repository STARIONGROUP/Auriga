...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Fa
{
    ...
    /// </summary>
    public class ComponentExchangeWriter : XmiElementWriter<Auriga.Model.Fa.IComponentExchange>
    {
        /// <summary>
        ...
        /// declares <c>ComponentExchange</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.fa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ComponentExchange</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Fa.IComponentExchange poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Fa.ComponentExchangeKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.ComponentExchangeKindProvider.ToXmlLiteral);
