...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Libraries
{
    ...
    /// </summary>
    public class ModelInformationWriter : XmiElementWriter<Auriga.Model.Libraries.IModelInformation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Libraries.IModelInformation poco, IXmiWriteContext context)
        {
