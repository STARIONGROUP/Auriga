// ------------------------------------------------------------------------------------------------
// <copyright file="SharedPkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Sharedmodel
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>SharedPkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class SharedPkgWriter : XmiElementWriter<Auriga.Model.Sharedmodel.ISharedPkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedPkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public SharedPkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>SharedPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.sharedmodel";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>SharedPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "SharedPkg";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>SharedPkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Sharedmodel.ISharedPkg poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElement(xmlWriter, "ownedGenericPkg", poco.OwnedGenericPkg, poco, "OwnedGenericPkg", context);
