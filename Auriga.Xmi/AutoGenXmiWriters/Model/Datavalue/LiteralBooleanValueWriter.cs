...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class LiteralBooleanValueWriter : XmiElementWriter<Auriga.Model.Information.Datavalue.ILiteralBooleanValue>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Datavalue.ILiteralBooleanValue poco, IXmiWriteContext context)
        {
