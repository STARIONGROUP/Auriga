...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information.Datavalue
{
    ...
    /// </summary>
    public class LiteralNumericValueWriter : XmiElementWriter<Auriga.Model.Information.Datavalue.ILiteralNumericValue>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.Datavalue.ILiteralNumericValue poco, IXmiWriteContext context)
        {
