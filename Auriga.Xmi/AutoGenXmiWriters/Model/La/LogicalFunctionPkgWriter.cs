...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class LogicalFunctionPkgWriter : XmiElementWriter<Auriga.Model.La.ILogicalFunctionPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.ILogicalFunctionPkg poco, IXmiWriteContext context)
        {
