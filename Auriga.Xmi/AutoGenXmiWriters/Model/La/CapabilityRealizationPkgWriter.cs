...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class CapabilityRealizationPkgWriter : XmiElementWriter<Auriga.Model.La.ICapabilityRealizationPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.ICapabilityRealizationPkg poco, IXmiWriteContext context)
        {
