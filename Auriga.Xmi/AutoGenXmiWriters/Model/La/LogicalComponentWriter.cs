// ------------------------------------------------------------------------------------------------
// <copyright file="LogicalComponentWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>LogicalComponent</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class LogicalComponentWriter : XmiElementWriter<Auriga.Model.La.ILogicalComponent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogicalComponentWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public LogicalComponentWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>LogicalComponent</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.la";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>LogicalComponent</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "LogicalComponent";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/la/7.0.0</c>) of the package that declares
        /// <c>LogicalComponent</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/la/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>LogicalComponent</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.ILogicalComponent poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "inExchangeLinks", poco.InExchangeLinks, poco, "InExchangeLinks", context);
            WriteStringAttribute(xmlWriter, "name", poco.Name);
            WriteReferenceListAttribute(xmlWriter, "outExchangeLinks", poco.OutExchangeLinks, poco, "OutExchangeLinks", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedLogicalArchitectures", poco.OwnedLogicalArchitectures, poco, "OwnedLogicalArchitectures", context);
            this.WriteContainedElements(xmlWriter, "ownedLogicalComponentPkgs", poco.OwnedLogicalComponentPkgs, poco, "OwnedLogicalComponentPkgs", context);
            this.WriteContainedElements(xmlWriter, "ownedLogicalComponents", poco.OwnedLogicalComponents, poco, "OwnedLogicalComponents", context);
