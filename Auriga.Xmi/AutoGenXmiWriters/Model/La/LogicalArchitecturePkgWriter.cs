...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class LogicalArchitecturePkgWriter : XmiElementWriter<Auriga.Model.La.ILogicalArchitecturePkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.ILogicalArchitecturePkg poco, IXmiWriteContext context)
        {
