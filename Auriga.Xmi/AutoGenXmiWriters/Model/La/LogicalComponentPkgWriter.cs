...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class LogicalComponentPkgWriter : XmiElementWriter<Auriga.Model.La.ILogicalComponentPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.ILogicalComponentPkg poco, IXmiWriteContext context)
        {
