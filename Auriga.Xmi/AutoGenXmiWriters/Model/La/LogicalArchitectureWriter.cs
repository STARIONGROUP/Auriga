...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// </summary>
    public class LogicalArchitectureWriter : XmiElementWriter<Auriga.Model.La.ILogicalArchitecture>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.ILogicalArchitecture poco, IXmiWriteContext context)
        {
