// ------------------------------------------------------------------------------------------------
// <copyright file="ContextInterfaceRealizationWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.La
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ContextInterfaceRealization</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ContextInterfaceRealizationWriter : XmiElementWriter<Auriga.Model.La.IContextInterfaceRealization>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContextInterfaceRealizationWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ContextInterfaceRealizationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ContextInterfaceRealization</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.la";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ContextInterfaceRealization</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ContextInterfaceRealization";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/la/7.0.0</c>) of the package that declares
        /// <c>ContextInterfaceRealization</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/la/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ContextInterfaceRealization</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.La.IContextInterfaceRealization poco, IXmiWriteContext context)
        {
