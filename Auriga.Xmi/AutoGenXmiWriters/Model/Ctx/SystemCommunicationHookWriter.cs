...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemCommunicationHookWriter : XmiElementWriter<Auriga.Model.Ctx.ISystemCommunicationHook>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Ctx.ISystemCommunicationHook poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "communication", poco.Communication, poco, "Communication", context);
