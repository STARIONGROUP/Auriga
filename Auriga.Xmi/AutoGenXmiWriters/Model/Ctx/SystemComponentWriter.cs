...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Ctx
{
    ...
    /// </summary>
    public class SystemComponentWriter : XmiElementWriter<Auriga.Model.Ctx.ISystemComponent>
    {
        /// <summary>
        ...
        /// declares <c>SystemComponent</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.ctx";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>SystemComponent</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Ctx.ISystemComponent poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "dataType", poco.DataType, poco, "DataType", context);
