// ------------------------------------------------------------------------------------------------
// <copyright file="MissionWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Ctx
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Mission</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class MissionWriter : XmiElementWriter<Auriga.Model.Ctx.IMission>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MissionWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public MissionWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>Mission</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.ctx";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Mission</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Mission";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Mission</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Ctx.IMission poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElements(xmlWriter, "ownedCapabilityExploitations", poco.OwnedCapabilityExploitations, poco, "OwnedCapabilityExploitations", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedMissionInvolvements", poco.OwnedMissionInvolvements, poco, "OwnedMissionInvolvements", context);
