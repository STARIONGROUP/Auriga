// ------------------------------------------------------------------------------------------------
// <copyright file="MissionPkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Ctx
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>MissionPkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class MissionPkgWriter : XmiElementWriter<Auriga.Model.Ctx.IMissionPkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MissionPkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public MissionPkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>MissionPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.ctx";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>MissionPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "MissionPkg";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>MissionPkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Ctx.IMissionPkg poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElements(xmlWriter, "ownedMissionPkgs", poco.OwnedMissionPkgs, poco, "OwnedMissionPkgs", context);
            this.WriteContainedElements(xmlWriter, "ownedMissions", poco.OwnedMissions, poco, "OwnedMissions", context);
