...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Interaction
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>CombinedFragment</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class CombinedFragmentWriter : XmiElementWriter<Auriga.Model.Interaction.ICombinedFragment>
    {
        /// <summary>
        ...
        public CombinedFragmentWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>CombinedFragment</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.interaction";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>CombinedFragment</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "CombinedFragment";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/interaction/7.0.0</c>) of the package that declares
        /// <c>CombinedFragment</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/interaction/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>CombinedFragment</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Interaction.ICombinedFragment poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "referencedOperands", poco.ReferencedOperands, poco, "ReferencedOperands", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedGates", poco.OwnedGates, poco, "OwnedGates", context);
