...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Interaction
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>InteractionOperand</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class InteractionOperandWriter : XmiElementWriter<Auriga.Model.Interaction.IInteractionOperand>
    {
        /// <summary>
        ...
        public InteractionOperandWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>InteractionOperand</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.interaction";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>InteractionOperand</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "InteractionOperand";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/interaction/7.0.0</c>) of the package that declares
        /// <c>InteractionOperand</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/interaction/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>InteractionOperand</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Interaction.IInteractionOperand poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "referencedInteractionFragments", poco.ReferencedInteractionFragments, poco, "ReferencedInteractionFragments", context);
