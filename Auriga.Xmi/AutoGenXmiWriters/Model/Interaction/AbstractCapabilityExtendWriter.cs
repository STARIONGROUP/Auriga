...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Interaction
{
    ...
    public class AbstractCapabilityExtendWriter : XmiElementWriter<Auriga.Model.Interaction.IAbstractCapabilityExtend>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Interaction.IAbstractCapabilityExtend poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "extended", poco.Extended, poco, "Extended", context);
            WriteReferenceAttribute(xmlWriter, "extensionLocation", poco.ExtensionLocation, poco, "ExtensionLocation", context);
