...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class RefinementLinkWriter : XmiElementWriter<Auriga.Model.Interaction.IRefinementLink>
    {
        /// <summary>
        ...
        /// declares <c>RefinementLink</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.interaction";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>RefinementLink</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Interaction.IRefinementLink poco, IXmiWriteContext context)
        {
