...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>TimeEvent</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class TimeEventWriter : XmiElementWriter<Auriga.Model.Capellacommon.ITimeEvent>
    {
        /// <summary>
        ...
        public TimeEventWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>TimeEvent</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacommon";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>TimeEvent</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "TimeEvent";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>TimeEvent</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.ITimeEvent poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Capellacommon.TimeEventKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.TimeEventKindProvider.ToLiteralString);
