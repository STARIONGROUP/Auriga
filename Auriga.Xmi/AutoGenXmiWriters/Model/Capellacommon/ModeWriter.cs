// ------------------------------------------------------------------------------------------------
// <copyright file="ModeWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Mode</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ModeWriter : XmiElementWriter<Auriga.Model.Capellacommon.IMode>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModeWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ModeWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>Mode</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Mode";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Mode</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IMode poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "doActivity", poco.DoActivity, poco, "DoActivity", context);
            WriteReferenceListAttribute(xmlWriter, "entry", poco.Entry, poco, "Entry", context);
            WriteReferenceListAttribute(xmlWriter, "exit", poco.Exit, poco, "Exit", context);
