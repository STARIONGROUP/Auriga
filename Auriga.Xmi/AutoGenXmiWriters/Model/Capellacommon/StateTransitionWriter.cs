// ------------------------------------------------------------------------------------------------
// <copyright file="StateTransitionWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    using System.Xml;
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>StateTransition</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class StateTransitionWriter : XmiElementWriter<Auriga.Model.Capellacommon.IStateTransition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateTransitionWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public StateTransitionWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>StateTransition</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacommon";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>StateTransition</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "StateTransition";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>StateTransition</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IStateTransition poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "effect", poco.Effect, poco, "Effect", context);
            WriteReferenceListAttribute(xmlWriter, "features", poco.Features, poco, "Features", context);
            WriteReferenceAttribute(xmlWriter, "guard", poco.Guard, poco, "Guard", context);
            ...
            WriteStringAttribute(xmlWriter, "triggerDescription", poco.TriggerDescription);
            WriteReferenceListAttribute(xmlWriter, "triggers", poco.Triggers, poco, "Triggers", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedStateTransitionRealizations", poco.OwnedStateTransitionRealizations, poco, "OwnedStateTransitionRealizations", context);
