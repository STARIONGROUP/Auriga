...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class RegionWriter : XmiElementWriter<Auriga.Model.Capellacommon.IRegion>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IRegion poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "involvedStates", poco.InvolvedStates, poco, "InvolvedStates", context);
