...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ChangeEvent</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ChangeEventWriter : XmiElementWriter<Auriga.Model.Capellacommon.IChangeEvent>
    {
        /// <summary>
        ...
        public ChangeEventWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ChangeEvent</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacommon";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ChangeEvent</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ChangeEvent";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ChangeEvent</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IChangeEvent poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "expression", poco.Expression, poco, "Expression", context);
            WriteReferenceListAttribute(xmlWriter, "features", poco.Features, poco, "Features", context);
            WriteEnumAttribute<Auriga.Model.Capellacommon.ChangeEventKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.ChangeEventKindProvider.ToLiteralString);
            ...
            this.WriteContainedElements(xmlWriter, "ownedStateEventRealizations", poco.OwnedStateEventRealizations, poco, "OwnedStateEventRealizations", context);
