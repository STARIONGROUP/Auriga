...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>StateMachine</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class StateMachineWriter : XmiElementWriter<Auriga.Model.Capellacommon.IStateMachine>
    {
        /// <summary>
        ...
        public StateMachineWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>StateMachine</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacommon";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>StateMachine</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "StateMachine";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>StateMachine</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IStateMachine poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "ownedParameter", poco.OwnedParameter, poco, "OwnedParameter", context);
            WriteReferenceListAttribute(xmlWriter, "ownedParameterSet", poco.OwnedParameterSet, poco, "OwnedParameterSet", context);
