...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class StateWriter : XmiElementWriter<Auriga.Model.Capellacommon.IState>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>State</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IState poco, IXmiWriteContext context)
        {
