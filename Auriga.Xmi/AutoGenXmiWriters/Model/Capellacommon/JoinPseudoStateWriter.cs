// ------------------------------------------------------------------------------------------------
// <copyright file="JoinPseudoStateWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>JoinPseudoState</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class JoinPseudoStateWriter : XmiElementWriter<Auriga.Model.Capellacommon.IJoinPseudoState>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JoinPseudoStateWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public JoinPseudoStateWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>JoinPseudoState</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacommon";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>JoinPseudoState</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "JoinPseudoState";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>JoinPseudoState</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IJoinPseudoState poco, IXmiWriteContext context)
        {
