// ------------------------------------------------------------------------------------------------
// <copyright file="StateEventRealizationWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacommon
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>StateEventRealization</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class StateEventRealizationWriter : XmiElementWriter<Auriga.Model.Capellacommon.IStateEventRealization>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateEventRealizationWriter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>StateEventRealization</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacommon.IStateEventRealization poco, IXmiWriteContext context)
        {
