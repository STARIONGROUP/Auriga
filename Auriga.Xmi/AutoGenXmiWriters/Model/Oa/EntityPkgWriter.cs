...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class EntityPkgWriter : XmiElementWriter<Auriga.Model.Oa.IEntityPkg>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IEntityPkg poco, IXmiWriteContext context)
        {
