// ------------------------------------------------------------------------------------------------
// <copyright file="EntityWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Entity</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class EntityWriter : XmiElementWriter<Auriga.Model.Oa.IEntity>
    {
        /// <summary>
        ...
        public EntityWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>Entity</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Entity</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IEntity poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteBooleanAttribute(xmlWriter, "abstract", poco.Abstract);
            WriteBooleanAttribute(xmlWriter, "actor", poco.Actor, false);
            WriteReferenceAttribute(xmlWriter, "actualLocation", poco.ActualLocation, poco, "ActualLocation", context);
            ...
            WriteReferenceListAttribute(xmlWriter, "composingLinks", poco.ComposingLinks, poco, "ComposingLinks", context);
            ...
            WriteReferenceListAttribute(xmlWriter, "organisationalUnitMemberships", poco.OrganisationalUnitMemberships, poco, "OrganisationalUnitMemberships", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedRoleAllocations", poco.OwnedRoleAllocations, poco, "OwnedRoleAllocations", context);
