...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    public class EntityWriter : XmiElementWriter<Auriga.Model.Oa.IEntity>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IEntity poco, IXmiWriteContext context)
        {
            ...
            this.WriteReferenceAttribute(xmlWriter, "actualLocation", poco.ActualLocation, poco, "ActualLocation", context);
            ...
            this.WriteReferenceListAttribute(xmlWriter, "organisationalUnitMemberships", poco.OrganisationalUnitMemberships, poco, "OrganisationalUnitMemberships", context);
