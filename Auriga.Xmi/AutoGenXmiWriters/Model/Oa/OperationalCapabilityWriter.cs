// ------------------------------------------------------------------------------------------------
// <copyright file="OperationalCapabilityWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>OperationalCapability</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class OperationalCapabilityWriter : XmiElementWriter<Auriga.Model.Oa.IOperationalCapability>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalCapabilityWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public OperationalCapabilityWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>OperationalCapability</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.oa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>OperationalCapability</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "OperationalCapability";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/oa/7.0.0</c>) of the package that declares
        /// <c>OperationalCapability</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/oa/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>OperationalCapability</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IOperationalCapability poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "availableInStates", poco.AvailableInStates, poco, "AvailableInStates", context);
            WriteReferenceListAttribute(xmlWriter, "compliances", poco.Compliances, poco, "Compliances", context);
            WriteReferenceListAttribute(xmlWriter, "configurations", poco.Configurations, poco, "Configurations", context);
            WriteStringAttribute(xmlWriter, "description", poco.Description);
            WriteReferenceListAttribute(xmlWriter, "features", poco.Features, poco, "Features", context);
            WriteStringAttribute(xmlWriter, "name", poco.Name);
            WriteReferenceAttribute(xmlWriter, "postCondition", poco.PostCondition, poco, "PostCondition", context);
            WriteReferenceAttribute(xmlWriter, "preCondition", poco.PreCondition, poco, "PreCondition", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedEntityOperationalCapabilityInvolvements", poco.OwnedEntityOperationalCapabilityInvolvements, poco, "OwnedEntityOperationalCapabilityInvolvements", context);
