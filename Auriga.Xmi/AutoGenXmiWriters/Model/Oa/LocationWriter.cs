// ------------------------------------------------------------------------------------------------
// <copyright file="LocationWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Location</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class LocationWriter : XmiElementWriter<Auriga.Model.Oa.ILocation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public LocationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>Location</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.oa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Location</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Location</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.ILocation poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceListAttribute(xmlWriter, "locatedEntities", poco.LocatedEntities, poco, "LocatedEntities", context);
            WriteStringAttribute(xmlWriter, "locationDescription", poco.LocationDescription);
