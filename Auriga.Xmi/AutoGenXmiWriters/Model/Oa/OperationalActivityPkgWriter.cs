// ------------------------------------------------------------------------------------------------
// <copyright file="OperationalActivityPkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>OperationalActivityPkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class OperationalActivityPkgWriter : XmiElementWriter<Auriga.Model.Oa.IOperationalActivityPkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalActivityPkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public OperationalActivityPkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>OperationalActivityPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.oa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>OperationalActivityPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "OperationalActivityPkg";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/oa/7.0.0</c>) of the package that declares
        /// <c>OperationalActivityPkg</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/oa/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>OperationalActivityPkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IOperationalActivityPkg poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElements(xmlWriter, "ownedCategories", poco.OwnedCategories, poco, "OwnedCategories", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedExchangeSpecificationRealizations", poco.OwnedExchangeSpecificationRealizations, poco, "OwnedExchangeSpecificationRealizations", context);
            this.WriteContainedElements(xmlWriter, "ownedExchanges", poco.OwnedExchanges, poco, "OwnedExchanges", context);
            this.WriteContainedElements(xmlWriter, "ownedExtensions", poco.OwnedExtensions, poco, "OwnedExtensions", context);
            this.WriteContainedElements(xmlWriter, "ownedFunctionSpecifications", poco.OwnedFunctionSpecifications, poco, "OwnedFunctionSpecifications", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedOperationalActivities", poco.OwnedOperationalActivities, poco, "OwnedOperationalActivities", context);
            this.WriteContainedElements(xmlWriter, "ownedOperationalActivityPkgs", poco.OwnedOperationalActivityPkgs, poco, "OwnedOperationalActivityPkgs", context);
