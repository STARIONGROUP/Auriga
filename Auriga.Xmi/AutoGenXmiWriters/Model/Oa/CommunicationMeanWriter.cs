...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class CommunicationMeanWriter : XmiElementWriter<Auriga.Model.Oa.ICommunicationMean>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.ICommunicationMean poco, IXmiWriteContext context)
        {
