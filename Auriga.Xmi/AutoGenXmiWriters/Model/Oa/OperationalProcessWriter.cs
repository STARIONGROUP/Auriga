...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    /// </summary>
    public class OperationalProcessWriter : XmiElementWriter<Auriga.Model.Oa.IOperationalProcess>
    {
        /// <summary>
        ...
        /// declares <c>OperationalProcess</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.oa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>OperationalProcess</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IOperationalProcess poco, IXmiWriteContext context)
        {
