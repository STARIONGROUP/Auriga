...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Oa
{
    ...
    public class OrganisationalUnitCompositionWriter : XmiElementWriter<Auriga.Model.Oa.IOrganisationalUnitComposition>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Oa.IOrganisationalUnitComposition poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "organisationalUnit", poco.OrganisationalUnit, poco, "OrganisationalUnit", context);
            WriteReferenceAttribute(xmlWriter, "participatingEntity", poco.ParticipatingEntity, poco, "ParticipatingEntity", context);
