// ------------------------------------------------------------------------------------------------
// <copyright file="MassWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Mass
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Mass</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class MassWriter : XmiElementWriter<Auriga.Model.Mass.IMass>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MassWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public MassWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>Mass</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Mass";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Mass</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Mass.IMass poco, IXmiWriteContext context)
        {
