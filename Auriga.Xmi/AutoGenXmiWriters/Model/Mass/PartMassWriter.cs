// ------------------------------------------------------------------------------------------------
// <copyright file="PartMassWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Mass
{
    using System.Xml;
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PartMass</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PartMassWriter : XmiElementWriter<Auriga.Model.Mass.IPartMass>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartMassWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PartMassWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
            : base(facade, loggerFactory)
        {
        }

        /// <summary>
        /// Gets the Capella <c>xmlns</c> prefix (<c>mass</c>) of the package that
        /// declares <c>PartMass</c>.
        /// </summary>
        public override string NamespacePrefix => "mass";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PartMass</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PartMass";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/mass</c>) of the package that declares
        /// <c>PartMass</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/mass";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PartMass</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Mass.IPartMass poco, IXmiWriteContext context)
        {
            ...
            WriteIntegerAttribute(xmlWriter, "maxValue", poco.MaxValue);
            WriteIntegerAttribute(xmlWriter, "minValue", poco.MinValue);
