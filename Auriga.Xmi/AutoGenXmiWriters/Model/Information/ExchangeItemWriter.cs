// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeItemWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ExchangeItem</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ExchangeItemWriter : XmiElementWriter<Auriga.Model.Information.IExchangeItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeItemWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ExchangeItemWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ExchangeItem</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ExchangeItem</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ExchangeItem";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ExchangeItem</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.IExchangeItem poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Information.ExchangeMechanism>(xmlWriter, "exchangeMechanism", poco.ExchangeMechanism, Auriga.Extensions.ExchangeMechanismProvider.ToLiteralString);
            ...
            this.WriteContainedElements(xmlWriter, "ownedExchangeItemInstances", poco.OwnedExchangeItemInstances, poco, "OwnedExchangeItemInstances", context);
