...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information
{
    ...
    public class ParameterWriter : XmiElementWriter<Auriga.Model.Information.IParameter>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.IParameter poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Modellingcore.ParameterEffectKind>(xmlWriter, "effect", poco.Effect, Auriga.Extensions.ParameterEffectKindProvider.ToXmlLiteral);
            ...
            WriteEnumAttribute<Auriga.Model.Information.PassingMode>(xmlWriter, "passingMode", poco.PassingMode, Auriga.Extensions.PassingModeProvider.ToXmlLiteral);
