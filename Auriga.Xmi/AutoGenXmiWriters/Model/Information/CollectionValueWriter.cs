// ------------------------------------------------------------------------------------------------
// <copyright file="CollectionValueWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>CollectionValue</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class CollectionValueWriter : XmiElementWriter<Auriga.Model.Information.ICollectionValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionValueWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public CollectionValueWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>CollectionValue</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>CollectionValue</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "CollectionValue";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>CollectionValue</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.ICollectionValue poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElement(xmlWriter, "ownedDefaultElement", poco.OwnedDefaultElement, poco, "OwnedDefaultElement", context);
