...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class ServiceWriter : XmiElementWriter<Auriga.Model.Information.IService>
    {
        /// <summary>
        ...
        /// declares <c>Service</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Service</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.IService poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Information.SynchronismKind>(xmlWriter, "synchronismKind", poco.SynchronismKind, Auriga.Extensions.SynchronismKindProvider.ToXmlLiteral);
