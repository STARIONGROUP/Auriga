...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Information
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Property</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PropertyWriter : XmiElementWriter<Auriga.Model.Information.IProperty>
    {
        /// <summary>
        ...
        public PropertyWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>Property</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.information";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Property</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Property</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Information.IProperty poco, IXmiWriteContext context)
        {
