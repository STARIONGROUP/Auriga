...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacore
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Generalization</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class GeneralizationWriter : XmiElementWriter<Auriga.Model.Capellacore.IGeneralization>
    {
        /// <summary>
        ...
        public GeneralizationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>Generalization</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacore";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>Generalization</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Generalization";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Generalization</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacore.IGeneralization poco, IXmiWriteContext context)
        {
            ...
            this.WriteReferenceAttribute(xmlWriter, "sub", poco.Sub, poco, "Sub", context);
            WriteStringAttribute(xmlWriter, "summary", poco.Summary);
            this.WriteReferenceAttribute(xmlWriter, "super", poco.Super, poco, "Super", context);
