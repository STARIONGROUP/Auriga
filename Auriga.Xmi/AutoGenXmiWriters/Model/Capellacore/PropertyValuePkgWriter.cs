// ------------------------------------------------------------------------------------------------
// <copyright file="PropertyValuePkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Capellacore
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PropertyValuePkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PropertyValuePkgWriter : XmiElementWriter<Auriga.Model.Capellacore.IPropertyValuePkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValuePkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PropertyValuePkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>PropertyValuePkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.capellacore";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PropertyValuePkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PropertyValuePkg";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/core/7.0.0</c>) of the package that declares
        /// <c>PropertyValuePkg</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/core/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PropertyValuePkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Capellacore.IPropertyValuePkg poco, IXmiWriteContext context)
        {
