// ------------------------------------------------------------------------------------------------
// <copyright file="SystemNonFunctionalRequirementWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirement
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>SystemNonFunctionalRequirement</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class SystemNonFunctionalRequirementWriter : XmiElementWriter<Auriga.Model.Requirement.ISystemNonFunctionalRequirement>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemNonFunctionalRequirementWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public SystemNonFunctionalRequirementWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>SystemNonFunctionalRequirement</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.basic.requirement";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>SystemNonFunctionalRequirement</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "SystemNonFunctionalRequirement";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/basic/requirement</c>) of the package that declares
        /// <c>SystemNonFunctionalRequirement</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/basic/requirement";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>SystemNonFunctionalRequirement</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirement.ISystemNonFunctionalRequirement poco, IXmiWriteContext context)
        {
