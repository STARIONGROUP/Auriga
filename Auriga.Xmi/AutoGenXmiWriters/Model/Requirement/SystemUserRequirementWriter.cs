// ------------------------------------------------------------------------------------------------
// <copyright file="SystemUserRequirementWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirement
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>SystemUserRequirement</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class SystemUserRequirementWriter : XmiElementWriter<Auriga.Model.Requirement.ISystemUserRequirement>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemUserRequirementWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public SystemUserRequirementWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>SystemUserRequirement</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.basic.requirement";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>SystemUserRequirement</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "SystemUserRequirement";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/basic/requirement</c>) of the package that declares
        /// <c>SystemUserRequirement</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/basic/requirement";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>SystemUserRequirement</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirement.ISystemUserRequirement poco, IXmiWriteContext context)
        {
