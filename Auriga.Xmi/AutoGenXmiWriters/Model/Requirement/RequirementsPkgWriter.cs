// ------------------------------------------------------------------------------------------------
// <copyright file="RequirementsPkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirement
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>RequirementsPkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class RequirementsPkgWriter : XmiElementWriter<Auriga.Model.Requirement.IRequirementsPkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequirementsPkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public RequirementsPkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>RequirementsPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.basic.requirement";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>RequirementsPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "RequirementsPkg";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>RequirementsPkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirement.IRequirementsPkg poco, IXmiWriteContext context)
        {
            ...
            WriteStringAttribute(xmlWriter, "level", poco.Level);
            ...
            this.WriteContainedElements(xmlWriter, "ownedRequirementPkgs", poco.OwnedRequirementPkgs, poco, "OwnedRequirementPkgs", context);
