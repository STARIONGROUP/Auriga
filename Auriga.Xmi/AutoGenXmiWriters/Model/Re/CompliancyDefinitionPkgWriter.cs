...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Re
{
    ...
    /// </summary>
    public class CompliancyDefinitionPkgWriter : XmiElementWriter<Auriga.Model.Re.ICompliancyDefinitionPkg>
    {
        /// <summary>
        ...
        /// declares <c>CompliancyDefinitionPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "re";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>CompliancyDefinitionPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Re.ICompliancyDefinitionPkg poco, IXmiWriteContext context)
        {
