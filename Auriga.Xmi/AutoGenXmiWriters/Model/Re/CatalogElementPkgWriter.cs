...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Re
{
    ...
    /// </summary>
    public class CatalogElementPkgWriter : XmiElementWriter<Auriga.Model.Re.ICatalogElementPkg>
    {
        /// <summary>
        ...
        /// declares <c>CatalogElementPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "re";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>CatalogElementPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Re.ICatalogElementPkg poco, IXmiWriteContext context)
        {
