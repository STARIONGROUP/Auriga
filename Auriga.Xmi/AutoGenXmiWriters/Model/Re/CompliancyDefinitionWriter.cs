...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Re
{
    ...
    /// </summary>
    public class CompliancyDefinitionWriter : XmiElementWriter<Auriga.Model.Re.ICompliancyDefinition>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Re.ICompliancyDefinition poco, IXmiWriteContext context)
        {
