...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Re
{
    ...
    /// </summary>
    public class RecCatalogWriter : XmiElementWriter<Auriga.Model.Re.IRecCatalog>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Re.IRecCatalog poco, IXmiWriteContext context)
        {
