...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Re
{
    ...
    /// </summary>
    public class CatalogElementLinkWriter : XmiElementWriter<Auriga.Model.Re.ICatalogElementLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Re.ICatalogElementLink poco, IXmiWriteContext context)
        {
            ...
            WriteStringListElements(xmlWriter, "unsynchronizedFeatures", poco.UnsynchronizedFeatures);
        }
    }
}
