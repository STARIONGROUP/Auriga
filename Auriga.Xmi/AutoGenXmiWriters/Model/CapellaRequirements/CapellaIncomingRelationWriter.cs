...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.CapellaRequirements
{
    ...
    /// </summary>
    public class CapellaIncomingRelationWriter : XmiElementWriter<Auriga.Model.CapellaRequirements.ICapellaIncomingRelation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.CapellaRequirements.ICapellaIncomingRelation poco, IXmiWriteContext context)
        {
