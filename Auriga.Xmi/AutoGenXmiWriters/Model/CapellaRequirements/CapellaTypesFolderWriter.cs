...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.CapellaRequirements
{
    ...
    /// </summary>
    public class CapellaTypesFolderWriter : XmiElementWriter<Auriga.Model.CapellaRequirements.ICapellaTypesFolder>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.CapellaRequirements.ICapellaTypesFolder poco, IXmiWriteContext context)
        {
