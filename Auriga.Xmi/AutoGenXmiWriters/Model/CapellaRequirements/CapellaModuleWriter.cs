...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.CapellaRequirements
{
    ...
    /// </summary>
    public class CapellaModuleWriter : XmiElementWriter<Auriga.Model.CapellaRequirements.ICapellaModule>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.CapellaRequirements.ICapellaModule poco, IXmiWriteContext context)
        {
