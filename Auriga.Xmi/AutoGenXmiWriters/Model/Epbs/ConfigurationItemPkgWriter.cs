// ------------------------------------------------------------------------------------------------
// <copyright file="ConfigurationItemPkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Epbs
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ConfigurationItemPkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ConfigurationItemPkgWriter : XmiElementWriter<Auriga.Model.Epbs.IConfigurationItemPkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationItemPkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ConfigurationItemPkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ConfigurationItemPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.epbs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ConfigurationItemPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ConfigurationItemPkg";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/epbs/7.0.0</c>) of the package that declares
        /// <c>ConfigurationItemPkg</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/epbs/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ConfigurationItemPkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Epbs.IConfigurationItemPkg poco, IXmiWriteContext context)
        {
