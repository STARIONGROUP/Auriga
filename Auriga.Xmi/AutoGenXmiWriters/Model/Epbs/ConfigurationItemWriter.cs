...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Epbs
{
    ...
    /// </summary>
    public class ConfigurationItemWriter : XmiElementWriter<Auriga.Model.Epbs.IConfigurationItem>
    {
        /// <summary>
        ...
        /// declares <c>ConfigurationItem</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.epbs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ConfigurationItem</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Epbs.IConfigurationItem poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Epbs.ConfigurationItemKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.ConfigurationItemKindProvider.ToLiteralString, Auriga.Model.Epbs.ConfigurationItemKind.Unset);
