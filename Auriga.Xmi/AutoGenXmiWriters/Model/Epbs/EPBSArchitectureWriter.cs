...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Epbs
{
    ...
    /// </summary>
    public class EPBSArchitectureWriter : XmiElementWriter<Auriga.Model.Epbs.IEPBSArchitecture>
    {
        /// <summary>
        ...
        /// declares <c>EPBSArchitecture</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.epbs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>EPBSArchitecture</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Epbs.IEPBSArchitecture poco, IXmiWriteContext context)
        {
