// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalArchitectureRealizationWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Epbs
{
    using System.Xml;
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PhysicalArchitectureRealization</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PhysicalArchitectureRealizationWriter : XmiElementWriter<Auriga.Model.Epbs.IPhysicalArchitectureRealization>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalArchitectureRealizationWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PhysicalArchitectureRealizationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
            : base(facade, loggerFactory)
        {
        }

        /// <summary>
        /// Gets the Capella <c>xmlns</c> prefix (<c>org.polarsys.capella.core.data.epbs</c>) of the package that
        /// declares <c>PhysicalArchitectureRealization</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.epbs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PhysicalArchitectureRealization</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PhysicalArchitectureRealization";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/epbs/7.0.0</c>) of the package that declares
        /// <c>PhysicalArchitectureRealization</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/epbs/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PhysicalArchitectureRealization</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Epbs.IPhysicalArchitectureRealization poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "sourceElement", poco.SourceElement, poco, "SourceElement", context);
            WriteReferenceAttribute(xmlWriter, "status", poco.Status, poco, "Status", context);
            WriteStringAttribute(xmlWriter, "summary", poco.Summary);
            WriteReferenceAttribute(xmlWriter, "targetElement", poco.TargetElement, poco, "TargetElement", context);
