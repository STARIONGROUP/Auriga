// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalPrimaryAssetWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>FunctionalPrimaryAsset</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class FunctionalPrimaryAssetWriter : XmiElementWriter<Auriga.Model.Cybersecurity.IFunctionalPrimaryAsset>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionalPrimaryAssetWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public FunctionalPrimaryAssetWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>FunctionalPrimaryAsset</c>.
        /// </summary>
        public override string NamespacePrefix => "cybersecurity";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>FunctionalPrimaryAsset</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "FunctionalPrimaryAsset";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/cybersecurity/1.0</c>) of the package that declares
        /// <c>FunctionalPrimaryAsset</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/cybersecurity/1.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>FunctionalPrimaryAsset</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cybersecurity.IFunctionalPrimaryAsset poco, IXmiWriteContext context)
        {
