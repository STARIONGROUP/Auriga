// ------------------------------------------------------------------------------------------------
// <copyright file="EnterprisePrimaryAssetWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>EnterprisePrimaryAsset</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class EnterprisePrimaryAssetWriter : XmiElementWriter<Auriga.Model.Cybersecurity.IEnterprisePrimaryAsset>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterprisePrimaryAssetWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public EnterprisePrimaryAssetWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>EnterprisePrimaryAsset</c>.
        /// </summary>
        public override string NamespacePrefix => "cybersecurity";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>EnterprisePrimaryAsset</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "EnterprisePrimaryAsset";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/cybersecurity/1.0</c>) of the package that declares
        /// <c>EnterprisePrimaryAsset</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/cybersecurity/1.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>EnterprisePrimaryAsset</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cybersecurity.IEnterprisePrimaryAsset poco, IXmiWriteContext context)
        {
