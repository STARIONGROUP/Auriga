// ------------------------------------------------------------------------------------------------
// <copyright file="ThreatWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>Threat</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ThreatWriter : XmiElementWriter<Auriga.Model.Cybersecurity.IThreat>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThreatWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ThreatWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// <summary>
        /// Gets the unqualified XMI type name (<c>Threat</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "Threat";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>Threat</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cybersecurity.IThreat poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteReferenceListAttribute(xmlWriter, "addressedBy", poco.AddressedBy, poco, "AddressedBy", context);
            ...
            WriteReferenceAttribute(xmlWriter, "kind", poco.Kind, poco, "Kind", context);
            WriteIntegerAttribute(xmlWriter, "level", poco.Level);
            ...
            WriteStringAttribute(xmlWriter, "rationale", poco.Rationale);
            ...
            this.WriteContainedElements(xmlWriter, "ownedThreatApplications", poco.OwnedThreatApplications, poco, "OwnedThreatApplications", context);
            this.WriteContainedElements(xmlWriter, "ownedThreatInvolvements", poco.OwnedThreatInvolvements, poco, "OwnedThreatInvolvements", context);
