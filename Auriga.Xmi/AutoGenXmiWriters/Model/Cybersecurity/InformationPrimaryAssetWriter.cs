// ------------------------------------------------------------------------------------------------
// <copyright file="InformationPrimaryAssetWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cybersecurity
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>InformationPrimaryAsset</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class InformationPrimaryAssetWriter : XmiElementWriter<Auriga.Model.Cybersecurity.IInformationPrimaryAsset>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InformationPrimaryAssetWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public InformationPrimaryAssetWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>InformationPrimaryAsset</c>.
        /// </summary>
        public override string NamespacePrefix => "cybersecurity";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>InformationPrimaryAsset</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "InformationPrimaryAsset";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/cybersecurity/1.0</c>) of the package that declares
        /// <c>InformationPrimaryAsset</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/cybersecurity/1.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>InformationPrimaryAsset</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cybersecurity.IInformationPrimaryAsset poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElements(xmlWriter, "ownedMembers", poco.OwnedMembers, poco, "OwnedMembers", context);
