...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class DataTypeDefinitionWriter : XmiElementWriter<Auriga.Model.Requirements.IDataTypeDefinition>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirements.IDataTypeDefinition poco, IXmiWriteContext context)
        {
