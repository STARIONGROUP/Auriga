...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class IntegerValueAttributeWriter : XmiElementWriter<Auriga.Model.Requirements.IIntegerValueAttribute>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirements.IIntegerValueAttribute poco, IXmiWriteContext context)
        {
