...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class StringValueAttributeWriter : XmiElementWriter<Auriga.Model.Requirements.IStringValueAttribute>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirements.IStringValueAttribute poco, IXmiWriteContext context)
        {
