...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class EnumerationValueAttributeWriter : XmiElementWriter<Auriga.Model.Requirements.IEnumerationValueAttribute>
    {
        /// <summary>
        ...
        /// declares <c>EnumerationValueAttribute</c>.
        /// </summary>
        public override string NamespacePrefix => "Requirements";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>EnumerationValueAttribute</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
