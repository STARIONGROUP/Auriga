...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class DateValueAttributeWriter : XmiElementWriter<Auriga.Model.Requirements.IDateValueAttribute>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirements.IDateValueAttribute poco, IXmiWriteContext context)
        {
