...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class AttributeDefinitionWriter : XmiElementWriter<Auriga.Model.Requirements.IAttributeDefinition>
    {
        /// <summary>
        ...
        /// declares <c>AttributeDefinition</c>.
        /// </summary>
        public override string NamespacePrefix => "Requirements";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>AttributeDefinition</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirements.IAttributeDefinition poco, IXmiWriteContext context)
        {
