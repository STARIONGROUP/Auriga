...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class RequirementWriter : XmiElementWriter<Auriga.Model.Requirements.IRequirement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Requirements.IRequirement poco, IXmiWriteContext context)
        {
