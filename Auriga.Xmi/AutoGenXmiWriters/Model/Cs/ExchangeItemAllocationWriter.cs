// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeItemAllocationWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cs
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ExchangeItemAllocation</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ExchangeItemAllocationWriter : XmiElementWriter<Auriga.Model.Cs.IExchangeItemAllocation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeItemAllocationWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ExchangeItemAllocationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ExchangeItemAllocation</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.cs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ExchangeItemAllocation</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ExchangeItemAllocation";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/cs/7.0.0</c>) of the package that declares
        /// <c>ExchangeItemAllocation</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/cs/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ExchangeItemAllocation</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cs.IExchangeItemAllocation poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "receiveProtocol", poco.ReceiveProtocol, Auriga.Extensions.CommunicationLinkProtocolProvider.ToXmlLiteral);
            WriteStringAttribute(xmlWriter, "review", poco.Review);
            WriteEnumAttribute<Auriga.Model.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "sendProtocol", poco.SendProtocol, Auriga.Extensions.CommunicationLinkProtocolProvider.ToXmlLiteral);
