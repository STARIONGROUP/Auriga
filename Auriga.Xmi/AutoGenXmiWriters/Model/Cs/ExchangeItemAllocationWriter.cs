...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cs
{
    ...
    public class ExchangeItemAllocationWriter : XmiElementWriter<Auriga.Model.Cs.IExchangeItemAllocation>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cs.IExchangeItemAllocation poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "receiveProtocol", poco.ReceiveProtocol);
            WriteStringAttribute(xmlWriter, "review", poco.Review);
            WriteEnumAttribute<Auriga.Model.Information.Communication.CommunicationLinkProtocol>(xmlWriter, "sendProtocol", poco.SendProtocol);
