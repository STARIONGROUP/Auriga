// ------------------------------------------------------------------------------------------------
// <copyright file="InterfaceUseWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cs
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>InterfaceUse</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class InterfaceUseWriter : XmiElementWriter<Auriga.Model.Cs.IInterfaceUse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceUseWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public InterfaceUseWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>InterfaceUse</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.cs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>InterfaceUse</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "InterfaceUse";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>InterfaceUse</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cs.IInterfaceUse poco, IXmiWriteContext context)
        {
            ...
            this.WriteReferenceAttribute(xmlWriter, "usedInterface", poco.UsedInterface, poco, "UsedInterface", context);
