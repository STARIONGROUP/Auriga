// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalPathWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Cs
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PhysicalPath</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PhysicalPathWriter : XmiElementWriter<Auriga.Model.Cs.IPhysicalPath>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalPathWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PhysicalPathWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>PhysicalPath</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.cs";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PhysicalPath</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PhysicalPath";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PhysicalPath</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Cs.IPhysicalPath poco, IXmiWriteContext context)
        {
            ...
            this.WriteReferenceListAttribute(xmlWriter, "involvedLinks", poco.InvolvedLinks, poco, "InvolvedLinks", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedComponentExchangeAllocations", poco.OwnedComponentExchangeAllocations, poco, "OwnedComponentExchangeAllocations", context);
            ...
            this.WriteContainedElements(xmlWriter, "ownedPhysicalPathInvolvements", poco.OwnedPhysicalPathInvolvements, poco, "OwnedPhysicalPathInvolvements", context);
            this.WriteContainedElements(xmlWriter, "ownedPhysicalPathRealizations", poco.OwnedPhysicalPathRealizations, poco, "OwnedPhysicalPathRealizations", context);
