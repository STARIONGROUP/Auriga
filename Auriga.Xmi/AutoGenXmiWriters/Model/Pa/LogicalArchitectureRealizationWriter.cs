// ------------------------------------------------------------------------------------------------
// <copyright file="LogicalArchitectureRealizationWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>LogicalArchitectureRealization</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class LogicalArchitectureRealizationWriter : XmiElementWriter<Auriga.Model.Pa.ILogicalArchitectureRealization>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogicalArchitectureRealizationWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public LogicalArchitectureRealizationWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>LogicalArchitectureRealization</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.pa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>LogicalArchitectureRealization</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "LogicalArchitectureRealization";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/pa/7.0.0</c>) of the package that declares
        /// <c>LogicalArchitectureRealization</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/pa/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>LogicalArchitectureRealization</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.ILogicalArchitectureRealization poco, IXmiWriteContext context)
        {
