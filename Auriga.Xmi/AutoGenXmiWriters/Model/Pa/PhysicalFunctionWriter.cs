// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalFunctionWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PhysicalFunction</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PhysicalFunctionWriter : XmiElementWriter<Auriga.Model.Pa.IPhysicalFunction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalFunctionWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PhysicalFunctionWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>PhysicalFunction</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.pa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PhysicalFunction</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PhysicalFunction";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/pa/7.0.0</c>) of the package that declares
        /// <c>PhysicalFunction</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/pa/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PhysicalFunction</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.IPhysicalFunction poco, IXmiWriteContext context)
        {
            ...
            WriteReferenceAttribute(xmlWriter, "behavior", poco.Behavior, poco, "Behavior", context);
            WriteStringAttribute(xmlWriter, "condition", poco.Condition);
            WriteReferenceAttribute(xmlWriter, "context", poco.Context, poco, "Context", context);
            ...
            WriteEnumAttribute<Auriga.Model.Fa.FunctionKind>(xmlWriter, "kind", poco.Kind, Auriga.Extensions.FunctionKindProvider.ToLiteralString);
