// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalFunctionPkgWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa
{
    using System.Xml;
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PhysicalFunctionPkg</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PhysicalFunctionPkgWriter : XmiElementWriter<Auriga.Model.Pa.IPhysicalFunctionPkg>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalFunctionPkgWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PhysicalFunctionPkgWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>PhysicalFunctionPkg</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.pa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PhysicalFunctionPkg</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PhysicalFunctionPkg";

        /// <summary>
        /// Gets the namespace URI (<c>http://www.polarsys.org/capella/core/pa/7.0.0</c>) of the package that declares
        /// <c>PhysicalFunctionPkg</c>.
        /// </summary>
        public override string NamespaceUri => "http://www.polarsys.org/capella/core/pa/7.0.0";

        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PhysicalFunctionPkg</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.IPhysicalFunctionPkg poco, IXmiWriteContext context)
        {
            ...
            this.WriteContainedElements(xmlWriter, "ownedPhysicalFunctionPkgs", poco.OwnedPhysicalFunctionPkgs, poco, "OwnedPhysicalFunctionPkgs", context);
            this.WriteContainedElements(xmlWriter, "ownedPhysicalFunctions", poco.OwnedPhysicalFunctions, poco, "OwnedPhysicalFunctions", context);
