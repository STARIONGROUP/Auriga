...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa
{
    ...
    public class PhysicalNodeWriter : XmiElementWriter<Auriga.Model.Pa.IPhysicalNode>
    {
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.IPhysicalNode poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Model.Pa.PhysicalComponentKind>(xmlWriter, "kind", poco.Kind);
            WriteStringAttribute(xmlWriter, "name", poco.Name);
            WriteEnumAttribute<Auriga.Model.Pa.PhysicalComponentNature>(xmlWriter, "nature", poco.Nature);
