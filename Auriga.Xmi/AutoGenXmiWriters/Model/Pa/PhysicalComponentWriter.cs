...
namespace Auriga.Xmi.Model.AutoGenXmiWriters.Pa
{
    ...
    /// </summary>
    public class PhysicalComponentWriter : XmiElementWriter<Auriga.Model.Pa.IPhysicalComponent>
    {
        /// <summary>
        ...
        /// declares <c>PhysicalComponent</c>.
        /// </summary>
        public override string NamespacePrefix => "org.polarsys.capella.core.data.pa";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PhysicalComponent</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Model.Pa.IPhysicalComponent poco, IXmiWriteContext context)
        {
