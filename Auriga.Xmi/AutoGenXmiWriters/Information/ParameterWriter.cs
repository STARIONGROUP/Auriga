...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class ParameterWriter : XmiElementWriter<Auriga.Information.IParameter>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IParameter poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Information.ParameterDirection>(xmlWriter, "direction", poco.Direction);
            WriteEnumAttribute<Auriga.Information.PassingMode>(xmlWriter, "passingMode", poco.PassingMode);
            ...
            WriteEnumAttribute<Auriga.Modellingcore.ParameterEffectKind>(xmlWriter, "effect", poco.Effect);
