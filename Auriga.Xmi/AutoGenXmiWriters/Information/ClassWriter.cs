...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class ClassWriter : XmiElementWriter<Auriga.Information.IClass>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IClass poco, IXmiWriteContext context)
        {
