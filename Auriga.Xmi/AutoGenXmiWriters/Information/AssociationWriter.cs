...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class AssociationWriter : XmiElementWriter<Auriga.Information.IAssociation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IAssociation poco, IXmiWriteContext context)
        {
