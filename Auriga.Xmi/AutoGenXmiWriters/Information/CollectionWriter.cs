...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class CollectionWriter : XmiElementWriter<Auriga.Information.ICollection>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.ICollection poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Information.CollectionKind>(xmlWriter, "kind", poco.Kind);
