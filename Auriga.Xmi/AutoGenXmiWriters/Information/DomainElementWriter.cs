...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class DomainElementWriter : XmiElementWriter<Auriga.Information.IDomainElement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IDomainElement poco, IXmiWriteContext context)
        {
