...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class ExchangeItemInstanceWriter : XmiElementWriter<Auriga.Information.IExchangeItemInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IExchangeItemInstance poco, IXmiWriteContext context)
        {
