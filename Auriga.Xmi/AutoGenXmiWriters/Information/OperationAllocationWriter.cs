...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class OperationAllocationWriter : XmiElementWriter<Auriga.Information.IOperationAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IOperationAllocation poco, IXmiWriteContext context)
        {
