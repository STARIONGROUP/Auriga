...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class PropertyWriter : XmiElementWriter<Auriga.Information.IProperty>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IProperty poco, IXmiWriteContext context)
        {
