...
namespace Auriga.Xmi.AutoGenXmiWriters.Information
{
    ...
    /// </summary>
    public class PortAllocationWriter : XmiElementWriter<Auriga.Information.IPortAllocation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.IPortAllocation poco, IXmiWriteContext context)
        {
