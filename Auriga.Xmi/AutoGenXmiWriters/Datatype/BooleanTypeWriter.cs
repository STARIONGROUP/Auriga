...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datatype
{
    ...
    /// </summary>
    public class BooleanTypeWriter : XmiElementWriter<Auriga.Information.Datatype.IBooleanType>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datatype.IBooleanType poco, IXmiWriteContext context)
        {
