...
namespace Auriga.Xmi.AutoGenXmiWriters.Information.Datatype
{
    ...
    /// </summary>
    public class StringTypeWriter : XmiElementWriter<Auriga.Information.Datatype.IStringType>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Information.Datatype.IStringType poco, IXmiWriteContext context)
        {
