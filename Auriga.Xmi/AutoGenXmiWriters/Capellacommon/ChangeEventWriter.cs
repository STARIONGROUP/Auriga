...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class ChangeEventWriter : XmiElementWriter<Auriga.Capellacommon.IChangeEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IChangeEvent poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Capellacommon.ChangeEventKind>(xmlWriter, "kind", poco.Kind);
