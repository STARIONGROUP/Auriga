...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class StateTransitionWriter : XmiElementWriter<Auriga.Capellacommon.IStateTransition>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IStateTransition poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Capellacommon.TransitionKind>(xmlWriter, "kind", poco.Kind);
