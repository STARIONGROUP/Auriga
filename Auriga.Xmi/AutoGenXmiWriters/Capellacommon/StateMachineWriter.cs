...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class StateMachineWriter : XmiElementWriter<Auriga.Capellacommon.IStateMachine>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IStateMachine poco, IXmiWriteContext context)
        {
