...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class TimeEventWriter : XmiElementWriter<Auriga.Capellacommon.ITimeEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.ITimeEvent poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Capellacommon.TimeEventKind>(xmlWriter, "kind", poco.Kind);
