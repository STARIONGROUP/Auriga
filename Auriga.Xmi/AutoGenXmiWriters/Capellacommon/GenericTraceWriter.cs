...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class GenericTraceWriter : XmiElementWriter<Auriga.Capellacommon.IGenericTrace>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IGenericTrace poco, IXmiWriteContext context)
        {
