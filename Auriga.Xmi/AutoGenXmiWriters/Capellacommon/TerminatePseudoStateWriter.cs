...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class TerminatePseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.ITerminatePseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.ITerminatePseudoState poco, IXmiWriteContext context)
        {
