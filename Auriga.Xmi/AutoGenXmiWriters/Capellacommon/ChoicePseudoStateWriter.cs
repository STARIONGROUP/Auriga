...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class ChoicePseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IChoicePseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IChoicePseudoState poco, IXmiWriteContext context)
        {
