...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class EntryPointPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IEntryPointPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IEntryPointPseudoState poco, IXmiWriteContext context)
        {
