...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class CapabilityRealizationInvolvementWriter : XmiElementWriter<Auriga.Capellacommon.ICapabilityRealizationInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.ICapabilityRealizationInvolvement poco, IXmiWriteContext context)
        {
