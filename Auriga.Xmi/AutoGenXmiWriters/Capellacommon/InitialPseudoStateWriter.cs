...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class InitialPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IInitialPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IInitialPseudoState poco, IXmiWriteContext context)
        {
