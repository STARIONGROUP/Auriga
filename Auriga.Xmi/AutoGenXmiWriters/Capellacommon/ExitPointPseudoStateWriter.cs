...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class ExitPointPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IExitPointPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IExitPointPseudoState poco, IXmiWriteContext context)
        {
