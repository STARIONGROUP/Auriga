...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class StateTransitionRealizationWriter : XmiElementWriter<Auriga.Capellacommon.IStateTransitionRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IStateTransitionRealization poco, IXmiWriteContext context)
        {
