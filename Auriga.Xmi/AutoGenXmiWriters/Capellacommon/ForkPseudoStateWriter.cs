...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class ForkPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IForkPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IForkPseudoState poco, IXmiWriteContext context)
        {
