...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class JoinPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IJoinPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IJoinPseudoState poco, IXmiWriteContext context)
        {
