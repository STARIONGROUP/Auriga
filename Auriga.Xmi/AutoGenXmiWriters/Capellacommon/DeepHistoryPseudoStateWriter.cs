...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class DeepHistoryPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IDeepHistoryPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IDeepHistoryPseudoState poco, IXmiWriteContext context)
        {
