...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class ShallowHistoryPseudoStateWriter : XmiElementWriter<Auriga.Capellacommon.IShallowHistoryPseudoState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IShallowHistoryPseudoState poco, IXmiWriteContext context)
        {
