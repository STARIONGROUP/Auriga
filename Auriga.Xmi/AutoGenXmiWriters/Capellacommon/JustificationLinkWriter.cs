...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class JustificationLinkWriter : XmiElementWriter<Auriga.Capellacommon.IJustificationLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IJustificationLink poco, IXmiWriteContext context)
        {
