...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class ModeWriter : XmiElementWriter<Auriga.Capellacommon.IMode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IMode poco, IXmiWriteContext context)
        {
