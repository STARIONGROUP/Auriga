...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class AbstractStateRealizationWriter : XmiElementWriter<Auriga.Capellacommon.IAbstractStateRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.IAbstractStateRealization poco, IXmiWriteContext context)
        {
