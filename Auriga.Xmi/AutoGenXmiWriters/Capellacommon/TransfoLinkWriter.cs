...
namespace Auriga.Xmi.AutoGenXmiWriters.Capellacommon
{
    ...
    /// </summary>
    public class TransfoLinkWriter : XmiElementWriter<Auriga.Capellacommon.ITransfoLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Capellacommon.ITransfoLink poco, IXmiWriteContext context)
        {
