...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class CreationEventWriter : XmiElementWriter<Auriga.Interaction.ICreationEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.ICreationEvent poco, IXmiWriteContext context)
        {
