...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class FragmentEndWriter : XmiElementWriter<Auriga.Interaction.IFragmentEnd>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IFragmentEnd poco, IXmiWriteContext context)
        {
