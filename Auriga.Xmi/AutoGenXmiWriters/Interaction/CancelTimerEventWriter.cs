...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class CancelTimerEventWriter : XmiElementWriter<Auriga.Interaction.ICancelTimerEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.ICancelTimerEvent poco, IXmiWriteContext context)
        {
