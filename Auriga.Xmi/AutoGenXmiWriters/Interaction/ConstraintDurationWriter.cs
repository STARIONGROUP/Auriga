...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class ConstraintDurationWriter : XmiElementWriter<Auriga.Interaction.IConstraintDuration>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IConstraintDuration poco, IXmiWriteContext context)
        {
