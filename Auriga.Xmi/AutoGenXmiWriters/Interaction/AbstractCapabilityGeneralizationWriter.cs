...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityGeneralizationWriter : XmiElementWriter<Auriga.Interaction.IAbstractCapabilityGeneralization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IAbstractCapabilityGeneralization poco, IXmiWriteContext context)
        {
