...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class EventReceiptOperationWriter : XmiElementWriter<Auriga.Interaction.IEventReceiptOperation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IEventReceiptOperation poco, IXmiWriteContext context)
        {
