...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class ScenarioRealizationWriter : XmiElementWriter<Auriga.Interaction.IScenarioRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IScenarioRealization poco, IXmiWriteContext context)
        {
