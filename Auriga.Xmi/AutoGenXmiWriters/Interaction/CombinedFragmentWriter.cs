...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class CombinedFragmentWriter : XmiElementWriter<Auriga.Interaction.ICombinedFragment>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.ICombinedFragment poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Interaction.InteractionOperatorKind>(xmlWriter, "operator", poco.Operator);
