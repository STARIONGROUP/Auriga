...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityRealizationWriter : XmiElementWriter<Auriga.Interaction.IAbstractCapabilityRealization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IAbstractCapabilityRealization poco, IXmiWriteContext context)
        {
