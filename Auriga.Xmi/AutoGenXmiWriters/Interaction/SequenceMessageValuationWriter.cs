...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class SequenceMessageValuationWriter : XmiElementWriter<Auriga.Interaction.ISequenceMessageValuation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.ISequenceMessageValuation poco, IXmiWriteContext context)
        {
