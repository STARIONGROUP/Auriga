...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityIncludeWriter : XmiElementWriter<Auriga.Interaction.IAbstractCapabilityInclude>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IAbstractCapabilityInclude poco, IXmiWriteContext context)
        {
