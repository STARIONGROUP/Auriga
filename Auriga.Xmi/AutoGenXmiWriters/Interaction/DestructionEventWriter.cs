...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class DestructionEventWriter : XmiElementWriter<Auriga.Interaction.IDestructionEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IDestructionEvent poco, IXmiWriteContext context)
        {
