...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class InstanceRoleWriter : XmiElementWriter<Auriga.Interaction.IInstanceRole>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IInstanceRole poco, IXmiWriteContext context)
        {
