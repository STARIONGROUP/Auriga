...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class FunctionalChainAbstractCapabilityInvolvementWriter : XmiElementWriter<Auriga.Interaction.IFunctionalChainAbstractCapabilityInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IFunctionalChainAbstractCapabilityInvolvement poco, IXmiWriteContext context)
        {
