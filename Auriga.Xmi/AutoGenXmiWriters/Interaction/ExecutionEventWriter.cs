...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class ExecutionEventWriter : XmiElementWriter<Auriga.Interaction.IExecutionEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IExecutionEvent poco, IXmiWriteContext context)
        {
