...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class InteractionUseWriter : XmiElementWriter<Auriga.Interaction.IInteractionUse>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IInteractionUse poco, IXmiWriteContext context)
        {
