...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class EventSentOperationWriter : XmiElementWriter<Auriga.Interaction.IEventSentOperation>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IEventSentOperation poco, IXmiWriteContext context)
        {
