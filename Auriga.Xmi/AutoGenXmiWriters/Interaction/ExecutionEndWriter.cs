...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class ExecutionEndWriter : XmiElementWriter<Auriga.Interaction.IExecutionEnd>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IExecutionEnd poco, IXmiWriteContext context)
        {
