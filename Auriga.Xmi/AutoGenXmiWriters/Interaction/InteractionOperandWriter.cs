...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class InteractionOperandWriter : XmiElementWriter<Auriga.Interaction.IInteractionOperand>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IInteractionOperand poco, IXmiWriteContext context)
        {
