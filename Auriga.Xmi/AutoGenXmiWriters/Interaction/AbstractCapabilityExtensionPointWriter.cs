...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class AbstractCapabilityExtensionPointWriter : XmiElementWriter<Auriga.Interaction.IAbstractCapabilityExtensionPoint>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IAbstractCapabilityExtensionPoint poco, IXmiWriteContext context)
        {
