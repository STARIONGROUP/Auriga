...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class AbstractFunctionAbstractCapabilityInvolvementWriter : XmiElementWriter<Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement poco, IXmiWriteContext context)
        {
