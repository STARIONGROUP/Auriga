...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class MergeLinkWriter : XmiElementWriter<Auriga.Interaction.IMergeLink>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IMergeLink poco, IXmiWriteContext context)
        {
