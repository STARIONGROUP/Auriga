...
namespace Auriga.Xmi.AutoGenXmiWriters.Interaction
{
    ...
    /// </summary>
    public class ArmTimerEventWriter : XmiElementWriter<Auriga.Interaction.IArmTimerEvent>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Interaction.IArmTimerEvent poco, IXmiWriteContext context)
        {
