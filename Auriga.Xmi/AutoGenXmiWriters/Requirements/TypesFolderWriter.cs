...
namespace Auriga.Xmi.AutoGenXmiWriters.Requirements
{
    ...
    /// </summary>
    public class TypesFolderWriter : XmiElementWriter<Auriga.Requirements.ITypesFolder>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Requirements.ITypesFolder poco, IXmiWriteContext context)
        {
