...
namespace Auriga.Xmi
{
    ...
    using Auriga.Xmi.Diagram.AutoGenXmiReaders;
    ...
    public sealed class SiriusXmiReaderBuilder
    {
        ...
        /// <c>.airdfragment</c> documents into the <c>Auriga.Diagram</c> object model.
        /// </summary>
        ...
        public IXmiReader Build()
        {
            ...
            var referenceResolver = new Auriga.Xmi.Core.ReferenceResolver.ReferenceResolver(this.loggerFactory);
