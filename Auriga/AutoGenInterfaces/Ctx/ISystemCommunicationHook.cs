...
namespace Auriga.Ctx
{
    ...
    /// </summary>
    public partial interface ISystemCommunicationHook : Auriga.Capellacore.INamedElement
    {
        /// <summary>
        /// Gets or sets the communication.
        /// </summary>
        Auriga.Ctx.ISystemCommunication Communication { get; set; }

        /// <summary>
        /// Gets or sets the type.
        /// </summary>
        Auriga.Cs.IComponent Type { get; set; }
