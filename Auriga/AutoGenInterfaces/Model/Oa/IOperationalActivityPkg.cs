...
namespace Auriga.Model.Oa
{
    ...
    /// </summary>
    public partial interface IOperationalActivityPkg : Auriga.Model.Fa.IFunctionPkg
    {
        /// <summary>
        /// Gets the owned operational activities.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Model.Oa.IOperationalActivity> OwnedOperationalActivities { get; }
