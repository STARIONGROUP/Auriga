...
namespace Auriga.Model.Capellacore
{
    ...
    /// </summary>
    public partial interface IInvolvedElement : Auriga.Model.Capellacore.ICapellaElement
    {
        /// <summary>
        /// Gets the involving involvements.
        /// </summary>
        IEnumerable<Auriga.Model.Capellacore.IInvolvement> InvolvingInvolvements { get; }
