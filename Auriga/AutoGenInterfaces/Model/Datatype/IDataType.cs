...
namespace Auriga.Model.Information.Datatype
{
    ...
    /// </summary>
    public partial interface IDataType : Auriga.Model.Capellacore.IGeneralizableElement, Auriga.Model.Information.Datavalue.IDataValueContainer, Auriga.Model.Modellingcore.IFinalizableElement
    {
        /// <summary>
        /// Gets the default value.
        /// </summary>
        Auriga.Model.Information.Datavalue.IDataValue DefaultValue { get; }
        ...
        /// Gets the null value.
        /// </summary>
        Auriga.Model.Information.Datavalue.IDataValue NullValue { get; }
        ...
        /// </summary>
        IEnumerable<Auriga.Model.Information.Datatype.IDataType> RealizedDataTypes { get; }

        /// <summary>
        /// Gets the realizing data types.
        /// </summary>
        IEnumerable<Auriga.Model.Information.Datatype.IDataType> RealizingDataTypes { get; }
