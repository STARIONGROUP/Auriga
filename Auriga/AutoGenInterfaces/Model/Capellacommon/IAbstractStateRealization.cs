...
namespace Auriga.Model.Capellacommon
{
    ...
    /// </summary>
    public partial interface IAbstractStateRealization : Auriga.Model.Capellacore.IAllocation
    {
        /// <summary>
        /// Gets the realized abstract state.
        /// </summary>
        Auriga.Model.Capellacommon.IAbstractState RealizedAbstractState { get; }

        /// <summary>
        /// Gets the realizing abstract state.
        /// </summary>
        Auriga.Model.Capellacommon.IAbstractState RealizingAbstractState { get; }
