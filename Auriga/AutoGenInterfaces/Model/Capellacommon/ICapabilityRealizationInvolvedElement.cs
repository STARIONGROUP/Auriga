...
namespace Auriga.Model.Capellacommon
{
    ...
    /// </summary>
    public partial interface ICapabilityRealizationInvolvedElement : Auriga.Model.Capellacore.IInvolvedElement
    {
        /// <summary>
        /// Gets the capability realization involvements.
        /// </summary>
        IEnumerable<Auriga.Model.Capellacommon.ICapabilityRealizationInvolvement> CapabilityRealizationInvolvements { get; }
