...
namespace Auriga.Model.Activity
{
    ...
    /// </summary>
    public partial interface IActivityExchange : Auriga.Model.Modellingcore.IAbstractInformationFlow
    {
        /// <summary>
        /// Gets the realizing activity flows.
        /// </summary>
        IEnumerable<Auriga.Model.Activity.IActivityEdge> RealizingActivityFlows { get; }
