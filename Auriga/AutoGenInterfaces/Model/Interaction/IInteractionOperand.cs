...
namespace Auriga.Model.Interaction
{
    ...
    /// </summary>
    public partial interface IInteractionOperand : Auriga.Model.Interaction.IInteractionFragment
    {
        /// <summary>
        ...
        /// </summary>
        List<Auriga.Model.Interaction.IInteractionFragment> ReferencedInteractionFragments { get; }
