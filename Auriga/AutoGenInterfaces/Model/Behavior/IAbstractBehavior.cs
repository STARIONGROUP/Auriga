...
namespace Auriga.Model.Behavior
{
    ...
    /// </summary>
    public partial interface IAbstractBehavior : Auriga.Model.Modellingcore.IAbstractNamedElement
    {
        /// <summary>
        ...
        /// </summary>
        List<Auriga.Model.Modellingcore.IAbstractParameter> OwnedParameter { get; }

        /// <summary>
        /// Gets the owned parameter set.
        /// </summary>
        List<Auriga.Model.Modellingcore.IAbstractParameterSet> OwnedParameterSet { get; }
