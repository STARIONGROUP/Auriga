...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial interface IAbstractPhysicalArtifact : Auriga.Model.Capellacore.ICapellaElement
    {
        /// <summary>
        /// Gets the allocator configuration items.
        /// </summary>
        IEnumerable<Auriga.Model.Epbs.IConfigurationItem> AllocatorConfigurationItems { get; }
