...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial interface IArchitectureAllocation : Auriga.Model.Capellacore.IAllocation
    {
        /// <summary>
        /// Gets the allocated architecture.
        /// </summary>
        Auriga.Model.Cs.IBlockArchitecture AllocatedArchitecture { get; }

        /// <summary>
        /// Gets the allocating architecture.
        /// </summary>
        Auriga.Model.Cs.IBlockArchitecture AllocatingArchitecture { get; }
