...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial interface IComponentRealization : Auriga.Model.Capellacore.IAllocation
    {
        /// <summary>
        /// Gets the realized component.
        /// </summary>
        Auriga.Model.Cs.IComponent RealizedComponent { get; }

        /// <summary>
        /// Gets the realizing component.
        /// </summary>
        Auriga.Model.Cs.IComponent RealizingComponent { get; }
