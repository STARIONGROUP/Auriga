...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial interface IInterfaceUse : Auriga.Model.Capellacore.IRelationship
    {
        /// <summary>
        /// Gets the interface user.
        /// </summary>
        Auriga.Model.Cs.IComponent InterfaceUser { get; }

        /// <summary>
        /// Gets or sets the used interface.
        /// </summary>
        Auriga.Model.Cs.IInterface UsedInterface { get; set; }
