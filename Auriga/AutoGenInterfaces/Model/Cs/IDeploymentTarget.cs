...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial interface IDeploymentTarget : Auriga.Model.Capellacore.INamedElement
    {
        /// <summary>
        /// Gets the deployment links.
        /// </summary>
        IEnumerable<Auriga.Model.Cs.IAbstractDeploymentLink> DeploymentLinks { get; }
