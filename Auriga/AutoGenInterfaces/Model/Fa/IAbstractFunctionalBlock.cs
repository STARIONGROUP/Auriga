...
namespace Auriga.Model.Fa
{
    ...
    /// </summary>
    public partial interface IAbstractFunctionalBlock : Auriga.Model.Capellacore.IModellingBlock
    {
        /// <summary>
        /// Gets the allocated functions.
        /// </summary>
        IEnumerable<Auriga.Model.Fa.IAbstractFunction> AllocatedFunctions { get; }

        /// <summary>
        /// Gets the functional allocations.
        /// </summary>
        IEnumerable<Auriga.Model.Fa.IComponentFunctionalAllocation> FunctionalAllocations { get; }

        /// <summary>
        /// Gets the in exchange links.
        /// </summary>
        List<Auriga.Model.Fa.IExchangeLink> InExchangeLinks { get; }

        /// <summary>
        /// Gets the out exchange links.
        /// </summary>
        List<Auriga.Model.Fa.IExchangeLink> OutExchangeLinks { get; }
        ...
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Model.Fa.IComponentFunctionalAllocation> OwnedFunctionalAllocation { get; }
