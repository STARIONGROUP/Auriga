...
namespace Auriga.Model.Fa
{
    ...
    public partial interface IReferenceHierarchyContext : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        List<Auriga.Model.Fa.IFunctionalChainReference> SourceReferenceHierarchy { get; }

        /// <summary>
        /// Gets the target reference hierarchy.
        /// </summary>
        List<Auriga.Model.Fa.IFunctionalChainReference> TargetReferenceHierarchy { get; }
