...
namespace Auriga.Model.Fa
{
    ...
    /// </summary>
    public partial interface IFunctionalExchangeRealization : Auriga.Model.Capellacore.IAllocation
    {
        /// <summary>
        /// Gets the realized functional exchange.
        /// </summary>
        Auriga.Model.Fa.IFunctionalExchange RealizedFunctionalExchange { get; }

        /// <summary>
        /// Gets the realizing functional exchange.
        /// </summary>
        Auriga.Model.Fa.IFunctionalExchange RealizingFunctionalExchange { get; }
