...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial interface IInteractionUse : Auriga.Interaction.IAbstractFragment
    {
        /// <summary>
        /// Gets the actual gates.
        /// </summary>
        IEnumerable<Auriga.Interaction.IGate> ActualGates { get; }

        /// <summary>
        /// Gets or sets the referenced scenario.
        /// </summary>
        Auriga.Interaction.IScenario ReferencedScenario { get; set; }
