...
namespace Auriga.Libraries
{
    ...
    /// </summary>
    public partial interface ILibraryReference : Auriga.Libraries.ILibraryAbstractElement
    {
        /// <summary>
        /// Gets or sets the access policy.
        /// </summary>
        Auriga.Libraries.AccessPolicy AccessPolicy { get; set; }

        /// <summary>
        /// Gets or sets the library.
        /// </summary>
        Auriga.Libraries.IModelInformation Library { get; set; }
