...
namespace Auriga.Diagram.Sequence.Template
{
    ...
    /// </summary>
    public partial interface ITReturnMessageMapping : Auriga.Diagram.Sequence.Template.ITMessageMapping
    {
        /// <summary>
        /// Gets or sets the invocation mapping.
        /// </summary>
        Auriga.Diagram.Sequence.Template.ITBasicMessageMapping InvocationMapping { get; set; }
