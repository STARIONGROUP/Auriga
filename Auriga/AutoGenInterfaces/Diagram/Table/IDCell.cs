...
namespace Auriga.Diagram.Table
{
    ...
    /// </summary>
    public partial interface IDCell : Auriga.Diagram.Viewpoint.IDSemanticDecorator, Auriga.Diagram.Table.IDTableElement
    {
        /// <summary>
        /// Gets or sets the column.
        /// </summary>
        Auriga.Diagram.Table.IDColumn Column { get; set; }
        ...
        /// </summary>
        Auriga.Diagram.Table.IDCellStyle CurrentStyle { get; set; }

        /// <summary>
        /// Gets or sets the intersection mapping.
        /// </summary>
        Auriga.Diagram.Table.Description.IIntersectionMapping IntersectionMapping { get; set; }
        ...
        /// </summary>
        Auriga.Diagram.Table.IDLine Line { get; set; }

        /// <summary>
        /// Gets the updater.
        /// </summary>
        Auriga.Diagram.Table.Description.ICellUpdater Updater { get; }
