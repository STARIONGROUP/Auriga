...
namespace Auriga.Diagram.Table
{
    ...
    /// </summary>
    public partial interface IDLine : Auriga.Diagram.Table.ILineContainer, Auriga.Diagram.Table.IDTableElement
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Table.IDCell> Cells { get; }
        ...
        /// </summary>
        Auriga.Diagram.Table.Description.ILineMapping OriginMapping { get; set; }
