...
namespace Auriga.Diagram.Table
{
    ...
    /// </summary>
    public partial interface IDCellStyle : Auriga.Diagram.Table.IDTableElementStyle
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Diagram.Table.Description.ITableMapping BackgroundStyleOrigin { get; set; }
        ...
        /// This TableMapping can be only an IntersectionMapping or a  ColumnMapping.
        /// </summary>
        Auriga.Diagram.Table.Description.ITableMapping ForegroundStyleOrigin { get; set; }
