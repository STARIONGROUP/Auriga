...
namespace Auriga.Diagram.Diagram.Description.Tool
{
    ...
    /// </summary>
    public partial interface IDoubleClickDescription : Auriga.Diagram.Viewpoint.Description.Tool.IMappingBasedToolDescription
    {
        /// <summary>
        /// The semantic element of the ViewPointElement to delete.
        /// </summary>
        Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable Element { get; set; }

        /// <summary>
        /// Gets or sets the element view.
        /// </summary>
        Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable ElementView { get; set; }
