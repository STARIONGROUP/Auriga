...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface IToolFilterDescription : Auriga.Core.IAurigaElement
    {
        /// <summary>
        ...
        /// Gets the listeners.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IFeatureChangeListener> Listeners { get; }
