// ------------------------------------------------------------------------------------------------
// <copyright file="ICoveringElementCreationTool.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Description.Tool
{
    ...
    public partial interface ICoveringElementCreationTool : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        Auriga.Diagram.Sequence.Description.ICoveredLifelinesVariable CoveredLifelines { get; set; }
