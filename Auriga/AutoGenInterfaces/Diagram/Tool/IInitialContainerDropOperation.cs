// ------------------------------------------------------------------------------------------------
// <copyright file="IInitialContainerDropOperation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    public partial interface IInitialContainerDropOperation : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Tool.IModelOperation FirstModelOperations { get; set; }
