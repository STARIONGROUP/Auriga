...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface IGroupMenu : Auriga.Diagram.Viewpoint.Description.Tool.IMenuItemDescription
    {
        /// <summary>
        /// Gets the item descriptions.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenuItem> ItemDescriptions { get; }
