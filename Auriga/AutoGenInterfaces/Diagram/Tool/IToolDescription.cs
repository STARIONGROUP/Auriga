...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface IToolDescription : Auriga.Diagram.Viewpoint.Description.Tool.IMappingBasedToolDescription
    {
        /// <summary>
        /// The variable container that represents the semantic element of the clicked view.
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable Element { get; set; }

        /// <summary>
        /// The variable that represents the clicked view.
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Tool.IElementViewVariable ElementView { get; set; }
