...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial interface ISwitch : Auriga.Diagram.Viewpoint.Description.Tool.IModelOperation
    {
        /// <summary>
        /// Gets the cases.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.ICase> Cases { get; }

        /// <summary>
        /// Gets or sets the default.
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Tool.IDefault Default { get; set; }
