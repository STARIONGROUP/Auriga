...
namespace Auriga.Diagram.Diagram.Description.Tool
{
    ...
    /// </summary>
    public partial interface IContainerCreationDescription : Auriga.Diagram.Viewpoint.Description.Tool.IMappingBasedToolDescription
    {
        /// <summary>
        /// The ContainerMapping to use.
        /// </summary>
        List<Auriga.Diagram.Diagram.Description.IContainerMapping> ContainerMappings { get; }

        /// <summary>
        /// All mappings that create views that are able to received a request to manage this creation
        /// </summary>
        List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping> ExtraMappings { get; }
        ...
        /// The first operation.
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Tool.IInitialNodeCreationOperation InitialOperation { get; set; }

        /// <summary>
        /// The semantic element of the cicked view.
        /// </summary>
        Auriga.Diagram.Diagram.Description.Tool.INodeCreationVariable Variable { get; set; }

        /// <summary>
        /// The clicked view (instance of ViewPoint or ViewNodeContainer).
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable ViewVariable { get; set; }
