// ------------------------------------------------------------------------------------------------
// <copyright file="IVariableContainer.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    public partial interface IVariableContainer : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.ISubVariable> SubVariables { get; }
