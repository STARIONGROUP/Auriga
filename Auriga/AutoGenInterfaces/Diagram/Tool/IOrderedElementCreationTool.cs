...
namespace Auriga.Diagram.Sequence.Description.Tool
{
    ...
    public partial interface IOrderedElementCreationTool : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        Auriga.Diagram.Sequence.Description.IMessageEndVariable FinishingEndPredecessor { get; set; }

        /// <summary>
        /// Gets or sets the starting end predecessor.
        /// </summary>
        Auriga.Diagram.Sequence.Description.IMessageEndVariable StartingEndPredecessor { get; set; }
