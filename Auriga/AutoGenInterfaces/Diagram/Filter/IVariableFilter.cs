...
namespace Auriga.Diagram.Diagram.Description.Filter
{
    ...
    /// </summary>
    public partial interface IVariableFilter : Auriga.Diagram.Diagram.Description.Filter.IFilter
    {
        /// <summary>
        /// Gets the owned variables.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.IInteractiveVariableDescription> OwnedVariables { get; }
