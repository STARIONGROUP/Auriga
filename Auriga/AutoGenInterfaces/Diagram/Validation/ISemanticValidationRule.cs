// ------------------------------------------------------------------------------------------------
// <copyright file="ISemanticValidationRule.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description.Validation
{
    ...
    /// </summary>
    public partial interface ISemanticValidationRule : Auriga.Diagram.Viewpoint.Description.Validation.IValidationRule
    {
        /// <summary>
