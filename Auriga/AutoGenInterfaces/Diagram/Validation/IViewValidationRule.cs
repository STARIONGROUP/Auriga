...
namespace Auriga.Diagram.Viewpoint.Description.Validation
{
    ...
    /// </summary>
    public partial interface IViewValidationRule : Auriga.Diagram.Viewpoint.Description.Validation.IValidationRule
    {
        /// <summary>
        /// The mapping to validate.
        /// </summary>
        List<Auriga.Diagram.Viewpoint.Description.IRepresentationElementMapping> Targets { get; }
