...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial interface IDiagramElementMapping : Auriga.Diagram.Viewpoint.Description.IRepresentationElementMapping, Auriga.Diagram.Viewpoint.Description.IPasteTargetDescription
    {
        /// <summary>
        ...
        /// </summary>
        Auriga.Diagram.Diagram.Description.Tool.IDeleteElementDescription DeletionDescription { get; set; }

        /// <summary>
        /// Gets or sets the double click description.
        /// </summary>
        Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription DoubleClickDescription { get; set; }

        /// <summary>
        /// The tool that describes what to do when the user edits the label of the elements.
        /// </summary>
        Auriga.Diagram.Diagram.Description.Tool.IDirectEditLabel LabelDirectEdit { get; set; }
