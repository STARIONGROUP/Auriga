...
namespace Auriga.Diagram.Viewpoint.Description
{
    ...
    public partial interface IDecorationDescription : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.DecorationDistributionDirection DistributionDirection { get; set; }
        ...
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.Position Position { get; set; }
