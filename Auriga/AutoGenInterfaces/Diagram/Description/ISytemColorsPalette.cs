// ------------------------------------------------------------------------------------------------
// <copyright file="ISytemColorsPalette.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description
{
    ...
    public partial interface ISytemColorsPalette : Auriga.Core.IAurigaElement
    {
        ...
        /// Gets the entries.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.ISystemColor> Entries { get; }
