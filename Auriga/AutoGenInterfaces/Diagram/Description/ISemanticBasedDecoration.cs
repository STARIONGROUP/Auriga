// ------------------------------------------------------------------------------------------------
// <copyright file="ISemanticBasedDecoration.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description
{
    ...
    /// </summary>
    public partial interface ISemanticBasedDecoration : Auriga.Diagram.Viewpoint.Description.IDecorationDescription
    {
        /// <summary>
