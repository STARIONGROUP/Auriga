...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial interface IContainerMappingImport : Auriga.Diagram.Diagram.Description.IContainerMapping, Auriga.Diagram.Viewpoint.Description.IAbstractMappingImport
    {
        /// <summary>
        /// The imported mapping used to define default values for the current mapping.
        /// </summary>
        Auriga.Diagram.Diagram.Description.IContainerMapping ImportedMapping { get; set; }
