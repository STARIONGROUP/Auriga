...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial interface IEdgeMapping : Auriga.Diagram.Diagram.Description.IDiagramElementMapping, Auriga.Diagram.Viewpoint.Description.IDocumentedElement, Auriga.Diagram.Diagram.Description.IIEdgeMapping
    {
        /// <summary>
        /// All conditional styles.
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.IConditionalEdgeStyleDescription> ConditionnalStyles { get; }
        ...
        /// </summary>
        List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping> PathNodeMapping { get; }

        /// <summary>
        /// Gets the reconnections.
        /// </summary>
        List<Auriga.Diagram.Diagram.Description.Tool.IReconnectEdgeDescription> Reconnections { get; }
        ...
        /// </summary>
        List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> SourceMapping { get; }

        /// <summary>
        /// The style of the edge.
        /// </summary>
        Auriga.Diagram.Diagram.Description.Style.IEdgeStyleDescription Style { get; set; }
        ...
        /// </summary>
        List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> TargetMapping { get; }
