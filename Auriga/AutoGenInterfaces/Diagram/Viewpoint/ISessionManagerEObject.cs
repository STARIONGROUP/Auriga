// ------------------------------------------------------------------------------------------------
// <copyright file="ISessionManagerEObject.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint
{
    ...
    public partial interface ISessionManagerEObject : Auriga.Core.IAurigaElement
    {
        ...
        /// </summary>
        Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.IDAnalysisSessionEObject> OwnedSessions { get; }
