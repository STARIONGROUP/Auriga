...
namespace Auriga.Diagram.Viewpoint
{
    ...
    /// </summary>
    public partial interface IDecoration : Auriga.Diagram.Viewpoint.IIdentifiedElement
    {
        /// <summary>
        /// The referenced DecorationDescription.
        /// </summary>
        Auriga.Diagram.Viewpoint.Description.IDecorationDescription Description { get; set; }
