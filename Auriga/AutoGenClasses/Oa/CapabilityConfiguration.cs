// ------------------------------------------------------------------------------------------------
// <copyright file="CapabilityConfiguration.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>CapabilityConfiguration</c> class.
    /// </summary>
    public partial class CapabilityConfiguration : Auriga.Core.AurigaElement, Auriga.Oa.ICapabilityConfiguration
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Oa.IOperationalCapability ConfiguredCapability { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CapabilityConfiguration</c>.
        /// </summary>
