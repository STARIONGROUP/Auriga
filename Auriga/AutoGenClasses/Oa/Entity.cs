...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class Entity : Auriga.Core.AurigaElement, Auriga.Oa.IEntity
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Oa.ILocation ActualLocation { get; set; }
        ...
        /// </summary>
        public IEnumerable<Auriga.Oa.IOperationalActivity> AllocatedOperationalActivities => Enumerable.Empty<Auriga.Oa.IOperationalActivity>();

        /// <summary>
        /// Gets the allocated roles.
        /// </summary>
        public IEnumerable<Auriga.Oa.IRole> AllocatedRoles => Enumerable.Empty<Auriga.Oa.IRole>();
        ...
        /// </summary>
        public List<Auriga.Oa.IItemInConcept> ComposingLinks { get; } = new List<Auriga.Oa.IItemInConcept>();
        ...
        /// </summary>
        public List<Auriga.Oa.IOrganisationalUnitComposition> OrganisationalUnitMemberships { get; } = new List<Auriga.Oa.IOrganisationalUnitComposition>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.ICommunicationMean> OwnedCommunicationMeans => this.backingOwnedCommunicationMeans ??= new Auriga.Core.ContainerList<Auriga.Oa.ICommunicationMean>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCommunicationMeans"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.ICommunicationMean> backingOwnedCommunicationMeans;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IEntity> OwnedEntities => this.backingOwnedEntities ??= new Auriga.Core.ContainerList<Auriga.Oa.IEntity>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedEntities"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IEntity> backingOwnedEntities;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IRoleAllocation> OwnedRoleAllocations => this.backingOwnedRoleAllocations ??= new Auriga.Core.ContainerList<Auriga.Oa.IRoleAllocation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRoleAllocations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IRoleAllocation> backingOwnedRoleAllocations;
        ...
        /// </summary>
        public IEnumerable<Auriga.Ctx.ISystemComponent> RealizingSystemComponents => Enumerable.Empty<Auriga.Ctx.ISystemComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Oa.IRoleAllocation> RoleAllocations => Enumerable.Empty<Auriga.Oa.IRoleAllocation>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Oa.IEntity> SubEntities => Enumerable.Empty<Auriga.Oa.IEntity>();
