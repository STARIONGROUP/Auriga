...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class ConceptPkg : Auriga.Core.AurigaElement, Auriga.Oa.IConceptPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IConceptPkg> OwnedConceptPkgs => this.backingOwnedConceptPkgs ??= new Auriga.Core.ContainerList<Auriga.Oa.IConceptPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConceptPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IConceptPkg> backingOwnedConceptPkgs;

        /// <summary>
        /// Gets the owned concepts.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IConcept> OwnedConcepts => this.backingOwnedConcepts ??= new Auriga.Core.ContainerList<Auriga.Oa.IConcept>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConcepts"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IConcept> backingOwnedConcepts;
