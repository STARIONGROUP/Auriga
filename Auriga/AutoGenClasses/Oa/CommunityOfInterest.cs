...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class CommunityOfInterest : Auriga.Core.AurigaElement, Auriga.Oa.ICommunityOfInterest
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.ICommunityOfInterestComposition> CommunityOfInterestCompositions => this.backingCommunityOfInterestCompositions ??= new Auriga.Core.ContainerList<Auriga.Oa.ICommunityOfInterestComposition>(this);

        /// <summary>
        /// Backing field for <see cref="CommunityOfInterestCompositions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.ICommunityOfInterestComposition> backingCommunityOfInterestCompositions;
