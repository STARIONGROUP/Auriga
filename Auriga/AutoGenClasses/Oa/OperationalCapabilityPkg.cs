...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class OperationalCapabilityPkg : Auriga.Core.AurigaElement, Auriga.Oa.IOperationalCapabilityPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.ICapabilityConfiguration> OwnedCapabilityConfigurations => this.backingOwnedCapabilityConfigurations ??= new Auriga.Core.ContainerList<Auriga.Oa.ICapabilityConfiguration>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityConfigurations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.ICapabilityConfiguration> backingOwnedCapabilityConfigurations;

        /// <summary>
        /// Gets the owned concept compliances.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IConceptCompliance> OwnedConceptCompliances => this.backingOwnedConceptCompliances ??= new Auriga.Core.ContainerList<Auriga.Oa.IConceptCompliance>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConceptCompliances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IConceptCompliance> backingOwnedConceptCompliances;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IOperationalCapability> OwnedOperationalCapabilities => this.backingOwnedOperationalCapabilities ??= new Auriga.Core.ContainerList<Auriga.Oa.IOperationalCapability>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedOperationalCapabilities"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IOperationalCapability> backingOwnedOperationalCapabilities;

        /// <summary>
        /// Gets the owned operational capability pkgs.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IOperationalCapabilityPkg> OwnedOperationalCapabilityPkgs => this.backingOwnedOperationalCapabilityPkgs ??= new Auriga.Core.ContainerList<Auriga.Oa.IOperationalCapabilityPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedOperationalCapabilityPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IOperationalCapabilityPkg> backingOwnedOperationalCapabilityPkgs;
