...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class OrganisationalUnit : Auriga.Core.AurigaElement, Auriga.Oa.IOrganisationalUnit
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Oa.ICommunityOfInterestComposition> CommunityOfInterestMemberships { get; } = new List<Auriga.Oa.ICommunityOfInterestComposition>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IOrganisationalUnitComposition> OrganisationalUnitCompositions => this.backingOrganisationalUnitCompositions ??= new Auriga.Core.ContainerList<Auriga.Oa.IOrganisationalUnitComposition>(this);

        /// <summary>
        /// Backing field for <see cref="OrganisationalUnitCompositions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IOrganisationalUnitComposition> backingOrganisationalUnitCompositions;
