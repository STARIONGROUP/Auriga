...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class OperationalActivityPkg : Auriga.Core.AurigaElement, Auriga.Oa.IOperationalActivityPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IOperationalActivity> OwnedOperationalActivities => this.backingOwnedOperationalActivities ??= new Auriga.Core.ContainerList<Auriga.Oa.IOperationalActivity>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedOperationalActivities"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IOperationalActivity> backingOwnedOperationalActivities;
