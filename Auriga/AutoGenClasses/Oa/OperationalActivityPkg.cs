...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class OperationalActivityPkg : Auriga.AurigaElement, Auriga.Oa.IOperationalActivityPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.Oa.IOperationalActivity> OwnedOperationalActivities => this.backingOwnedOperationalActivities ??= new Auriga.ContainerList<Auriga.Oa.IOperationalActivity>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedOperationalActivities"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Oa.IOperationalActivity> backingOwnedOperationalActivities;

        /// <summary>
        /// Gets the owned operational activity pkgs.
        /// </summary>
        public Auriga.IContainerList<Auriga.Oa.IOperationalActivityPkg> OwnedOperationalActivityPkgs => this.backingOwnedOperationalActivityPkgs ??= new Auriga.ContainerList<Auriga.Oa.IOperationalActivityPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedOperationalActivityPkgs"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Oa.IOperationalActivityPkg> backingOwnedOperationalActivityPkgs;
