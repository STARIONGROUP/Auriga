...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class ConceptCompliance : Auriga.Core.AurigaElement, Auriga.Oa.IConceptCompliance
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Oa.IOperationalCapability CompliantCapability { get; set; }

        /// <summary>
        /// Gets or sets the comply with concept.
        /// </summary>
        public Auriga.Oa.IConcept ComplyWithConcept { get; set; }
