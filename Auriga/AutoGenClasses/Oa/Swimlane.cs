...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class Swimlane : Auriga.Core.AurigaElement, Auriga.Oa.ISwimlane
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Activity.IActivityEdge> OwnedEdges => this.backingOwnedEdges ??= new Auriga.Core.ContainerList<Auriga.Activity.IActivityEdge>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedEdges"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Activity.IActivityEdge> backingOwnedEdges;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Activity.IActivityNode> OwnedNodes => this.backingOwnedNodes ??= new Auriga.Core.ContainerList<Auriga.Activity.IActivityNode>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedNodes"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Activity.IActivityNode> backingOwnedNodes;
        ...
        /// </summary>
        public Auriga.Modellingcore.IAbstractType RepresentedElement { get; set; }

        /// <summary>
        /// Gets the represented entity.
        /// </summary>
        public Auriga.Oa.IEntity RepresentedEntity => default;
        ...
        /// Gets the sub groups.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Activity.IActivityGroup> SubGroups => this.backingSubGroups ??= new Auriga.Core.ContainerList<Auriga.Activity.IActivityGroup>(this);

        /// <summary>
        /// Backing field for <see cref="SubGroups"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Activity.IActivityGroup> backingSubGroups;

        /// <summary>
        /// Gets the sub partitions.
        /// </summary>
        public IEnumerable<Auriga.Activity.IActivityPartition> SubPartitions => Enumerable.Empty<Auriga.Activity.IActivityPartition>();
        ...
        /// </summary>
        public Auriga.Activity.IActivityGroup SuperGroup { get; set; }

        /// <summary>
        /// Gets the super partition.
        /// </summary>
        public Auriga.Activity.IActivityPartition SuperPartition => default;
