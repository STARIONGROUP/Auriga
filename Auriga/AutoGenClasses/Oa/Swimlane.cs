...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class Swimlane : Auriga.AurigaElement, Auriga.Oa.ISwimlane
    {
        /// <summary>
        ...
        /// Gets the sub groups.
        /// </summary>
        public Auriga.IContainerList<Auriga.Activity.IActivityGroup> SubGroups => this.backingSubGroups ??= new Auriga.ContainerList<Auriga.Activity.IActivityGroup>(this);

        /// <summary>
        /// Backing field for <see cref="SubGroups"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Activity.IActivityGroup> backingSubGroups;
