...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class Concept : Auriga.Core.AurigaElement, Auriga.Oa.IConcept
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IItemInConcept> CompositeLinks => this.backingCompositeLinks ??= new Auriga.Core.ContainerList<Auriga.Oa.IItemInConcept>(this);

        /// <summary>
        /// Backing field for <see cref="CompositeLinks"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IItemInConcept> backingCompositeLinks;
