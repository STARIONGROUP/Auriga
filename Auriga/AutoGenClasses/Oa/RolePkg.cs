...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class RolePkg : Auriga.Core.AurigaElement, Auriga.Oa.IRolePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IRolePkg> OwnedRolePkgs => this.backingOwnedRolePkgs ??= new Auriga.Core.ContainerList<Auriga.Oa.IRolePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRolePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IRolePkg> backingOwnedRolePkgs;

        /// <summary>
        /// Gets the owned roles.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Oa.IRole> OwnedRoles => this.backingOwnedRoles ??= new Auriga.Core.ContainerList<Auriga.Oa.IRole>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRoles"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Oa.IRole> backingOwnedRoles;
