// ------------------------------------------------------------------------------------------------
// <copyright file="Location.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Oa
{
    ...
    /// </summary>
    public partial class Location : Auriga.Core.AurigaElement, Auriga.Oa.ILocation
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Oa.IEntity> LocatedEntities { get; } = new List<Auriga.Oa.IEntity>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Location</c>.
        /// </summary>
