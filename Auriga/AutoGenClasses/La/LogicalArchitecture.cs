...
namespace Auriga.La
{
    ...
    /// </summary>
    public partial class LogicalArchitecture : Auriga.Core.AurigaElement, Auriga.La.ILogicalArchitecture
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.La.ISystemAnalysisRealization> OwnedSystemAnalysisRealizations => this.backingOwnedSystemAnalysisRealizations ??= new Auriga.Core.ContainerList<Auriga.La.ISystemAnalysisRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemAnalysisRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.La.ISystemAnalysisRealization> backingOwnedSystemAnalysisRealizations;
