...
namespace Auriga.La
{
    ...
    /// </summary>
    public partial class LogicalComponent : Auriga.AurigaElement, Auriga.La.ILogicalComponent
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.La.ILogicalArchitecture> OwnedLogicalArchitectures => this.backingOwnedLogicalArchitectures ??= new Auriga.ContainerList<Auriga.La.ILogicalArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalArchitectures"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.La.ILogicalArchitecture> backingOwnedLogicalArchitectures;

        /// <summary>
        /// Gets the owned logical component pkgs.
        /// </summary>
        public Auriga.IContainerList<Auriga.La.ILogicalComponentPkg> OwnedLogicalComponentPkgs => this.backingOwnedLogicalComponentPkgs ??= new Auriga.ContainerList<Auriga.La.ILogicalComponentPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalComponentPkgs"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.La.ILogicalComponentPkg> backingOwnedLogicalComponentPkgs;

        /// <summary>
        /// Gets the owned logical components.
        /// </summary>
        public Auriga.IContainerList<Auriga.La.ILogicalComponent> OwnedLogicalComponents => this.backingOwnedLogicalComponents ??= new Auriga.ContainerList<Auriga.La.ILogicalComponent>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalComponents"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.La.ILogicalComponent> backingOwnedLogicalComponents;
