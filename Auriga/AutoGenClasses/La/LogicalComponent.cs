...
namespace Auriga.La
{
    ...
    /// </summary>
    public partial class LogicalComponent : Auriga.Core.AurigaElement, Auriga.La.ILogicalComponent
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.La.ILogicalFunction> AllocatedLogicalFunctions => Enumerable.Empty<Auriga.La.ILogicalFunction>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.La.ILogicalArchitecture> OwnedLogicalArchitectures => this.backingOwnedLogicalArchitectures ??= new Auriga.Core.ContainerList<Auriga.La.ILogicalArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalArchitectures"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.La.ILogicalArchitecture> backingOwnedLogicalArchitectures;

        /// <summary>
        /// Gets the owned logical component pkgs.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.La.ILogicalComponentPkg> OwnedLogicalComponentPkgs => this.backingOwnedLogicalComponentPkgs ??= new Auriga.Core.ContainerList<Auriga.La.ILogicalComponentPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalComponentPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.La.ILogicalComponentPkg> backingOwnedLogicalComponentPkgs;

        /// <summary>
        /// Gets the owned logical components.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.La.ILogicalComponent> OwnedLogicalComponents => this.backingOwnedLogicalComponents ??= new Auriga.Core.ContainerList<Auriga.La.ILogicalComponent>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalComponents"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.La.ILogicalComponent> backingOwnedLogicalComponents;
        ...
        /// </summary>
        public IEnumerable<Auriga.Ctx.ISystemComponent> RealizedSystemComponents => Enumerable.Empty<Auriga.Ctx.ISystemComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Pa.IPhysicalComponent> RealizingPhysicalComponents => Enumerable.Empty<Auriga.Pa.IPhysicalComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.La.ILogicalComponent> SubLogicalComponents => Enumerable.Empty<Auriga.La.ILogicalComponent>();
