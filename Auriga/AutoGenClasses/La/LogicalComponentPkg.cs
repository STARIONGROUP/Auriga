// ------------------------------------------------------------------------------------------------
// <copyright file="LogicalComponentPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.La
{
    ...
    /// <summary>
    /// Definition of the <c>LogicalComponentPkg</c> class.
    /// </summary>
    public partial class LogicalComponentPkg : Auriga.Core.AurigaElement, Auriga.La.ILogicalComponentPkg
    {
        /// <summary>
