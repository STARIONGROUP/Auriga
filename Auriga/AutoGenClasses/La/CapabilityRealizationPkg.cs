...
namespace Auriga.La
{
    ...
    /// </summary>
    public partial class CapabilityRealizationPkg : Auriga.AurigaElement, Auriga.La.ICapabilityRealizationPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.La.ICapabilityRealizationPkg> OwnedCapabilityRealizationPkgs => this.backingOwnedCapabilityRealizationPkgs ??= new Auriga.ContainerList<Auriga.La.ICapabilityRealizationPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityRealizationPkgs"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.La.ICapabilityRealizationPkg> backingOwnedCapabilityRealizationPkgs;

        /// <summary>
        /// Gets the owned capability realizations.
        /// </summary>
        public Auriga.IContainerList<Auriga.La.ICapabilityRealization> OwnedCapabilityRealizations => this.backingOwnedCapabilityRealizations ??= new Auriga.ContainerList<Auriga.La.ICapabilityRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityRealizations"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.La.ICapabilityRealization> backingOwnedCapabilityRealizations;
