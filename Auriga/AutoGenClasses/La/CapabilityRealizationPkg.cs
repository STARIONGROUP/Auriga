...
namespace Auriga.La
{
    ...
    /// </summary>
    public partial class CapabilityRealizationPkg : Auriga.Core.AurigaElement, Auriga.La.ICapabilityRealizationPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.La.ICapabilityRealizationPkg> OwnedCapabilityRealizationPkgs => this.backingOwnedCapabilityRealizationPkgs ??= new Auriga.Core.ContainerList<Auriga.La.ICapabilityRealizationPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityRealizationPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.La.ICapabilityRealizationPkg> backingOwnedCapabilityRealizationPkgs;

        /// <summary>
        /// Gets the owned capability realizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.La.ICapabilityRealization> OwnedCapabilityRealizations => this.backingOwnedCapabilityRealizations ??= new Auriga.Core.ContainerList<Auriga.La.ICapabilityRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.La.ICapabilityRealization> backingOwnedCapabilityRealizations;
