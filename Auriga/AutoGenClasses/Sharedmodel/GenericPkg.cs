...
namespace Auriga.Sharedmodel
{
    ...
    /// </summary>
    public partial class GenericPkg : Auriga.Core.AurigaElement, Auriga.Sharedmodel.IGenericPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.ICapellaElement> CapellaElements => this.backingCapellaElements ??= new Auriga.Core.ContainerList<Auriga.Capellacore.ICapellaElement>(this);

        /// <summary>
        /// Backing field for <see cref="CapellaElements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.ICapellaElement> backingCapellaElements;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Sharedmodel.IGenericPkg> SubGenericPkgs => this.backingSubGenericPkgs ??= new Auriga.Core.ContainerList<Auriga.Sharedmodel.IGenericPkg>(this);

        /// <summary>
        /// Backing field for <see cref="SubGenericPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Sharedmodel.IGenericPkg> backingSubGenericPkgs;
