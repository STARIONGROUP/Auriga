...
namespace Auriga.Epbs
{
    ...
    /// </summary>
    public partial class ConfigurationItem : Auriga.Core.AurigaElement, Auriga.Epbs.IConfigurationItem
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IAbstractPhysicalArtifact> AllocatedPhysicalArtifacts => Enumerable.Empty<Auriga.Cs.IAbstractPhysicalArtifact>();
        ...
        /// </summary>
        public Auriga.Epbs.ConfigurationItemKind? Kind { get; set; }
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Epbs.IConfigurationItemPkg> OwnedConfigurationItemPkgs => this.backingOwnedConfigurationItemPkgs ??= new Auriga.Core.ContainerList<Auriga.Epbs.IConfigurationItemPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConfigurationItemPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Epbs.IConfigurationItemPkg> backingOwnedConfigurationItemPkgs;

        /// <summary>
        /// Gets the owned configuration items.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Epbs.IConfigurationItem> OwnedConfigurationItems => this.backingOwnedConfigurationItems ??= new Auriga.Core.ContainerList<Auriga.Epbs.IConfigurationItem>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConfigurationItems"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Epbs.IConfigurationItem> backingOwnedConfigurationItems;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Epbs.IPhysicalArtifactRealization> OwnedPhysicalArtifactRealizations => this.backingOwnedPhysicalArtifactRealizations ??= new Auriga.Core.ContainerList<Auriga.Epbs.IPhysicalArtifactRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalArtifactRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Epbs.IPhysicalArtifactRealization> backingOwnedPhysicalArtifactRealizations;
