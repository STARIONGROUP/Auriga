...
namespace Auriga.Epbs
{
    ...
    /// </summary>
    public partial class EPBSArchitecturePkg : Auriga.Core.AurigaElement, Auriga.Epbs.IEPBSArchitecturePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Epbs.IEPBSArchitecture> OwnedEPBSArchitectures => this.backingOwnedEPBSArchitectures ??= new Auriga.Core.ContainerList<Auriga.Epbs.IEPBSArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedEPBSArchitectures"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Epbs.IEPBSArchitecture> backingOwnedEPBSArchitectures;
