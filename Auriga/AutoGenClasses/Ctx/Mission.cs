...
namespace Auriga.Ctx
{
    ...
    /// </summary>
    public partial class Mission : Auriga.Core.AurigaElement, Auriga.Ctx.IMission
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Ctx.ICapability> ExploitedCapabilities => Enumerable.Empty<Auriga.Ctx.ICapability>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.ICapabilityExploitation> OwnedCapabilityExploitations => this.backingOwnedCapabilityExploitations ??= new Auriga.Core.ContainerList<Auriga.Ctx.ICapabilityExploitation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityExploitations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.ICapabilityExploitation> backingOwnedCapabilityExploitations;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.IMissionInvolvement> OwnedMissionInvolvements => this.backingOwnedMissionInvolvements ??= new Auriga.Core.ContainerList<Auriga.Ctx.IMissionInvolvement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMissionInvolvements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.IMissionInvolvement> backingOwnedMissionInvolvements;
