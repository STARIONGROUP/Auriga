// ------------------------------------------------------------------------------------------------
// <copyright file="SystemFunctionPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>SystemFunctionPkg</c> class.
    /// </summary>
    public partial class SystemFunctionPkg : Auriga.Core.AurigaElement, Auriga.Ctx.ISystemFunctionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IExchangeCategory> OwnedCategories => this.backingOwnedCategories ??= new Auriga.Core.ContainerList<Auriga.Fa.IExchangeCategory>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCategories"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IExchangeCategory> backingOwnedCategories;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IExchangeSpecificationRealization> OwnedExchangeSpecificationRealizations => this.backingOwnedExchangeSpecificationRealizations ??= new Auriga.Core.ContainerList<Auriga.Fa.IExchangeSpecificationRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedExchangeSpecificationRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IExchangeSpecificationRealization> backingOwnedExchangeSpecificationRealizations;

        /// <summary>
        /// Gets the owned exchanges.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IFunctionalExchangeSpecification> OwnedExchanges => this.backingOwnedExchanges ??= new Auriga.Core.ContainerList<Auriga.Fa.IFunctionalExchangeSpecification>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedExchanges"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IFunctionalExchangeSpecification> backingOwnedExchanges;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IFunctionSpecification> OwnedFunctionSpecifications => this.backingOwnedFunctionSpecifications ??= new Auriga.Core.ContainerList<Auriga.Fa.IFunctionSpecification>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedFunctionSpecifications"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IFunctionSpecification> backingOwnedFunctionSpecifications;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.ISystemFunctionPkg> OwnedSystemFunctionPkgs => this.backingOwnedSystemFunctionPkgs ??= new Auriga.Core.ContainerList<Auriga.Ctx.ISystemFunctionPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemFunctionPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.ISystemFunctionPkg> backingOwnedSystemFunctionPkgs;

        /// <summary>
        /// Gets the owned system functions.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.ISystemFunction> OwnedSystemFunctions => this.backingOwnedSystemFunctions ??= new Auriga.Core.ContainerList<Auriga.Ctx.ISystemFunction>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemFunctions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.ISystemFunction> backingOwnedSystemFunctions;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemFunctionPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedSystemFunctionPkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedSystemFunctions)
            {
                yield return element;
            }
