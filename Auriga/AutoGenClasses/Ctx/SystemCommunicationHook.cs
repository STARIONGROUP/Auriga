...
namespace Auriga.Ctx
{
    ...
    /// </summary>
    public partial class SystemCommunicationHook : Auriga.Core.AurigaElement, Auriga.Ctx.ISystemCommunicationHook
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Ctx.ISystemCommunication Communication { get; set; }
        ...
        /// </summary>
        public Auriga.Cs.IComponent Type { get; set; }
