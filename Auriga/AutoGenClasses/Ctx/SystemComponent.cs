// ------------------------------------------------------------------------------------------------
// <copyright file="SystemComponent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>SystemComponent</c> class.
    /// </summary>
    public partial class SystemComponent : Auriga.AurigaElement, Auriga.Ctx.ISystemComponent
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Ctx.ISystemFunction> AllocatedSystemFunctions => Enumerable.Empty<Auriga.Ctx.ISystemFunction>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Ctx.ICapabilityInvolvement> CapabilityInvolvements => Enumerable.Empty<Auriga.Ctx.ICapabilityInvolvement>();
        ...
        /// </summary>
        public bool? DataComponent { get; set; }

        /// <summary>
        /// Gets the data type.
        /// </summary>
        public List<Auriga.Capellacore.IClassifier> DataType { get; } = new List<Auriga.Capellacore.IClassifier>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Ctx.IMission> InvolvingMissions => Enumerable.Empty<Auriga.Ctx.IMission>();

        /// <summary>
        /// Gets the mission involvements.
        /// </summary>
        public IEnumerable<Auriga.Ctx.IMissionInvolvement> MissionInvolvements => Enumerable.Empty<Auriga.Ctx.IMissionInvolvement>();
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.Ctx.ISystemComponentPkg> OwnedSystemComponentPkgs => this.backingOwnedSystemComponentPkgs ??= new Auriga.ContainerList<Auriga.Ctx.ISystemComponentPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemComponentPkgs"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Ctx.ISystemComponentPkg> backingOwnedSystemComponentPkgs;

        /// <summary>
        /// Gets the owned system components.
        /// </summary>
        public Auriga.IContainerList<Auriga.Ctx.ISystemComponent> OwnedSystemComponents => this.backingOwnedSystemComponents ??= new Auriga.ContainerList<Auriga.Ctx.ISystemComponent>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemComponents"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Ctx.ISystemComponent> backingOwnedSystemComponents;
        ...
        /// </summary>
        public IEnumerable<Auriga.Oa.IEntity> RealizedEntities => Enumerable.Empty<Auriga.Oa.IEntity>();
        ...
        /// </summary>
        public IEnumerable<Auriga.La.ILogicalComponent> RealizingLogicalComponents => Enumerable.Empty<Auriga.La.ILogicalComponent>();
