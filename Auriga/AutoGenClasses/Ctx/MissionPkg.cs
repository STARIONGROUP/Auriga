...
namespace Auriga.Ctx
{
    ...
    /// </summary>
    public partial class MissionPkg : Auriga.Core.AurigaElement, Auriga.Ctx.IMissionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.IMissionPkg> OwnedMissionPkgs => this.backingOwnedMissionPkgs ??= new Auriga.Core.ContainerList<Auriga.Ctx.IMissionPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMissionPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.IMissionPkg> backingOwnedMissionPkgs;

        /// <summary>
        /// Gets the owned missions.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Ctx.IMission> OwnedMissions => this.backingOwnedMissions ??= new Auriga.Core.ContainerList<Auriga.Ctx.IMission>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMissions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Ctx.IMission> backingOwnedMissions;
