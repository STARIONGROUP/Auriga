...
namespace Auriga.Pa
{
    ...
    /// </summary>
    public partial class PhysicalArchitecturePkg : Auriga.Core.AurigaElement, Auriga.Pa.IPhysicalArchitecturePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.IPhysicalArchitecturePkg> OwnedPhysicalArchitecturePkgs => this.backingOwnedPhysicalArchitecturePkgs ??= new Auriga.Core.ContainerList<Auriga.Pa.IPhysicalArchitecturePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalArchitecturePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.IPhysicalArchitecturePkg> backingOwnedPhysicalArchitecturePkgs;

        /// <summary>
        /// Gets the owned physical architectures.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.IPhysicalArchitecture> OwnedPhysicalArchitectures => this.backingOwnedPhysicalArchitectures ??= new Auriga.Core.ContainerList<Auriga.Pa.IPhysicalArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalArchitectures"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.IPhysicalArchitecture> backingOwnedPhysicalArchitectures;
