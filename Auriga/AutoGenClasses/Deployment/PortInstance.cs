...
namespace Auriga.Pa.Deployment
{
    ...
    /// </summary>
    public partial class PortInstance : Auriga.Core.AurigaElement, Auriga.Pa.Deployment.IPortInstance
    {
        /// <summary>
        ...
        /// Gets the component.
        /// </summary>
        public Auriga.Pa.Deployment.IComponentInstance Component => default;

        /// <summary>
        /// Gets the connections.
        /// </summary>
        public List<Auriga.Pa.Deployment.IConnectionInstance> Connections { get; } = new List<Auriga.Pa.Deployment.IConnectionInstance>();
        ...
        /// </summary>
        public Auriga.Fa.IComponentPort Type { get; set; }
