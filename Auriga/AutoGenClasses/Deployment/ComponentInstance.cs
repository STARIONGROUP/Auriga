...
namespace Auriga.Pa.Deployment
{
    ...
    /// </summary>
    public partial class ComponentInstance : Auriga.Core.AurigaElement, Auriga.Pa.Deployment.IComponentInstance
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.Deployment.IAbstractPhysicalInstance> OwnedAbstractPhysicalInstances => this.backingOwnedAbstractPhysicalInstances ??= new Auriga.Core.ContainerList<Auriga.Pa.Deployment.IAbstractPhysicalInstance>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedAbstractPhysicalInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.Deployment.IAbstractPhysicalInstance> backingOwnedAbstractPhysicalInstances;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.Deployment.IInstanceDeploymentLink> OwnedInstanceDeploymentLinks => this.backingOwnedInstanceDeploymentLinks ??= new Auriga.Core.ContainerList<Auriga.Pa.Deployment.IInstanceDeploymentLink>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedInstanceDeploymentLinks"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.Deployment.IInstanceDeploymentLink> backingOwnedInstanceDeploymentLinks;
        ...
        /// </summary>
        public IEnumerable<Auriga.Pa.Deployment.IPortInstance> PortInstances => Enumerable.Empty<Auriga.Pa.Deployment.IPortInstance>();
        ...
        /// </summary>
        public Auriga.Pa.IPhysicalComponent Type { get; set; }
