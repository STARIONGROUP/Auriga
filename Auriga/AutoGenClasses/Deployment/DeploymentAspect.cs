...
namespace Auriga.Pa.Deployment
{
    ...
    /// </summary>
    public partial class DeploymentAspect : Auriga.Core.AurigaElement, Auriga.Pa.Deployment.IDeploymentAspect
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.Deployment.IDeploymentConfiguration> OwnedConfigurations => this.backingOwnedConfigurations ??= new Auriga.Core.ContainerList<Auriga.Pa.Deployment.IDeploymentConfiguration>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConfigurations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.Deployment.IDeploymentConfiguration> backingOwnedConfigurations;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.Deployment.IDeploymentAspect> OwnedDeploymentAspects => this.backingOwnedDeploymentAspects ??= new Auriga.Core.ContainerList<Auriga.Pa.Deployment.IDeploymentAspect>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedDeploymentAspects"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.Deployment.IDeploymentAspect> backingOwnedDeploymentAspects;
