...
namespace Auriga.Pa.Deployment
{
    ...
    /// </summary>
    public partial class ConnectionInstance : Auriga.Core.AurigaElement, Auriga.Pa.Deployment.IConnectionInstance
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Pa.Deployment.IPortInstance> ConnectionEnds { get; } = new List<Auriga.Pa.Deployment.IPortInstance>();
        ...
        /// </summary>
        public Auriga.Fa.IComponentExchange Type { get; set; }
