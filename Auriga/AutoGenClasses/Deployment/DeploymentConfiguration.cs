...
namespace Auriga.Pa.Deployment
{
    ...
    /// </summary>
    public partial class DeploymentConfiguration : Auriga.Core.AurigaElement, Auriga.Pa.Deployment.IDeploymentConfiguration
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Pa.Deployment.IAbstractPhysicalInstance> OwnedPhysicalInstances => this.backingOwnedPhysicalInstances ??= new Auriga.Core.ContainerList<Auriga.Pa.Deployment.IAbstractPhysicalInstance>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Pa.Deployment.IAbstractPhysicalInstance> backingOwnedPhysicalInstances;
