...
namespace Auriga.Capellacommon
{
    ...
    /// </summary>
    public partial class Region : Auriga.AurigaElement, Auriga.Capellacommon.IRegion
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.Capellacommon.IAbstractState> OwnedStates => this.backingOwnedStates ??= new Auriga.ContainerList<Auriga.Capellacommon.IAbstractState>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedStates"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Capellacommon.IAbstractState> backingOwnedStates;

        /// <summary>
        /// Gets the owned transitions.
        /// </summary>
        public Auriga.IContainerList<Auriga.Capellacommon.IStateTransition> OwnedTransitions => this.backingOwnedTransitions ??= new Auriga.ContainerList<Auriga.Capellacommon.IStateTransition>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedTransitions"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Capellacommon.IStateTransition> backingOwnedTransitions;
