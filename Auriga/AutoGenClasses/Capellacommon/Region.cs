...
namespace Auriga.Capellacommon
{
    ...
    /// </summary>
    public partial class Region : Auriga.Core.AurigaElement, Auriga.Capellacommon.IRegion
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Capellacommon.IAbstractState> InvolvedStates { get; } = new List<Auriga.Capellacommon.IAbstractState>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacommon.IAbstractState> OwnedStates => this.backingOwnedStates ??= new Auriga.Core.ContainerList<Auriga.Capellacommon.IAbstractState>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedStates"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacommon.IAbstractState> backingOwnedStates;

        /// <summary>
        /// Gets the owned transitions.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacommon.IStateTransition> OwnedTransitions => this.backingOwnedTransitions ??= new Auriga.Core.ContainerList<Auriga.Capellacommon.IStateTransition>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedTransitions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacommon.IStateTransition> backingOwnedTransitions;
