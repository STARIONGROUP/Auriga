// ------------------------------------------------------------------------------------------------
// <copyright file="Message.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Information.Communication
{
    ...
    /// <summary>
    /// Definition of the <c>Message</c> class.
    /// </summary>
    public partial class Message : Auriga.Core.AurigaElement, Auriga.Information.Communication.IMessage
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Message</c>.
        /// </summary>
