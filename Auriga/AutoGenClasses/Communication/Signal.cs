// ------------------------------------------------------------------------------------------------
// <copyright file="Signal.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Information.Communication
{
    ...
    /// <summary>
    /// Definition of the <c>Signal</c> class.
    /// </summary>
    public partial class Signal : Auriga.Core.AurigaElement, Auriga.Information.Communication.ISignal
    {
        /// <summary>
        ...
        /// Gets the properties.
        /// </summary>
        public IEnumerable<Auriga.Information.IProperty> Properties => Enumerable.Empty<Auriga.Information.IProperty>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Information.Communication.ISignalInstance> SignalInstances => this.backingSignalInstances ??= new Auriga.Core.ContainerList<Auriga.Information.Communication.ISignalInstance>(this);

        /// <summary>
        /// Backing field for <see cref="SignalInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Information.Communication.ISignalInstance> backingSignalInstances;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Signal</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.SignalInstances)
            {
                yield return element;
            }
        }
