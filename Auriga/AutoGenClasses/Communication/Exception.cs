// ------------------------------------------------------------------------------------------------
// <copyright file="Exception.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Information.Communication
{
    ...
    /// <summary>
    /// Definition of the <c>Exception</c> class.
    /// </summary>
    public partial class Exception : Auriga.Core.AurigaElement, Auriga.Information.Communication.IException
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Exception</c>.
        /// </summary>
