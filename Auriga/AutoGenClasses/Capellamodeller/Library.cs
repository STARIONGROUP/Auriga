...
namespace Auriga.Capellamodeller
{
    ...
    /// </summary>
    public partial class Library : Auriga.Core.AurigaElement, Auriga.Capellamodeller.ILibrary
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.IKeyValue> KeyValuePairs => this.backingKeyValuePairs ??= new Auriga.Core.ContainerList<Auriga.Capellacore.IKeyValue>(this);

        /// <summary>
        /// Backing field for <see cref="KeyValuePairs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.IKeyValue> backingKeyValuePairs;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellamodeller.IFolder> OwnedFolders => this.backingOwnedFolders ??= new Auriga.Core.ContainerList<Auriga.Capellamodeller.IFolder>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedFolders"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellamodeller.IFolder> backingOwnedFolders;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellamodeller.IModelRoot> OwnedModelRoots => this.backingOwnedModelRoots ??= new Auriga.Core.ContainerList<Auriga.Capellamodeller.IModelRoot>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedModelRoots"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellamodeller.IModelRoot> backingOwnedModelRoots;
