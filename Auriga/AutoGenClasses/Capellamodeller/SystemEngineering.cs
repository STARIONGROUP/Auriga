...
namespace Auriga.Capellamodeller
{
    ...
    /// </summary>
    public partial class SystemEngineering : Auriga.Core.AurigaElement, Auriga.Capellamodeller.ISystemEngineering
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.IModellingArchitecturePkg> OwnedArchitecturePkgs => this.backingOwnedArchitecturePkgs ??= new Auriga.Core.ContainerList<Auriga.Capellacore.IModellingArchitecturePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedArchitecturePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.IModellingArchitecturePkg> backingOwnedArchitecturePkgs;

        /// <summary>
        /// Gets the owned architectures.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.IModellingArchitecture> OwnedArchitectures => this.backingOwnedArchitectures ??= new Auriga.Core.ContainerList<Auriga.Capellacore.IModellingArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedArchitectures"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.IModellingArchitecture> backingOwnedArchitectures;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.IReuseLink> OwnedReuseLinks => this.backingOwnedReuseLinks ??= new Auriga.Core.ContainerList<Auriga.Capellacore.IReuseLink>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedReuseLinks"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.IReuseLink> backingOwnedReuseLinks;
