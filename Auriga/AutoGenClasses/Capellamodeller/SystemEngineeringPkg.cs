...
namespace Auriga.Capellamodeller
{
    ...
    /// </summary>
    public partial class SystemEngineeringPkg : Auriga.Core.AurigaElement, Auriga.Capellamodeller.ISystemEngineeringPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellamodeller.ISystemEngineering> OwnedSystemEngineerings => this.backingOwnedSystemEngineerings ??= new Auriga.Core.ContainerList<Auriga.Capellamodeller.ISystemEngineering>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemEngineerings"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellamodeller.ISystemEngineering> backingOwnedSystemEngineerings;
