...
namespace Auriga.Cs
{
    ...
    /// </summary>
    public partial class InterfacePkg : Auriga.Core.AurigaElement, Auriga.Cs.IInterfacePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Cs.IInterfacePkg> OwnedInterfacePkgs => this.backingOwnedInterfacePkgs ??= new Auriga.Core.ContainerList<Auriga.Cs.IInterfacePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedInterfacePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Cs.IInterfacePkg> backingOwnedInterfacePkgs;

        /// <summary>
        /// Gets the owned interfaces.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Cs.IInterface> OwnedInterfaces => this.backingOwnedInterfaces ??= new Auriga.Core.ContainerList<Auriga.Cs.IInterface>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedInterfaces"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Cs.IInterface> backingOwnedInterfaces;
