...
namespace Auriga.Cs
{
    ...
    /// </summary>
    public partial class PhysicalLink : Auriga.AurigaElement, Auriga.Cs.IPhysicalLink
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.Cs.IPhysicalLinkEnd> OwnedPhysicalLinkEnds => this.backingOwnedPhysicalLinkEnds ??= new Auriga.ContainerList<Auriga.Cs.IPhysicalLinkEnd>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalLinkEnds"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Cs.IPhysicalLinkEnd> backingOwnedPhysicalLinkEnds;

        /// <summary>
        /// Gets the owned physical link realizations.
        /// </summary>
        public Auriga.IContainerList<Auriga.Cs.IPhysicalLinkRealization> OwnedPhysicalLinkRealizations => this.backingOwnedPhysicalLinkRealizations ??= new Auriga.ContainerList<Auriga.Cs.IPhysicalLinkRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalLinkRealizations"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Cs.IPhysicalLinkRealization> backingOwnedPhysicalLinkRealizations;
