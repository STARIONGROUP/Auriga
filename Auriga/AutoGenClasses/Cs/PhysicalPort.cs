...
namespace Auriga.Cs
{
    ...
    /// </summary>
    public partial class PhysicalPort : Auriga.Core.AurigaElement, Auriga.Cs.IPhysicalPort
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> AllocatedComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalLink> InvolvedLinks => Enumerable.Empty<Auriga.Cs.IPhysicalLink>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IComponentPortAllocation> OwnedComponentPortAllocations => this.backingOwnedComponentPortAllocations ??= new Auriga.Core.ContainerList<Auriga.Fa.IComponentPortAllocation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedComponentPortAllocations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IComponentPortAllocation> backingOwnedComponentPortAllocations;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Cs.IPhysicalPortRealization> OwnedPhysicalPortRealizations => this.backingOwnedPhysicalPortRealizations ??= new Auriga.Core.ContainerList<Auriga.Cs.IPhysicalPortRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalPortRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Cs.IPhysicalPortRealization> backingOwnedPhysicalPortRealizations;

        /// <summary>
        /// Gets the owned port allocations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Information.IPortAllocation> OwnedPortAllocations => this.backingOwnedPortAllocations ??= new Auriga.Core.ContainerList<Auriga.Information.IPortAllocation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPortAllocations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Information.IPortAllocation> backingOwnedPortAllocations;

        /// <summary>
        /// Gets the owned port realizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Information.IPortRealization> OwnedPortRealizations => this.backingOwnedPortRealizations ??= new Auriga.Core.ContainerList<Auriga.Information.IPortRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPortRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Information.IPortRealization> backingOwnedPortRealizations;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacommon.IStateMachine> OwnedProtocols => this.backingOwnedProtocols ??= new Auriga.Core.ContainerList<Auriga.Capellacommon.IStateMachine>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedProtocols"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacommon.IStateMachine> backingOwnedProtocols;
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalPort> RealizedPhysicalPorts => Enumerable.Empty<Auriga.Cs.IPhysicalPort>();

        /// <summary>
        /// Gets the realizing physical ports.
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalPort> RealizingPhysicalPorts => Enumerable.Empty<Auriga.Cs.IPhysicalPort>();
