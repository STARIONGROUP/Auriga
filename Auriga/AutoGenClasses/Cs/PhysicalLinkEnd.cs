// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalLinkEnd.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalLinkEnd</c> class.
    /// </summary>
    public partial class PhysicalLinkEnd : Auriga.Core.AurigaElement, Auriga.Cs.IPhysicalLinkEnd
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Cs.IPhysicalPort Port { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalLinkEnd</c>.
        /// </summary>
