...
namespace Auriga.Cs
{
    ...
    public partial class PhysicalPath : Auriga.AurigaElement, Auriga.Cs.IPhysicalPath
    {
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalPathInvolvement> FirstPhysicalPathInvolvements => Enumerable.Empty<Auriga.Cs.IPhysicalPathInvolvement>();
        ...
        /// </summary>
        public List<Auriga.Cs.IAbstractPhysicalPathLink> InvolvedLinks { get; } = new List<Auriga.Cs.IAbstractPhysicalPathLink>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalPath> RealizedPhysicalPaths => Enumerable.Empty<Auriga.Cs.IPhysicalPath>();

        /// <summary>
        /// Gets the realizing physical paths.
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalPath> RealizingPhysicalPaths => Enumerable.Empty<Auriga.Cs.IPhysicalPath>();
