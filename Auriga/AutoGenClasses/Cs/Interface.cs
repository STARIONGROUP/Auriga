...
namespace Auriga.Cs
{
    ...
    /// </summary>
    public partial class Interface : Auriga.Core.AurigaElement, Auriga.Cs.IInterface
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IComponent> AllocatingComponents => Enumerable.Empty<Auriga.Cs.IComponent>();

        /// <summary>
        /// Gets the allocating interfaces.
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterface> AllocatingInterfaces => Enumerable.Empty<Auriga.Cs.IInterface>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Information.IExchangeItem> ExchangeItems => Enumerable.Empty<Auriga.Information.IExchangeItem>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IComponent> ImplementorComponents => Enumerable.Empty<Auriga.Cs.IComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterfaceImplementation> InterfaceImplementations => Enumerable.Empty<Auriga.Cs.IInterfaceImplementation>();

        /// <summary>
        /// Gets the interface uses.
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterfaceUse> InterfaceUses => Enumerable.Empty<Auriga.Cs.IInterfaceUse>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.IGeneralClass> NestedGeneralClasses => this.backingNestedGeneralClasses ??= new Auriga.Core.ContainerList<Auriga.Capellacore.IGeneralClass>(this);

        /// <summary>
        /// Backing field for <see cref="NestedGeneralClasses"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.IGeneralClass> backingNestedGeneralClasses;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Cs.IExchangeItemAllocation> OwnedExchangeItemAllocations => this.backingOwnedExchangeItemAllocations ??= new Auriga.Core.ContainerList<Auriga.Cs.IExchangeItemAllocation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedExchangeItemAllocations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Cs.IExchangeItemAllocation> backingOwnedExchangeItemAllocations;
        ...
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> ProvidingComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();

        /// <summary>
        /// Gets the providing components.
        /// </summary>
        public IEnumerable<Auriga.Cs.IComponent> ProvidingComponents => Enumerable.Empty<Auriga.Cs.IComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterfaceAllocation> ProvisioningInterfaceAllocations => Enumerable.Empty<Auriga.Cs.IInterfaceAllocation>();

        /// <summary>
        /// Gets the realized context interfaces.
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterface> RealizedContextInterfaces => Enumerable.Empty<Auriga.Cs.IInterface>();

        /// <summary>
        /// Gets the realized logical interfaces.
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterface> RealizedLogicalInterfaces => Enumerable.Empty<Auriga.Cs.IInterface>();

        /// <summary>
        /// Gets the realizing logical interfaces.
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterface> RealizingLogicalInterfaces => Enumerable.Empty<Auriga.Cs.IInterface>();

        /// <summary>
        /// Gets the realizing physical interfaces.
        /// </summary>
        public IEnumerable<Auriga.Cs.IInterface> RealizingPhysicalInterfaces => Enumerable.Empty<Auriga.Cs.IInterface>();

        /// <summary>
        /// Gets the requiring component ports.
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> RequiringComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();

        /// <summary>
        /// Gets the requiring components.
        /// </summary>
        public IEnumerable<Auriga.Cs.IComponent> RequiringComponents => Enumerable.Empty<Auriga.Cs.IComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Cs.IComponent> UserComponents => Enumerable.Empty<Auriga.Cs.IComponent>();
