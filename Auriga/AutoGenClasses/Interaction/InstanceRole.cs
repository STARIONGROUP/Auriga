...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial class InstanceRole : Auriga.Core.AurigaElement, Auriga.Interaction.IInstanceRole
    {
        /// <summary>
        /// Gets the abstract ends.
        /// </summary>
        public IEnumerable<Auriga.Interaction.IAbstractEnd> AbstractEnds => Enumerable.Empty<Auriga.Interaction.IAbstractEnd>();
        ...
        /// </summary>
        public Auriga.Information.IAbstractInstance RepresentedInstance { get; set; }
