...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial class AbstractFunctionAbstractCapabilityInvolvement : Auriga.AurigaElement, Auriga.Interaction.IAbstractFunctionAbstractCapabilityInvolvement
    {
        /// <summary>
