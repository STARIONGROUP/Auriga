...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial class InteractionUse : Auriga.Core.AurigaElement, Auriga.Interaction.IInteractionUse
    {
        /// <summary>
        /// Gets the actual gates.
        /// </summary>
        public IEnumerable<Auriga.Interaction.IGate> ActualGates => Enumerable.Empty<Auriga.Interaction.IGate>();
        ...
        /// </summary>
        public Auriga.Interaction.IScenario ReferencedScenario { get; set; }
