...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial class InteractionOperand : Auriga.Core.AurigaElement, Auriga.Interaction.IInteractionOperand
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Interaction.IInteractionFragment> ReferencedInteractionFragments { get; } = new List<Auriga.Interaction.IInteractionFragment>();
