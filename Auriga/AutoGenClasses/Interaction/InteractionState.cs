...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial class InteractionState : Auriga.Core.AurigaElement, Auriga.Interaction.IInteractionState
    {
        /// <summary>
        ...
        /// Gets the covered.
        /// </summary>
        public Auriga.Interaction.IInstanceRole Covered => default;

        /// <summary>
        /// Gets the covered instance roles.
        /// </summary>
        public List<Auriga.Interaction.IInstanceRole> CoveredInstanceRoles { get; } = new List<Auriga.Interaction.IInstanceRole>();
        ...
        /// </summary>
        public Auriga.Fa.IAbstractFunction RelatedAbstractFunction { get; set; }

        /// <summary>
        /// @deprecated : relatedAbstractState shall not be used anymore
        /// </summary>
        public Auriga.Capellacommon.IAbstractState RelatedAbstractState { get; set; }
