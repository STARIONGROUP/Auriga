...
namespace Auriga.Interaction
{
    ...
    /// </summary>
    public partial class FunctionalChainAbstractCapabilityInvolvement : Auriga.AurigaElement, Auriga.Interaction.IFunctionalChainAbstractCapabilityInvolvement
    {
        /// <summary>
