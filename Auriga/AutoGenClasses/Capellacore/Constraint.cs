...
namespace Auriga.Capellacore
{
    ...
    /// </summary>
    public partial class Constraint : Auriga.Core.AurigaElement, Auriga.Capellacore.IConstraint
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Modellingcore.IModelElement> ConstrainedElements { get; } = new List<Auriga.Modellingcore.IModelElement>();
        ...
        /// Gets the context.
        /// </summary>
        public Auriga.Modellingcore.IModelElement Context => default;
