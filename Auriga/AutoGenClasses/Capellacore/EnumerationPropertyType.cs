...
namespace Auriga.Capellacore
{
    ...
    /// </summary>
    public partial class EnumerationPropertyType : Auriga.Core.AurigaElement, Auriga.Capellacore.IEnumerationPropertyType
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Capellacore.IEnumerationPropertyLiteral> OwnedLiterals => this.backingOwnedLiterals ??= new Auriga.Core.ContainerList<Auriga.Capellacore.IEnumerationPropertyLiteral>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLiterals"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Capellacore.IEnumerationPropertyLiteral> backingOwnedLiterals;
