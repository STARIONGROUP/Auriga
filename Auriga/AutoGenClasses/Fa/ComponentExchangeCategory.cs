...
namespace Auriga.Fa
{
    ...
    /// </summary>
    public partial class ComponentExchangeCategory : Auriga.Core.AurigaElement, Auriga.Fa.IComponentExchangeCategory
    {
        /// <summary>
        ...
        /// Gets the exchanges.
        /// </summary>
        public List<Auriga.Fa.IComponentExchange> Exchanges { get; } = new List<Auriga.Fa.IComponentExchange>();
