...
namespace Auriga.Fa
{
    ...
    /// </summary>
    public partial class ExchangeCategory : Auriga.Core.AurigaElement, Auriga.Fa.IExchangeCategory
    {
        /// <summary>
        ...
        /// Gets the exchanges.
        /// </summary>
        public List<Auriga.Fa.IFunctionalExchange> Exchanges { get; } = new List<Auriga.Fa.IFunctionalExchange>();
