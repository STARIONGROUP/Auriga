...
namespace Auriga.Fa
{
    ...
    /// </summary>
    public partial class FunctionalExchange : Auriga.Core.AurigaElement, Auriga.Fa.IFunctionalExchange
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IFunctionalExchangeRealization> OwnedFunctionalExchangeRealizations => this.backingOwnedFunctionalExchangeRealizations ??= new Auriga.Core.ContainerList<Auriga.Fa.IFunctionalExchangeRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedFunctionalExchangeRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IFunctionalExchangeRealization> backingOwnedFunctionalExchangeRealizations;
