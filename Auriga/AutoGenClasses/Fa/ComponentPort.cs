// ------------------------------------------------------------------------------------------------
// <copyright file="ComponentPort.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ComponentPort</c> class.
    /// </summary>
    public partial class ComponentPort : Auriga.Core.AurigaElement, Auriga.Fa.IComponentPort
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Fa.IFunctionPort> AllocatedFunctionPorts => Enumerable.Empty<Auriga.Fa.IFunctionPort>();

        /// <summary>
        /// Gets the allocating physical ports.
        /// </summary>
        public IEnumerable<Auriga.Cs.IPhysicalPort> AllocatingPhysicalPorts => Enumerable.Empty<Auriga.Cs.IPhysicalPort>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentExchange> ComponentExchanges => Enumerable.Empty<Auriga.Fa.IComponentExchange>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> DelegatedComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();

        /// <summary>
        /// Gets the delegating component ports.
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> DelegatingComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();
        ...
        /// </summary>
        public Auriga.Fa.ComponentPortKind? Kind { get; set; }
        ...
        /// </summary>
        public Auriga.Fa.OrientationPortKind? Orientation { get; set; }
        ...
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> RealizedComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();

        /// <summary>
        /// Gets the realizing component ports.
        /// </summary>
        public IEnumerable<Auriga.Fa.IComponentPort> RealizingComponentPorts => Enumerable.Empty<Auriga.Fa.IComponentPort>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComponentPort</c>.
        /// </summary>
