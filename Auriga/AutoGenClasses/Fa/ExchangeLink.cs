...
namespace Auriga.Fa
{
    ...
    /// </summary>
    public partial class ExchangeLink : Auriga.Core.AurigaElement, Auriga.Fa.IExchangeLink
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Fa.IFunctionSpecification> Destinations { get; } = new List<Auriga.Fa.IFunctionSpecification>();

        /// <summary>
        /// Gets the exchange containment links.
        /// </summary>
        public List<Auriga.Fa.IExchangeContainment> ExchangeContainmentLinks { get; } = new List<Auriga.Fa.IExchangeContainment>();

        /// <summary>
        /// Gets the exchanges.
        /// </summary>
        public IEnumerable<Auriga.Fa.IExchangeSpecification> Exchanges => Enumerable.Empty<Auriga.Fa.IExchangeSpecification>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Fa.IExchangeContainment> OwnedExchangeContainments => this.backingOwnedExchangeContainments ??= new Auriga.Core.ContainerList<Auriga.Fa.IExchangeContainment>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedExchangeContainments"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Fa.IExchangeContainment> backingOwnedExchangeContainments;
        ...
        /// Gets the sources.
        /// </summary>
        public List<Auriga.Fa.IFunctionSpecification> Sources { get; } = new List<Auriga.Fa.IFunctionSpecification>();
