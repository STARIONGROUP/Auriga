...
namespace Auriga.Fa
{
    ...
    /// </summary>
    public partial class FunctionOutputPort : Auriga.Core.AurigaElement, Auriga.Fa.IFunctionOutputPort
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Information.IExchangeItem> OutgoingExchangeItems { get; } = new List<Auriga.Information.IExchangeItem>();

        /// <summary>
        /// Gets the outgoing functional exchanges.
        /// </summary>
        public IEnumerable<Auriga.Fa.IFunctionalExchange> OutgoingFunctionalExchanges => Enumerable.Empty<Auriga.Fa.IFunctionalExchange>();
