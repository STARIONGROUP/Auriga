...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial class Switch : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.ISwitch
    {
        /// <summary>
        /// Gets the cases.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.ICase> Cases => this.backingCases ??= new Auriga.Core.ContainerList<Auriga.Diagram.Viewpoint.Description.Tool.ICase>(this);

        /// <summary>
        /// Backing field for <see cref="Cases"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.ICase> backingCases;

        /// <summary>
        /// Gets or sets the default.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IDefault Default
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IDefault backingDefault;
