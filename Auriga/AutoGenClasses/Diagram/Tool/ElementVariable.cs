// ------------------------------------------------------------------------------------------------
// <copyright file="ElementVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>ElementVariable</c> class.
    /// </summary>
    public partial class ElementVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ElementVariable</c>.
        /// </summary>
