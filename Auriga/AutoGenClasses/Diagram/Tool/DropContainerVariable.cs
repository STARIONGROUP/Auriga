// ------------------------------------------------------------------------------------------------
// <copyright file="DropContainerVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>DropContainerVariable</c> class.
    /// </summary>
    public partial class DropContainerVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>DropContainerVariable</c>.
        /// </summary>
