...
namespace Auriga.Diagram.Sequence.Description.Tool
{
    ...
    /// </summary>
    public partial class MessageCreationTool : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.Tool.IMessageCreationTool
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IEdgeMapping> EdgeMappings { get; } = new List<Auriga.Diagram.Diagram.Description.IEdgeMapping>();
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> ExtraSourceMappings { get; } = new List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping>();

        /// <summary>
        /// All mappings that create views that are able to received a request to manage this creation
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> ExtraTargetMappings { get; } = new List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping>();
        ...
        /// </summary>
        public Auriga.Diagram.Sequence.Description.IMessageEndVariable FinishingEndPredecessor
        {
        ...
        /// </summary>
        private Auriga.Diagram.Sequence.Description.IMessageEndVariable backingFinishingEndPredecessor;
        ...
        /// The first operation.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IInitEdgeCreationOperation InitialOperation
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IInitEdgeCreationOperation backingInitialOperation;
        ...
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeCreationVariable SourceVariable
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeCreationVariable backingSourceVariable;

        /// <summary>
        /// The source view (instance of EdgeTarget)
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeViewCreationVariable SourceViewVariable
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeViewCreationVariable backingSourceViewVariable;

        /// <summary>
        /// Gets or sets the starting end predecessor.
        /// </summary>
        public Auriga.Diagram.Sequence.Description.IMessageEndVariable StartingEndPredecessor
        {
        ...
        /// </summary>
        private Auriga.Diagram.Sequence.Description.IMessageEndVariable backingStartingEndPredecessor;

        /// <summary>
        /// The semantic element of the target view.
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable TargetVariable
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable backingTargetVariable;

        /// <summary>
        /// The target view (instance of EdgeTarget)
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeViewCreationVariable TargetViewVariable
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeViewCreationVariable backingTargetViewVariable;
