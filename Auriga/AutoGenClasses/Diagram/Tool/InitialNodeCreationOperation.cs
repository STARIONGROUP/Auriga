// ------------------------------------------------------------------------------------------------
// <copyright file="InitialNodeCreationOperation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial class InitialNodeCreationOperation : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IInitialNodeCreationOperation
    {
        /// <summary>
