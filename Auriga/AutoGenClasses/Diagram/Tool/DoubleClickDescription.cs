// ------------------------------------------------------------------------------------------------
// <copyright file="DoubleClickDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Tool
{
    ...
    /// </summary>
    public partial class DoubleClickDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Tool.IDoubleClickDescription
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable Element
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable backingElement;

        /// <summary>
        /// Gets or sets the element view.
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable ElementView
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable backingElementView;
