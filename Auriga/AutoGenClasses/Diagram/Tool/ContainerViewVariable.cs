// ------------------------------------------------------------------------------------------------
// <copyright file="ContainerViewVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>ContainerViewVariable</c> class.
    /// </summary>
    public partial class ContainerViewVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ContainerViewVariable</c>.
        /// </summary>
