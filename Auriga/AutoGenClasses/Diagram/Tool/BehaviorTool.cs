// ------------------------------------------------------------------------------------------------
// <copyright file="BehaviorTool.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Tool
{
    ...
    /// </summary>
    public partial class BehaviorTool : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Tool.IBehaviorTool
    {
        /// <summary>
