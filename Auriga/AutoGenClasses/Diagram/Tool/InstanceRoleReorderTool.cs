...
namespace Auriga.Diagram.Sequence.Description.Tool
{
    ...
    /// </summary>
    public partial class InstanceRoleReorderTool : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.Tool.IInstanceRoleReorderTool
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IInitialOperation InstanceRoleMoved
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IInitialOperation backingInstanceRoleMoved;
        ...
        /// Gets the mappings.
        /// </summary>
        public List<Auriga.Diagram.Sequence.Description.IInstanceRoleMapping> Mappings { get; } = new List<Auriga.Diagram.Sequence.Description.IInstanceRoleMapping>();
        ...
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable PredecessorAfter
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable backingPredecessorAfter;

        /// <summary>
        /// Gets or sets the predecessor before.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable PredecessorBefore
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IElementVariable backingPredecessorBefore;
