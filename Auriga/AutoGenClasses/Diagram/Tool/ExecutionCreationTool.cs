// ------------------------------------------------------------------------------------------------
// <copyright file="ExecutionCreationTool.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Description.Tool
{
    ...
    /// <summary>
    /// Definition of the <c>ExecutionCreationTool</c> class.
    /// </summary>
    public partial class ExecutionCreationTool : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.Tool.IExecutionCreationTool
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.INodeMapping> NodeMappings { get; } = new List<Auriga.Diagram.Diagram.Description.INodeMapping>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExecutionCreationTool</c>.
        /// </summary>
