// ------------------------------------------------------------------------------------------------
// <copyright file="SourceEdgeViewCreationVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>SourceEdgeViewCreationVariable</c> class.
    /// </summary>
    public partial class SourceEdgeViewCreationVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Tool.ISourceEdgeViewCreationVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SourceEdgeViewCreationVariable</c>.
        /// </summary>
