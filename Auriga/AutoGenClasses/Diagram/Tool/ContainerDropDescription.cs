...
namespace Auriga.Diagram.Diagram.Description.Tool
{
    ...
    public partial class ContainerDropDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Tool.IContainerDropDescription
    {
        ...
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.DragSource DragSource { get; set; }

        /// <summary>
        /// The semantic element that is dragged and dropped.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IElementDropVariable Element
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IElementDropVariable backingElement;
        ...
        /// The first operation.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IInitialContainerDropOperation InitialOperation
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IInitialContainerDropOperation backingInitialOperation;
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> Mappings { get; } = new List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping>();
        ...
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable NewContainer
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable backingNewContainer;

        /// <summary>
        /// The new view container (instance of ViewPoint or ViewPointElement).
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable NewViewContainer
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable backingNewViewContainer;

        /// <summary>
        /// The semantic element of the old container view.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable OldContainer
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IDropContainerVariable backingOldContainer;
