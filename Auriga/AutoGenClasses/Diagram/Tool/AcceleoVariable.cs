// ------------------------------------------------------------------------------------------------
// <copyright file="AcceleoVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>AcceleoVariable</c> class.
    /// </summary>
    public partial class AcceleoVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IAcceleoVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>AcceleoVariable</c>.
        /// </summary>
