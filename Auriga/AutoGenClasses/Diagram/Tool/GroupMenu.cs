...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial class GroupMenu : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenu
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenuItem> ItemDescriptions => this.backingItemDescriptions ??= new Auriga.Core.ContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenuItem>(this);

        /// <summary>
        /// Backing field for <see cref="ItemDescriptions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IGroupMenuItem> backingItemDescriptions;
