// ------------------------------------------------------------------------------------------------
// <copyright file="ExternalJavaAction.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial class ExternalJavaAction : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaAction
    {
        /// <summary>
        ...
        /// Gets the parameters.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter> Parameters => this.backingParameters ??= new Auriga.Core.ContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter>(this);

        /// <summary>
        /// Backing field for <see cref="Parameters"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionParameter> backingParameters;
