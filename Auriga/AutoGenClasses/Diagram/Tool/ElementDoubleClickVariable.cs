// ------------------------------------------------------------------------------------------------
// <copyright file="ElementDoubleClickVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>ElementDoubleClickVariable</c> class.
    /// </summary>
    public partial class ElementDoubleClickVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Tool.IElementDoubleClickVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ElementDoubleClickVariable</c>.
        /// </summary>
