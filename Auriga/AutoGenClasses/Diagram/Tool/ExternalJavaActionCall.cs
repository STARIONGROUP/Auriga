...
namespace Auriga.Diagram.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public partial class ExternalJavaActionCall : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaActionCall
    {
        /// <summary>
        /// The action to call.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IExternalJavaAction Action { get; set; }
