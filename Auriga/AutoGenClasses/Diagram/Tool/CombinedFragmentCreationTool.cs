// ------------------------------------------------------------------------------------------------
// <copyright file="CombinedFragmentCreationTool.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Description.Tool
{
    ...
    /// <summary>
    /// Definition of the <c>CombinedFragmentCreationTool</c> class.
    /// </summary>
    public partial class CombinedFragmentCreationTool : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.Tool.ICombinedFragmentCreationTool
    {
        /// <summary>
        /// The ContainerMapping to use.
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IContainerMapping> ContainerMappings { get; } = new List<Auriga.Diagram.Diagram.Description.IContainerMapping>();

        /// <summary>
        /// Gets or sets the covered lifelines.
        /// </summary>
        public Auriga.Diagram.Sequence.Description.ICoveredLifelinesVariable CoveredLifelines
        {
            get => this.backingCoveredLifelines;
            set
            {
                if (value != null)
                {
                ...
                this.backingCoveredLifelines = value;
            }
        }

        /// <summary>
        /// Backing field for <see cref="CoveredLifelines"/>.
        /// </summary>
        private Auriga.Diagram.Sequence.Description.ICoveredLifelinesVariable backingCoveredLifelines;
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping> ExtraMappings { get; } = new List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping>();
        ...
        /// The first operation.
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IInitialNodeCreationOperation InitialOperation
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IInitialNodeCreationOperation backingInitialOperation;
        ...
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Tool.INodeCreationVariable Variable
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Tool.INodeCreationVariable backingVariable;

        /// <summary>
        /// The clicked view (instance of ViewPoint or ViewNodeContainer).
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable ViewVariable
        {
        ...
        /// </summary>
        private Auriga.Diagram.Viewpoint.Description.Tool.IContainerViewVariable backingViewVariable;

        /// <summary>
        /// Gets the elements directly contained by this <c>CombinedFragmentCreationTool</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            {
                yield return this.CoveredLifelines;
            }
