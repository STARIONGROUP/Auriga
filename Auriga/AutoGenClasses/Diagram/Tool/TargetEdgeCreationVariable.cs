// ------------------------------------------------------------------------------------------------
// <copyright file="TargetEdgeCreationVariable.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Tool
{
    ...
    /// </summary>
    public partial class TargetEdgeCreationVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Tool.ITargetEdgeCreationVariable
    {
        /// <summary>
