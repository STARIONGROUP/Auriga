// ------------------------------------------------------------------------------------------------
// <copyright file="ElementDropVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>ElementDropVariable</c> class.
    /// </summary>
    public partial class ElementDropVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.IElementDropVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ElementDropVariable</c>.
        /// </summary>
