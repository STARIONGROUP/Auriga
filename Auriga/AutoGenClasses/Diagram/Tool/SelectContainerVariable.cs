// ------------------------------------------------------------------------------------------------
// <copyright file="SelectContainerVariable.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>SelectContainerVariable</c> class.
    /// </summary>
    public partial class SelectContainerVariable : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Tool.ISelectContainerVariable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SelectContainerVariable</c>.
        /// </summary>
