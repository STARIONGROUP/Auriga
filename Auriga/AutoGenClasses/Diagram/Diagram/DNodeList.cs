...
namespace Auriga.Diagram.Diagram
{
    ...
    /// </summary>
    public partial class DNodeList : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.IDNodeList
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Diagram.IDNodeListElement> OwnedElements => this.backingOwnedElements ??= new Auriga.Core.ContainerList<Auriga.Diagram.Diagram.IDNodeListElement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedElements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Diagram.IDNodeListElement> backingOwnedElements;
