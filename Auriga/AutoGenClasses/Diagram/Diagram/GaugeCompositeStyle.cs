...
namespace Auriga.Diagram.Diagram
{
    ...
    /// </summary>
    public partial class GaugeCompositeStyle : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.IGaugeCompositeStyle
    {
        /// <summary>
        ...
        /// The sections.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Diagram.IGaugeSection> Sections => this.backingSections ??= new Auriga.Core.ContainerList<Auriga.Diagram.Diagram.IGaugeSection>(this);

        /// <summary>
        /// Backing field for <see cref="Sections"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Diagram.IGaugeSection> backingSections;
