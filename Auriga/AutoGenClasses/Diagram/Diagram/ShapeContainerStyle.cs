...
namespace Auriga.Diagram.Diagram
{
    ...
    /// </summary>
    public partial class ShapeContainerStyle : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.IShapeContainerStyle
    {
        /// <summary>
        /// The background color.
        /// </summary>
        public string BackgroundColor { get; set; } = "209,209,209";
