// ------------------------------------------------------------------------------------------------
// <copyright file="DDiagram.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram
{
    ...
    /// </summary>
    public partial class DDiagram : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.IDDiagram
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>DDiagram</c>.
        /// </summary>
