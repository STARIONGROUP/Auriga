// ------------------------------------------------------------------------------------------------
// <copyright file="TConditionalExecutionStyle.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Template
{
    ...
    /// </summary>
    public partial class TConditionalExecutionStyle : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Template.ITConditionalExecutionStyle
    {
        /// <summary>
        /// Gets the outputs.
        /// </summary>
