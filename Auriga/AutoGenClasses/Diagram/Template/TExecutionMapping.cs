...
namespace Auriga.Diagram.Sequence.Template
{
    ...
    /// </summary>
    public partial class TExecutionMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Template.ITExecutionMapping
    {
        /// <summary>
        /// Gets the conditional styles.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Sequence.Template.ITConditionalExecutionStyle> ConditionalStyles => this.backingConditionalStyles ??= new Auriga.Core.ContainerList<Auriga.Diagram.Sequence.Template.ITConditionalExecutionStyle>(this);

        /// <summary>
        /// Backing field for <see cref="ConditionalStyles"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Sequence.Template.ITConditionalExecutionStyle> backingConditionalStyles;
        ...
        /// </summary>
        public Auriga.Diagram.Sequence.Template.ITExecutionStyle Style
        {
        ...
        /// </summary>
        private Auriga.Diagram.Sequence.Template.ITExecutionStyle backingStyle;
