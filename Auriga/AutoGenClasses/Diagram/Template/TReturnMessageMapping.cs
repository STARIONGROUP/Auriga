// ------------------------------------------------------------------------------------------------
// <copyright file="TReturnMessageMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Template
{
    ...
    /// <summary>
    /// Definition of the <c>TReturnMessageMapping</c> class.
    /// </summary>
    public partial class TReturnMessageMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Template.ITReturnMessageMapping
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Sequence.Template.ITBasicMessageMapping InvocationMapping { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>TReturnMessageMapping</c>.
        /// </summary>
