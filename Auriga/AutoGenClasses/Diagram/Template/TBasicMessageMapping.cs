// ------------------------------------------------------------------------------------------------
// <copyright file="TBasicMessageMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Template
{
    ...
    /// <summary>
    /// Definition of the <c>TBasicMessageMapping</c> class.
    /// </summary>
    public partial class TBasicMessageMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Template.ITBasicMessageMapping
    {
        /// <summary>
        ...
        /// Gets the target.
        /// </summary>
        public List<Auriga.Diagram.Sequence.Template.ITMessageExtremity> Target { get; } = new List<Auriga.Diagram.Sequence.Template.ITMessageExtremity>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>TBasicMessageMapping</c>.
        /// </summary>
