// ------------------------------------------------------------------------------------------------
// <copyright file="DeleteLineTool.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>DeleteLineTool</c> class.
    /// </summary>
    public partial class DeleteLineTool : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.IDeleteLineTool
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>DeleteLineTool</c>.
        /// </summary>
