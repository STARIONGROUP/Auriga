// ------------------------------------------------------------------------------------------------
// <copyright file="CreateCrossColumnTool.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Table.Description
{
    ...
    /// </summary>
    public partial class CreateCrossColumnTool : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.ICreateCrossColumnTool
    {
        /// <summary>
