// ------------------------------------------------------------------------------------------------
// <copyright file="DeleteColumnTool.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>DeleteColumnTool</c> class.
    /// </summary>
    public partial class DeleteColumnTool : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.IDeleteColumnTool
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Table.Description.IElementColumnMapping Mapping { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>DeleteColumnTool</c>.
        /// </summary>
