...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial class OrderedTreeLayout : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.IOrderedTreeLayout
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping> NodeMapping { get; } = new List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping>();
