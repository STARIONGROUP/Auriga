// ------------------------------------------------------------------------------------------------
// <copyright file="FixedColor.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description
{
    ...
    /// </summary>
    public partial class FixedColor : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.IFixedColor
    {
        /// <summary>
