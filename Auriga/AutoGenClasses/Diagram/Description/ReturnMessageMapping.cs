// ------------------------------------------------------------------------------------------------
// <copyright file="ReturnMessageMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>ReturnMessageMapping</c> class.
    /// </summary>
    public partial class ReturnMessageMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.IReturnMessageMapping
    {
        /// <summary>
        /// All conditional styles.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.IConditionalEdgeStyleDescription> ConditionnalStyles => this.backingConditionnalStyles ??= new Auriga.Core.ContainerList<Auriga.Diagram.Diagram.Description.IConditionalEdgeStyleDescription>(this);

        /// <summary>
        /// Backing field for <see cref="ConditionnalStyles"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.IConditionalEdgeStyleDescription> backingConditionnalStyles;
        ...
        /// </summary>
        public string InvocationMessageFinderExpression { get; set; }
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping> PathNodeMapping { get; } = new List<Auriga.Diagram.Diagram.Description.IAbstractNodeMapping>();
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.Tool.IReconnectEdgeDescription> Reconnections { get; } = new List<Auriga.Diagram.Diagram.Description.Tool.IReconnectEdgeDescription>();
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> SourceMapping { get; } = new List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping>();

        /// <summary>
        /// The style of the edge.
        /// </summary>
        public Auriga.Diagram.Diagram.Description.Style.IEdgeStyleDescription Style
        {
        ...
        /// </summary>
        private Auriga.Diagram.Diagram.Description.Style.IEdgeStyleDescription backingStyle;
        ...
        /// </summary>
        public List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping> TargetMapping { get; } = new List<Auriga.Diagram.Diagram.Description.IDiagramElementMapping>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ReturnMessageMapping</c>.
        /// </summary>
