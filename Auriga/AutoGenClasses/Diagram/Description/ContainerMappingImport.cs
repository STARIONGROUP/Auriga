...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial class ContainerMappingImport : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.IContainerMappingImport
    {
        /// <summary>
        ...
        /// </summary>
        public bool? HideSubMappings { get; set; } = false;

        /// <summary>
        /// The imported mapping used to define default values for the current mapping.
        /// </summary>
        public Auriga.Diagram.Diagram.Description.IContainerMapping ImportedMapping { get; set; }
