// ------------------------------------------------------------------------------------------------
// <copyright file="DestructionMessageMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>DestructionMessageMapping</c> class.
    /// </summary>
    public partial class DestructionMessageMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.IDestructionMessageMapping
    {
        /// <summary>
