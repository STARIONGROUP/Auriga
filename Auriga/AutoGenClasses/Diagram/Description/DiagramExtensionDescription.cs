...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial class DiagramExtensionDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.IDiagramExtensionDescription
    {
        /// <summary>
        ...
        /// Gets the layers.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.IAdditionalLayer> Layers => this.backingLayers ??= new Auriga.Core.ContainerList<Auriga.Diagram.Diagram.Description.IAdditionalLayer>(this);

        /// <summary>
        /// Backing field for <see cref="Layers"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.IAdditionalLayer> backingLayers;
