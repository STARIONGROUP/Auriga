// ------------------------------------------------------------------------------------------------
// <copyright file="IntegerLayoutOption.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description
{
    ...
    /// </summary>
    public partial class IntegerLayoutOption : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.IIntegerLayoutOption
    {
        /// <summary>
