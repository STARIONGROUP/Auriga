// ------------------------------------------------------------------------------------------------
// <copyright file="CreateColumnTool.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>CreateColumnTool</c> class.
    /// </summary>
    public partial class CreateColumnTool : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.ICreateColumnTool
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CreateColumnTool</c>.
        /// </summary>
