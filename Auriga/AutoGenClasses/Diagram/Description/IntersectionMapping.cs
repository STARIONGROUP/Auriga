// ------------------------------------------------------------------------------------------------
// <copyright file="IntersectionMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Table.Description
{
    ...
    /// <summary>
    /// Definition of the <c>IntersectionMapping</c> class.
    /// </summary>
    public partial class IntersectionMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.IIntersectionMapping
    {
        /// <summary>
        ...
        /// </summary>
        public string ColumnFinderExpression { get; set; }

        /// <summary>
        /// Gets or sets the column mapping.
        /// </summary>
        public Auriga.Diagram.Table.Description.IColumnMapping ColumnMapping { get; set; }

        /// <summary>
        /// Gets or sets the create.
        /// </summary>
        public Auriga.Diagram.Table.Description.ICreateCellTool Create
        {
            get => this.backingCreate;
            set
            {
                if (value != null)
                {
        ...
        /// </summary>
        private Auriga.Diagram.Table.Description.ICreateCellTool backingCreate;
        ...
        /// </summary>
        public string LineFinderExpression { get; set; }

        /// <summary>
        /// Gets the line mapping.
        /// </summary>
        public List<Auriga.Diagram.Table.Description.ILineMapping> LineMapping { get; } = new List<Auriga.Diagram.Table.Description.ILineMapping>();
