...
namespace Auriga.Diagram.Table.Description
{
    ...
    /// </summary>
    public partial class LineMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.ILineMapping
    {
        /// <summary>
        /// Gets the all sub lines.
        /// </summary>
        public IEnumerable<Auriga.Diagram.Table.Description.ILineMapping> AllSubLines => Enumerable.Empty<Auriga.Diagram.Table.Description.ILineMapping>();
        ...
        /// Gets the create.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Table.Description.ICreateLineTool> Create => this.backingCreate ??= new Auriga.Core.ContainerList<Auriga.Diagram.Table.Description.ICreateLineTool>(this);

        /// <summary>
        /// Backing field for <see cref="Create"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Table.Description.ICreateLineTool> backingCreate;
        ...
        /// </summary>
        public Auriga.Diagram.Table.Description.IDeleteLineTool Delete
        {
        ...
        /// </summary>
        private Auriga.Diagram.Table.Description.IDeleteLineTool backingDelete;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Table.Description.ILineMapping> OwnedSubLines => this.backingOwnedSubLines ??= new Auriga.Core.ContainerList<Auriga.Diagram.Table.Description.ILineMapping>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSubLines"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Table.Description.ILineMapping> backingOwnedSubLines;

        /// <summary>
        /// Gets the reused in mappings.
        /// </summary>
        public List<Auriga.Diagram.Table.Description.ILineMapping> ReusedInMappings { get; } = new List<Auriga.Diagram.Table.Description.ILineMapping>();

        /// <summary>
        /// Gets the reused sub lines.
        /// </summary>
        public List<Auriga.Diagram.Table.Description.ILineMapping> ReusedSubLines { get; } = new List<Auriga.Diagram.Table.Description.ILineMapping>();
