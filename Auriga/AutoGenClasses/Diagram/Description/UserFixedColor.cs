// ------------------------------------------------------------------------------------------------
// <copyright file="UserFixedColor.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description
{
    ...
    /// </summary>
    public partial class UserFixedColor : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.IUserFixedColor
    {
        /// <summary>
