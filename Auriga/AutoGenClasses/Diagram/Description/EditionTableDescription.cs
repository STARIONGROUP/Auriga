...
namespace Auriga.Diagram.Table.Description
{
    ...
    /// </summary>
    public partial class EditionTableDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.IEditionTableDescription
    {
        /// <summary>
        /// Gets the all column mappings.
        /// </summary>
        public IEnumerable<Auriga.Diagram.Table.Description.IFeatureColumnMapping> AllColumnMappings => Enumerable.Empty<Auriga.Diagram.Table.Description.IFeatureColumnMapping>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Table.Description.IFeatureColumnMapping> OwnedColumnMappings => this.backingOwnedColumnMappings ??= new Auriga.Core.ContainerList<Auriga.Diagram.Table.Description.IFeatureColumnMapping>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedColumnMappings"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Table.Description.IFeatureColumnMapping> backingOwnedColumnMappings;
        ...
        /// </summary>
        public List<Auriga.Diagram.Table.Description.IFeatureColumnMapping> ReusedColumnMappings { get; } = new List<Auriga.Diagram.Table.Description.IFeatureColumnMapping>();
