// ------------------------------------------------------------------------------------------------
// <copyright file="CreateLineTool.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>CreateLineTool</c> class.
    /// </summary>
    public partial class CreateLineTool : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.ICreateLineTool
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Table.Description.ILineMapping Mapping { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CreateLineTool</c>.
        /// </summary>
