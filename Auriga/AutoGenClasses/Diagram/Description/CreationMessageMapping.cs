// ------------------------------------------------------------------------------------------------
// <copyright file="CreationMessageMapping.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Sequence.Description
{
    ...
    /// <summary>
    /// Definition of the <c>CreationMessageMapping</c> class.
    /// </summary>
    public partial class CreationMessageMapping : Auriga.Core.AurigaElement, Auriga.Diagram.Sequence.Description.ICreationMessageMapping
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CreationMessageMapping</c>.
        /// </summary>
