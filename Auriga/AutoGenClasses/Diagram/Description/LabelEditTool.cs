// ------------------------------------------------------------------------------------------------
// <copyright file="LabelEditTool.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>LabelEditTool</c> class.
    /// </summary>
    public partial class LabelEditTool : Auriga.Core.AurigaElement, Auriga.Diagram.Table.Description.ILabelEditTool
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>LabelEditTool</c>.
        /// </summary>
