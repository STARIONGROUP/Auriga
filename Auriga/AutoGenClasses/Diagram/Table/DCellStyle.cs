...
namespace Auriga.Diagram.Table
{
    ...
    /// </summary>
    public partial class DCellStyle : Auriga.Core.AurigaElement, Auriga.Diagram.Table.IDCellStyle
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Table.Description.ITableMapping BackgroundStyleOrigin { get; set; }
        ...
        /// This TableMapping can be only an IntersectionMapping or a  ColumnMapping.
        /// </summary>
        public Auriga.Diagram.Table.Description.ITableMapping ForegroundStyleOrigin { get; set; }
