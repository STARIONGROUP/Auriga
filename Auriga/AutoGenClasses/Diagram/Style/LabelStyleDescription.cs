// ------------------------------------------------------------------------------------------------
// <copyright file="LabelStyleDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Viewpoint.Description.Style
{
    ...
    /// </summary>
    public partial class LabelStyleDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Viewpoint.Description.Style.ILabelStyleDescription
    {
        /// <summary>
