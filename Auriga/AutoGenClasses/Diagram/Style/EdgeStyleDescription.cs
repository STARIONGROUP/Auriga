// ------------------------------------------------------------------------------------------------
// <copyright file="EdgeStyleDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class EdgeStyleDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.IEdgeStyleDescription
    {
        /// <summary>
