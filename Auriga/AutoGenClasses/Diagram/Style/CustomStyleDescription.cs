// ------------------------------------------------------------------------------------------------
// <copyright file="CustomStyleDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// <summary>
    /// Definition of the <c>CustomStyleDescription</c> class.
    /// </summary>
    public partial class CustomStyleDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.ICustomStyleDescription
    {
        /// <summary>
