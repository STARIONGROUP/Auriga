// ------------------------------------------------------------------------------------------------
// <copyright file="EllipseNodeDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class EllipseNodeDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.IEllipseNodeDescription
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.IColorDescription Color { get; set; }
        ...
        /// </summary>
        public string HorizontalDiameterComputationExpression { get; set; } = "0";
        ...
        /// </summary>
        public string VerticalDiameterComputationExpression { get; set; } = "0";
