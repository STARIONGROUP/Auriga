// ------------------------------------------------------------------------------------------------
// <copyright file="NoteDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class NoteDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.INoteDescription
    {
        /// <summary>
