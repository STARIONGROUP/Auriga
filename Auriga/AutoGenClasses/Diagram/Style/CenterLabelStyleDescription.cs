// ------------------------------------------------------------------------------------------------
// <copyright file="CenterLabelStyleDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class CenterLabelStyleDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.ICenterLabelStyleDescription
    {
        /// <summary>
