// ------------------------------------------------------------------------------------------------
// <copyright file="LozengeNodeDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class LozengeNodeDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.ILozengeNodeDescription
    {
        /// <summary>
