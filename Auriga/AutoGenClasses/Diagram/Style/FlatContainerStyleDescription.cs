// ------------------------------------------------------------------------------------------------
// <copyright file="FlatContainerStyleDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class FlatContainerStyleDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.IFlatContainerStyleDescription
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Diagram.Viewpoint.Description.Style.ILabelBorderStyleDescription LabelBorderStyle { get; set; }
