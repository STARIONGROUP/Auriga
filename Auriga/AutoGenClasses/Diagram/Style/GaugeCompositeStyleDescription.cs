// ------------------------------------------------------------------------------------------------
// <copyright file="GaugeCompositeStyleDescription.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Diagram.Description.Style
{
    ...
    /// </summary>
    public partial class GaugeCompositeStyleDescription : Auriga.Core.AurigaElement, Auriga.Diagram.Diagram.Description.Style.IGaugeCompositeStyleDescription
    {
        /// <summary>
        /// The alignment of the gauges
        /// </summary>
        public Auriga.Diagram.Diagram.AlignmentKind? Alignment { get; set; } = Auriga.Diagram.Diagram.AlignmentKind.SQUARE;
        ...
        /// The sections.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription> Sections => this.backingSections ??= new Auriga.Core.ContainerList<Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription>(this);

        /// <summary>
        /// Backing field for <see cref="Sections"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Diagram.Diagram.Description.Style.IGaugeSectionDescription> backingSections;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>GaugeCompositeStyleDescription</c>.
        /// </summary>
