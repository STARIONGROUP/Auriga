// ------------------------------------------------------------------------------------------------
// <copyright file="BasicSemanticCompartment.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Notation
{
    ...
    /// <summary>
    /// Definition of the <c>BasicSemanticCompartment</c> class.
    /// </summary>
    public partial class BasicSemanticCompartment : Auriga.Core.AurigaElement, Auriga.Diagram.Notation.IBasicSemanticCompartment
    {
        /// <summary>
