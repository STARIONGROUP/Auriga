// ------------------------------------------------------------------------------------------------
// <copyright file="ListCompartment.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Notation
{
    ...
    /// </summary>
    public partial class ListCompartment : Auriga.Core.AurigaElement, Auriga.Diagram.Notation.IListCompartment
    {
        /// <summary>
