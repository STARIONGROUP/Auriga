// ------------------------------------------------------------------------------------------------
// <copyright file="Compartment.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Diagram.Notation
{
    ...
    /// <summary>
    /// Definition of the <c>Compartment</c> class.
    /// </summary>
    public partial class Compartment : Auriga.Core.AurigaElement, Auriga.Diagram.Notation.ICompartment
    {
        /// <summary>
