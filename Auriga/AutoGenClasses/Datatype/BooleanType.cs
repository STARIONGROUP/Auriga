// ------------------------------------------------------------------------------------------------
// <copyright file="BooleanType.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Information.Datatype
{
    ...
    /// <summary>
    /// Definition of the <c>BooleanType</c> class.
    /// </summary>
    public partial class BooleanType : Auriga.Core.AurigaElement, Auriga.Information.Datatype.IBooleanType
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Information.Datavalue.ILiteralBooleanValue> OwnedLiterals => this.backingOwnedLiterals ??= new Auriga.Core.ContainerList<Auriga.Information.Datavalue.ILiteralBooleanValue>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLiterals"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Information.Datavalue.ILiteralBooleanValue> backingOwnedLiterals;
