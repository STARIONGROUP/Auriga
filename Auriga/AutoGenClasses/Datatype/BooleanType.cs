...
namespace Auriga.Information.Datatype
{
    ...
    /// </summary>
    public partial class BooleanType : Auriga.AurigaElement, Auriga.Information.Datatype.IBooleanType
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.IContainerList<Auriga.Information.Datavalue.ILiteralBooleanValue> OwnedLiterals => this.backingOwnedLiterals ??= new Auriga.ContainerList<Auriga.Information.Datavalue.ILiteralBooleanValue>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLiterals"/>.
        /// </summary>
        private Auriga.IContainerList<Auriga.Information.Datavalue.ILiteralBooleanValue> backingOwnedLiterals;
