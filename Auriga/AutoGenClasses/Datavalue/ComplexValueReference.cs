...
namespace Auriga.Information.Datavalue
{
    ...
    /// </summary>
    public partial class ComplexValueReference : Auriga.Core.AurigaElement, Auriga.Information.Datavalue.IComplexValueReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Information.IProperty ReferencedProperty { get; set; }

        /// <summary>
        /// Gets or sets the referenced value.
        /// </summary>
        public Auriga.Information.Datavalue.IAbstractComplexValue ReferencedValue { get; set; }
