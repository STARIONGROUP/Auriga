// ------------------------------------------------------------------------------------------------
// <copyright file="ComponentExchangeRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ComponentExchangeRealization</c> class.
    /// </summary>
    public partial class ComponentExchangeRealization : Auriga.Core.AurigaElement, Auriga.Model.Fa.IComponentExchangeRealization
    {
        /// <summary>
        /// Gets the allocated component exchange.
        /// </summary>
        public Auriga.Model.Fa.IComponentExchange AllocatedComponentExchange => default;

        /// <summary>
        /// Gets the allocating component exchange.
        /// </summary>
        public Auriga.Model.Fa.IComponentExchange AllocatingComponentExchange => default;
        ...
        /// </summary>
        public Auriga.Model.Fa.IExchangeSpecification RealizedExchangeSpecification => default;
        ...
        /// </summary>
        public Auriga.Model.Fa.IExchangeSpecification RealizingExchangeSpecification => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComponentExchangeRealization</c>.
        /// </summary>
