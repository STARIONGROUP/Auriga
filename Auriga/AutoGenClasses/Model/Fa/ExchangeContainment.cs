// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeContainment.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ExchangeContainment</c> class.
    /// </summary>
    public partial class ExchangeContainment : Auriga.Core.AurigaElement, Auriga.Model.Fa.IExchangeContainment
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Fa.IExchangeSpecification Exchange { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Fa.IExchangeLink Link { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExchangeContainment</c>.
        /// </summary>
