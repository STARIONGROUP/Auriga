// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ExchangeLink</c> class.
    /// </summary>
    public partial class ExchangeLink : Auriga.Core.AurigaElement, Auriga.Model.Fa.IExchangeLink
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Fa.IFunctionSpecification> Destinations { get; } = new List<Auriga.Model.Fa.IFunctionSpecification>();

        /// <summary>
        /// Gets the exchange containment links.
        /// </summary>
        public List<Auriga.Model.Fa.IExchangeContainment> ExchangeContainmentLinks { get; } = new List<Auriga.Model.Fa.IExchangeContainment>();

        /// <summary>
        /// Gets the exchanges.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IExchangeSpecification> Exchanges => Enumerable.Empty<Auriga.Model.Fa.IExchangeSpecification>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Fa.IExchangeContainment> OwnedExchangeContainments => this.backingOwnedExchangeContainments ??= new Auriga.Core.ContainerList<Auriga.Model.Fa.IExchangeContainment>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedExchangeContainments"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Fa.IExchangeContainment> backingOwnedExchangeContainments;
        ...
        /// Gets the sources.
        /// </summary>
        public List<Auriga.Model.Fa.IFunctionSpecification> Sources { get; } = new List<Auriga.Model.Fa.IFunctionSpecification>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExchangeLink</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedExchangeContainments)
            {
                yield return element;
            }
