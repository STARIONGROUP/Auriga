...
namespace Auriga.Model.Fa
{
    ...
    /// </summary>
    public partial class FunctionInputPort : Auriga.Core.AurigaElement, Auriga.Model.Fa.IFunctionInputPort
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Information.IExchangeItem> IncomingExchangeItems { get; } = new List<Auriga.Model.Information.IExchangeItem>();

        /// <summary>
        /// Gets the incoming functional exchanges.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalExchange> IncomingFunctionalExchanges => Enumerable.Empty<Auriga.Model.Fa.IFunctionalExchange>();
        ...
        /// </summary>
        public Auriga.Model.Activity.IAbstractAction InputEvaluationAction { get; set; }
