// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalChainInvolvementFunction.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>FunctionalChainInvolvementFunction</c> class.
    /// </summary>
    public partial class FunctionalChainInvolvementFunction : Auriga.Core.AurigaElement, Auriga.Model.Fa.IFunctionalChainInvolvementFunction
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalChainInvolvementLink> IncomingInvolvementLinks => Enumerable.Empty<Auriga.Model.Fa.IFunctionalChainInvolvementLink>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalChainInvolvementLink> OutgoingInvolvementLinks => Enumerable.Empty<Auriga.Model.Fa.IFunctionalChainInvolvementLink>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FunctionalChainInvolvementFunction</c>.
        /// </summary>
