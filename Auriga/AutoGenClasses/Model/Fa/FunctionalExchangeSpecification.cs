// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalExchangeSpecification.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>FunctionalExchangeSpecification</c> class.
    /// </summary>
    public partial class FunctionalExchangeSpecification : Auriga.Core.AurigaElement, Auriga.Model.Fa.IFunctionalExchangeSpecification
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the functional exchanges.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalExchange> FunctionalExchanges => Enumerable.Empty<Auriga.Model.Fa.IFunctionalExchange>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FunctionalExchangeSpecification</c>.
        /// </summary>
