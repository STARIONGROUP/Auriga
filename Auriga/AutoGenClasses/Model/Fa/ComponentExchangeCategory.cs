// ------------------------------------------------------------------------------------------------
// <copyright file="ComponentExchangeCategory.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ComponentExchangeCategory</c> class.
    /// </summary>
    public partial class ComponentExchangeCategory : Auriga.Core.AurigaElement, Auriga.Model.Fa.IComponentExchangeCategory
    {
        /// <summary>
        ...
        /// Gets the exchanges.
        /// </summary>
        public List<Auriga.Model.Fa.IComponentExchange> Exchanges { get; } = new List<Auriga.Model.Fa.IComponentExchange>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComponentExchangeCategory</c>.
        /// </summary>
