// ------------------------------------------------------------------------------------------------
// <copyright file="ControlNode.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ControlNode</c> class.
    /// </summary>
    public partial class ControlNode : Auriga.Core.AurigaElement, Auriga.Model.Fa.IControlNode
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Fa.ControlNodeKind? Kind { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ControlNode</c>.
        /// </summary>
