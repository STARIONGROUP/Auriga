// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalChainInvolvementLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>FunctionalChainInvolvementLink</c> class.
    /// </summary>
    public partial class FunctionalChainInvolvementLink : Auriga.Core.AurigaElement, Auriga.Model.Fa.IFunctionalChainInvolvementLink
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IConstraint ExchangeContext { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IInvolvedElement Involved { get; set; }

        /// <summary>
        /// Gets the involved element.
        /// </summary>
        public Auriga.Model.Capellacore.IInvolvedElement InvolvedElement => default;

        /// <summary>
        /// Gets the involver.
        /// </summary>
        public Auriga.Model.Capellacore.IInvolverElement Involver => default;

        /// <summary>
        /// Gets the next functional chain involvements.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalChainInvolvement> NextFunctionalChainInvolvements => Enumerable.Empty<Auriga.Model.Fa.IFunctionalChainInvolvement>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalChainInvolvement> PreviousFunctionalChainInvolvements => Enumerable.Empty<Auriga.Model.Fa.IFunctionalChainInvolvement>();
        ...
        /// </summary>
        public Auriga.Model.Fa.IFunctionalChainInvolvementFunction Source { get; set; }

        /// <summary>
        /// Gets the source reference hierarchy.
        /// </summary>
        public List<Auriga.Model.Fa.IFunctionalChainReference> SourceReferenceHierarchy { get; } = new List<Auriga.Model.Fa.IFunctionalChainReference>();
        ...
        /// </summary>
        public Auriga.Model.Fa.IFunctionalChainInvolvementFunction Target { get; set; }

        /// <summary>
        /// Gets the target reference hierarchy.
        /// </summary>
        public List<Auriga.Model.Fa.IFunctionalChainReference> TargetReferenceHierarchy { get; } = new List<Auriga.Model.Fa.IFunctionalChainReference>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FunctionalChainInvolvementLink</c>.
        /// </summary>
