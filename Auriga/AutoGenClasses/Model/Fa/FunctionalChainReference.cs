// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalChainReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>FunctionalChainReference</c> class.
    /// </summary>
    public partial class FunctionalChainReference : Auriga.Core.AurigaElement, Auriga.Model.Fa.IFunctionalChainReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Fa.IFunctionalChain ReferencedFunctionalChain => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FunctionalChainReference</c>.
        /// </summary>
