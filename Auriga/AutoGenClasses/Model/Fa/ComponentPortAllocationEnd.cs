// ------------------------------------------------------------------------------------------------
// <copyright file="ComponentPortAllocationEnd.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ComponentPortAllocationEnd</c> class.
    /// </summary>
    public partial class ComponentPortAllocationEnd : Auriga.Core.AurigaElement, Auriga.Model.Fa.IComponentPortAllocationEnd
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Fa.IComponentPortAllocation OwningComponentPortAllocation => default;

        /// <summary>
        /// Gets or sets the part.
        /// </summary>
        public Auriga.Model.Cs.IPart Part { get; set; }

        /// <summary>
        /// Gets or sets the port.
        /// </summary>
        public Auriga.Model.Information.IPort Port { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComponentPortAllocationEnd</c>.
        /// </summary>
