// ------------------------------------------------------------------------------------------------
// <copyright file="ComponentExchangeEnd.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ComponentExchangeEnd</c> class.
    /// </summary>
    public partial class ComponentExchangeEnd : Auriga.Core.AurigaElement, Auriga.Model.Fa.IComponentExchangeEnd
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComponentExchangeEnd</c>.
        /// </summary>
