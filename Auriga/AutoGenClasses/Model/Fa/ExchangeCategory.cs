// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeCategory.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>ExchangeCategory</c> class.
    /// </summary>
    public partial class ExchangeCategory : Auriga.Core.AurigaElement, Auriga.Model.Fa.IExchangeCategory
    {
        /// <summary>
        ...
        /// Gets the exchanges.
        /// </summary>
        public List<Auriga.Model.Fa.IFunctionalExchange> Exchanges { get; } = new List<Auriga.Model.Fa.IFunctionalExchange>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExchangeCategory</c>.
        /// </summary>
