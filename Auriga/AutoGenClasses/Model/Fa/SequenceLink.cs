// ------------------------------------------------------------------------------------------------
// <copyright file="SequenceLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Fa
{
    ...
    /// <summary>
    /// Definition of the <c>SequenceLink</c> class.
    /// </summary>
    public partial class SequenceLink : Auriga.Core.AurigaElement, Auriga.Model.Fa.ISequenceLink
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IConstraint Condition { get; set; }
        ...
        /// Gets the links.
        /// </summary>
        public List<Auriga.Model.Fa.IFunctionalChainInvolvementLink> Links { get; } = new List<Auriga.Model.Fa.IFunctionalChainInvolvementLink>();
        ...
        /// </summary>
        public Auriga.Model.Fa.ISequenceLinkEnd Source { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Fa.ISequenceLinkEnd Target { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SequenceLink</c>.
        /// </summary>
