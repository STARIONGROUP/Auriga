// ------------------------------------------------------------------------------------------------
// <copyright file="UnionProperty.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>UnionProperty</c> class.
    /// </summary>
    public partial class UnionProperty : Auriga.Core.AurigaElement, Auriga.Model.Information.IUnionProperty
    {
        /// <summary>
        ...
        /// Gets the qualifier.
        /// </summary>
        public List<Auriga.Model.Information.Datavalue.IDataValue> Qualifier { get; } = new List<Auriga.Model.Information.Datavalue.IDataValue>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>UnionProperty</c>.
        /// </summary>
