// ------------------------------------------------------------------------------------------------
// <copyright file="KeyPart.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>KeyPart</c> class.
    /// </summary>
    public partial class KeyPart : Auriga.Core.AurigaElement, Auriga.Model.Information.IKeyPart
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.IProperty Property { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>KeyPart</c>.
        /// </summary>
