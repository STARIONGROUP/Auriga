...
namespace Auriga.Model.Information
{
    ...
    /// </summary>
    public partial class ExchangeItem : Auriga.Core.AurigaElement, Auriga.Model.Information.IExchangeItem
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IInterface> AllocatorInterfaces => Enumerable.Empty<Auriga.Model.Cs.IInterface>();
        ...
        /// </summary>
        public Auriga.Model.Information.ExchangeMechanism ExchangeMechanism { get; set; }
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Information.IExchangeItemElement> OwnedElements => this.backingOwnedElements ??= new Auriga.Core.ContainerList<Auriga.Model.Information.IExchangeItemElement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedElements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Information.IExchangeItemElement> backingOwnedElements;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Information.IExchangeItemInstance> OwnedExchangeItemInstances => this.backingOwnedExchangeItemInstances ??= new Auriga.Core.ContainerList<Auriga.Model.Information.IExchangeItemInstance>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedExchangeItemInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Information.IExchangeItemInstance> backingOwnedExchangeItemInstances;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Information.IExchangeItem> RealizingExchangeItems => Enumerable.Empty<Auriga.Model.Information.IExchangeItem>();

        /// <summary>
        /// Gets the realizing operations.
        /// </summary>
        public IEnumerable<Auriga.Model.Information.IOperation> RealizingOperations => Enumerable.Empty<Auriga.Model.Information.IOperation>();
