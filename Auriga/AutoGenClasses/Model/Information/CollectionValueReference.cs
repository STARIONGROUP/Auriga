// ------------------------------------------------------------------------------------------------
// <copyright file="CollectionValueReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>CollectionValueReference</c> class.
    /// </summary>
    public partial class CollectionValueReference : Auriga.Core.AurigaElement, Auriga.Model.Information.ICollectionValueReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.IAbstractCollectionValue ReferencedValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CollectionValueReference</c>.
        /// </summary>
