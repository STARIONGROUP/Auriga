// ------------------------------------------------------------------------------------------------
// <copyright file="CollectionValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>CollectionValue</c> class.
    /// </summary>
    public partial class CollectionValue : Auriga.Core.AurigaElement, Auriga.Model.Information.ICollectionValue
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Datavalue.IDataValue OwnedDefaultElement
        {
        ...
        /// </summary>
        private Auriga.Model.Information.Datavalue.IDataValue backingOwnedDefaultElement;

        /// <summary>
        /// Gets the owned elements.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Information.Datavalue.IDataValue> OwnedElements => this.backingOwnedElements ??= new Auriga.Core.ContainerList<Auriga.Model.Information.Datavalue.IDataValue>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedElements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Information.Datavalue.IDataValue> backingOwnedElements;
