// ------------------------------------------------------------------------------------------------
// <copyright file="OperationAllocation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>OperationAllocation</c> class.
    /// </summary>
    public partial class OperationAllocation : Auriga.Core.AurigaElement, Auriga.Model.Information.IOperationAllocation
    {
        /// <summary>
        /// Gets the allocated operation.
        /// </summary>
        public Auriga.Model.Information.IOperation AllocatedOperation => default;

        /// <summary>
        /// Gets the allocating operation.
        /// </summary>
        public Auriga.Model.Information.IOperation AllocatingOperation => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>OperationAllocation</c>.
        /// </summary>
