// ------------------------------------------------------------------------------------------------
// <copyright file="PortAllocation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>PortAllocation</c> class.
    /// </summary>
    public partial class PortAllocation : Auriga.Core.AurigaElement, Auriga.Model.Information.IPortAllocation
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PortAllocation</c>.
        /// </summary>
