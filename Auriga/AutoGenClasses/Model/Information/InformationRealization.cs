// ------------------------------------------------------------------------------------------------
// <copyright file="InformationRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information
{
    ...
    /// <summary>
    /// Definition of the <c>InformationRealization</c> class.
    /// </summary>
    public partial class InformationRealization : Auriga.Core.AurigaElement, Auriga.Model.Information.IInformationRealization
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InformationRealization</c>.
        /// </summary>
