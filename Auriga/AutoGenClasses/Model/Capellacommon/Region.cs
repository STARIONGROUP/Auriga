...
namespace Auriga.Model.Capellacommon
{
    ...
    /// <summary>
    /// Definition of the <c>Region</c> class.
    /// </summary>
    public partial class Region : Auriga.Core.AurigaElement, Auriga.Model.Capellacommon.IRegion
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Capellacommon.IAbstractState> InvolvedStates { get; } = new List<Auriga.Model.Capellacommon.IAbstractState>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IAbstractState> OwnedStates => this.backingOwnedStates ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacommon.IAbstractState>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedStates"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IAbstractState> backingOwnedStates;

        /// <summary>
        /// Gets the owned transitions.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IStateTransition> OwnedTransitions => this.backingOwnedTransitions ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacommon.IStateTransition>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedTransitions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IStateTransition> backingOwnedTransitions;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Region</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedStates)
            {
                yield return element;
            }

            foreach (var element in this.OwnedTransitions)
            {
                yield return element;
            }
        }
