// ------------------------------------------------------------------------------------------------
// <copyright file="StateTransitionRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacommon
{
    ...
    /// <summary>
    /// Definition of the <c>StateTransitionRealization</c> class.
    /// </summary>
    public partial class StateTransitionRealization : Auriga.Core.AurigaElement, Auriga.Model.Capellacommon.IStateTransitionRealization
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Capellacommon.IStateTransition RealizedStateTransition => default;

        /// <summary>
        /// Gets the realizing state transition.
        /// </summary>
        public Auriga.Model.Capellacommon.IStateTransition RealizingStateTransition => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>StateTransitionRealization</c>.
        /// </summary>
