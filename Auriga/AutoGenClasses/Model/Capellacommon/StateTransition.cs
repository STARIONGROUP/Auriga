// ------------------------------------------------------------------------------------------------
// <copyright file="StateTransition.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacommon
{
    ...
    /// <summary>
    /// Definition of the <c>StateTransition</c> class.
    /// </summary>
    public partial class StateTransition : Auriga.Core.AurigaElement, Auriga.Model.Capellacommon.IStateTransition
    {
        /// <summary>
        ...
        /// Gets the effect.
        /// </summary>
        public List<Auriga.Model.Behavior.IAbstractEvent> Effect { get; } = new List<Auriga.Model.Behavior.IAbstractEvent>();
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IConstraint Guard { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Capellacommon.TransitionKind? Kind { get; set; }
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IStateTransitionRealization> OwnedStateTransitionRealizations => this.backingOwnedStateTransitionRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacommon.IStateTransitionRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedStateTransitionRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IStateTransitionRealization> backingOwnedStateTransitionRealizations;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Capellacommon.IStateTransition> RealizedStateTransitions => Enumerable.Empty<Auriga.Model.Capellacommon.IStateTransition>();

        /// <summary>
        /// Gets the realizing state transitions.
        /// </summary>
        public IEnumerable<Auriga.Model.Capellacommon.IStateTransition> RealizingStateTransitions => Enumerable.Empty<Auriga.Model.Capellacommon.IStateTransition>();
        ...
        /// </summary>
        public Auriga.Model.Capellacommon.IAbstractState Source { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Capellacommon.IAbstractState Target { get; set; }
        ...
        /// Gets the triggers.
        /// </summary>
        public List<Auriga.Model.Behavior.IAbstractEvent> Triggers { get; } = new List<Auriga.Model.Behavior.IAbstractEvent>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>StateTransition</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedStateTransitionRealizations)
            {
                yield return element;
            }
        }
