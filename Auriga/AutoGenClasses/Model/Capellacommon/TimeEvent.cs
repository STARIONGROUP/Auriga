// ------------------------------------------------------------------------------------------------
// <copyright file="TimeEvent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacommon
{
    ...
    /// <summary>
    /// Definition of the <c>TimeEvent</c> class.
    /// </summary>
    public partial class TimeEvent : Auriga.Core.AurigaElement, Auriga.Model.Capellacommon.ITimeEvent
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IConstraint Expression { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Capellacommon.TimeEventKind? Kind { get; set; }
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IStateEventRealization> OwnedStateEventRealizations => this.backingOwnedStateEventRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacommon.IStateEventRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedStateEventRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacommon.IStateEventRealization> backingOwnedStateEventRealizations;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>TimeEvent</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedStateEventRealizations)
            {
                yield return element;
            }
        }
