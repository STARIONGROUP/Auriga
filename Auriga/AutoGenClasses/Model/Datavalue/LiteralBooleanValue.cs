// ------------------------------------------------------------------------------------------------
// <copyright file="LiteralBooleanValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>LiteralBooleanValue</c> class.
    /// </summary>
    public partial class LiteralBooleanValue : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.ILiteralBooleanValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>LiteralBooleanValue</c>.
        /// </summary>
