// ------------------------------------------------------------------------------------------------
// <copyright file="EnumerationReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>EnumerationReference</c> class.
    /// </summary>
    public partial class EnumerationReference : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IEnumerationReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.IProperty ReferencedProperty { get; set; }

        /// <summary>
        /// Gets or sets the referenced value.
        /// </summary>
        public Auriga.Model.Information.Datavalue.IAbstractEnumerationValue ReferencedValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>EnumerationReference</c>.
        /// </summary>
