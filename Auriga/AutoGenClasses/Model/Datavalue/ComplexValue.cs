// ------------------------------------------------------------------------------------------------
// <copyright file="ComplexValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>ComplexValue</c> class.
    /// </summary>
    public partial class ComplexValue : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IComplexValue
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Information.Datavalue.IValuePart> OwnedParts => this.backingOwnedParts ??= new Auriga.Core.ContainerList<Auriga.Model.Information.Datavalue.IValuePart>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedParts"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Information.Datavalue.IValuePart> backingOwnedParts;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComplexValue</c>.
        /// </summary>
