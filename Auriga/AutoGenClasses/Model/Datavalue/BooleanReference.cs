// ------------------------------------------------------------------------------------------------
// <copyright file="BooleanReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>BooleanReference</c> class.
    /// </summary>
    public partial class BooleanReference : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IBooleanReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Datavalue.IAbstractBooleanValue ReferencedValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>BooleanReference</c>.
        /// </summary>
