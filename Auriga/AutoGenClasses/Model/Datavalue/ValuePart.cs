// ------------------------------------------------------------------------------------------------
// <copyright file="ValuePart.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>ValuePart</c> class.
    /// </summary>
    public partial class ValuePart : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IValuePart
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Datavalue.IDataValue OwnedValue
        {
        ...
        /// </summary>
        private Auriga.Model.Information.Datavalue.IDataValue backingOwnedValue;
