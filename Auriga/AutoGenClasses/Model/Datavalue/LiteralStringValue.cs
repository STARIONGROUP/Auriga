// ------------------------------------------------------------------------------------------------
// <copyright file="LiteralStringValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>LiteralStringValue</c> class.
    /// </summary>
    public partial class LiteralStringValue : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.ILiteralStringValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>LiteralStringValue</c>.
        /// </summary>
