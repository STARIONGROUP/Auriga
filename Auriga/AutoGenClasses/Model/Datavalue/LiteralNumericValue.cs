// ------------------------------------------------------------------------------------------------
// <copyright file="LiteralNumericValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>LiteralNumericValue</c> class.
    /// </summary>
    public partial class LiteralNumericValue : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.ILiteralNumericValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>LiteralNumericValue</c>.
        /// </summary>
