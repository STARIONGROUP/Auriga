// ------------------------------------------------------------------------------------------------
// <copyright file="NumericReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>NumericReference</c> class.
    /// </summary>
    public partial class NumericReference : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.INumericReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Datavalue.INumericValue ReferencedValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>NumericReference</c>.
        /// </summary>
