// ------------------------------------------------------------------------------------------------
// <copyright file="ComplexValueReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>ComplexValueReference</c> class.
    /// </summary>
    public partial class ComplexValueReference : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IComplexValueReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Datavalue.IAbstractComplexValue ReferencedValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComplexValueReference</c>.
        /// </summary>
