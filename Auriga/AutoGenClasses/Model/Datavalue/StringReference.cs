// ------------------------------------------------------------------------------------------------
// <copyright file="StringReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>StringReference</c> class.
    /// </summary>
    public partial class StringReference : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IStringReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Datavalue.IAbstractStringValue ReferencedValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>StringReference</c>.
        /// </summary>
