// ------------------------------------------------------------------------------------------------
// <copyright file="OpaqueExpression.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Datavalue
{
    ...
    /// <summary>
    /// Definition of the <c>OpaqueExpression</c> class.
    /// </summary>
    public partial class OpaqueExpression : Auriga.Core.AurigaElement, Auriga.Model.Information.Datavalue.IOpaqueExpression
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>OpaqueExpression</c>.
        /// </summary>
