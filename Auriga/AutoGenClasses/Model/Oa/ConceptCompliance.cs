// ------------------------------------------------------------------------------------------------
// <copyright file="ConceptCompliance.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>ConceptCompliance</c> class.
    /// </summary>
    public partial class ConceptCompliance : Auriga.Core.AurigaElement, Auriga.Model.Oa.IConceptCompliance
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Oa.IOperationalCapability CompliantCapability { get; set; }

        /// <summary>
        /// Gets or sets the comply with concept.
        /// </summary>
        public Auriga.Model.Oa.IConcept ComplyWithConcept { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ConceptCompliance</c>.
        /// </summary>
