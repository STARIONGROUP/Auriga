// ------------------------------------------------------------------------------------------------
// <copyright file="RoleAssemblyUsage.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>RoleAssemblyUsage</c> class.
    /// </summary>
    public partial class RoleAssemblyUsage : Auriga.Core.AurigaElement, Auriga.Model.Oa.IRoleAssemblyUsage
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Oa.IRole Child { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>RoleAssemblyUsage</c>.
        /// </summary>
