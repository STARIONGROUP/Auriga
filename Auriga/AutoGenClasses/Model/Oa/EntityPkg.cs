...
namespace Auriga.Model.Oa
{
    ...
    /// </summary>
    public partial class EntityPkg : Auriga.Core.AurigaElement, Auriga.Model.Oa.IEntityPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IEntityPkg> OwnedEntityPkgs => this.backingOwnedEntityPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IEntityPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedEntityPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IEntityPkg> backingOwnedEntityPkgs;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.ILocation> OwnedLocations => this.backingOwnedLocations ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.ILocation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLocations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.ILocation> backingOwnedLocations;
