// ------------------------------------------------------------------------------------------------
// <copyright file="ItemInConcept.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>ItemInConcept</c> class.
    /// </summary>
    public partial class ItemInConcept : Auriga.Core.AurigaElement, Auriga.Model.Oa.IItemInConcept
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Oa.IConcept Concept { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Oa.IAbstractConceptItem Item { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ItemInConcept</c>.
        /// </summary>
