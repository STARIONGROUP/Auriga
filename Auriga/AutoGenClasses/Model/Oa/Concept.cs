// ------------------------------------------------------------------------------------------------
// <copyright file="Concept.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>Concept</c> class.
    /// </summary>
    public partial class Concept : Auriga.Core.AurigaElement, Auriga.Model.Oa.IConcept
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IItemInConcept> CompositeLinks => this.backingCompositeLinks ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IItemInConcept>(this);

        /// <summary>
        /// Backing field for <see cref="CompositeLinks"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IItemInConcept> backingCompositeLinks;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Concept</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.CompositeLinks)
            {
