// ------------------------------------------------------------------------------------------------
// <copyright file="OrganisationalUnit.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>OrganisationalUnit</c> class.
    /// </summary>
    public partial class OrganisationalUnit : Auriga.Core.AurigaElement, Auriga.Model.Oa.IOrganisationalUnit
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Oa.ICommunityOfInterestComposition> CommunityOfInterestMemberships { get; } = new List<Auriga.Model.Oa.ICommunityOfInterestComposition>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IOrganisationalUnitComposition> OrganisationalUnitCompositions => this.backingOrganisationalUnitCompositions ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IOrganisationalUnitComposition>(this);

        /// <summary>
        /// Backing field for <see cref="OrganisationalUnitCompositions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IOrganisationalUnitComposition> backingOrganisationalUnitCompositions;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>OrganisationalUnit</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.OrganisationalUnitCompositions)
            {
