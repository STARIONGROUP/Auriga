// ------------------------------------------------------------------------------------------------
// <copyright file="ConceptPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>ConceptPkg</c> class.
    /// </summary>
    public partial class ConceptPkg : Auriga.Core.AurigaElement, Auriga.Model.Oa.IConceptPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IConceptPkg> OwnedConceptPkgs => this.backingOwnedConceptPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IConceptPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConceptPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IConceptPkg> backingOwnedConceptPkgs;

        /// <summary>
        /// Gets the owned concepts.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IConcept> OwnedConcepts => this.backingOwnedConcepts ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IConcept>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConcepts"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IConcept> backingOwnedConcepts;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ConceptPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedConceptPkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedConcepts)
            {
                yield return element;
            }
