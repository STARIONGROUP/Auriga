// ------------------------------------------------------------------------------------------------
// <copyright file="CommunityOfInterest.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>CommunityOfInterest</c> class.
    /// </summary>
    public partial class CommunityOfInterest : Auriga.Core.AurigaElement, Auriga.Model.Oa.ICommunityOfInterest
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.ICommunityOfInterestComposition> CommunityOfInterestCompositions => this.backingCommunityOfInterestCompositions ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.ICommunityOfInterestComposition>(this);

        /// <summary>
        /// Backing field for <see cref="CommunityOfInterestCompositions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.ICommunityOfInterestComposition> backingCommunityOfInterestCompositions;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CommunityOfInterest</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.CommunityOfInterestCompositions)
            {
