// ------------------------------------------------------------------------------------------------
// <copyright file="RoleAllocation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>RoleAllocation</c> class.
    /// </summary>
    public partial class RoleAllocation : Auriga.Core.AurigaElement, Auriga.Model.Oa.IRoleAllocation
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>RoleAllocation</c>.
        /// </summary>
