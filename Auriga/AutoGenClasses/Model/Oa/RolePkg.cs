// ------------------------------------------------------------------------------------------------
// <copyright file="RolePkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Oa
{
    ...
    /// <summary>
    /// Definition of the <c>RolePkg</c> class.
    /// </summary>
    public partial class RolePkg : Auriga.Core.AurigaElement, Auriga.Model.Oa.IRolePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IRolePkg> OwnedRolePkgs => this.backingOwnedRolePkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IRolePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRolePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IRolePkg> backingOwnedRolePkgs;

        /// <summary>
        /// Gets the owned roles.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Oa.IRole> OwnedRoles => this.backingOwnedRoles ??= new Auriga.Core.ContainerList<Auriga.Model.Oa.IRole>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRoles"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Oa.IRole> backingOwnedRoles;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>RolePkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedRolePkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedRoles)
            {
                yield return element;
            }
