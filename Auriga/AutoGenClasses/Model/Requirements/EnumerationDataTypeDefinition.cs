...
namespace Auriga.Model.Requirements
{
    ...
    /// </summary>
    public partial class EnumerationDataTypeDefinition : Auriga.Core.AurigaElement, Auriga.Model.Requirements.IEnumerationDataTypeDefinition
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Requirements.IEnumValue> SpecifiedValues => this.backingSpecifiedValues ??= new Auriga.Core.ContainerList<Auriga.Model.Requirements.IEnumValue>(this);

        /// <summary>
        /// Backing field for <see cref="SpecifiedValues"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Requirements.IEnumValue> backingSpecifiedValues;
