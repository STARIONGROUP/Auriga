// ------------------------------------------------------------------------------------------------
// <copyright file="ModuleType.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>ModuleType</c> class.
    /// </summary>
    public partial class ModuleType : Auriga.Core.AurigaElement, Auriga.Model.Requirements.IModuleType
    {
        /// <summary>
