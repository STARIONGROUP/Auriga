// ------------------------------------------------------------------------------------------------
// <copyright file="DateValueAttribute.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Requirements
{
    ...
    /// <summary>
    /// Definition of the <c>DateValueAttribute</c> class.
    /// </summary>
    public partial class DateValueAttribute : Auriga.Core.AurigaElement, Auriga.Model.Requirements.IDateValueAttribute
    {
        /// <summary>
