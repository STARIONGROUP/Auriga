// ------------------------------------------------------------------------------------------------
// <copyright file="InternalRelation.cs" company="Starion Group S.A.">
//
...
{
    /// <summary>
    /// Definition of the <c>InternalRelation</c> class.
    /// </summary>
    public partial class InternalRelation : Auriga.Core.AurigaElement, Auriga.Model.Requirements.IInternalRelation
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Requirements.IRequirement Target { get; set; }
