// ------------------------------------------------------------------------------------------------
// <copyright file="ReuseLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>ReuseLink</c> class.
    /// </summary>
    public partial class ReuseLink : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IReuseLink
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IReuseableStructure Reused { get; set; }

        /// <summary>
        /// Gets or sets the reuser.
        /// </summary>
        public Auriga.Model.Capellacore.IReuserStructure Reuser { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ReuseLink</c>.
        /// </summary>
