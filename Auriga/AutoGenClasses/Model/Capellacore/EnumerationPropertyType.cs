// ------------------------------------------------------------------------------------------------
// <copyright file="EnumerationPropertyType.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>EnumerationPropertyType</c> class.
    /// </summary>
    public partial class EnumerationPropertyType : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IEnumerationPropertyType
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacore.IEnumerationPropertyLiteral> OwnedLiterals => this.backingOwnedLiterals ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacore.IEnumerationPropertyLiteral>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLiterals"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacore.IEnumerationPropertyLiteral> backingOwnedLiterals;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>EnumerationPropertyType</c>.
        /// </summary>
