// ------------------------------------------------------------------------------------------------
// <copyright file="EnumerationPropertyValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>EnumerationPropertyValue</c> class.
    /// </summary>
    public partial class EnumerationPropertyValue : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IEnumerationPropertyValue
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Capellacore.ICapellaElement> InvolvedElements { get; } = new List<Auriga.Model.Capellacore.ICapellaElement>();
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyType Type { get; set; }

        /// <summary>
        /// Gets or sets the value.
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral Value { get; set; }

        /// <summary>
        /// Gets the valued elements.
        /// </summary>
        public IEnumerable<Auriga.Model.Capellacore.ICapellaElement> ValuedElements => Enumerable.Empty<Auriga.Model.Capellacore.ICapellaElement>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>EnumerationPropertyValue</c>.
        /// </summary>
