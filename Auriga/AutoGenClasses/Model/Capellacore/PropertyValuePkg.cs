// ------------------------------------------------------------------------------------------------
// <copyright file="PropertyValuePkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>PropertyValuePkg</c> class.
    /// </summary>
    public partial class PropertyValuePkg : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IPropertyValuePkg
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PropertyValuePkg</c>.
        /// </summary>
