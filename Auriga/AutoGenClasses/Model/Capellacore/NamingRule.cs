// ------------------------------------------------------------------------------------------------
// <copyright file="NamingRule.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>NamingRule</c> class.
    /// </summary>
    public partial class NamingRule : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.INamingRule
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>NamingRule</c>.
        /// </summary>
