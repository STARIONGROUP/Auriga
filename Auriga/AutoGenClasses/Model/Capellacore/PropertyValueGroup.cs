// ------------------------------------------------------------------------------------------------
// <copyright file="PropertyValueGroup.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>PropertyValueGroup</c> class.
    /// </summary>
    public partial class PropertyValueGroup : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IPropertyValueGroup
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PropertyValueGroup</c>.
        /// </summary>
