// ------------------------------------------------------------------------------------------------
// <copyright file="StringPropertyValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>StringPropertyValue</c> class.
    /// </summary>
    public partial class StringPropertyValue : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IStringPropertyValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>StringPropertyValue</c>.
        /// </summary>
