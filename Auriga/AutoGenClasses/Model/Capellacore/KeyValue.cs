// ------------------------------------------------------------------------------------------------
// <copyright file="KeyValue.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellacore
{
    ...
    /// <summary>
    /// Definition of the <c>KeyValue</c> class.
    /// </summary>
    public partial class KeyValue : Auriga.Core.AurigaElement, Auriga.Model.Capellacore.IKeyValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>KeyValue</c>.
        /// </summary>
