// ------------------------------------------------------------------------------------------------
// <copyright file="ThreatApplication.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>ThreatApplication</c> class.
    /// </summary>
    public partial class ThreatApplication : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IThreatApplication
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cybersecurity.IPrimaryAsset Asset { get; set; }
        ...
        /// Gets the threat obj.
        /// </summary>
        public Auriga.Model.Cybersecurity.IThreat ThreatObj => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ThreatApplication</c>.
        /// </summary>
