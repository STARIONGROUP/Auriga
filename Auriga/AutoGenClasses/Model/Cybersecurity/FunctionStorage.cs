// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionStorage.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>FunctionStorage</c> class.
    /// </summary>
    public partial class FunctionStorage : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IFunctionStorage
    {
        /// <summary>
        ...
        /// </summary>
        public bool? RemanentData { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FunctionStorage</c>.
        /// </summary>
