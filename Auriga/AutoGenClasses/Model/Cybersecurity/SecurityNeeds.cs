// ------------------------------------------------------------------------------------------------
// <copyright file="SecurityNeeds.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>SecurityNeeds</c> class.
    /// </summary>
    public partial class SecurityNeeds : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.ISecurityNeeds
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral AvailabilityValue { get; set; }

        /// <summary>
        /// Gets or sets the confidentiality value.
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral ConfidentialityValue { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral IntegrityValue { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral TraceabilityValue { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SecurityNeeds</c>.
        /// </summary>
