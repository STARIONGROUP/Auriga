// ------------------------------------------------------------------------------------------------
// <copyright file="TrustBoundaryStorage.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>TrustBoundaryStorage</c> class.
    /// </summary>
    public partial class TrustBoundaryStorage : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.ITrustBoundaryStorage
    {
        /// <summary>
        ...
        /// </summary>
        public bool? ThreatSource { get; set; }

        /// <summary>
        /// Gets or sets the threat source profile.
        /// </summary>
        public int? ThreatSourceProfile { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>TrustBoundaryStorage</c>.
        /// </summary>
