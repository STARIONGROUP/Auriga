// ------------------------------------------------------------------------------------------------
// <copyright file="FunctionalPrimaryAsset.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>FunctionalPrimaryAsset</c> class.
    /// </summary>
    public partial class FunctionalPrimaryAsset : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IFunctionalPrimaryAsset
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalChain> FunctionalChains => Enumerable.Empty<Auriga.Model.Fa.IFunctionalChain>();

        /// <summary>
        /// Gets the functions.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IAbstractFunction> Functions => Enumerable.Empty<Auriga.Model.Fa.IAbstractFunction>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IPrimaryAssetMember> OwnedMembers => this.backingOwnedMembers ??= new Auriga.Core.ContainerList<Auriga.Model.Cybersecurity.IPrimaryAssetMember>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMembers"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IPrimaryAssetMember> backingOwnedMembers;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cybersecurity.IPrimaryAsset> RealizedPrimaryAssets => Enumerable.Empty<Auriga.Model.Cybersecurity.IPrimaryAsset>();

        /// <summary>
        /// Gets the realizing primary assets.
        /// </summary>
        public IEnumerable<Auriga.Model.Cybersecurity.IPrimaryAsset> RealizingPrimaryAssets => Enumerable.Empty<Auriga.Model.Cybersecurity.IPrimaryAsset>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FunctionalPrimaryAsset</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedMembers)
            {
                yield return element;
            }
