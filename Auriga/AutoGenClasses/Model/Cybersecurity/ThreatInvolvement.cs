// ------------------------------------------------------------------------------------------------
// <copyright file="ThreatInvolvement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>ThreatInvolvement</c> class.
    /// </summary>
    public partial class ThreatInvolvement : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IThreatInvolvement
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cs.IComponent Component { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ThreatInvolvement</c>.
        /// </summary>
