// ------------------------------------------------------------------------------------------------
// <copyright file="PrimaryAssetStorage.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>PrimaryAssetStorage</c> class.
    /// </summary>
    public partial class PrimaryAssetStorage : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IPrimaryAssetStorage
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PrimaryAssetStorage</c>.
        /// </summary>
