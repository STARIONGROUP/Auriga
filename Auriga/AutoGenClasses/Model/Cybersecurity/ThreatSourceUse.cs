// ------------------------------------------------------------------------------------------------
// <copyright file="ThreatSourceUse.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>ThreatSourceUse</c> class.
    /// </summary>
    public partial class ThreatSourceUse : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IThreatSourceUse
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cs.IComponent ThreatSource => default;

        /// <summary>
        /// Gets or sets the used.
        /// </summary>
        public Auriga.Model.Cs.IComponent Used { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ThreatSourceUse</c>.
        /// </summary>
