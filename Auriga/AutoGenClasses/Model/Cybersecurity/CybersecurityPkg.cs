// ------------------------------------------------------------------------------------------------
// <copyright file="CybersecurityPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>CybersecurityPkg</c> class.
    /// </summary>
    public partial class CybersecurityPkg : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.ICybersecurityPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.ICybersecurityPkg> OwnedCybersecurityPkgs => this.backingOwnedCybersecurityPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Cybersecurity.ICybersecurityPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCybersecurityPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.ICybersecurityPkg> backingOwnedCybersecurityPkgs;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IPrimaryAsset> OwnedPrimaryAssets => this.backingOwnedPrimaryAssets ??= new Auriga.Core.ContainerList<Auriga.Model.Cybersecurity.IPrimaryAsset>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPrimaryAssets"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IPrimaryAsset> backingOwnedPrimaryAssets;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IThreat> OwnedThreats => this.backingOwnedThreats ??= new Auriga.Core.ContainerList<Auriga.Model.Cybersecurity.IThreat>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedThreats"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IThreat> backingOwnedThreats;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CybersecurityPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedCybersecurityPkgs)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedPrimaryAssets)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedThreats)
            {
                yield return element;
            }
        }
