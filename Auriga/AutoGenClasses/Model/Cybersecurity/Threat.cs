// ------------------------------------------------------------------------------------------------
// <copyright file="Threat.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cybersecurity
{
    ...
    /// <summary>
    /// Definition of the <c>Threat</c> class.
    /// </summary>
    public partial class Threat : Auriga.Core.AurigaElement, Auriga.Model.Cybersecurity.IThreat
    {
        /// <summary>
        /// Gets the abstract capability extension points.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityExtensionPoint> AbstractCapabilityExtensionPoints => this.backingAbstractCapabilityExtensionPoints ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IAbstractCapabilityExtensionPoint>(this);

        /// <summary>
        /// Backing field for <see cref="AbstractCapabilityExtensionPoints"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityExtensionPoint> backingAbstractCapabilityExtensionPoints;

        /// <summary>
        /// Gets the addressed by.
        /// </summary>
        public List<Auriga.Model.Cs.IComponent> AddressedBy { get; } = new List<Auriga.Model.Cs.IComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapability> ExtendedAbstractCapabilities => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapability>();

        /// <summary>
        /// Gets the extending.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapabilityExtend> Extending => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapabilityExtend>();

        /// <summary>
        /// Gets the extending abstract capabilities.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapability> ExtendingAbstractCapabilities => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapability>();

        /// <summary>
        /// Gets the extends.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityExtend> Extends => this.backingExtends ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IAbstractCapabilityExtend>(this);

        /// <summary>
        /// Backing field for <see cref="Extends"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityExtend> backingExtends;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapability> IncludedAbstractCapabilities => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapability>();

        /// <summary>
        /// Gets the includes.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityInclude> Includes => this.backingIncludes ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IAbstractCapabilityInclude>(this);

        /// <summary>
        /// Backing field for <see cref="Includes"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityInclude> backingIncludes;

        /// <summary>
        /// Gets the including.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapabilityInclude> Including => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapabilityInclude>();

        /// <summary>
        /// Gets the including abstract capabilities.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapability> IncludingAbstractCapabilities => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapability>();

        /// <summary>
        /// Gets the incoming capability allocation.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapabilityRealization> IncomingCapabilityAllocation => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapabilityRealization>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IAbstractFunction> InvolvedAbstractFunctions => Enumerable.Empty<Auriga.Model.Fa.IAbstractFunction>();

        /// <summary>
        /// Gets the involved functional chains.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IFunctionalChain> InvolvedFunctionalChains => Enumerable.Empty<Auriga.Model.Fa.IFunctionalChain>();
        ...
        /// </summary>
        public Auriga.Model.Capellacore.IEnumerationPropertyLiteral Kind { get; set; }
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapabilityRealization> OutgoingCapabilityAllocation => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapabilityRealization>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityRealization> OwnedAbstractCapabilityRealizations => this.backingOwnedAbstractCapabilityRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IAbstractCapabilityRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedAbstractCapabilityRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityRealization> backingOwnedAbstractCapabilityRealizations;

        /// <summary>
        /// Gets the owned abstract function abstract capability involvements.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractFunctionAbstractCapabilityInvolvement> OwnedAbstractFunctionAbstractCapabilityInvolvements => this.backingOwnedAbstractFunctionAbstractCapabilityInvolvements ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IAbstractFunctionAbstractCapabilityInvolvement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedAbstractFunctionAbstractCapabilityInvolvements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractFunctionAbstractCapabilityInvolvement> backingOwnedAbstractFunctionAbstractCapabilityInvolvements;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement> OwnedFunctionalChainAbstractCapabilityInvolvements => this.backingOwnedFunctionalChainAbstractCapabilityInvolvements ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedFunctionalChainAbstractCapabilityInvolvements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IFunctionalChainAbstractCapabilityInvolvement> backingOwnedFunctionalChainAbstractCapabilityInvolvements;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IScenario> OwnedScenarios => this.backingOwnedScenarios ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IScenario>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedScenarios"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IScenario> backingOwnedScenarios;

        /// <summary>
        /// Gets the owned threat applications.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IThreatApplication> OwnedThreatApplications => this.backingOwnedThreatApplications ??= new Auriga.Core.ContainerList<Auriga.Model.Cybersecurity.IThreatApplication>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedThreatApplications"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IThreatApplication> backingOwnedThreatApplications;

        /// <summary>
        /// Gets the owned threat involvements.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IThreatInvolvement> OwnedThreatInvolvements => this.backingOwnedThreatInvolvements ??= new Auriga.Core.ContainerList<Auriga.Model.Cybersecurity.IThreatInvolvement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedThreatInvolvements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cybersecurity.IThreatInvolvement> backingOwnedThreatInvolvements;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cybersecurity.IThreat> RealizedThreats => Enumerable.Empty<Auriga.Model.Cybersecurity.IThreat>();

        /// <summary>
        /// Gets the realizing threats.
        /// </summary>
        public IEnumerable<Auriga.Model.Cybersecurity.IThreat> RealizingThreats => Enumerable.Empty<Auriga.Model.Cybersecurity.IThreat>();
        ...
        /// Gets the sub.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapability> Sub => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapability>();

        /// <summary>
        /// Gets the sub generalizations.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapabilityGeneralization> SubGeneralizations => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapabilityGeneralization>();
        ...
        /// Gets the super.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractCapability> Super => Enumerable.Empty<Auriga.Model.Interaction.IAbstractCapability>();

        /// <summary>
        /// Gets the super generalizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityGeneralization> SuperGeneralizations => this.backingSuperGeneralizations ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IAbstractCapabilityGeneralization>(this);

        /// <summary>
        /// Backing field for <see cref="SuperGeneralizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IAbstractCapabilityGeneralization> backingSuperGeneralizations;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Threat</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.AbstractCapabilityExtensionPoints)
            {
                yield return element;
            }

            foreach (var element in this.Extends)
            {
                yield return element;
            }

            foreach (var element in this.Includes)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedAbstractCapabilityRealizations)
            {
                yield return element;
            }

            foreach (var element in this.OwnedAbstractFunctionAbstractCapabilityInvolvements)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedFunctionalChainAbstractCapabilityInvolvements)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedScenarios)
            {
                yield return element;
            }

            foreach (var element in this.OwnedThreatApplications)
            {
                yield return element;
            }

            foreach (var element in this.OwnedThreatInvolvements)
            {
                yield return element;
            }
            ...
            foreach (var element in this.SuperGeneralizations)
            {
                yield return element;
            }
        }
