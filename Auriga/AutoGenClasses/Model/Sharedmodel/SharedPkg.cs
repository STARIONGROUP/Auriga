// ------------------------------------------------------------------------------------------------
// <copyright file="SharedPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Sharedmodel
{
    ...
    /// <summary>
    /// Definition of the <c>SharedPkg</c> class.
    /// </summary>
    public partial class SharedPkg : Auriga.Core.AurigaElement, Auriga.Model.Sharedmodel.ISharedPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Sharedmodel.IGenericPkg OwnedGenericPkg
        {
        ...
        /// </summary>
        private Auriga.Model.Sharedmodel.IGenericPkg backingOwnedGenericPkg;
