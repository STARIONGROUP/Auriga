// ------------------------------------------------------------------------------------------------
// <copyright file="GenericPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Sharedmodel
{
    ...
    /// <summary>
    /// Definition of the <c>GenericPkg</c> class.
    /// </summary>
    public partial class GenericPkg : Auriga.Core.AurigaElement, Auriga.Model.Sharedmodel.IGenericPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacore.ICapellaElement> CapellaElements => this.backingCapellaElements ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacore.ICapellaElement>(this);

        /// <summary>
        /// Backing field for <see cref="CapellaElements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacore.ICapellaElement> backingCapellaElements;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Sharedmodel.IGenericPkg> SubGenericPkgs => this.backingSubGenericPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Sharedmodel.IGenericPkg>(this);

        /// <summary>
        /// Backing field for <see cref="SubGenericPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Sharedmodel.IGenericPkg> backingSubGenericPkgs;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>GenericPkg</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.CapellaElements)
            {
            ...
            foreach (var element in this.SubGenericPkgs)
            {
                yield return element;
            }
        }
