// ------------------------------------------------------------------------------------------------
// <copyright file="MissionPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>MissionPkg</c> class.
    /// </summary>
    public partial class MissionPkg : Auriga.Core.AurigaElement, Auriga.Model.Ctx.IMissionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.IMissionPkg> OwnedMissionPkgs => this.backingOwnedMissionPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.IMissionPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMissionPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.IMissionPkg> backingOwnedMissionPkgs;

        /// <summary>
        /// Gets the owned missions.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.IMission> OwnedMissions => this.backingOwnedMissions ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.IMission>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMissions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.IMission> backingOwnedMissions;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>MissionPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedMissionPkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedMissions)
            {
                yield return element;
            }
