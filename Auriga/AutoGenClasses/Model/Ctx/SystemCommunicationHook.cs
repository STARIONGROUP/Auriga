// ------------------------------------------------------------------------------------------------
// <copyright file="SystemCommunicationHook.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>SystemCommunicationHook</c> class.
    /// </summary>
    public partial class SystemCommunicationHook : Auriga.Core.AurigaElement, Auriga.Model.Ctx.ISystemCommunicationHook
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Ctx.ISystemCommunication Communication { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Cs.IComponent Type { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemCommunicationHook</c>.
        /// </summary>
