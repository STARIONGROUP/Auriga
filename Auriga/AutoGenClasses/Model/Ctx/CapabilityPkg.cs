// ------------------------------------------------------------------------------------------------
// <copyright file="CapabilityPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>CapabilityPkg</c> class.
    /// </summary>
    public partial class CapabilityPkg : Auriga.Core.AurigaElement, Auriga.Model.Ctx.ICapabilityPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.ICapability> OwnedCapabilities => this.backingOwnedCapabilities ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.ICapability>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilities"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.ICapability> backingOwnedCapabilities;

        /// <summary>
        /// Gets the owned capability pkgs.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.ICapabilityPkg> OwnedCapabilityPkgs => this.backingOwnedCapabilityPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.ICapabilityPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.ICapabilityPkg> backingOwnedCapabilityPkgs;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CapabilityPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedCapabilities)
            {
                yield return element;
            }

            foreach (var element in this.OwnedCapabilityPkgs)
            {
                yield return element;
            }
