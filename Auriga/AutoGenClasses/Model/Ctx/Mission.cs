// ------------------------------------------------------------------------------------------------
// <copyright file="Mission.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>Mission</c> class.
    /// </summary>
    public partial class Mission : Auriga.Core.AurigaElement, Auriga.Model.Ctx.IMission
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Ctx.ICapability> ExploitedCapabilities => Enumerable.Empty<Auriga.Model.Ctx.ICapability>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.ICapabilityExploitation> OwnedCapabilityExploitations => this.backingOwnedCapabilityExploitations ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.ICapabilityExploitation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityExploitations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.ICapabilityExploitation> backingOwnedCapabilityExploitations;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.IMissionInvolvement> OwnedMissionInvolvements => this.backingOwnedMissionInvolvements ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.IMissionInvolvement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedMissionInvolvements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.IMissionInvolvement> backingOwnedMissionInvolvements;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Mission</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.OwnedCapabilityExploitations)
            {
            ...
            foreach (var element in this.OwnedMissionInvolvements)
            {
                yield return element;
            }
