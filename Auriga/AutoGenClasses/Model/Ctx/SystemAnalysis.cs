// ------------------------------------------------------------------------------------------------
// <copyright file="SystemAnalysis.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>SystemAnalysis</c> class.
    /// </summary>
    public partial class SystemAnalysis : Auriga.Core.AurigaElement, Auriga.Model.Ctx.ISystemAnalysis
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Oa.IOperationalAnalysis> AllocatedOperationalAnalyses => Enumerable.Empty<Auriga.Model.Oa.IOperationalAnalysis>();

        /// <summary>
        /// Gets the allocated operational analysis realizations.
        /// </summary>
        public IEnumerable<Auriga.Model.Ctx.IOperationalAnalysisRealization> AllocatedOperationalAnalysisRealizations => Enumerable.Empty<Auriga.Model.Ctx.IOperationalAnalysisRealization>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.La.ILogicalArchitecture> AllocatingLogicalArchitectures => Enumerable.Empty<Auriga.Model.La.ILogicalArchitecture>();
        ...
        /// </summary>
        public Auriga.Model.Ctx.ICapabilityPkg ContainedCapabilityPkg => default;
        ...
        /// </summary>
        public Auriga.Model.Ctx.ISystemFunctionPkg ContainedSystemFunctionPkg => default;
        ...
        /// </summary>
        public Auriga.Model.Ctx.IMissionPkg OwnedMissionPkg
        {
            get => this.backingOwnedMissionPkg;
            set
            {
                if (value != null)
                {
                ...
                this.backingOwnedMissionPkg = value;
            }
        }

        /// <summary>
        /// Backing field for <see cref="OwnedMissionPkg"/>.
        /// </summary>
        private Auriga.Model.Ctx.IMissionPkg backingOwnedMissionPkg;

        /// <summary>
        /// Gets the owned operational analysis realizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.IOperationalAnalysisRealization> OwnedOperationalAnalysisRealizations => this.backingOwnedOperationalAnalysisRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.IOperationalAnalysisRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedOperationalAnalysisRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.IOperationalAnalysisRealization> backingOwnedOperationalAnalysisRealizations;
        ...
        /// </summary>
        public Auriga.Model.Ctx.ISystemComponentPkg OwnedSystemComponentPkg
        {
            get => this.backingOwnedSystemComponentPkg;
            set
            {
                if (value != null)
                {
                ...
                this.backingOwnedSystemComponentPkg = value;
            }
        }

        /// <summary>
        /// Backing field for <see cref="OwnedSystemComponentPkg"/>.
        /// </summary>
        private Auriga.Model.Ctx.ISystemComponentPkg backingOwnedSystemComponentPkg;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemAnalysis</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            {
                yield return this.OwnedMissionPkg;
            }

            foreach (var element in this.OwnedOperationalAnalysisRealizations)
            {
                yield return element;
            }
            ...
            {
                yield return this.OwnedSystemComponentPkg;
            }
