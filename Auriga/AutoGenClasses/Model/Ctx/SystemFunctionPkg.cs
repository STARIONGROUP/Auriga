...
namespace Auriga.Model.Ctx
{
    ...
    /// </summary>
    public partial class SystemFunctionPkg : Auriga.Core.AurigaElement, Auriga.Model.Ctx.ISystemFunctionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.ISystemFunction> OwnedSystemFunctions => this.backingOwnedSystemFunctions ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.ISystemFunction>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemFunctions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.ISystemFunction> backingOwnedSystemFunctions;
