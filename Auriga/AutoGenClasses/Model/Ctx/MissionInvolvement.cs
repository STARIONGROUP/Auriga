// ------------------------------------------------------------------------------------------------
// <copyright file="MissionInvolvement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>MissionInvolvement</c> class.
    /// </summary>
    public partial class MissionInvolvement : Auriga.Core.AurigaElement, Auriga.Model.Ctx.IMissionInvolvement
    {
        /// <summary>
        ...
        /// Gets the mission.
        /// </summary>
        public Auriga.Model.Ctx.IMission Mission => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>MissionInvolvement</c>.
        /// </summary>
