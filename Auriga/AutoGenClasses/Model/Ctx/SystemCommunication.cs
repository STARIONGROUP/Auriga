// ------------------------------------------------------------------------------------------------
// <copyright file="SystemCommunication.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>SystemCommunication</c> class.
    /// </summary>
    public partial class SystemCommunication : Auriga.Core.AurigaElement, Auriga.Model.Ctx.ISystemCommunication
    {
        /// <summary>
        ...
        /// Gets the ends.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.ISystemCommunicationHook> Ends => this.backingEnds ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.ISystemCommunicationHook>(this);

        /// <summary>
        /// Backing field for <see cref="Ends"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.ISystemCommunicationHook> backingEnds;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemCommunication</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.Ends)
            {
