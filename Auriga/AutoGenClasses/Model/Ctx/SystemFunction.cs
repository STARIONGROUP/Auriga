// ------------------------------------------------------------------------------------------------
// <copyright file="SystemFunction.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Ctx
{
    ...
    /// <summary>
    /// Definition of the <c>SystemFunction</c> class.
    /// </summary>
    public partial class SystemFunction : Auriga.Core.AurigaElement, Auriga.Model.Ctx.ISystemFunction
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Ctx.ISystemComponent> AllocatingSystemComponents => Enumerable.Empty<Auriga.Model.Ctx.ISystemComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Ctx.ISystemFunction> ChildrenSystemFunctions => Enumerable.Empty<Auriga.Model.Ctx.ISystemFunction>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Ctx.ISystemFunction> ContainedSystemFunctions => Enumerable.Empty<Auriga.Model.Ctx.ISystemFunction>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Ctx.ISystemFunctionPkg> OwnedSystemFunctionPkgs => this.backingOwnedSystemFunctionPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Ctx.ISystemFunctionPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemFunctionPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Ctx.ISystemFunctionPkg> backingOwnedSystemFunctionPkgs;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Oa.IOperationalActivity> RealizedOperationalActivities => Enumerable.Empty<Auriga.Model.Oa.IOperationalActivity>();

        /// <summary>
        /// Gets the realizing logical functions.
        /// </summary>
        public IEnumerable<Auriga.Model.La.ILogicalFunction> RealizingLogicalFunctions => Enumerable.Empty<Auriga.Model.La.ILogicalFunction>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemFunction</c>.
        /// </summary>
