// ------------------------------------------------------------------------------------------------
// <copyright file="InterfaceImplementation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>InterfaceImplementation</c> class.
    /// </summary>
    public partial class InterfaceImplementation : Auriga.Core.AurigaElement, Auriga.Model.Cs.IInterfaceImplementation
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cs.IInterface ImplementedInterface { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Cs.IComponent InterfaceImplementor => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InterfaceImplementation</c>.
        /// </summary>
