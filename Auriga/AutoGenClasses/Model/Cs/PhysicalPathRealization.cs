// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalPathRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalPathRealization</c> class.
    /// </summary>
    public partial class PhysicalPathRealization : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalPathRealization
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalPathRealization</c>.
        /// </summary>
