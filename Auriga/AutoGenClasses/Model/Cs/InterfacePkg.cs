// ------------------------------------------------------------------------------------------------
// <copyright file="InterfacePkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>InterfacePkg</c> class.
    /// </summary>
    public partial class InterfacePkg : Auriga.Core.AurigaElement, Auriga.Model.Cs.IInterfacePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cs.IInterfacePkg> OwnedInterfacePkgs => this.backingOwnedInterfacePkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Cs.IInterfacePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedInterfacePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cs.IInterfacePkg> backingOwnedInterfacePkgs;

        /// <summary>
        /// Gets the owned interfaces.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cs.IInterface> OwnedInterfaces => this.backingOwnedInterfaces ??= new Auriga.Core.ContainerList<Auriga.Model.Cs.IInterface>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedInterfaces"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cs.IInterface> backingOwnedInterfaces;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InterfacePkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedInterfacePkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedInterfaces)
            {
                yield return element;
            }
