// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalPortRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalPortRealization</c> class.
    /// </summary>
    public partial class PhysicalPortRealization : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalPortRealization
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalPortRealization</c>.
        /// </summary>
