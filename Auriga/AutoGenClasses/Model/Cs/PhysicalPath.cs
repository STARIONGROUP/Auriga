// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalPath.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// </summary>
    public partial class PhysicalPath : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalPath
    {
        /// <summary>
        /// Gets the allocated component exchanges.
        /// </summary>
        public IEnumerable<Auriga.Model.Fa.IComponentExchange> AllocatedComponentExchanges => Enumerable.Empty<Auriga.Model.Fa.IComponentExchange>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalPathInvolvement> FirstPhysicalPathInvolvements => Enumerable.Empty<Auriga.Model.Cs.IPhysicalPathInvolvement>();
        ...
        /// </summary>
        public List<Auriga.Model.Cs.IAbstractPhysicalPathLink> InvolvedLinks { get; } = new List<Auriga.Model.Cs.IAbstractPhysicalPathLink>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Fa.IComponentExchangeAllocation> OwnedComponentExchangeAllocations => this.backingOwnedComponentExchangeAllocations ??= new Auriga.Core.ContainerList<Auriga.Model.Fa.IComponentExchangeAllocation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedComponentExchangeAllocations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Fa.IComponentExchangeAllocation> backingOwnedComponentExchangeAllocations;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalPathInvolvement> OwnedPhysicalPathInvolvements => this.backingOwnedPhysicalPathInvolvements ??= new Auriga.Core.ContainerList<Auriga.Model.Cs.IPhysicalPathInvolvement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalPathInvolvements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalPathInvolvement> backingOwnedPhysicalPathInvolvements;

        /// <summary>
        /// Gets the owned physical path realizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalPathRealization> OwnedPhysicalPathRealizations => this.backingOwnedPhysicalPathRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Cs.IPhysicalPathRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalPathRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Cs.IPhysicalPathRealization> backingOwnedPhysicalPathRealizations;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalPath> RealizedPhysicalPaths => Enumerable.Empty<Auriga.Model.Cs.IPhysicalPath>();

        /// <summary>
        /// Gets the realizing physical paths.
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalPath> RealizingPhysicalPaths => Enumerable.Empty<Auriga.Model.Cs.IPhysicalPath>();
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedPhysicalPathInvolvements)
            {
                yield return element;
            }

            foreach (var element in this.OwnedPhysicalPathRealizations)
            {
                yield return element;
            }
