// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalPathReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalPathReference</c> class.
    /// </summary>
    public partial class PhysicalPathReference : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalPathReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cs.IComponent InvolvedComponent => default;

        /// <summary>
        /// Gets the involved element.
        /// </summary>
        public Auriga.Model.Cs.IAbstractPathInvolvedElement InvolvedElement => default;
        ...
        /// </summary>
        public List<Auriga.Model.Cs.IPhysicalPathInvolvement> NextInvolvements { get; } = new List<Auriga.Model.Cs.IPhysicalPathInvolvement>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IPhysicalPathInvolvement> PreviousInvolvements => Enumerable.Empty<Auriga.Model.Cs.IPhysicalPathInvolvement>();
        ...
        /// <summary>
        /// Gets the referenced physical path.
        /// </summary>
        public Auriga.Model.Cs.IPhysicalPath ReferencedPhysicalPath => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalPathReference</c>.
        /// </summary>
