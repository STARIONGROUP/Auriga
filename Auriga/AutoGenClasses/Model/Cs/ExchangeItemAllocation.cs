// ------------------------------------------------------------------------------------------------
// <copyright file="ExchangeItemAllocation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>ExchangeItemAllocation</c> class.
    /// </summary>
    public partial class ExchangeItemAllocation : Auriga.Core.AurigaElement, Auriga.Model.Cs.IExchangeItemAllocation
    {
        /// <summary>
        /// Gets or sets the allocated item.
        /// </summary>
        public Auriga.Model.Information.IExchangeItem AllocatedItem { get; set; }

        /// <summary>
        /// Gets the allocating interface.
        /// </summary>
        public Auriga.Model.Cs.IInterface AllocatingInterface => default;
        ...
        /// </summary>
        public Auriga.Model.Information.Communication.CommunicationLinkProtocol? ReceiveProtocol { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Information.Communication.CommunicationLinkProtocol? SendProtocol { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExchangeItemAllocation</c>.
        /// </summary>
