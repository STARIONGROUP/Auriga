// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalLinkCategory.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalLinkCategory</c> class.
    /// </summary>
    public partial class PhysicalLinkCategory : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalLinkCategory
    {
        /// <summary>
        ...
        /// Gets the links.
        /// </summary>
        public List<Auriga.Model.Cs.IPhysicalLink> Links { get; } = new List<Auriga.Model.Cs.IPhysicalLink>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalLinkCategory</c>.
        /// </summary>
