// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalPathInvolvement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalPathInvolvement</c> class.
    /// </summary>
    public partial class PhysicalPathInvolvement : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalPathInvolvement
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalPathInvolvement</c>.
        /// </summary>
