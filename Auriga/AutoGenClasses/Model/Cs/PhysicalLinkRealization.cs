// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalLinkRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Cs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalLinkRealization</c> class.
    /// </summary>
    public partial class PhysicalLinkRealization : Auriga.Core.AurigaElement, Auriga.Model.Cs.IPhysicalLinkRealization
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalLinkRealization</c>.
        /// </summary>
