// ------------------------------------------------------------------------------------------------
// <copyright file="SystemNonFunctionalRequirement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Requirement
{
    ...
    /// <summary>
    /// Definition of the <c>SystemNonFunctionalRequirement</c> class.
    /// </summary>
    public partial class SystemNonFunctionalRequirement : Auriga.Core.AurigaElement, Auriga.Model.Requirement.ISystemNonFunctionalRequirement
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemNonFunctionalRequirement</c>.
        /// </summary>
