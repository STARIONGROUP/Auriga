// ------------------------------------------------------------------------------------------------
// <copyright file="SystemFunctionalRequirement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Requirement
{
    ...
    /// <summary>
    /// Definition of the <c>SystemFunctionalRequirement</c> class.
    /// </summary>
    public partial class SystemFunctionalRequirement : Auriga.Core.AurigaElement, Auriga.Model.Requirement.ISystemFunctionalRequirement
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemFunctionalRequirement</c>.
        /// </summary>
