// ------------------------------------------------------------------------------------------------
// <copyright file="SystemNonFunctionalInterfaceRequirement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Requirement
{
    ...
    /// <summary>
    /// Definition of the <c>SystemNonFunctionalInterfaceRequirement</c> class.
    /// </summary>
    public partial class SystemNonFunctionalInterfaceRequirement : Auriga.Core.AurigaElement, Auriga.Model.Requirement.ISystemNonFunctionalInterfaceRequirement
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Capellacore.ICapellaElement> RelatedCapellaElements => Enumerable.Empty<Auriga.Model.Capellacore.ICapellaElement>();
        ...
        /// </summary>
        public string VerificationPhase { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemNonFunctionalInterfaceRequirement</c>.
        /// </summary>
