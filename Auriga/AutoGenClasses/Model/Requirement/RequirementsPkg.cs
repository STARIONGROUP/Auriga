// ------------------------------------------------------------------------------------------------
// <copyright file="RequirementsPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Requirement
{
    ...
    /// <summary>
    /// Definition of the <c>RequirementsPkg</c> class.
    /// </summary>
    public partial class RequirementsPkg : Auriga.Core.AurigaElement, Auriga.Model.Requirement.IRequirementsPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Requirement.IRequirementsPkg> OwnedRequirementPkgs => this.backingOwnedRequirementPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Requirement.IRequirementsPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRequirementPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Requirement.IRequirementsPkg> backingOwnedRequirementPkgs;

        /// <summary>
        /// Gets the owned requirements.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Requirement.IRequirement> OwnedRequirements => this.backingOwnedRequirements ??= new Auriga.Core.ContainerList<Auriga.Model.Requirement.IRequirement>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedRequirements"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Requirement.IRequirement> backingOwnedRequirements;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>RequirementsPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedRequirementPkgs)
            {
                yield return element;
            }
