// ------------------------------------------------------------------------------------------------
// <copyright file="SystemUserRequirement.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Requirement
{
    ...
    /// <summary>
    /// Definition of the <c>SystemUserRequirement</c> class.
    /// </summary>
    public partial class SystemUserRequirement : Auriga.Core.AurigaElement, Auriga.Model.Requirement.ISystemUserRequirement
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemUserRequirement</c>.
        /// </summary>
