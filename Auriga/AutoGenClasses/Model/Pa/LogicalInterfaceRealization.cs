// ------------------------------------------------------------------------------------------------
// <copyright file="LogicalInterfaceRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Pa
{
    ...
    /// <summary>
    /// Definition of the <c>LogicalInterfaceRealization</c> class.
    /// </summary>
    public partial class LogicalInterfaceRealization : Auriga.Core.AurigaElement, Auriga.Model.Pa.ILogicalInterfaceRealization
    {
        /// <summary>
        /// Gets the allocated interface.
        /// </summary>
        public Auriga.Model.Cs.IInterface AllocatedInterface => default;

        /// <summary>
        /// Gets the allocating interface allocator.
        /// </summary>
        public Auriga.Model.Cs.IInterfaceAllocator AllocatingInterfaceAllocator => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>LogicalInterfaceRealization</c>.
        /// </summary>
