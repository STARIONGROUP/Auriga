...
namespace Auriga.Model.Pa
{
    ...
    /// </summary>
    public partial class PhysicalFunctionPkg : Auriga.Core.AurigaElement, Auriga.Model.Pa.IPhysicalFunctionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Pa.IPhysicalFunction> OwnedPhysicalFunctions => this.backingOwnedPhysicalFunctions ??= new Auriga.Core.ContainerList<Auriga.Model.Pa.IPhysicalFunction>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalFunctions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Pa.IPhysicalFunction> backingOwnedPhysicalFunctions;
