...
namespace Auriga.Model.Pa
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalArchitecturePkg</c> class.
    /// </summary>
    public partial class PhysicalArchitecturePkg : Auriga.Core.AurigaElement, Auriga.Model.Pa.IPhysicalArchitecturePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Pa.IPhysicalArchitecturePkg> OwnedPhysicalArchitecturePkgs => this.backingOwnedPhysicalArchitecturePkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Pa.IPhysicalArchitecturePkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalArchitecturePkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Pa.IPhysicalArchitecturePkg> backingOwnedPhysicalArchitecturePkgs;

        /// <summary>
        /// Gets the owned physical architectures.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Pa.IPhysicalArchitecture> OwnedPhysicalArchitectures => this.backingOwnedPhysicalArchitectures ??= new Auriga.Core.ContainerList<Auriga.Model.Pa.IPhysicalArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalArchitectures"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Pa.IPhysicalArchitecture> backingOwnedPhysicalArchitectures;
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedPhysicalArchitecturePkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedPhysicalArchitectures)
            {
                yield return element;
            }
