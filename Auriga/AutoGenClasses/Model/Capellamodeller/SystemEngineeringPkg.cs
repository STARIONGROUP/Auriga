// ------------------------------------------------------------------------------------------------
// <copyright file="SystemEngineeringPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellamodeller
{
    ...
    /// <summary>
    /// Definition of the <c>SystemEngineeringPkg</c> class.
    /// </summary>
    public partial class SystemEngineeringPkg : Auriga.Core.AurigaElement, Auriga.Model.Capellamodeller.ISystemEngineeringPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellamodeller.ISystemEngineering> OwnedSystemEngineerings => this.backingOwnedSystemEngineerings ??= new Auriga.Core.ContainerList<Auriga.Model.Capellamodeller.ISystemEngineering>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSystemEngineerings"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellamodeller.ISystemEngineering> backingOwnedSystemEngineerings;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SystemEngineeringPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedSystemEngineerings)
            {
                yield return element;
            }
