// ------------------------------------------------------------------------------------------------
// <copyright file="Library.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Capellamodeller
{
    ...
    /// <summary>
    /// Definition of the <c>Library</c> class.
    /// </summary>
    public partial class Library : Auriga.Core.AurigaElement, Auriga.Model.Capellamodeller.ILibrary
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellacore.IKeyValue> KeyValuePairs => this.backingKeyValuePairs ??= new Auriga.Core.ContainerList<Auriga.Model.Capellacore.IKeyValue>(this);

        /// <summary>
        /// Backing field for <see cref="KeyValuePairs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellacore.IKeyValue> backingKeyValuePairs;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellamodeller.IFolder> OwnedFolders => this.backingOwnedFolders ??= new Auriga.Core.ContainerList<Auriga.Model.Capellamodeller.IFolder>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedFolders"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellamodeller.IFolder> backingOwnedFolders;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Capellamodeller.IModelRoot> OwnedModelRoots => this.backingOwnedModelRoots ??= new Auriga.Core.ContainerList<Auriga.Model.Capellamodeller.IModelRoot>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedModelRoots"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Capellamodeller.IModelRoot> backingOwnedModelRoots;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Library</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.KeyValuePairs)
            {
            ...
            foreach (var element in this.OwnedFolders)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedModelRoots)
            {
                yield return element;
            }
