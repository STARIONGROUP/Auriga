// ------------------------------------------------------------------------------------------------
// <copyright file="AbstractCapabilityExtend.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>AbstractCapabilityExtend</c> class.
    /// </summary>
    public partial class AbstractCapabilityExtend : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IAbstractCapabilityExtend
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability Extended { get; set; }

        /// <summary>
        /// Gets the extension.
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability Extension => default;

        /// <summary>
        /// Gets or sets the extension location.
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapabilityExtensionPoint ExtensionLocation { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>AbstractCapabilityExtend</c>.
        /// </summary>
