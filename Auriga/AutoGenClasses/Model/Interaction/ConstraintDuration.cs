// ------------------------------------------------------------------------------------------------
// <copyright file="ConstraintDuration.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>ConstraintDuration</c> class.
    /// </summary>
    public partial class ConstraintDuration : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IConstraintDuration
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ConstraintDuration</c>.
        /// </summary>
