// ------------------------------------------------------------------------------------------------
// <copyright file="MergeLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>MergeLink</c> class.
    /// </summary>
    public partial class MergeLink : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IMergeLink
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>MergeLink</c>.
        /// </summary>
