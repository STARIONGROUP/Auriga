...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>InteractionOperand</c> class.
    /// </summary>
    public partial class InteractionOperand : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IInteractionOperand
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Interaction.IInteractionFragment> ReferencedInteractionFragments { get; } = new List<Auriga.Model.Interaction.IInteractionFragment>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InteractionOperand</c>.
        /// </summary>
