// ------------------------------------------------------------------------------------------------
// <copyright file="MessageEnd.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>MessageEnd</c> class.
    /// </summary>
    public partial class MessageEnd : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IMessageEnd
    {
        /// <summary>
        ...
        /// Gets the message.
        /// </summary>
        public Auriga.Model.Interaction.ISequenceMessage Message => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>MessageEnd</c>.
        /// </summary>
