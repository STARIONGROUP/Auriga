// ------------------------------------------------------------------------------------------------
// <copyright file="EventSentOperation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>EventSentOperation</c> class.
    /// </summary>
    public partial class EventSentOperation : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IEventSentOperation
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>EventSentOperation</c>.
        /// </summary>
