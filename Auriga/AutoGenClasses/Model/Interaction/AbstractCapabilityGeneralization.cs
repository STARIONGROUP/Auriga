// ------------------------------------------------------------------------------------------------
// <copyright file="AbstractCapabilityGeneralization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>AbstractCapabilityGeneralization</c> class.
    /// </summary>
    public partial class AbstractCapabilityGeneralization : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IAbstractCapabilityGeneralization
    {
        /// <summary>
        ...
        /// Gets the sub.
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability Sub => default;
        ...
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability Super { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>AbstractCapabilityGeneralization</c>.
        /// </summary>
