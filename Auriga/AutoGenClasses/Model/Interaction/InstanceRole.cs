// ------------------------------------------------------------------------------------------------
// <copyright file="InstanceRole.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>InstanceRole</c> class.
    /// </summary>
    public partial class InstanceRole : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IInstanceRole
    {
        /// <summary>
        /// Gets the abstract ends.
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IAbstractEnd> AbstractEnds => Enumerable.Empty<Auriga.Model.Interaction.IAbstractEnd>();
        ...
        /// </summary>
        public Auriga.Model.Information.IAbstractInstance RepresentedInstance { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InstanceRole</c>.
        /// </summary>
