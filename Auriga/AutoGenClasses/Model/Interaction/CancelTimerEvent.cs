// ------------------------------------------------------------------------------------------------
// <copyright file="CancelTimerEvent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>CancelTimerEvent</c> class.
    /// </summary>
    public partial class CancelTimerEvent : Auriga.Core.AurigaElement, Auriga.Model.Interaction.ICancelTimerEvent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CancelTimerEvent</c>.
        /// </summary>
