// ------------------------------------------------------------------------------------------------
// <copyright file="ArmTimerEvent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>ArmTimerEvent</c> class.
    /// </summary>
    public partial class ArmTimerEvent : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IArmTimerEvent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ArmTimerEvent</c>.
        /// </summary>
