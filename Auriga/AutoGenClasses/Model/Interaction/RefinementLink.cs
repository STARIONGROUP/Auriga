// ------------------------------------------------------------------------------------------------
// <copyright file="RefinementLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>RefinementLink</c> class.
    /// </summary>
    public partial class RefinementLink : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IRefinementLink
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>RefinementLink</c>.
        /// </summary>
