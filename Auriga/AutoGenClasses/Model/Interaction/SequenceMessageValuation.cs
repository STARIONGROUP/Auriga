// ------------------------------------------------------------------------------------------------
// <copyright file="SequenceMessageValuation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>SequenceMessageValuation</c> class.
    /// </summary>
    public partial class SequenceMessageValuation : Auriga.Core.AurigaElement, Auriga.Model.Interaction.ISequenceMessageValuation
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the exchange item element.
        /// </summary>
        public Auriga.Model.Information.IExchangeItemElement ExchangeItemElement { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Modellingcore.IValueSpecification Value { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SequenceMessageValuation</c>.
        /// </summary>
