// ------------------------------------------------------------------------------------------------
// <copyright file="Execution.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>Execution</c> class.
    /// </summary>
    public partial class Execution : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IExecution
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Execution</c>.
        /// </summary>
