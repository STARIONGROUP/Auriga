// ------------------------------------------------------------------------------------------------
// <copyright file="CreationEvent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>CreationEvent</c> class.
    /// </summary>
    public partial class CreationEvent : Auriga.Core.AurigaElement, Auriga.Model.Interaction.ICreationEvent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CreationEvent</c>.
        /// </summary>
