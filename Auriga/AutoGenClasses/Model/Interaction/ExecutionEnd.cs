// ------------------------------------------------------------------------------------------------
// <copyright file="ExecutionEnd.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>ExecutionEnd</c> class.
    /// </summary>
    public partial class ExecutionEnd : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IExecutionEnd
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Interaction.IEvent Event { get; set; }

        /// <summary>
        /// Gets the execution.
        /// </summary>
        public Auriga.Model.Interaction.IExecution Execution => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExecutionEnd</c>.
        /// </summary>
