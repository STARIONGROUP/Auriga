// ------------------------------------------------------------------------------------------------
// <copyright file="CombinedFragment.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>CombinedFragment</c> class.
    /// </summary>
    public partial class CombinedFragment : Auriga.Core.AurigaElement, Auriga.Model.Interaction.ICombinedFragment
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Interaction.IGate> ExpressionGates => Enumerable.Empty<Auriga.Model.Interaction.IGate>();
        ...
        /// </summary>
        public Auriga.Model.Interaction.IInteractionFragment Finish { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Interaction.InteractionOperatorKind? Operator { get; set; } = Auriga.Model.Interaction.InteractionOperatorKind.UNSET;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.IGate> OwnedGates => this.backingOwnedGates ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.IGate>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedGates"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.IGate> backingOwnedGates;
        ...
        /// </summary>
        public List<Auriga.Model.Interaction.IInteractionOperand> ReferencedOperands { get; } = new List<Auriga.Model.Interaction.IInteractionOperand>();
        ...
        /// </summary>
        public Auriga.Model.Interaction.IInteractionFragment Start { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CombinedFragment</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedGates)
            {
                yield return element;
            }
