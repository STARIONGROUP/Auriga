// ------------------------------------------------------------------------------------------------
// <copyright file="FragmentEnd.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>FragmentEnd</c> class.
    /// </summary>
    public partial class FragmentEnd : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IFragmentEnd
    {
        /// <summary>
        /// Gets the abstract fragment.
        /// </summary>
        public Auriga.Model.Interaction.IAbstractFragment AbstractFragment => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>FragmentEnd</c>.
        /// </summary>
