// ------------------------------------------------------------------------------------------------
// <copyright file="AbstractCapabilityInclude.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>AbstractCapabilityInclude</c> class.
    /// </summary>
    public partial class AbstractCapabilityInclude : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IAbstractCapabilityInclude
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability Included { get; set; }

        /// <summary>
        /// Gets the inclusion.
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability Inclusion => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>AbstractCapabilityInclude</c>.
        /// </summary>
