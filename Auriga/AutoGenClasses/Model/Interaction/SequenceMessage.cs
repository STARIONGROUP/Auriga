// ------------------------------------------------------------------------------------------------
// <copyright file="SequenceMessage.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>SequenceMessage</c> class.
    /// </summary>
    public partial class SequenceMessage : Auriga.Core.AurigaElement, Auriga.Model.Interaction.ISequenceMessage
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.IAbstractEventOperation InvokedOperation => default;

        /// <summary>
        /// Gets or sets the kind.
        /// </summary>
        public Auriga.Model.Interaction.MessageKind? Kind { get; set; }
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Interaction.ISequenceMessageValuation> OwnedSequenceMessageValuations => this.backingOwnedSequenceMessageValuations ??= new Auriga.Core.ContainerList<Auriga.Model.Interaction.ISequenceMessageValuation>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedSequenceMessageValuations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Interaction.ISequenceMessageValuation> backingOwnedSequenceMessageValuations;

        /// <summary>
        /// Gets or sets the receiving end.
        /// </summary>
        public Auriga.Model.Interaction.IMessageEnd ReceivingEnd { get; set; }

        /// <summary>
        /// Gets the receiving function.
        /// </summary>
        public Auriga.Model.Fa.IAbstractFunction ReceivingFunction => default;

        /// <summary>
        /// Gets the receiving part.
        /// </summary>
        public Auriga.Model.Cs.IPart ReceivingPart => default;
        ...
        /// </summary>
        public Auriga.Model.Interaction.IMessageEnd SendingEnd { get; set; }

        /// <summary>
        /// Gets the sending function.
        /// </summary>
        public Auriga.Model.Fa.IAbstractFunction SendingFunction => default;

        /// <summary>
        /// Gets the sending part.
        /// </summary>
        public Auriga.Model.Cs.IPart SendingPart => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SequenceMessage</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedSequenceMessageValuations)
            {
                yield return element;
            }
        }
