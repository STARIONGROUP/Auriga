// ------------------------------------------------------------------------------------------------
// <copyright file="DestructionEvent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>DestructionEvent</c> class.
    /// </summary>
    public partial class DestructionEvent : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IDestructionEvent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>DestructionEvent</c>.
        /// </summary>
