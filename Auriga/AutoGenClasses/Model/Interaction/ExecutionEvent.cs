// ------------------------------------------------------------------------------------------------
// <copyright file="ExecutionEvent.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>ExecutionEvent</c> class.
    /// </summary>
    public partial class ExecutionEvent : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IExecutionEvent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ExecutionEvent</c>.
        /// </summary>
