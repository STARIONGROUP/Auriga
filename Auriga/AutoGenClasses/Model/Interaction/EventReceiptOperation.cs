// ------------------------------------------------------------------------------------------------
// <copyright file="EventReceiptOperation.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>EventReceiptOperation</c> class.
    /// </summary>
    public partial class EventReceiptOperation : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IEventReceiptOperation
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.IAbstractEventOperation Operation { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>EventReceiptOperation</c>.
        /// </summary>
