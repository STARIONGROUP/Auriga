// ------------------------------------------------------------------------------------------------
// <copyright file="AbstractCapabilityExtensionPoint.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>AbstractCapabilityExtensionPoint</c> class.
    /// </summary>
    public partial class AbstractCapabilityExtensionPoint : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IAbstractCapabilityExtensionPoint
    {
        /// <summary>
        /// Gets the abstract capability.
        /// </summary>
        public Auriga.Model.Interaction.IAbstractCapability AbstractCapability => default;
        ...
        /// </summary>
        public List<Auriga.Model.Interaction.IAbstractCapabilityExtend> ExtendLinks { get; } = new List<Auriga.Model.Interaction.IAbstractCapabilityExtend>();
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>AbstractCapabilityExtensionPoint</c>.
        /// </summary>
