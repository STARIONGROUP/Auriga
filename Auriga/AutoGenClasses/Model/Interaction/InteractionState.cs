// ------------------------------------------------------------------------------------------------
// <copyright file="InteractionState.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Interaction
{
    ...
    /// <summary>
    /// Definition of the <c>InteractionState</c> class.
    /// </summary>
    public partial class InteractionState : Auriga.Core.AurigaElement, Auriga.Model.Interaction.IInteractionState
    {
        /// <summary>
        ...
        /// Gets the covered.
        /// </summary>
        public Auriga.Model.Interaction.IInstanceRole Covered => default;

        /// <summary>
        /// Gets the covered instance roles.
        /// </summary>
        public List<Auriga.Model.Interaction.IInstanceRole> CoveredInstanceRoles { get; } = new List<Auriga.Model.Interaction.IInstanceRole>();
        ...
        /// </summary>
        public Auriga.Model.Fa.IAbstractFunction RelatedAbstractFunction { get; set; }

        /// <summary>
        /// @deprecated : relatedAbstractState shall not be used anymore
        /// </summary>
        public Auriga.Model.Capellacommon.IAbstractState RelatedAbstractState { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>InteractionState</c>.
        /// </summary>
