...
namespace Auriga.Model.Re
{
    ...
    /// </summary>
    public partial class CompliancyDefinitionPkg : Auriga.Core.AurigaElement, Auriga.Model.Re.ICompliancyDefinitionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Re.ICompliancyDefinition> OwnedDefinitions => this.backingOwnedDefinitions ??= new Auriga.Core.ContainerList<Auriga.Model.Re.ICompliancyDefinition>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedDefinitions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Re.ICompliancyDefinition> backingOwnedDefinitions;
