// ------------------------------------------------------------------------------------------------
// <copyright file="GroupingElementPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Re
{
    ...
    /// </summary>
    public partial class GroupingElementPkg : Auriga.Core.AurigaElement, Auriga.Model.Re.IGroupingElementPkg
    {
        /// <summary>
