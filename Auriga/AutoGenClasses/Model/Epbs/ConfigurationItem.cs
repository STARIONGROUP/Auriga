// ------------------------------------------------------------------------------------------------
// <copyright file="ConfigurationItem.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Epbs
{
    ...
    /// <summary>
    /// Definition of the <c>ConfigurationItem</c> class.
    /// </summary>
    public partial class ConfigurationItem : Auriga.Core.AurigaElement, Auriga.Model.Epbs.IConfigurationItem
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Cs.IAbstractPhysicalArtifact> AllocatedPhysicalArtifacts => Enumerable.Empty<Auriga.Model.Cs.IAbstractPhysicalArtifact>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Epbs.IConfigurationItemPkg> OwnedConfigurationItemPkgs => this.backingOwnedConfigurationItemPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.Epbs.IConfigurationItemPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConfigurationItemPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Epbs.IConfigurationItemPkg> backingOwnedConfigurationItemPkgs;

        /// <summary>
        /// Gets the owned configuration items.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Epbs.IConfigurationItem> OwnedConfigurationItems => this.backingOwnedConfigurationItems ??= new Auriga.Core.ContainerList<Auriga.Model.Epbs.IConfigurationItem>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedConfigurationItems"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Epbs.IConfigurationItem> backingOwnedConfigurationItems;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Epbs.IPhysicalArtifactRealization> OwnedPhysicalArtifactRealizations => this.backingOwnedPhysicalArtifactRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.Epbs.IPhysicalArtifactRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalArtifactRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Epbs.IPhysicalArtifactRealization> backingOwnedPhysicalArtifactRealizations;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ConfigurationItem</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedConfigurationItemPkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedConfigurationItems)
            {
                yield return element;
            }
            ...
            foreach (var element in this.OwnedPhysicalArtifactRealizations)
            {
                yield return element;
            }
