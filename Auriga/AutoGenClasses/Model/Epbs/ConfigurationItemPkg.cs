// ------------------------------------------------------------------------------------------------
// <copyright file="ConfigurationItemPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Epbs
{
    ...
    /// <summary>
    /// Definition of the <c>ConfigurationItemPkg</c> class.
    /// </summary>
    public partial class ConfigurationItemPkg : Auriga.Core.AurigaElement, Auriga.Model.Epbs.IConfigurationItemPkg
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ConfigurationItemPkg</c>.
        /// </summary>
