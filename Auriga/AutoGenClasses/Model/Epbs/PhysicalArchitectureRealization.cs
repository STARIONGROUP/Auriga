// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalArchitectureRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Epbs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalArchitectureRealization</c> class.
    /// </summary>
    public partial class PhysicalArchitectureRealization : Auriga.Core.AurigaElement, Auriga.Model.Epbs.IPhysicalArchitectureRealization
    {
        /// <summary>
        /// Gets the allocated architecture.
        /// </summary>
        public Auriga.Model.Cs.IBlockArchitecture AllocatedArchitecture => default;

        /// <summary>
        /// Gets the allocating architecture.
        /// </summary>
        public Auriga.Model.Cs.IBlockArchitecture AllocatingArchitecture => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalArchitectureRealization</c>.
        /// </summary>
