// ------------------------------------------------------------------------------------------------
// <copyright file="EPBSArchitecturePkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Epbs
{
    ...
    /// <summary>
    /// Definition of the <c>EPBSArchitecturePkg</c> class.
    /// </summary>
    public partial class EPBSArchitecturePkg : Auriga.Core.AurigaElement, Auriga.Model.Epbs.IEPBSArchitecturePkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Epbs.IEPBSArchitecture> OwnedEPBSArchitectures => this.backingOwnedEPBSArchitectures ??= new Auriga.Core.ContainerList<Auriga.Model.Epbs.IEPBSArchitecture>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedEPBSArchitectures"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Epbs.IEPBSArchitecture> backingOwnedEPBSArchitectures;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>EPBSArchitecturePkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedEPBSArchitectures)
            {
                yield return element;
            }
