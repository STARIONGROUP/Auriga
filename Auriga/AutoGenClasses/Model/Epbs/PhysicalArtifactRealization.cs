// ------------------------------------------------------------------------------------------------
// <copyright file="PhysicalArtifactRealization.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Epbs
{
    ...
    /// <summary>
    /// Definition of the <c>PhysicalArtifactRealization</c> class.
    /// </summary>
    public partial class PhysicalArtifactRealization : Auriga.Core.AurigaElement, Auriga.Model.Epbs.IPhysicalArtifactRealization
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cs.IAbstractPhysicalArtifact RealizedPhysicalArtifact => default;

        /// <summary>
        /// Gets the realizing configuration item.
        /// </summary>
        public Auriga.Model.Epbs.IConfigurationItem RealizingConfigurationItem => default;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PhysicalArtifactRealization</c>.
        /// </summary>
