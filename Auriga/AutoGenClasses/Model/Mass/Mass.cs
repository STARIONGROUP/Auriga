// ------------------------------------------------------------------------------------------------
// <copyright file="Mass.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Mass
{
    ...
    /// <summary>
    /// Definition of the <c>Mass</c> class.
    /// </summary>
    public partial class Mass : Auriga.Core.AurigaElement, Auriga.Model.Mass.IMass
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>Mass</c>.
        /// </summary>
