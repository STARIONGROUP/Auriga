...
namespace Auriga.Model.La
{
    ...
    /// </summary>
    public partial class LogicalFunctionPkg : Auriga.Core.AurigaElement, Auriga.Model.La.ILogicalFunctionPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.La.ILogicalFunction> OwnedLogicalFunctions => this.backingOwnedLogicalFunctions ??= new Auriga.Core.ContainerList<Auriga.Model.La.ILogicalFunction>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalFunctions"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.La.ILogicalFunction> backingOwnedLogicalFunctions;
