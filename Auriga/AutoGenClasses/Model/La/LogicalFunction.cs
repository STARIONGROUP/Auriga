// ------------------------------------------------------------------------------------------------
// <copyright file="LogicalFunction.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.La
{
    ...
    /// <summary>
    /// Definition of the <c>LogicalFunction</c> class.
    /// </summary>
    public partial class LogicalFunction : Auriga.Core.AurigaElement, Auriga.Model.La.ILogicalFunction
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.La.ILogicalComponent> AllocatingLogicalComponents => Enumerable.Empty<Auriga.Model.La.ILogicalComponent>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.La.ILogicalFunction> ChildrenLogicalFunctions => Enumerable.Empty<Auriga.Model.La.ILogicalFunction>();
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.La.ILogicalFunction> ContainedLogicalFunctions => Enumerable.Empty<Auriga.Model.La.ILogicalFunction>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.La.ILogicalFunctionPkg> OwnedLogicalFunctionPkgs => this.backingOwnedLogicalFunctionPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.La.ILogicalFunctionPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedLogicalFunctionPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.La.ILogicalFunctionPkg> backingOwnedLogicalFunctionPkgs;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Ctx.ISystemFunction> RealizedSystemFunctions => Enumerable.Empty<Auriga.Model.Ctx.ISystemFunction>();

        /// <summary>
        /// Gets the realizing physical functions.
        /// </summary>
        public IEnumerable<Auriga.Model.Pa.IPhysicalFunction> RealizingPhysicalFunctions => Enumerable.Empty<Auriga.Model.Pa.IPhysicalFunction>();
