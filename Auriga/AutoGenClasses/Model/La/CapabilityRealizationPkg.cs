// ------------------------------------------------------------------------------------------------
// <copyright file="CapabilityRealizationPkg.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.La
{
    ...
    /// <summary>
    /// Definition of the <c>CapabilityRealizationPkg</c> class.
    /// </summary>
    public partial class CapabilityRealizationPkg : Auriga.Core.AurigaElement, Auriga.Model.La.ICapabilityRealizationPkg
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.La.ICapabilityRealizationPkg> OwnedCapabilityRealizationPkgs => this.backingOwnedCapabilityRealizationPkgs ??= new Auriga.Core.ContainerList<Auriga.Model.La.ICapabilityRealizationPkg>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityRealizationPkgs"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.La.ICapabilityRealizationPkg> backingOwnedCapabilityRealizationPkgs;

        /// <summary>
        /// Gets the owned capability realizations.
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.La.ICapabilityRealization> OwnedCapabilityRealizations => this.backingOwnedCapabilityRealizations ??= new Auriga.Core.ContainerList<Auriga.Model.La.ICapabilityRealization>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedCapabilityRealizations"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.La.ICapabilityRealization> backingOwnedCapabilityRealizations;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CapabilityRealizationPkg</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedCapabilityRealizationPkgs)
            {
                yield return element;
            }

            foreach (var element in this.OwnedCapabilityRealizations)
            {
                yield return element;
            }
