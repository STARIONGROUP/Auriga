// ------------------------------------------------------------------------------------------------
// <copyright file="TypeDeploymentLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Pa.Deployment
{
    ...
    /// <summary>
    /// Definition of the <c>TypeDeploymentLink</c> class.
    /// </summary>
    public partial class TypeDeploymentLink : Auriga.Core.AurigaElement, Auriga.Model.Pa.Deployment.ITypeDeploymentLink
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>TypeDeploymentLink</c>.
        /// </summary>
