// ------------------------------------------------------------------------------------------------
// <copyright file="PartDeploymentLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Pa.Deployment
{
    ...
    /// <summary>
    /// Definition of the <c>PartDeploymentLink</c> class.
    /// </summary>
    public partial class PartDeploymentLink : Auriga.Core.AurigaElement, Auriga.Model.Pa.Deployment.IPartDeploymentLink
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Cs.IDeployableElement DeployedElement { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Cs.IDeploymentTarget Location { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PartDeploymentLink</c>.
        /// </summary>
