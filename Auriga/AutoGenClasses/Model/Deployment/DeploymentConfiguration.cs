// ------------------------------------------------------------------------------------------------
// <copyright file="DeploymentConfiguration.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Pa.Deployment
{
    ...
    /// <summary>
    /// Definition of the <c>DeploymentConfiguration</c> class.
    /// </summary>
    public partial class DeploymentConfiguration : Auriga.Core.AurigaElement, Auriga.Model.Pa.Deployment.IDeploymentConfiguration
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Pa.Deployment.IAbstractPhysicalInstance> OwnedPhysicalInstances => this.backingOwnedPhysicalInstances ??= new Auriga.Core.ContainerList<Auriga.Model.Pa.Deployment.IAbstractPhysicalInstance>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedPhysicalInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Pa.Deployment.IAbstractPhysicalInstance> backingOwnedPhysicalInstances;
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>DeploymentConfiguration</c>.
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            ...
            foreach (var element in this.OwnedPhysicalInstances)
            {
                yield return element;
            }
