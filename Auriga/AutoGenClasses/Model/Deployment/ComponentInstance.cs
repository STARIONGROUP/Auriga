...
namespace Auriga.Model.Pa.Deployment
{
    ...
    /// <summary>
    /// Definition of the <c>ComponentInstance</c> class.
    /// </summary>
    public partial class ComponentInstance : Auriga.Core.AurigaElement, Auriga.Model.Pa.Deployment.IComponentInstance
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Pa.Deployment.IAbstractPhysicalInstance> OwnedAbstractPhysicalInstances => this.backingOwnedAbstractPhysicalInstances ??= new Auriga.Core.ContainerList<Auriga.Model.Pa.Deployment.IAbstractPhysicalInstance>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedAbstractPhysicalInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Pa.Deployment.IAbstractPhysicalInstance> backingOwnedAbstractPhysicalInstances;
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Pa.Deployment.IInstanceDeploymentLink> OwnedInstanceDeploymentLinks => this.backingOwnedInstanceDeploymentLinks ??= new Auriga.Core.ContainerList<Auriga.Model.Pa.Deployment.IInstanceDeploymentLink>(this);

        /// <summary>
        /// Backing field for <see cref="OwnedInstanceDeploymentLinks"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Pa.Deployment.IInstanceDeploymentLink> backingOwnedInstanceDeploymentLinks;
        ...
        /// </summary>
        public IEnumerable<Auriga.Model.Pa.Deployment.IPortInstance> PortInstances => Enumerable.Empty<Auriga.Model.Pa.Deployment.IPortInstance>();
        ...
        /// </summary>
        public Auriga.Model.Pa.IPhysicalComponent Type { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ComponentInstance</c>.
        /// </summary>
        /// <returns>the directly contained elements</returns>
        public override System.Collections.Generic.IEnumerable<Auriga.Core.IAurigaElement> QueryContainedElements()
        {
            foreach (var element in this.OwnedAbstractPhysicalInstances)
            {
            ...
            foreach (var element in this.OwnedInstanceDeploymentLinks)
            {
                yield return element;
            }
