// ------------------------------------------------------------------------------------------------
// <copyright file="ConnectionInstance.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Pa.Deployment
{
    ...
    /// <summary>
    /// Definition of the <c>ConnectionInstance</c> class.
    /// </summary>
    public partial class ConnectionInstance : Auriga.Core.AurigaElement, Auriga.Model.Pa.Deployment.IConnectionInstance
    {
        /// <summary>
        ...
        /// </summary>
        public List<Auriga.Model.Pa.Deployment.IPortInstance> ConnectionEnds { get; } = new List<Auriga.Model.Pa.Deployment.IPortInstance>();
        ...
        /// </summary>
        public Auriga.Model.Fa.IComponentExchange Type { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>ConnectionInstance</c>.
        /// </summary>
