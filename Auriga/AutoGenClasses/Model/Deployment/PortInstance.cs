...
namespace Auriga.Model.Pa.Deployment
{
    ...
    /// <summary>
    /// Definition of the <c>PortInstance</c> class.
    /// </summary>
    public partial class PortInstance : Auriga.Core.AurigaElement, Auriga.Model.Pa.Deployment.IPortInstance
    {
        /// <summary>
        ...
        /// Gets the component.
        /// </summary>
        public Auriga.Model.Pa.Deployment.IComponentInstance Component => default;

        /// <summary>
        /// Gets the connections.
        /// </summary>
        public List<Auriga.Model.Pa.Deployment.IConnectionInstance> Connections { get; } = new List<Auriga.Model.Pa.Deployment.IConnectionInstance>();
        ...
        /// </summary>
        public Auriga.Model.Fa.IComponentPort Type { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>PortInstance</c>.
        /// </summary>
