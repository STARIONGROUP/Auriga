...
namespace Auriga.Model.Information.Communication
{
    ...
    /// </summary>
    public partial class Signal : Auriga.Core.AurigaElement, Auriga.Model.Information.Communication.ISignal
    {
        /// <summary>
        ...
        /// Gets the properties.
        /// </summary>
        public IEnumerable<Auriga.Model.Information.IProperty> Properties => Enumerable.Empty<Auriga.Model.Information.IProperty>();
        ...
        /// </summary>
        public Auriga.Core.IContainerList<Auriga.Model.Information.Communication.ISignalInstance> SignalInstances => this.backingSignalInstances ??= new Auriga.Core.ContainerList<Auriga.Model.Information.Communication.ISignalInstance>(this);

        /// <summary>
        /// Backing field for <see cref="SignalInstances"/>.
        /// </summary>
        private Auriga.Core.IContainerList<Auriga.Model.Information.Communication.ISignalInstance> backingSignalInstances;
