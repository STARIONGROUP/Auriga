// ------------------------------------------------------------------------------------------------
// <copyright file="SignalInstance.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Communication
{
    ...
    /// <summary>
    /// Definition of the <c>SignalInstance</c> class.
    /// </summary>
    public partial class SignalInstance : Auriga.Core.AurigaElement, Auriga.Model.Information.Communication.ISignalInstance
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>SignalInstance</c>.
        /// </summary>
