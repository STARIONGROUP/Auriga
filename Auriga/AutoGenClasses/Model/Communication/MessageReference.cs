// ------------------------------------------------------------------------------------------------
// <copyright file="MessageReference.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Communication
{
    ...
    /// <summary>
    /// Definition of the <c>MessageReference</c> class.
    /// </summary>
    public partial class MessageReference : Auriga.Core.AurigaElement, Auriga.Model.Information.Communication.IMessageReference
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.Communication.IMessage Message { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>MessageReference</c>.
        /// </summary>
