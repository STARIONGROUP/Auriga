// ------------------------------------------------------------------------------------------------
// <copyright file="CommunicationLink.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Model.Information.Communication
{
    ...
    /// <summary>
    /// Definition of the <c>CommunicationLink</c> class.
    /// </summary>
    public partial class CommunicationLink : Auriga.Core.AurigaElement, Auriga.Model.Information.Communication.ICommunicationLink
    {
        /// <summary>
        ...
        /// </summary>
        public Auriga.Model.Information.IExchangeItem ExchangeItem { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Information.Communication.CommunicationLinkKind? Kind { get; set; }
        ...
        /// </summary>
        public Auriga.Model.Information.Communication.CommunicationLinkProtocol? Protocol { get; set; }
        ...
        /// <summary>
        /// Gets the elements directly contained by this <c>CommunicationLink</c>.
        /// </summary>
