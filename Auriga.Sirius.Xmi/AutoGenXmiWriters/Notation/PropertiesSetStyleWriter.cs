...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class PropertiesSetStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IPropertiesSetStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IPropertiesSetStyle poco, IXmiWriteContext context)
        {
