...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class IntValueStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IIntValueStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IIntValueStyle poco, IXmiWriteContext context)
        {
