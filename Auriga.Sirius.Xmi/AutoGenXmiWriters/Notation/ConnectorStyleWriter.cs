...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class ConnectorStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IConnectorStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IConnectorStyle poco, IXmiWriteContext context)
        {
