...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class BasicDecorationNodeWriter : XmiElementWriter<Auriga.Sirius.Notation.IBasicDecorationNode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IBasicDecorationNode poco, IXmiWriteContext context)
        {
