...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class ArrowStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IArrowStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IArrowStyle poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Sirius.Notation.ArrowType>(xmlWriter, "arrowSource", poco.ArrowSource);
            WriteEnumAttribute<Auriga.Sirius.Notation.ArrowType>(xmlWriter, "arrowTarget", poco.ArrowTarget);
        }
    }
}
