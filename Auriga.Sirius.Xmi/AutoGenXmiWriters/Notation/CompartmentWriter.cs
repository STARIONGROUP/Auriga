...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class CompartmentWriter : XmiElementWriter<Auriga.Sirius.Notation.ICompartment>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.ICompartment poco, IXmiWriteContext context)
        {
