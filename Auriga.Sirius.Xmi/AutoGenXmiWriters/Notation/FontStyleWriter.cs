...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class FontStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IFontStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IFontStyle poco, IXmiWriteContext context)
        {
