...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class ImageBufferStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IImageBufferStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IImageBufferStyle poco, IXmiWriteContext context)
        {
