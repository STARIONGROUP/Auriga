...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class SortingStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.ISortingStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.ISortingStyle poco, IXmiWriteContext context)
        {
