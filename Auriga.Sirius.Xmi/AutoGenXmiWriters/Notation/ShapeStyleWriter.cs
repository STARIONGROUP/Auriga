...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class ShapeStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IShapeStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IShapeStyle poco, IXmiWriteContext context)
        {
