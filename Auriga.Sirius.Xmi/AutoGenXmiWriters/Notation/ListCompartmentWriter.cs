// ------------------------------------------------------------------------------------------------
// <copyright file="ListCompartmentWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>ListCompartment</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class ListCompartmentWriter : XmiElementWriter<Auriga.Sirius.Notation.IListCompartment>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCompartmentWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public ListCompartmentWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>ListCompartment</c>.
        /// </summary>
        public override string NamespacePrefix => "notation";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>ListCompartment</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "ListCompartment";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>ListCompartment</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IListCompartment poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Sirius.Notation.Filtering>(xmlWriter, "filtering", poco.Filtering);
            ...
            WriteEnumAttribute<Auriga.Sirius.Notation.Sorting>(xmlWriter, "sorting", poco.Sorting);
