...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class SemanticListCompartmentWriter : XmiElementWriter<Auriga.Sirius.Notation.ISemanticListCompartment>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.ISemanticListCompartment poco, IXmiWriteContext context)
        {
