...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class DiagramStyleWriter : XmiElementWriter<Auriga.Sirius.Notation.IDiagramStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IDiagramStyle poco, IXmiWriteContext context)
        {
