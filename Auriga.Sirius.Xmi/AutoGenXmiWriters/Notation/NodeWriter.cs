...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class NodeWriter : XmiElementWriter<Auriga.Sirius.Notation.INode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.INode poco, IXmiWriteContext context)
        {
