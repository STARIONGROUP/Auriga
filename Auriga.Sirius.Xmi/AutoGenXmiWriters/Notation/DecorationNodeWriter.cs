...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Notation
{
    ...
    /// </summary>
    public class DecorationNodeWriter : XmiElementWriter<Auriga.Sirius.Notation.IDecorationNode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Notation.IDecorationNode poco, IXmiWriteContext context)
        {
