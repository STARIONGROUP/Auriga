...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Validation
{
    ...
    /// </summary>
    public class ViewValidationRuleWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Validation.IViewValidationRule>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Validation.IViewValidationRule poco, IXmiWriteContext context)
        {
