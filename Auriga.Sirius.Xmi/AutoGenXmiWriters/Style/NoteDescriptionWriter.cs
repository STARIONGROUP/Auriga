...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class NoteDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.INoteDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.INoteDescription poco, IXmiWriteContext context)
        {
