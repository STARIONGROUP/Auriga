...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class WorkspaceImageDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.IWorkspaceImageDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.IWorkspaceImageDescription poco, IXmiWriteContext context)
        {
