...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class DotDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.IDotDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.IDotDescription poco, IXmiWriteContext context)
        {
