...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class SquareDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.ISquareDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.ISquareDescription poco, IXmiWriteContext context)
        {
