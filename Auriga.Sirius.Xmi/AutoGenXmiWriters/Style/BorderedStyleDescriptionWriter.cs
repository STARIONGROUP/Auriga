...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class BorderedStyleDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.IBorderedStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.IBorderedStyleDescription poco, IXmiWriteContext context)
        {
