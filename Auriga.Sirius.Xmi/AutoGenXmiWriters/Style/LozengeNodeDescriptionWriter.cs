...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class LozengeNodeDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.ILozengeNodeDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.ILozengeNodeDescription poco, IXmiWriteContext context)
        {
