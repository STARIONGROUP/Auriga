...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Style
{
    ...
    /// </summary>
    public class BasicLabelStyleDescriptionWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Style.IBasicLabelStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Style.IBasicLabelStyleDescription poco, IXmiWriteContext context)
        {
