...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class GaugeCompositeStyleDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.IGaugeCompositeStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.IGaugeCompositeStyleDescription poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Sirius.Diagram.AlignmentKind>(xmlWriter, "alignment", poco.Alignment);
