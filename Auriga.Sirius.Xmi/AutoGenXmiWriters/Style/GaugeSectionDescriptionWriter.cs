...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Style
{
    ...
    /// </summary>
    public class GaugeSectionDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Style.IGaugeSectionDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Style.IGaugeSectionDescription poco, IXmiWriteContext context)
        {
