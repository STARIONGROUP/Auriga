...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Style
{
    ...
    /// </summary>
    public class LabelStyleDescriptionWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Style.ILabelStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Style.ILabelStyleDescription poco, IXmiWriteContext context)
        {
