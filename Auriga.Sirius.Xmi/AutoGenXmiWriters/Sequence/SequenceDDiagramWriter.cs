...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence
{
    using System.Xml;
    ...
    /// </summary>
    public class SequenceDDiagramWriter : XmiElementWriter<Auriga.Sirius.Sequence.ISequenceDDiagram>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.ISequenceDDiagram poco, IXmiWriteContext context)
        {
