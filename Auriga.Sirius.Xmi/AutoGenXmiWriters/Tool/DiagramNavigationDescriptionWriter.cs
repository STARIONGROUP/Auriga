...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class DiagramNavigationDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.IDiagramNavigationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.IDiagramNavigationDescription poco, IXmiWriteContext context)
        {
