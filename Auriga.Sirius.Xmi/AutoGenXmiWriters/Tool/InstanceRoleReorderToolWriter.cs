...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class InstanceRoleReorderToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleReorderTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleReorderTool poco, IXmiWriteContext context)
        {
