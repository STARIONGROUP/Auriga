...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class NodeCreationDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.INodeCreationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.INodeCreationDescription poco, IXmiWriteContext context)
        {
