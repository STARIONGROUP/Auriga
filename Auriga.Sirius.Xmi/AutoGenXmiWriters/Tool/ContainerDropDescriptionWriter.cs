...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class ContainerDropDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.IContainerDropDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.IContainerDropDescription poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteStringAttribute(xmlWriter, "documentation", poco.Documentation);
            WriteEnumAttribute<Auriga.Sirius.Viewpoint.Description.Tool.DragSource>(xmlWriter, "dragSource", poco.DragSource);
