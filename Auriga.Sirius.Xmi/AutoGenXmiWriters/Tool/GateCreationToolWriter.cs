...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class GateCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IGateCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IGateCreationTool poco, IXmiWriteContext context)
        {
