...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class FeatureChangeListenerWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.IFeatureChangeListener>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.IFeatureChangeListener poco, IXmiWriteContext context)
        {
