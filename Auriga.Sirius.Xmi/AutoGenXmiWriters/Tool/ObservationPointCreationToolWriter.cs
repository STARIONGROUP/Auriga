...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class ObservationPointCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IObservationPointCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IObservationPointCreationTool poco, IXmiWriteContext context)
        {
