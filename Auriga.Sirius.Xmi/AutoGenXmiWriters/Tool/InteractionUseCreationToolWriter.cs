...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class InteractionUseCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IInteractionUseCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IInteractionUseCreationTool poco, IXmiWriteContext context)
        {
