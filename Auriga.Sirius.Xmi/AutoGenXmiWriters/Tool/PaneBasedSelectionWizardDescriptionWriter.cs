...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class PaneBasedSelectionWizardDescriptionWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.IPaneBasedSelectionWizardDescription poco, IXmiWriteContext context)
        {
