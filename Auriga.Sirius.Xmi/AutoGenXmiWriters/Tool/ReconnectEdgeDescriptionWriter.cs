...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class ReconnectEdgeDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.IReconnectEdgeDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.IReconnectEdgeDescription poco, IXmiWriteContext context)
        {
            ...
            WriteEnumAttribute<Auriga.Sirius.Diagram.Description.Tool.ReconnectionKind>(xmlWriter, "reconnectionKind", poco.ReconnectionKind);
