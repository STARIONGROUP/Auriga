// ------------------------------------------------------------------------------------------------
// <copyright file="PopupMenuWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>PopupMenu</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class PopupMenuWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.IPopupMenu>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PopupMenuWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public PopupMenuWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>PopupMenu</c>.
        /// </summary>
        public override string NamespacePrefix => "tool";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>PopupMenu</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "PopupMenu";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>PopupMenu</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.IPopupMenu poco, IXmiWriteContext context)
        {
