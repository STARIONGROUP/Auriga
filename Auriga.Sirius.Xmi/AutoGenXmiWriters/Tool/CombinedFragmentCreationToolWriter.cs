...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class CombinedFragmentCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.ICombinedFragmentCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.ICombinedFragmentCreationTool poco, IXmiWriteContext context)
        {
