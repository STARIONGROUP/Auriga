...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class ToolDescriptionWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.IToolDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.IToolDescription poco, IXmiWriteContext context)
        {
