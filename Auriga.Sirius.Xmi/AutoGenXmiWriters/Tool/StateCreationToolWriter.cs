...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class StateCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IStateCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IStateCreationTool poco, IXmiWriteContext context)
        {
