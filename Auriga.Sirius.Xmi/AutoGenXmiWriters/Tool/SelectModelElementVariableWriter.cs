...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class SelectModelElementVariableWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.ISelectModelElementVariable>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.ISelectModelElementVariable poco, IXmiWriteContext context)
        {
