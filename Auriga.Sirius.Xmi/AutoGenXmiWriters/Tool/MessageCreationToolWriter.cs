...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class MessageCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IMessageCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IMessageCreationTool poco, IXmiWriteContext context)
        {
