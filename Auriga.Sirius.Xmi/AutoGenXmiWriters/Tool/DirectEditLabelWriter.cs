...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class DirectEditLabelWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.IDirectEditLabel>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.IDirectEditLabel poco, IXmiWriteContext context)
        {
