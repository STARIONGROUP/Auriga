...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class EditMaskVariablesWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.IEditMaskVariables>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.IEditMaskVariables poco, IXmiWriteContext context)
        {
