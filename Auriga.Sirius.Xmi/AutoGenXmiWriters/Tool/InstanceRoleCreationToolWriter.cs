...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class InstanceRoleCreationToolWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleCreationTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleCreationTool poco, IXmiWriteContext context)
        {
