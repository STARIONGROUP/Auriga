...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class OperationActionWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.Tool.IOperationAction>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.Tool.IOperationAction poco, IXmiWriteContext context)
        {
