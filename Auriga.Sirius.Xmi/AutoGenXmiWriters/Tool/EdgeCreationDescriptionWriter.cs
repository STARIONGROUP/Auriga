...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class EdgeCreationDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.IEdgeCreationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.IEdgeCreationDescription poco, IXmiWriteContext context)
        {
