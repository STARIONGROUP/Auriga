...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class BehaviorToolWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Tool.IBehaviorTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Tool.IBehaviorTool poco, IXmiWriteContext context)
        {
