...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class NoteWriter : XmiElementWriter<Auriga.Sirius.Diagram.INote>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.INote poco, IXmiWriteContext context)
        {
