...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class GaugeCompositeStyleWriter : XmiElementWriter<Auriga.Sirius.Diagram.IGaugeCompositeStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IGaugeCompositeStyle poco, IXmiWriteContext context)
        {
