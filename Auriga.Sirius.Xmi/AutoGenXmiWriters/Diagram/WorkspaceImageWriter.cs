...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class WorkspaceImageWriter : XmiElementWriter<Auriga.Sirius.Diagram.IWorkspaceImage>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IWorkspaceImage poco, IXmiWriteContext context)
        {
