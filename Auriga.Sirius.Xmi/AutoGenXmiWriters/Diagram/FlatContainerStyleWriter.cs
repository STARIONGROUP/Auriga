...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class FlatContainerStyleWriter : XmiElementWriter<Auriga.Sirius.Diagram.IFlatContainerStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IFlatContainerStyle poco, IXmiWriteContext context)
        {
