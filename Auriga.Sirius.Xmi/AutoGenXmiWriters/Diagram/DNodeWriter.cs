...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class DNodeWriter : XmiElementWriter<Auriga.Sirius.Diagram.IDNode>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IDNode poco, IXmiWriteContext context)
        {
