...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class ShapeContainerStyleWriter : XmiElementWriter<Auriga.Sirius.Diagram.IShapeContainerStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IShapeContainerStyle poco, IXmiWriteContext context)
        {
