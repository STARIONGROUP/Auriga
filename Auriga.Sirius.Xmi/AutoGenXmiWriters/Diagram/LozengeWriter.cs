...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class LozengeWriter : XmiElementWriter<Auriga.Sirius.Diagram.ILozenge>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.ILozenge poco, IXmiWriteContext context)
        {
