...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class BundledImageWriter : XmiElementWriter<Auriga.Sirius.Diagram.IBundledImage>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IBundledImage poco, IXmiWriteContext context)
        {
