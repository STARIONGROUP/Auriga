...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class DNodeListElementWriter : XmiElementWriter<Auriga.Sirius.Diagram.IDNodeListElement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IDNodeListElement poco, IXmiWriteContext context)
        {
