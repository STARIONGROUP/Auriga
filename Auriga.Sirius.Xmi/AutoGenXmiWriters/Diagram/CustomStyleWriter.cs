...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class CustomStyleWriter : XmiElementWriter<Auriga.Sirius.Diagram.ICustomStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.ICustomStyle poco, IXmiWriteContext context)
        {
