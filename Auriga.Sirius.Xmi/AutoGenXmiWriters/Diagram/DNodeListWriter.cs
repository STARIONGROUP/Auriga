...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class DNodeListWriter : XmiElementWriter<Auriga.Sirius.Diagram.IDNodeList>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IDNodeList poco, IXmiWriteContext context)
        {
