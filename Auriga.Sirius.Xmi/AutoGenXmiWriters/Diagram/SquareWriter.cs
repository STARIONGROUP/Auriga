...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class SquareWriter : XmiElementWriter<Auriga.Sirius.Diagram.ISquare>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.ISquare poco, IXmiWriteContext context)
        {
