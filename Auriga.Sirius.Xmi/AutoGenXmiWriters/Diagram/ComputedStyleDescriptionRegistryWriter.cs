...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram
{
    ...
    /// </summary>
    public class ComputedStyleDescriptionRegistryWriter : XmiElementWriter<Auriga.Sirius.Diagram.IComputedStyleDescriptionRegistry>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.IComputedStyleDescriptionRegistry poco, IXmiWriteContext context)
        {
