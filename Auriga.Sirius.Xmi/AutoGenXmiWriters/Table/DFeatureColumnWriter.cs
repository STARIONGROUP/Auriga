// ------------------------------------------------------------------------------------------------
// <copyright file="DFeatureColumnWriter.cs" company="Starion Group S.A.">
//
...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table
{
    ...
    /// <summary>
    /// The generated XMI writer that serializes an <c>DFeatureColumn</c> back to its XMI
    /// representation. Contained elements are written recursively through the facade; cross-references are
    /// written as <c>#id</c> (or cross-document <c>href</c>) attributes.
    /// </summary>
    public class DFeatureColumnWriter : XmiElementWriter<Auriga.Sirius.Table.IDFeatureColumn>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DFeatureColumnWriter"/> class.
        /// </summary>
        /// <param name="facade">the writer facade used to write contained elements</param>
        /// <param name="loggerFactory">the logger factory, or <c>null</c> to disable logging</param>
        public DFeatureColumnWriter(IXmiElementWriterFacade facade, ILoggerFactory? loggerFactory)
        ...
        /// declares <c>DFeatureColumn</c>.
        /// </summary>
        public override string NamespacePrefix => "table";

        /// <summary>
        /// Gets the unqualified XMI type name (<c>DFeatureColumn</c>) written in the element's
        /// <c>xsi:type</c>.
        /// </summary>
        public override string TypeName => "DFeatureColumn";
        ...
        /// <summary>
        /// Writes the <c>id</c>, attributes and contained children of an <c>DFeatureColumn</c>.
        /// </summary>
        /// <param name="xmlWriter">the XML writer</param>
        /// <param name="poco">the element whose body to write</param>
        /// <param name="context">the write context</param>
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.IDFeatureColumn poco, IXmiWriteContext context)
        {
