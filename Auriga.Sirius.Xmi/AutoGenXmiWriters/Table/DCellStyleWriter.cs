...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table
{
    ...
    /// </summary>
    public class DCellStyleWriter : XmiElementWriter<Auriga.Sirius.Table.IDCellStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.IDCellStyle poco, IXmiWriteContext context)
        {
