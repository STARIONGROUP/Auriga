...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description.Concern
{
    ...
    /// </summary>
    public class ConcernDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.Concern.IConcernDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.Concern.IConcernDescription poco, IXmiWriteContext context)
        {
