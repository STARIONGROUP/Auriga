...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class CreateLineToolWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ICreateLineTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ICreateLineTool poco, IXmiWriteContext context)
        {
