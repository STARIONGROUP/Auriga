...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class BasicMessageMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IBasicMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IBasicMessageMapping poco, IXmiWriteContext context)
        {
