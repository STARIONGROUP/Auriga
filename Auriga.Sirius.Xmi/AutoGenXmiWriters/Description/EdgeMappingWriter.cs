...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class EdgeMappingWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IEdgeMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IEdgeMapping poco, IXmiWriteContext context)
        {
