...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class NodeMappingWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.INodeMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.INodeMapping poco, IXmiWriteContext context)
        {
