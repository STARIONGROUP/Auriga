...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class StateMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IStateMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IStateMapping poco, IXmiWriteContext context)
        {
