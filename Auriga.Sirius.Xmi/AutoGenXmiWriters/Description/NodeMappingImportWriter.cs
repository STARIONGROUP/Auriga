...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class NodeMappingImportWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.INodeMappingImport>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.INodeMappingImport poco, IXmiWriteContext context)
        {
