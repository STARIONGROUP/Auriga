...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class CreateCrossColumnToolWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ICreateCrossColumnTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ICreateCrossColumnTool poco, IXmiWriteContext context)
        {
