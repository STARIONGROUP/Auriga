...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class DiagramExtensionDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IDiagramExtensionDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IDiagramExtensionDescription poco, IXmiWriteContext context)
        {
