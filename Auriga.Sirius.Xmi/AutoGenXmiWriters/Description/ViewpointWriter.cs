...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class ViewpointWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.IViewpoint>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.IViewpoint poco, IXmiWriteContext context)
        {
