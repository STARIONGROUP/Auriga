...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class CompositeLayoutWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.ICompositeLayout>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.ICompositeLayout poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Sirius.Diagram.Description.LayoutDirection>(xmlWriter, "direction", poco.Direction);
            WriteStringAttribute(xmlWriter, "documentation", poco.Documentation);
            WriteIntegerAttribute(xmlWriter, "padding", poco.Padding);
        }
    }
}
