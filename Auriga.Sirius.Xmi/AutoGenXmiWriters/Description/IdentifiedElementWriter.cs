...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class IdentifiedElementWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.IIdentifiedElement>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.IIdentifiedElement poco, IXmiWriteContext context)
        {
