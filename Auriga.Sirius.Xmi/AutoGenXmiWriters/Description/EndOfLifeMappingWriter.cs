...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class EndOfLifeMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IEndOfLifeMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IEndOfLifeMapping poco, IXmiWriteContext context)
        {
