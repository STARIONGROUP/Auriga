...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class ContainerMappingImportWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IContainerMappingImport>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IContainerMappingImport poco, IXmiWriteContext context)
        {
