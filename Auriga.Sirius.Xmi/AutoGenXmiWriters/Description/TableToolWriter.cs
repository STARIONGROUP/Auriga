...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class TableToolWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ITableTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ITableTool poco, IXmiWriteContext context)
        {
