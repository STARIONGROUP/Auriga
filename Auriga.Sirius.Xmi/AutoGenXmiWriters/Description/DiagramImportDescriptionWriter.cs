...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class DiagramImportDescriptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IDiagramImportDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IDiagramImportDescription poco, IXmiWriteContext context)
        {
