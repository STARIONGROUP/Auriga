...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class ExecutionMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IExecutionMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IExecutionMapping poco, IXmiWriteContext context)
        {
