...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class CreateColumnToolWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ICreateColumnTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ICreateColumnTool poco, IXmiWriteContext context)
        {
