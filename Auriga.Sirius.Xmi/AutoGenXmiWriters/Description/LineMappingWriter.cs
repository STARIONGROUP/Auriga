...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class LineMappingWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ILineMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ILineMapping poco, IXmiWriteContext context)
        {
