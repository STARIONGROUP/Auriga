...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class EditionTableDescriptionWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IEditionTableDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IEditionTableDescription poco, IXmiWriteContext context)
        {
