...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class DeleteLineToolWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IDeleteLineTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IDeleteLineTool poco, IXmiWriteContext context)
        {
