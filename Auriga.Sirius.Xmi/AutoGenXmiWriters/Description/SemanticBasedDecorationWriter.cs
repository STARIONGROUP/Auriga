...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class SemanticBasedDecorationWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.ISemanticBasedDecoration>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.ISemanticBasedDecoration poco, IXmiWriteContext context)
        {
