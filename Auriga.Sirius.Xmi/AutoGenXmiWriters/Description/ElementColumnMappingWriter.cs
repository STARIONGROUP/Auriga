...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class ElementColumnMappingWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IElementColumnMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IElementColumnMapping poco, IXmiWriteContext context)
        {
