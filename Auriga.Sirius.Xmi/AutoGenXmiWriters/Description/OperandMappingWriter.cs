...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class OperandMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IOperandMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IOperandMapping poco, IXmiWriteContext context)
        {
