...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class CombinedFragmentMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.ICombinedFragmentMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.ICombinedFragmentMapping poco, IXmiWriteContext context)
        {
