...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class MappingBasedDecorationWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IMappingBasedDecoration>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IMappingBasedDecoration poco, IXmiWriteContext context)
        {
