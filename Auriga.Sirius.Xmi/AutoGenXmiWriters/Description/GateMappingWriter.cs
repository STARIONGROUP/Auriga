...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class GateMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IGateMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IGateMapping poco, IXmiWriteContext context)
        {
