...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class ForegroundConditionalStyleWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IForegroundConditionalStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IForegroundConditionalStyle poco, IXmiWriteContext context)
        {
