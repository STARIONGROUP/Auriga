...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class GenericDecorationDescriptionWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.IGenericDecorationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.IGenericDecorationDescription poco, IXmiWriteContext context)
        {
            WriteId(xmlWriter, poco);
            WriteEnumAttribute<Auriga.Sirius.Viewpoint.Description.DecorationDistributionDirection>(xmlWriter, "distributionDirection", poco.DistributionDirection);
            WriteStringAttribute(xmlWriter, "imageExpression", poco.ImageExpression);
            WriteStringAttribute(xmlWriter, "name", poco.Name);
            WriteEnumAttribute<Auriga.Sirius.Viewpoint.Description.Position>(xmlWriter, "position", poco.Position);
