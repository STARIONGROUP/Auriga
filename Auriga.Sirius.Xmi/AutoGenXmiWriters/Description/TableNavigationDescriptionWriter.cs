...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class TableNavigationDescriptionWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ITableNavigationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ITableNavigationDescription poco, IXmiWriteContext context)
        {
