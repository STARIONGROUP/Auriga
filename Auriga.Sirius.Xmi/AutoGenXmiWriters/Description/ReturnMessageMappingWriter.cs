...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class ReturnMessageMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IReturnMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IReturnMessageMapping poco, IXmiWriteContext context)
        {
