...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class DeleteColumnToolWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IDeleteColumnTool>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IDeleteColumnTool poco, IXmiWriteContext context)
        {
