...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class IntersectionMappingWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IIntersectionMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IIntersectionMapping poco, IXmiWriteContext context)
        {
