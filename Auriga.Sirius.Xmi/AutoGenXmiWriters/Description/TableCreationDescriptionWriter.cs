...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class TableCreationDescriptionWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ITableCreationDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ITableCreationDescription poco, IXmiWriteContext context)
        {
