...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class InteractionUseMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IInteractionUseMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IInteractionUseMapping poco, IXmiWriteContext context)
        {
