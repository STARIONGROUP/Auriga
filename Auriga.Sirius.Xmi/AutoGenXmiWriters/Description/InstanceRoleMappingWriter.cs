...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Description
{
    ...
    /// </summary>
    public class InstanceRoleMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Description.IInstanceRoleMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Description.IInstanceRoleMapping poco, IXmiWriteContext context)
        {
