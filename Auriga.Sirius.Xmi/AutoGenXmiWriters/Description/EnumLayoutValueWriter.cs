...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class EnumLayoutValueWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IEnumLayoutValue>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IEnumLayoutValue poco, IXmiWriteContext context)
        {
