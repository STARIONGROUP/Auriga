...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class CrossTableDescriptionWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ICrossTableDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ICrossTableDescription poco, IXmiWriteContext context)
        {
