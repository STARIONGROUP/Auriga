...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class FeatureColumnMappingWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IFeatureColumnMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IFeatureColumnMapping poco, IXmiWriteContext context)
        {
