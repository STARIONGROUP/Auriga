...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint.Description
{
    ...
    /// </summary>
    public class EAttributeCustomizationWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.Description.IEAttributeCustomization>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.Description.IEAttributeCustomization poco, IXmiWriteContext context)
        {
