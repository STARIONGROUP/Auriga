...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class ForegroundStyleDescriptionWriter : XmiElementWriter<Auriga.Sirius.Table.Description.IForegroundStyleDescription>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.IForegroundStyleDescription poco, IXmiWriteContext context)
        {
