...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Table.Description
{
    ...
    /// </summary>
    public class TableMappingWriter : XmiElementWriter<Auriga.Sirius.Table.Description.ITableMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Table.Description.ITableMapping poco, IXmiWriteContext context)
        {
