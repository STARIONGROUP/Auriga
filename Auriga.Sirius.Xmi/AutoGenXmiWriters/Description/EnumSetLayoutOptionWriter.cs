...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Diagram.Description
{
    ...
    /// </summary>
    public class EnumSetLayoutOptionWriter : XmiElementWriter<Auriga.Sirius.Diagram.Description.IEnumSetLayoutOption>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Diagram.Description.IEnumSetLayoutOption poco, IXmiWriteContext context)
        {
