...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class DResourceContainerWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.IDResourceContainer>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.IDResourceContainer poco, IXmiWriteContext context)
        {
