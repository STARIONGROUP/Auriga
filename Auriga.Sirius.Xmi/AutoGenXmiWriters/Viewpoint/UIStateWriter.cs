...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class UIStateWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.IUIState>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.IUIState poco, IXmiWriteContext context)
        {
