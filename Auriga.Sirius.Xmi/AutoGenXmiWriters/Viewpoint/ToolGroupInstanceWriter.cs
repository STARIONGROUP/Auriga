...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class ToolGroupInstanceWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.IToolGroupInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.IToolGroupInstance poco, IXmiWriteContext context)
        {
