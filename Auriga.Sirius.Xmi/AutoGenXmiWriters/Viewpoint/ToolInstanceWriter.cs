...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class ToolInstanceWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.IToolInstance>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.IToolInstance poco, IXmiWriteContext context)
        {
