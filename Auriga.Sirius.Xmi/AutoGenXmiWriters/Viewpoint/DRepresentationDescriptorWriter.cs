...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Viewpoint
{
    ...
    /// </summary>
    public class DRepresentationDescriptorWriter : XmiElementWriter<Auriga.Sirius.Viewpoint.IDRepresentationDescriptor>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Viewpoint.IDRepresentationDescriptor poco, IXmiWriteContext context)
        {
