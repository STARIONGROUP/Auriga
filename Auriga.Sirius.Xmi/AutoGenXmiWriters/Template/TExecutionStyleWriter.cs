...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TExecutionStyleWriter : XmiElementWriter<Auriga.Sirius.Sequence.Template.ITExecutionStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Template.ITExecutionStyle poco, IXmiWriteContext context)
        {
