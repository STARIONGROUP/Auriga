...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TLifelineStyleWriter : XmiElementWriter<Auriga.Sirius.Sequence.Template.ITLifelineStyle>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Template.ITLifelineStyle poco, IXmiWriteContext context)
        {
