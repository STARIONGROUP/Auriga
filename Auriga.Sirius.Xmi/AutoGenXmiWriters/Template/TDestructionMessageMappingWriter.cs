...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TDestructionMessageMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Template.ITDestructionMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Template.ITDestructionMessageMapping poco, IXmiWriteContext context)
        {
