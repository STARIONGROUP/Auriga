...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TCreationMessageMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Template.ITCreationMessageMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Template.ITCreationMessageMapping poco, IXmiWriteContext context)
        {
