...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TExecutionMappingWriter : XmiElementWriter<Auriga.Sirius.Sequence.Template.ITExecutionMapping>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Template.ITExecutionMapping poco, IXmiWriteContext context)
        {
