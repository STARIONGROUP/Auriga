...
namespace Auriga.Sirius.Xmi.AutoGenXmiWriters.Sequence.Template
{
    ...
    /// </summary>
    public class TSequenceDiagramWriter : XmiElementWriter<Auriga.Sirius.Sequence.Template.ITSequenceDiagram>
    {
        /// <summary>
        ...
        protected override void WriteBody(XmlWriter xmlWriter, Auriga.Sirius.Sequence.Template.ITSequenceDiagram poco, IXmiWriteContext context)
        {
