...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class CenterLabelStyleReader : XmiElementReader<Auriga.Sirius.Diagram.ICenterLabelStyle>, IXmiElementReader<Auriga.Sirius.Diagram.ICenterLabelStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.ICenterLabelStyle"/></returns>
        public Auriga.Sirius.Diagram.ICenterLabelStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.CenterLabelStyle();
