...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class BundledImageReader : XmiElementReader<Auriga.Sirius.Diagram.IBundledImage>, IXmiElementReader<Auriga.Sirius.Diagram.IBundledImage>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IBundledImage"/></returns>
        public Auriga.Sirius.Diagram.IBundledImage Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.BundledImage();
