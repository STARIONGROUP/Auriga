...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DSemanticDiagramReader : XmiElementReader<Auriga.Sirius.Diagram.IDSemanticDiagram>, IXmiElementReader<Auriga.Sirius.Diagram.IDSemanticDiagram>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IDSemanticDiagram"/></returns>
        public Auriga.Sirius.Diagram.IDSemanticDiagram Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.DSemanticDiagram();
