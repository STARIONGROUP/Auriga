...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class NoteReader : XmiElementReader<Auriga.Sirius.Diagram.INote>, IXmiElementReader<Auriga.Sirius.Diagram.INote>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.INote"/></returns>
        public Auriga.Sirius.Diagram.INote Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Note();
