...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DNodeListReader : XmiElementReader<Auriga.Sirius.Diagram.IDNodeList>, IXmiElementReader<Auriga.Sirius.Diagram.IDNodeList>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IDNodeList"/></returns>
        public Auriga.Sirius.Diagram.IDNodeList Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.DNodeList();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedElements":
                            {
                                ...
                                {
                                    poco.OwnedElements.Add((Auriga.Sirius.Diagram.IDNodeListElement)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
