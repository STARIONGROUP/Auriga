...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DEdgeReader : XmiElementReader<Auriga.Sirius.Diagram.IDEdge>, IXmiElementReader<Auriga.Sirius.Diagram.IDEdge>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IDEdge"/></returns>
        public Auriga.Sirius.Diagram.IDEdge Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.DEdge();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedStyle":
                            {
                                ...
                                {
                                    poco.OwnedStyle = (Auriga.Sirius.Diagram.IEdgeStyle)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
