...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class BracketEdgeStyleReader : XmiElementReader<Auriga.Sirius.Diagram.IBracketEdgeStyle>, IXmiElementReader<Auriga.Sirius.Diagram.IBracketEdgeStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IBracketEdgeStyle"/></returns>
        public Auriga.Sirius.Diagram.IBracketEdgeStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.BracketEdgeStyle();
