...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DotReader : XmiElementReader<Auriga.Sirius.Diagram.IDot>, IXmiElementReader<Auriga.Sirius.Diagram.IDot>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IDot"/></returns>
        public Auriga.Sirius.Diagram.IDot Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Dot();
