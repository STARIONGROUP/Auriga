...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class EllipseReader : XmiElementReader<Auriga.Sirius.Diagram.IEllipse>, IXmiElementReader<Auriga.Sirius.Diagram.IEllipse>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IEllipse"/></returns>
        public Auriga.Sirius.Diagram.IEllipse Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Ellipse();
