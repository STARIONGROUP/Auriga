...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class GaugeSectionReader : XmiElementReader<Auriga.Sirius.Diagram.IGaugeSection>, IXmiElementReader<Auriga.Sirius.Diagram.IGaugeSection>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IGaugeSection"/></returns>
        public Auriga.Sirius.Diagram.IGaugeSection Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.GaugeSection();
