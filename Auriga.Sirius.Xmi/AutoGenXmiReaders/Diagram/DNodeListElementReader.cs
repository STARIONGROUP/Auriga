...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class DNodeListElementReader : XmiElementReader<Auriga.Sirius.Diagram.IDNodeListElement>, IXmiElementReader<Auriga.Sirius.Diagram.IDNodeListElement>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IDNodeListElement"/></returns>
        public Auriga.Sirius.Diagram.IDNodeListElement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.DNodeListElement();
