...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class GaugeCompositeStyleReader : XmiElementReader<Auriga.Sirius.Diagram.IGaugeCompositeStyle>, IXmiElementReader<Auriga.Sirius.Diagram.IGaugeCompositeStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IGaugeCompositeStyle"/></returns>
        public Auriga.Sirius.Diagram.IGaugeCompositeStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.GaugeCompositeStyle();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "sections":
                            {
                                ...
                                {
                                    poco.Sections.Add((Auriga.Sirius.Diagram.IGaugeSection)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
