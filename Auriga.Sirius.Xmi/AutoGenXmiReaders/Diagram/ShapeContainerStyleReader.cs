...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class ShapeContainerStyleReader : XmiElementReader<Auriga.Sirius.Diagram.IShapeContainerStyle>, IXmiElementReader<Auriga.Sirius.Diagram.IShapeContainerStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IShapeContainerStyle"/></returns>
        public Auriga.Sirius.Diagram.IShapeContainerStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.ShapeContainerStyle();
