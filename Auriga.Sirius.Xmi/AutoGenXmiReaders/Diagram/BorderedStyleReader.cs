...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class BorderedStyleReader : XmiElementReader<Auriga.Sirius.Diagram.IBorderedStyle>, IXmiElementReader<Auriga.Sirius.Diagram.IBorderedStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IBorderedStyle"/></returns>
        public Auriga.Sirius.Diagram.IBorderedStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.BorderedStyle();
