...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class CustomStyleReader : XmiElementReader<Auriga.Sirius.Diagram.ICustomStyle>, IXmiElementReader<Auriga.Sirius.Diagram.ICustomStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.ICustomStyle"/></returns>
        public Auriga.Sirius.Diagram.ICustomStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.CustomStyle();
