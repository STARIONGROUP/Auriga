...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram
{
    ...
    /// </summary>
    public class FlatContainerStyleReader : XmiElementReader<Auriga.Sirius.Diagram.IFlatContainerStyle>, IXmiElementReader<Auriga.Sirius.Diagram.IFlatContainerStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.IFlatContainerStyle"/></returns>
        public Auriga.Sirius.Diagram.IFlatContainerStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.FlatContainerStyle();
