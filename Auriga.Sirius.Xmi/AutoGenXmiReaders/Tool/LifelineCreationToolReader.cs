...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class LifelineCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.ILifelineCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.ILifelineCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.ILifelineCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.ILifelineCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.LifelineCreationTool();
