...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Viewpoint.Description.Tool
{
    ...
    /// </summary>
    public class ExternalJavaActionCallReader : XmiElementReader<Auriga.Sirius.Viewpoint.Description.Tool.IExternalJavaActionCall>, IXmiElementReader<Auriga.Sirius.Viewpoint.Description.Tool.IExternalJavaActionCall>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Viewpoint.Description.Tool.IExternalJavaActionCall"/></returns>
        public Auriga.Sirius.Viewpoint.Description.Tool.IExternalJavaActionCall Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Viewpoint.Description.Tool.ExternalJavaActionCall();
