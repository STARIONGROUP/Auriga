...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class NodeCreationDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Tool.INodeCreationDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Tool.INodeCreationDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Tool.INodeCreationDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Tool.INodeCreationDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Tool.NodeCreationDescription();
