...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class CombinedFragmentCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.ICombinedFragmentCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.ICombinedFragmentCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.ICombinedFragmentCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.ICombinedFragmentCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.CombinedFragmentCreationTool();
