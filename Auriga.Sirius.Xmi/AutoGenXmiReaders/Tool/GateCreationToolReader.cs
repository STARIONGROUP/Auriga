...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class GateCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IGateCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IGateCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.IGateCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.IGateCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.GateCreationTool();
