...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class OperandCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IOperandCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IOperandCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.IOperandCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.IOperandCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.OperandCreationTool();
