...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class StateCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IStateCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IStateCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.IStateCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.IStateCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.StateCreationTool();
