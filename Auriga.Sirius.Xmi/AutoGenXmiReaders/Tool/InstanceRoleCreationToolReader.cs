...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class InstanceRoleCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.IInstanceRoleCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.InstanceRoleCreationTool();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "predecessor":
                            {
                                ...
                                {
                                    poco.Predecessor = (Auriga.Sirius.Viewpoint.Description.Tool.IElementVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
