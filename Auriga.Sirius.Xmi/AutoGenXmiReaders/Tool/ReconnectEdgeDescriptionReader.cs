...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class ReconnectEdgeDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Tool.IReconnectEdgeDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Tool.IReconnectEdgeDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Tool.IReconnectEdgeDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Tool.IReconnectEdgeDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Tool.ReconnectEdgeDescription();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Sirius.Diagram.Description.Tool.ReconnectionKind>(xmlReader.GetAttribute("reconnectionKind"), out var parsed))
                    {
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            case "edgeView":
                            {
                                ...
                                {
                                    poco.EdgeView = (Auriga.Sirius.Viewpoint.Description.Tool.IElementSelectVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "source":
                            {
                                ...
                                {
                                    poco.Source = (Auriga.Sirius.Diagram.Description.Tool.ISourceEdgeCreationVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "sourceView":
                            {
                                ...
                                {
                                    poco.SourceView = (Auriga.Sirius.Diagram.Description.Tool.ISourceEdgeViewCreationVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "target":
                            {
                                ...
                                {
                                    poco.Target = (Auriga.Sirius.Diagram.Description.Tool.ITargetEdgeCreationVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "targetView":
                            {
                                ...
                                {
                                    poco.TargetView = (Auriga.Sirius.Diagram.Description.Tool.ITargetEdgeViewCreationVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
