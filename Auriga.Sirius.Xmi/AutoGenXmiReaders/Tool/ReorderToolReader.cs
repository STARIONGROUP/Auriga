...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class ReorderToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IReorderTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IReorderTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.IReorderTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.IReorderTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.ReorderTool();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "finishingEndPredecessorAfter":
                            {
                                ...
                                {
                                    poco.FinishingEndPredecessorAfter = (Auriga.Sirius.Sequence.Description.IMessageEndVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "finishingEndPredecessorBefore":
                            {
                                ...
                                {
                                    poco.FinishingEndPredecessorBefore = (Auriga.Sirius.Sequence.Description.IMessageEndVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "onEventMovedOperation":
                            {
                                ...
                                {
                                    poco.OnEventMovedOperation = (Auriga.Sirius.Viewpoint.Description.Tool.IInitialOperation)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "startingEndPredecessorAfter":
                            {
                                ...
                                {
                                    poco.StartingEndPredecessorAfter = (Auriga.Sirius.Sequence.Description.IMessageEndVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "startingEndPredecessorBefore":
                            {
                                ...
                                {
                                    poco.StartingEndPredecessorBefore = (Auriga.Sirius.Sequence.Description.IMessageEndVariable)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
