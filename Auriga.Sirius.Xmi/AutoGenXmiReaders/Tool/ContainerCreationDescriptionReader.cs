...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class ContainerCreationDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Tool.IContainerCreationDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Tool.IContainerCreationDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Tool.IContainerCreationDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Tool.IContainerCreationDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Tool.ContainerCreationDescription();
