...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Tool
{
    ...
    /// </summary>
    public class EdgeCreationDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Tool.IEdgeCreationDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Tool.IEdgeCreationDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Tool.IEdgeCreationDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Tool.IEdgeCreationDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Tool.EdgeCreationDescription();
