...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description.Tool
{
    ...
    /// </summary>
    public class ObservationPointCreationToolReader : XmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IObservationPointCreationTool>, IXmiElementReader<Auriga.Sirius.Sequence.Description.Tool.IObservationPointCreationTool>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.Tool.IObservationPointCreationTool"/></returns>
        public Auriga.Sirius.Sequence.Description.Tool.IObservationPointCreationTool Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.Tool.ObservationPointCreationTool();
