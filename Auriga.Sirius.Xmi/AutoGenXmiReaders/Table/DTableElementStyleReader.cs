...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Table
{
    ...
    /// </summary>
    public class DTableElementStyleReader : XmiElementReader<Auriga.Sirius.Table.IDTableElementStyle>, IXmiElementReader<Auriga.Sirius.Table.IDTableElementStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Table.IDTableElementStyle"/></returns>
        public Auriga.Sirius.Table.IDTableElementStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Table.DTableElementStyle();
