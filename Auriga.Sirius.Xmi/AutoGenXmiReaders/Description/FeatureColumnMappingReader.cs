...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Table.Description
{
    ...
    /// </summary>
    public class FeatureColumnMappingReader : XmiElementReader<Auriga.Sirius.Table.Description.IFeatureColumnMapping>, IXmiElementReader<Auriga.Sirius.Table.Description.IFeatureColumnMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Table.Description.IFeatureColumnMapping"/></returns>
        public Auriga.Sirius.Table.Description.IFeatureColumnMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Table.Description.FeatureColumnMapping();
