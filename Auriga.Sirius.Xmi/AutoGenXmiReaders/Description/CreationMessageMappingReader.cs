...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class CreationMessageMappingReader : XmiElementReader<Auriga.Sirius.Sequence.Description.ICreationMessageMapping>, IXmiElementReader<Auriga.Sirius.Sequence.Description.ICreationMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.ICreationMessageMapping"/></returns>
        public Auriga.Sirius.Sequence.Description.ICreationMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.CreationMessageMapping();
