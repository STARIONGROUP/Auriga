...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Table.Description
{
    ...
    /// </summary>
    public class LineMappingReader : XmiElementReader<Auriga.Sirius.Table.Description.ILineMapping>, IXmiElementReader<Auriga.Sirius.Table.Description.ILineMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Table.Description.ILineMapping"/></returns>
        public Auriga.Sirius.Table.Description.ILineMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Table.Description.LineMapping();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "create":
                            {
                                ...
                                {
                                    poco.Create.Add((Auriga.Sirius.Table.Description.ICreateLineTool)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "delete":
                            {
                                ...
                                {
                                    poco.Delete = (Auriga.Sirius.Table.Description.IDeleteLineTool)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
                            ...
                            case "ownedSubLines":
                            {
                                ...
                                {
                                    poco.OwnedSubLines.Add((Auriga.Sirius.Table.Description.ILineMapping)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
