...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class SequenceDiagramDescriptionReader : XmiElementReader<Auriga.Sirius.Sequence.Description.ISequenceDiagramDescription>, IXmiElementReader<Auriga.Sirius.Sequence.Description.ISequenceDiagramDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.ISequenceDiagramDescription"/></returns>
        public Auriga.Sirius.Sequence.Description.ISequenceDiagramDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.SequenceDiagramDescription();
