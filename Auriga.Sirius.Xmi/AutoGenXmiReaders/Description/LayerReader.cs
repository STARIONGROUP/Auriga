...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class LayerReader : XmiElementReader<Auriga.Sirius.Diagram.Description.ILayer>, IXmiElementReader<Auriga.Sirius.Diagram.Description.ILayer>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.ILayer"/></returns>
        public Auriga.Sirius.Diagram.Description.ILayer Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Layer();
