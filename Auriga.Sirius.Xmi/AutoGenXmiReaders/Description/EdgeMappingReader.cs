...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class EdgeMappingReader : XmiElementReader<Auriga.Sirius.Diagram.Description.IEdgeMapping>, IXmiElementReader<Auriga.Sirius.Diagram.Description.IEdgeMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.IEdgeMapping"/></returns>
        public Auriga.Sirius.Diagram.Description.IEdgeMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.EdgeMapping();
