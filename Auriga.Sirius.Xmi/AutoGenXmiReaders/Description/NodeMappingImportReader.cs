...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class NodeMappingImportReader : XmiElementReader<Auriga.Sirius.Diagram.Description.INodeMappingImport>, IXmiElementReader<Auriga.Sirius.Diagram.Description.INodeMappingImport>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.INodeMappingImport"/></returns>
        public Auriga.Sirius.Diagram.Description.INodeMappingImport Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.NodeMappingImport();
