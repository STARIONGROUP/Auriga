...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Table.Description
{
    ...
    /// </summary>
    public class CellUpdaterReader : XmiElementReader<Auriga.Sirius.Table.Description.ICellUpdater>, IXmiElementReader<Auriga.Sirius.Table.Description.ICellUpdater>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Table.Description.ICellUpdater"/></returns>
        public Auriga.Sirius.Table.Description.ICellUpdater Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Table.Description.CellUpdater();
