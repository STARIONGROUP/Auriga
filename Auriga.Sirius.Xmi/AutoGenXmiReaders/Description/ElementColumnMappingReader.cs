...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Table.Description
{
    ...
    /// </summary>
    public class ElementColumnMappingReader : XmiElementReader<Auriga.Sirius.Table.Description.IElementColumnMapping>, IXmiElementReader<Auriga.Sirius.Table.Description.IElementColumnMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Table.Description.IElementColumnMapping"/></returns>
        public Auriga.Sirius.Table.Description.IElementColumnMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Table.Description.ElementColumnMapping();
                    ...
                    while (xmlReader.Read())
                    {
                        ...
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "create":
                            {
                                ...
                                {
                                    poco.Create.Add((Auriga.Sirius.Table.Description.ICreateColumnTool)this.Facade.QueryElement(xmlReader, documentName, namespaceUri));
                                }
                            ...
                            case "delete":
                            {
                                ...
                                {
                                    poco.Delete = (Auriga.Sirius.Table.Description.IDeleteColumnTool)this.Facade.QueryElement(xmlReader, documentName, namespaceUri);
                                }
