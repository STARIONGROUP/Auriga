...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description
{
    ...
    /// </summary>
    public class EdgeMappingImportReader : XmiElementReader<Auriga.Sirius.Diagram.Description.IEdgeMappingImport>, IXmiElementReader<Auriga.Sirius.Diagram.Description.IEdgeMappingImport>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.IEdgeMappingImport"/></returns>
        public Auriga.Sirius.Diagram.Description.IEdgeMappingImport Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.EdgeMappingImport();
