...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Table.Description
{
    ...
    /// </summary>
    public class ColumnMappingReader : XmiElementReader<Auriga.Sirius.Table.Description.IColumnMapping>, IXmiElementReader<Auriga.Sirius.Table.Description.IColumnMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Table.Description.IColumnMapping"/></returns>
        public Auriga.Sirius.Table.Description.IColumnMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Table.Description.ColumnMapping();
