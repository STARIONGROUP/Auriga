...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class BasicMessageMappingReader : XmiElementReader<Auriga.Sirius.Sequence.Description.IBasicMessageMapping>, IXmiElementReader<Auriga.Sirius.Sequence.Description.IBasicMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.IBasicMessageMapping"/></returns>
        public Auriga.Sirius.Sequence.Description.IBasicMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.BasicMessageMapping();
