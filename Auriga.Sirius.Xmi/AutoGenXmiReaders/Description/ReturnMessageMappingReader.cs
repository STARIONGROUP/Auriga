...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Description
{
    ...
    /// </summary>
    public class ReturnMessageMappingReader : XmiElementReader<Auriga.Sirius.Sequence.Description.IReturnMessageMapping>, IXmiElementReader<Auriga.Sirius.Sequence.Description.IReturnMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Description.IReturnMessageMapping"/></returns>
        public Auriga.Sirius.Sequence.Description.IReturnMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Description.ReturnMessageMapping();
