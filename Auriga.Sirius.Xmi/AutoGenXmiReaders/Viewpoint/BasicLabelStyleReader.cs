...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Viewpoint
{
    ...
    /// </summary>
    public class BasicLabelStyleReader : XmiElementReader<Auriga.Sirius.Viewpoint.IBasicLabelStyle>, IXmiElementReader<Auriga.Sirius.Viewpoint.IBasicLabelStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Viewpoint.IBasicLabelStyle"/></returns>
        public Auriga.Sirius.Viewpoint.IBasicLabelStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Viewpoint.BasicLabelStyle();
