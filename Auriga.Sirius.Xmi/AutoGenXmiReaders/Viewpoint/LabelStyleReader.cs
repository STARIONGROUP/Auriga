...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Viewpoint
{
    ...
    /// </summary>
    public class LabelStyleReader : XmiElementReader<Auriga.Sirius.Viewpoint.ILabelStyle>, IXmiElementReader<Auriga.Sirius.Viewpoint.ILabelStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Viewpoint.ILabelStyle"/></returns>
        public Auriga.Sirius.Viewpoint.ILabelStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Viewpoint.LabelStyle();
