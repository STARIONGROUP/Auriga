...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class ListCompartmentReader : XmiElementReader<Auriga.Sirius.Notation.IListCompartment>, IXmiElementReader<Auriga.Sirius.Notation.IListCompartment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IListCompartment"/></returns>
        public Auriga.Sirius.Notation.IListCompartment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.ListCompartment();
