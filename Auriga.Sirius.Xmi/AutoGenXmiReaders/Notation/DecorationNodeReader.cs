...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class DecorationNodeReader : XmiElementReader<Auriga.Sirius.Notation.IDecorationNode>, IXmiElementReader<Auriga.Sirius.Notation.IDecorationNode>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IDecorationNode"/></returns>
        public Auriga.Sirius.Notation.IDecorationNode Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.DecorationNode();
