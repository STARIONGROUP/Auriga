...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class SemanticListCompartmentReader : XmiElementReader<Auriga.Sirius.Notation.ISemanticListCompartment>, IXmiElementReader<Auriga.Sirius.Notation.ISemanticListCompartment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.ISemanticListCompartment"/></returns>
        public Auriga.Sirius.Notation.ISemanticListCompartment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.SemanticListCompartment();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Sirius.Notation.Filtering>(xmlReader.GetAttribute("filtering"), out var parsed))
                    {
                ...
                {
                    if (TryParseEnum<Auriga.Sirius.Notation.Sorting>(xmlReader.GetAttribute("sorting"), out var parsed))
                    {
                        poco.Sorting = parsed;
                    }
                }
