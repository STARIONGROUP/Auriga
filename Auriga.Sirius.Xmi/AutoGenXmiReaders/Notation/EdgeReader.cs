...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class EdgeReader : XmiElementReader<Auriga.Sirius.Notation.IEdge>, IXmiElementReader<Auriga.Sirius.Notation.IEdge>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IEdge"/></returns>
        public Auriga.Sirius.Notation.IEdge Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.Edge();
