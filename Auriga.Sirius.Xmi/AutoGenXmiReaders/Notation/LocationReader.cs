...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class LocationReader : XmiElementReader<Auriga.Sirius.Notation.ILocation>, IXmiElementReader<Auriga.Sirius.Notation.ILocation>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.ILocation"/></returns>
        public Auriga.Sirius.Notation.ILocation Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.Location();
