...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class DrawerStyleReader : XmiElementReader<Auriga.Sirius.Notation.IDrawerStyle>, IXmiElementReader<Auriga.Sirius.Notation.IDrawerStyle>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IDrawerStyle"/></returns>
        public Auriga.Sirius.Notation.IDrawerStyle Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.DrawerStyle();
