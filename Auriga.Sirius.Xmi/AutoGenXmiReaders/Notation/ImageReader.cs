...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class ImageReader : XmiElementReader<Auriga.Sirius.Notation.IImage>, IXmiElementReader<Auriga.Sirius.Notation.IImage>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IImage"/></returns>
        public Auriga.Sirius.Notation.IImage Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.Image();
