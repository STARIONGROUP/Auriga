...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class BasicCompartmentReader : XmiElementReader<Auriga.Sirius.Notation.IBasicCompartment>, IXmiElementReader<Auriga.Sirius.Notation.IBasicCompartment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IBasicCompartment"/></returns>
        public Auriga.Sirius.Notation.IBasicCompartment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.BasicCompartment();
