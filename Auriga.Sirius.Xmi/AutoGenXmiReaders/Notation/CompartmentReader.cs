...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class CompartmentReader : XmiElementReader<Auriga.Sirius.Notation.ICompartment>, IXmiElementReader<Auriga.Sirius.Notation.ICompartment>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.ICompartment"/></returns>
        public Auriga.Sirius.Notation.ICompartment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.Compartment();
