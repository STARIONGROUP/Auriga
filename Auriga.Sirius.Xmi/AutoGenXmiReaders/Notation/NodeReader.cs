...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class NodeReader : XmiElementReader<Auriga.Sirius.Notation.INode>, IXmiElementReader<Auriga.Sirius.Notation.INode>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.INode"/></returns>
        public Auriga.Sirius.Notation.INode Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.Node();
