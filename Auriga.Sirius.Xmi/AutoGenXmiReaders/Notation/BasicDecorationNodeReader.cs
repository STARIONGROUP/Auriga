...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class BasicDecorationNodeReader : XmiElementReader<Auriga.Sirius.Notation.IBasicDecorationNode>, IXmiElementReader<Auriga.Sirius.Notation.IBasicDecorationNode>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.IBasicDecorationNode"/></returns>
        public Auriga.Sirius.Notation.IBasicDecorationNode Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.BasicDecorationNode();
