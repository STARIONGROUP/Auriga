...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Notation
{
    ...
    /// </summary>
    public class SizeReader : XmiElementReader<Auriga.Sirius.Notation.ISize>, IXmiElementReader<Auriga.Sirius.Notation.ISize>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Notation.ISize"/></returns>
        public Auriga.Sirius.Notation.ISize Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Notation.Size();
