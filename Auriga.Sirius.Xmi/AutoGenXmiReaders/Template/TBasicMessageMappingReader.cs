...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Sequence.Template
{
    ...
    /// </summary>
    public class TBasicMessageMappingReader : XmiElementReader<Auriga.Sirius.Sequence.Template.ITBasicMessageMapping>, IXmiElementReader<Auriga.Sirius.Sequence.Template.ITBasicMessageMapping>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Sequence.Template.ITBasicMessageMapping"/></returns>
        public Auriga.Sirius.Sequence.Template.ITBasicMessageMapping Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Sequence.Template.TBasicMessageMapping();
