...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class BeginLabelStyleDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.IBeginLabelStyleDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.IBeginLabelStyleDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.IBeginLabelStyleDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.IBeginLabelStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.BeginLabelStyleDescription();
