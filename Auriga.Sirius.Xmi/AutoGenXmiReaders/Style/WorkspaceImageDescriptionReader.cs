...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class WorkspaceImageDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.IWorkspaceImageDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.IWorkspaceImageDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.IWorkspaceImageDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.IWorkspaceImageDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.WorkspaceImageDescription();
