...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class EdgeStyleDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.IEdgeStyleDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.IEdgeStyleDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.IEdgeStyleDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.IEdgeStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.EdgeStyleDescription();
