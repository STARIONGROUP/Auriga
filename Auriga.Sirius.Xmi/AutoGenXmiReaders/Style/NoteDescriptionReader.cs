...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class NoteDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.INoteDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.INoteDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.INoteDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.INoteDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.NoteDescription();
