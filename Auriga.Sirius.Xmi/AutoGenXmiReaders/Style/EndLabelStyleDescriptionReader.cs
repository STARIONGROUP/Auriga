...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class EndLabelStyleDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.IEndLabelStyleDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.IEndLabelStyleDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.IEndLabelStyleDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.IEndLabelStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.EndLabelStyleDescription();
