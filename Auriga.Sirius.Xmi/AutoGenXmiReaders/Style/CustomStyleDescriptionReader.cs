...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class CustomStyleDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.ICustomStyleDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.ICustomStyleDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.ICustomStyleDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.ICustomStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.CustomStyleDescription();
