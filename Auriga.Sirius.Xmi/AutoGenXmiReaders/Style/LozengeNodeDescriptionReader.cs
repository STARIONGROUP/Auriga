...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class LozengeNodeDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.ILozengeNodeDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.ILozengeNodeDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.ILozengeNodeDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.ILozengeNodeDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.LozengeNodeDescription();
