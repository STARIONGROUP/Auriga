...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class SquareDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.ISquareDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.ISquareDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.ISquareDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.ISquareDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.SquareDescription();
