...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class ShapeContainerStyleDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.IShapeContainerStyleDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.IShapeContainerStyleDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.IShapeContainerStyleDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.IShapeContainerStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.ShapeContainerStyleDescription();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Sirius.Diagram.ContainerShape>(xmlReader.GetAttribute("shape"), out var parsed))
                    {
                        poco.Shape = parsed;
                    }
                }
