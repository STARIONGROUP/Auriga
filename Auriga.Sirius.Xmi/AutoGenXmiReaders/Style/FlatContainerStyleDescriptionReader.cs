...
namespace Auriga.Sirius.Xmi.AutoGenXmiReaders.Diagram.Description.Style
{
    ...
    /// </summary>
    public class FlatContainerStyleDescriptionReader : XmiElementReader<Auriga.Sirius.Diagram.Description.Style.IFlatContainerStyleDescription>, IXmiElementReader<Auriga.Sirius.Diagram.Description.Style.IFlatContainerStyleDescription>
    {
        /// <summary>
        ...
        /// <returns>the populated <see cref="Auriga.Sirius.Diagram.Description.Style.IFlatContainerStyleDescription"/></returns>
        public Auriga.Sirius.Diagram.Description.Style.IFlatContainerStyleDescription Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            var poco = new Auriga.Sirius.Diagram.Description.Style.FlatContainerStyleDescription();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    if (TryParseEnum<Auriga.Sirius.Diagram.BackgroundStyle>(xmlReader.GetAttribute("backgroundStyle"), out var parsed))
                    {
